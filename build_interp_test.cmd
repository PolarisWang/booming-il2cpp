...
if %ERRORLEVEL% neq 0 exit /b 1
msbuild tests\contracts\native\interpreter\chaos_interpreter_integration.vcxproj /p:Configuration=RelWithDebInfo /p:Platform=x64 /t:Build /nologo /verbosity:minimal
if %ERRORLEVEL% neq 0 exit /b 1
echo.
