...
| Hotpatch 验证 runner | `tests/e2e/verification/tooling/hotupdate_verification_runner.py` |
| 验证报告生成器 | `tests/e2e/verification/tooling/hotupdate_verification_runner.py` |
