...
- 本地准备、产物路径和排障说明见 [`wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/runtime-baseline/local-verification.md`](../../../wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/runtime-baseline/local-verification.md)。
