...
Write-Host '---STDOUT---'
Get-Content 'D:\agent\booming-il2cpp\_tmp_stdout.txt' | ForEach-Object { Write-Host $_ }
Write-Host '---STDERR---'
Get-Content 'D:\agent\booming-il2cpp\_tmp_stderr.txt' | ForEach-Object { Write-Host $_ }