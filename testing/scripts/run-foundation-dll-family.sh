...
PYTHONPATH="$REPO_ROOT/testing/foundation-dll:$REPO_ROOT/testing/src/python:$REPO_ROOT/build/toolchains/run/testing/foundation_dll:$REPO_ROOT/build/toolchains/run"
export PYTHONPATH

echo "=== Foundation DLL Verification: $FAMILY_SLUG ==="
echo "PYTHONPATH=$PYTHONPATH"

python -m _core.python.cli "$FAMILY_SLUG" "$@"
