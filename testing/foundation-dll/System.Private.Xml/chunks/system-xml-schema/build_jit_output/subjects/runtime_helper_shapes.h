...
enum ShapeId : CHAOS_IL2CPP_UINT32 {
    ...
    SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_ARECOMOBJECTSAVAILABLEFORCLEANUP = 0x06EADF2Fu,
    ...
    SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_GETEXCEPTIONCODE = 0xF6D9E896u,
    SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_GETEXCEPTIONPOINTERS = 0x03A0EC4Du,
    ...
    SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_SETLASTPINVOKEERROR_SYSTEM_INT32 = 0x5A7D87C3u,
...
CHAOS_IL2CPP_INTPTR DispatchNativeInt(Args... args) {
    ...
    else if constexpr (S == SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_GETEXCEPTIONPOINTERS) {
        return reinterpret_cast<CHAOS_IL2CPP_INTPTR>(
...
void DispatchVoid(Args... args) {
    ...
    else if constexpr (S == SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_SETLASTPINVOKEERROR_SYSTEM_INT32) {
...
CHAOS_IL2CPP_INT32 DispatchInt32(Args... args) {
    ...
    else if constexpr (S == SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_ARECOMOBJECTSAVAILABLEFORCLEANUP) {
        return static_cast<CHAOS_IL2CPP_INT32>(
    ...
    else if constexpr (S == SHAPE_SYSTEM_RUNTIME_INTEROPSERVICES_MARSHAL_GETEXCEPTIONCODE) {
        return static_cast<CHAOS_IL2CPP_INT32>(
...
static_assert(SHAPE_COUNT == 367u,
