...
public static partial class MarshallingAttributesSubjects
{
    ...
    {
        try { if (((default(StructLayoutAttribute)!.Value).GetHashCode()) != ((default(StructLayoutAttribute)!.Value).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { new StructLayoutAttribute(LayoutKind.Auto); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(MarshalAsAttribute)!.Value).GetHashCode()) != ((default(MarshalAsAttribute)!.Value).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { new MarshalAsAttribute(UnmanagedType.Bool); }
        catch { _exitCode = 1; }
    }
