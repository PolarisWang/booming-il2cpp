...
public static partial class GeneratedMarshallingSubjects
{
    ...
    {
        try {
            Assert.IsNotNull(ComExposedClassAttribute.GetComInterfaceEntries(out 42));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            new ComExposedClassAttribute<byte>();
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            default(ComObject)!.FinalRelease();
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ComVariantMarshaller.ConvertToManaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ComVariantMarshaller.ConvertToUnmanaged(null!));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            ComVariantMarshaller.Free(default);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            ComVariantMarshaller.RefPropagate.Free();
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            ComVariantMarshaller.RefPropagate.FromManaged(null!);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            ComVariantMarshaller.RefPropagate.FromUnmanaged(default);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ComVariantMarshaller.RefPropagate.ToManaged());
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ComVariantMarshaller.RefPropagate.ToUnmanaged());
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ExceptionAsDefaultMarshaller.ConvertToUnmanaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ExceptionAsHResultMarshaller.ConvertToUnmanaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(ExceptionAsNaNMarshaller.ConvertToUnmanaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IComExposedClass.GetComInterfaceEntries(out 42));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IComExposedDetails.GetComInterfaceEntries(out 42));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownCacheStrategy)!.ConstructTableInfo(default(System.RuntimeTypeHandle), default, default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownCacheStrategy)!.TryGetTableInfo(default(System.RuntimeTypeHandle), out default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownCacheStrategy)!.TrySetTableInfo(default(System.RuntimeTypeHandle), default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownCacheStrategy.TableInfo.ManagedType);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownCacheStrategy.TableInfo.Table);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownCacheStrategy.TableInfo.ThisPtr);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            IIUnknownCacheStrategy.TableInfo.ManagedType = default(System.RuntimeTypeHandle);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            IIUnknownCacheStrategy.TableInfo.Table = default;
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            IIUnknownCacheStrategy.TableInfo.ThisPtr = default;
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownDerivedDetails)!.Iid);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownDerivedDetails)!.Implementation);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownDerivedDetails)!.ManagedVirtualMethodTable);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownInterfaceDetailsStrategy.GetComExposedTypeDetails(default(System.RuntimeTypeHandle)));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownInterfaceDetailsStrategy.GetIUnknownDerivedDetails(default(System.RuntimeTypeHandle)));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownInterfaceType)!.Iid);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IIUnknownInterfaceType)!.ManagedVirtualMethodTable);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownStrategy.CreateInstancePointer(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownStrategy.QueryInterface(default, out Guid.Empty, out default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IIUnknownStrategy.Release(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IUnknownDerivedAttribute)!.Iid);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IUnknownDerivedAttribute)!.Implementation);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(IUnknownDerivedAttribute)!.ManagedVirtualMethodTable);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            new IUnknownDerivedAttribute<byte, byte>();
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(IUnmanagedVirtualMethodTableProvider.GetVirtualMethodTableInfoForKey(typeof(byte)));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(StrategyBasedComWrappers)!.DefaultIUnknownInterfaceDetailsStrategy);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(StrategyBasedComWrappers)!.DefaultIUnknownStrategy);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(UniqueComInterfaceMarshaller.ConvertToManaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(UniqueComInterfaceMarshaller.ConvertToUnmanaged(default));
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            default(VirtualMethodTableInfo).Deconstruct(out default, out default);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(VirtualMethodTableInfo).ThisPointer);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            Assert.IsNotNull(default(VirtualMethodTableInfo).VirtualMethodTable);
        }
        catch { _exitCode = 1; }
    }
    ...
    {
        try {
            new VirtualMethodTableInfo(default, default);
        }
        catch { _exitCode = 1; }
    }
