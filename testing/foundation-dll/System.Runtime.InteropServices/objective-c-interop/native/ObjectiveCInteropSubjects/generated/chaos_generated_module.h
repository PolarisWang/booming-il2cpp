...
struct Functions {
    struct ObjectiveCInteropSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct ObjectiveCInteropSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.objectiveCInteropSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.objectiveCInteropSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.objectiveCInteropSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.objectiveCInteropSubjects.Subject_3(
        );
    }
