...
struct PinvokeDllimportSubjects {
    ...
    static inline void Subject_10(
        ...
        return kFunctions.pinvokeDllimportSubjects.Subject_10(
        );
    }
    static inline void Subject_11(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_11(
        );
    }
    ...
    static inline void Subject_4(
        ...
        return kFunctions.pinvokeDllimportSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_7(
        );
    }
    static inline void Subject_8(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_8(
        );
    }
    static inline void Subject_9(
    ) {
        return kFunctions.pinvokeDllimportSubjects.Subject_9(
        );
    }
