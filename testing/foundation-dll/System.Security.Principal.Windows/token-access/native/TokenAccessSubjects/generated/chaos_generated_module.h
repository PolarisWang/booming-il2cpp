...
struct TokenAccessSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.tokenAccessSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.tokenAccessSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.tokenAccessSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.tokenAccessSubjects.Subject_3(
        );
    }
