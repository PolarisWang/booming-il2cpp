...
public static partial class IdentityReferenceSubjects
{
    ...
    {        try { _ = default(IdentityReference)!.IsValidTargetType(typeof(byte)); } catch { _exitCode = 1; }    }

    // [6] System.Security.Principal.Windows/System.Security.Principal.IdentityReference::ToString:System.String()
    public static void CustomEntrySubject_6()
    {        try { _ = default(IdentityReference)!.ToString(); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(IdentityReference)!.Translate(typeof(byte)); } catch { _exitCode = 1; }    }
    ...
    {        try { new IdentityReferenceCollection()[] = default; } catch { _exitCode = 1; }    }
