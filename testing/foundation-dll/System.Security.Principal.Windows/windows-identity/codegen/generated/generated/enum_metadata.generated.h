    ...
    const char* subject_id) noexcept
{
    ...
    switch (h) {
        ...
        case 0x061AC859u: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.TokenAccessLevels
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.TokenAccessLevels") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_TOKENACCESSLEVELS;
        }
        case 0x0664927Au: {
        ...
        case 0x12A1341Cu: {
            // Verify: System.Security.Principal.Windows/Interop+ClaimSecurityAttributeType
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+ClaimSecurityAttributeType") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_CLAIMSECURITYATTRIBUTETYPE;
        }
        case 0x14CEEA24u: {
        ...
        case 0x3FF78D02u: {
            // Verify: System.Security.Principal.Windows/Interop+SspiCli+KERB_LOGON_SUBMIT_TYPE
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+SspiCli+KERB_LOGON_SUBMIT_TYPE") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_SSPICLI_KERB_LOGON_SUBMIT_TYPE;
        }
        case 0x408817F8u: {
        ...
        case 0x456FD2CEu: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.WellKnownSidType
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.WellKnownSidType") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_WELLKNOWNSIDTYPE;
        }
        case 0x457A11CEu: {
        ...
        case 0x485C0D34u: {
            // Verify: System.Security.Principal.Windows/Interop+ObjectAttributes
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+ObjectAttributes") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_OBJECTATTRIBUTES;
        }
        case 0x489A818Du: {
        ...
        case 0x55630264u: {
            // Verify: System.Security.Principal.Windows/Interop+Advapi32+PolicyRights
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+Advapi32+PolicyRights") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_ADVAPI32_POLICYRIGHTS;
        }
        case 0x5585C5C3u: {
        ...
        case 0x5966E49Bu: {
            // Verify: System.Security.Principal.Windows/Interop+SspiCli+SECURITY_LOGON_TYPE
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+SspiCli+SECURITY_LOGON_TYPE") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_SSPICLI_SECURITY_LOGON_TYPE;
        }
        case 0x59827356u: {
        ...
        case 0x766156D9u: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.SidNameUse
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.SidNameUse") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_SIDNAMEUSE;
        }
        case 0x7766AFD2u: {
        ...
        case 0x7A47B68Fu: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.WindowsAccountType
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.WindowsAccountType") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_WINDOWSACCOUNTTYPE;
        }
        case 0x7AF0D34Eu: {
        ...
        case 0x7FB080F3u: {
            // Verify: System.Security.Principal.Windows/Interop+ContextTrackingMode
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+ContextTrackingMode") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_CONTEXTTRACKINGMODE;
        }
        case 0x80617111u: {
        ...
        case 0x85CB09EEu: {
            // Verify: System.Security.Principal.Windows/Interop+BOOLEAN
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+BOOLEAN") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_BOOLEAN;
        }
        case 0x862972CDu: {
        ...
        case 0xB238E3C3u: {
            // Verify: System.Security.Claims/System.Security.Claims.Claim+SerializationMask
            if (std::strcmp(subject_id, "System.Security.Claims/System.Security.Claims.Claim+SerializationMask") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_CLAIMS_SYSTEM_SECURITY_CLAIMS_CLAIM_SERIALIZATIONMASK;
        }
        case 0xB2CE6651u: {
        ...
        case 0xC21BA0FEu: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.TokenInformationClass
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.TokenInformationClass") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_TOKENINFORMATIONCLASS;
        }
        case 0xC3197A07u: {
        ...
        case 0xC38A623Au: {
            // Verify: System.Security.Claims/System.Security.Claims.ClaimsPrincipal+SerializationMask
            if (std::strcmp(subject_id, "System.Security.Claims/System.Security.Claims.ClaimsPrincipal+SerializationMask") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_CLAIMS_SYSTEM_SECURITY_CLAIMS_CLAIMSPRINCIPAL_SERIALIZATIONMASK;
        }
        case 0xC4DFC1B5u: {
        ...
        case 0xCA3292D8u: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.TokenType
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.TokenType") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_TOKENTYPE;
        }
        case 0xCC731390u: {
        ...
        case 0xCCF0E73Cu: {
            // Verify: System.Security.Claims/System.Security.Claims.ClaimsIdentity+SerializationMask
            if (std::strcmp(subject_id, "System.Security.Claims/System.Security.Claims.ClaimsIdentity+SerializationMask") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_CLAIMS_SYSTEM_SECURITY_CLAIMS_CLAIMSIDENTITY_SERIALIZATIONMASK;
        }
        case 0xCE4AC3A5u: {
        ...
        case 0xD281CC4Au: {
            // Verify: System.Security.Principal.Windows/Interop+BOOL
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+BOOL") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_BOOL;
        }
        case 0xD3CFB0F0u: {
        ...
        case 0xD74931F3u: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.WindowsBuiltInRole
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.WindowsBuiltInRole") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_WINDOWSBUILTINROLE;
        }
        case 0xD8BB0FE9u: {
        ...
        case 0xDAC98DEDu: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.IdentifierAuthority
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.IdentifierAuthority") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_IDENTIFIERAUTHORITY;
        }
        case 0xDAD664FCu: {
            // Verify: System.Security.Principal.Windows/Interop+ImpersonationLevel
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+ImpersonationLevel") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_IMPERSONATIONLEVEL;
        }
        case 0xDB611107u: {
        ...
        case 0xE42CEB7Cu: {
            // Verify: System.Security.Principal.Windows/System.Security.Principal.WinSecurityContext
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/System.Security.Principal.WinSecurityContext") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_SYSTEM_SECURITY_PRINCIPAL_WINSECURITYCONTEXT;
        }
        case 0xE53A620Eu: {
        ...
        case 0xF6A6625Cu: {
            // Verify: System.Security.Principal.Windows/Interop+SspiCli+KerbS4uLogonFlags
            if (std::strcmp(subject_id, "System.Security.Principal.Windows/Interop+SspiCli+KerbS4uLogonFlags") != 0) break;
            return &kEnumTable_SYSTEM_SECURITY_PRINCIPAL_WINDOWS_INTEROP_SSPICLI_KERBS4ULOGONFLAGS;
        }
        case 0xF722539Au: {
