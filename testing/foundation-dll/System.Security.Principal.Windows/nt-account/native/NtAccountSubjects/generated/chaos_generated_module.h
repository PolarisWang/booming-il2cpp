...
struct NtAccountSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.ntAccountSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.ntAccountSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.ntAccountSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.ntAccountSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.ntAccountSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.ntAccountSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.ntAccountSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.ntAccountSubjects.Subject_7(
        );
    }
    static inline void Subject_8(
    ) {
        return kFunctions.ntAccountSubjects.Subject_8(
        );
    }
    static inline void Subject_9(
    ) {
        return kFunctions.ntAccountSubjects.Subject_9(
        );
    }
