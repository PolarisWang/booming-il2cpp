...
struct OptionsSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.optionsSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.optionsSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.optionsSubjects.Subject_2(
        );
    }
