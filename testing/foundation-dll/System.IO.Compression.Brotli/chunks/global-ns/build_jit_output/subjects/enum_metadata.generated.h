...
// ── Enum: System.IO.Compression.Brotli/Interop+BOOL ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL[] = {
    { "FALSE", 0 },
    { "TRUE", 1 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL = {
    kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL, 2
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL = {
    0u,
    0u,
    "System.IO.Compression.Brotli/Interop+BOOL"
};

/// Per-enum ToString dispatch for System.IO.Compression.Brotli/Interop+BOOL (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("FALSE");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("TRUE");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION[] = {
    { "Process", 0 },
    { "Flush", 1 },
    { "Finish", 2 },
    { "EmitMetadata", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION = {
    kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION = {
    0u,
    0u,
    "System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation"
};

/// Per-enum ToString dispatch for System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Process");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Flush");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Finish");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("EmitMetadata");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER[] = {
    { "Mode", 0 },
    { "Quality", 1 },
    { "LGWin", 2 },
    { "LGBlock", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER = {
    kEnumFields_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER, 6
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER = {
    0u,
    0u,
    "System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter"
};

/// Per-enum ToString dispatch for System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Mode");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Quality");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("LGWin");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("LGBlock");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("LCModeling");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("SizeHint");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0x5AC5FFu, &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER },
    ...
    { 0x5DE3C9u, &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION },
    ...
    { 0x98CC87u, &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL },
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x5AC5FFu, &ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER },
    ...
    { 0x5DE3C9u, &ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION },
    ...
    { 0x98CC87u, &ChaosEnumToString_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL },
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.IO.Compression.Brotli/Interop+BOOL"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION));
    ChaosRegisterExternalType(
