...
struct EncoderSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.encoderSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.encoderSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.encoderSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.encoderSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.encoderSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.encoderSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.encoderSubjects.Subject_6(
        );
    }
