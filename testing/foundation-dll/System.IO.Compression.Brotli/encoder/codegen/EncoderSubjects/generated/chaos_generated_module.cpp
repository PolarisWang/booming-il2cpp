...
extern "C" void EncoderSubjects_EncoderSubjects_Subject_0(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_1(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_2(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_3(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_4(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_5(
        void
);
extern "C" void EncoderSubjects_EncoderSubjects_Subject_6(
        void
);
...
static const Functions s_functions = {
    {
        &EncoderSubjects_EncoderSubjects_Subject_0,
        &EncoderSubjects_EncoderSubjects_Subject_1,
        &EncoderSubjects_EncoderSubjects_Subject_2,
        &EncoderSubjects_EncoderSubjects_Subject_3,
        &EncoderSubjects_EncoderSubjects_Subject_4,
        &EncoderSubjects_EncoderSubjects_Subject_5,
        &EncoderSubjects_EncoderSubjects_Subject_6,
    },
    7,
};
