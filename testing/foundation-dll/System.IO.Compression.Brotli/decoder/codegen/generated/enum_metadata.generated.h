    ...
    const char* subject_id) noexcept
{
    ...
    switch (h) {
        ...
        case 0x2C5AC5FFu: {
            // Verify: System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter
            if (std::strcmp(subject_id, "System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderParameter") != 0) break;
            return &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODERPARAMETER;
        }
        case 0x2C85D069u: {
        ...
        case 0x8398CC87u: {
            // Verify: System.IO.Compression.Brotli/Interop+BOOL
            if (std::strcmp(subject_id, "System.IO.Compression.Brotli/Interop+BOOL") != 0) break;
            return &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_INTEROP_BOOL;
        }
        case 0x83A7057Cu: {
        ...
        case 0xBA5DE3C9u: {
            // Verify: System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation
            if (std::strcmp(subject_id, "System.IO.Compression.Brotli/System.IO.Compression.BrotliEncoderOperation") != 0) break;
            return &kEnumTable_SYSTEM_IO_COMPRESSION_BROTLI_SYSTEM_IO_COMPRESSION_BROTLIENCODEROPERATION;
        }
        case 0xBAA247D5u: {
