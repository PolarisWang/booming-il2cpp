...
public static partial class ObservableCollectionsSubjects
{
    ...
    {        try { default(ObservableCollection<byte>)!.add_CollectionChanged(default); } catch { _exitCode = 1; }    }
    ...
    {        try { default(ObservableCollection<byte>)!.remove_CollectionChanged(default); } catch { _exitCode = 1; }    }
