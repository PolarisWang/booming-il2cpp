...
struct Functions {
    struct CollectionChangeNotificationsSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct CollectionChangeNotificationsSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.collectionChangeNotificationsSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.collectionChangeNotificationsSubjects.Subject_1(
        );
    }
