...
public static partial class ZipFileApisSubjects
{
    ...
    {        try { ZipFile.ExtractToDirectory("hello", "hello", true); } catch { _exitCode = 1; }    }
    ...
    {        try { ZipFile.ExtractToDirectory("hello", "hello", default); } catch { _exitCode = 1; }    }
    ...
    {        try { ZipFile.ExtractToDirectory(new MemoryStream(), "hello", true); } catch { _exitCode = 1; }    }
    ...
    {        try { ZipFile.ExtractToDirectory(new MemoryStream(), "hello", default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = ZipFile.ExtractToDirectoryAsync("hello", "hello", true, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = ZipFile.ExtractToDirectoryAsync("hello", "hello", default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = ZipFile.ExtractToDirectoryAsync(new MemoryStream(), "hello", true, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = ZipFile.ExtractToDirectoryAsync(new MemoryStream(), "hello", default, default); } catch { _exitCode = 1; }    }
