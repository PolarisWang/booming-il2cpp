...
// ── Enum: System.IO.Compression.ZipFile/System.IO.Compression.ZipFile+CreateEntryType ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE[] = {
    { "File", 0 },
    { "Directory", 1 },
    { "Unsupported", 2 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE = {
    kEnumFields_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE = {
    0u,
    0u,
    "System.IO.Compression.ZipFile/System.IO.Compression.ZipFile+CreateEntryType"
};
    ...
    const char* subject_id) noexcept
{
    ...
    switch (h) {
        ...
        case 0x8A374F93u: {
            // Verify: System.IO.Compression.ZipFile/System.IO.Compression.ZipFile+CreateEntryType
            if (std::strcmp(subject_id, "System.IO.Compression.ZipFile/System.IO.Compression.ZipFile+CreateEntryType") != 0) break;
            return &kEnumTable_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE;
        }
        case 0x8AE75260u: {
    ...
    CHAOS_IL2CPP_UINT32 fnv24) noexcept
{
    switch (fnv24) {
        ...
        case 0x374F93u: return &kEnumTable_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE;
...
struct _EnumMetadataRegistrar {
    _EnumMetadataRegistrar() noexcept {
        ...
        ChaosRegisterExternalType(
            compute_enum_hash24("System.IO.Compression.ZipFile/System.IO.Compression.ZipFile+CreateEntryType"),
            reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
                &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_IO_COMPRESSION_ZIPFILE_SYSTEM_IO_COMPRESSION_ZIPFILE_CREATEENTRYTYPE));
        ChaosRegisterExternalType(
