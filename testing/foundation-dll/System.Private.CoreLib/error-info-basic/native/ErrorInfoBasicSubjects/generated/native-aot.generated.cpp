...
CHAOS_IL2CPP_INTPTR chaos_reflection_resolve_method_handle(CHAOS_IL2CPP_INTPTR chaos_type_handle, const char* chaos_method_name) noexcept
{
	...
	switch (chaos_type_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(48813153u):
			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, ".ctor") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(105042197u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Main") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(117164908u);
			}
...
extern "C" void ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
extern "C" void ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
...
static constexpr struct {
...
} s_abi_manifest_storage = {
	{
		...
		12u,
		2u,
		4254009797u,  // FNV-1a over entries+params
	...
	},
	{
		...
		{ 0u, 0u },  // ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor
		{ 0u, 1u },  // ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[12] = {
	...
	{ "Run", 0x0000000Au, 1u },  // ErrorInfoBasicNativeEntry
	{ "TestGetExceptionForHR_Zero", 0x0000000Eu, 0u },  // ErrorInfoBasicNativeEntry
	{ "TestGetExceptionForHR", 0x0000000Bu, 0u },  // ErrorInfoBasicNativeEntry
	{ "TestGetHRForException", 0x0000000Cu, 0u },  // ErrorInfoBasicNativeEntry
	{ "TestThrowExceptionForHR_S_OK", 0x0000000Du, 0u },  // ErrorInfoBasicNativeEntry
	{ "Subject_0", 0x00000005u, 0u },  // ErrorInfoBasicSubjects
	{ "Subject_1", 0x00000006u, 0u },  // ErrorInfoBasicSubjects
	{ "Subject_2", 0x00000007u, 0u },  // ErrorInfoBasicSubjects
	{ "Subject_3", 0x00000008u, 0u },  // ErrorInfoBasicSubjects
	{ "Subject_4", 0x00000009u, 0u },  // ErrorInfoBasicSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[3] = {
	{ "AutoGeneratedProgram", "", 0u, 2u },
	{ "ErrorInfoBasicNativeEntry", "", 2u, 5u },
	{ "ErrorInfoBasicSubjects", "", 7u, 5u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[12] = {
	...
	{ reinterpret_cast<void*>(&ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative },  // AutoGeneratedProgram::.ctor
	{ reinterpret_cast<void*>(&ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // AutoGeneratedProgram::Main
...
static void (*kAotMethods[12])() = {
	...
	reinterpret_cast<void(*)()>(&ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor),
	reinterpret_cast<void(*)()>(&ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String),
...
static const struct {
	...
	/* ── Entry 5: ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 6: ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 7: ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_Run_System_Int32 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 8: ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetExceptionForHR_Zero ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 9: ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetExceptionForHR ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 10: ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetHRForException ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 11: ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestThrowExceptionForHR_S_OK ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry5 = ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor */
	.entry5 = {
		/* entry_total_size = 28 */ 28u,
		/* code_address */ reinterpret_cast<const void*>(&ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor),
		/* frame_size = 16 */ 16u,
		/* num_gc_slots = 2 */ 2u,
		/* slots */ { 0u, 8u }
	},
	/* entry6 = ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String */
	.entry6 = {
		/* entry_total_size = 24 */ 24u,
		/* code_address */ reinterpret_cast<const void*>(&ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String),
		/* frame_size = 8 */ 8u,
		/* num_gc_slots = 1 */ 1u,
		/* slots */ { 0u }
	},
	/* entry7 = ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_Run_System_Int32 */
	.entry7 = {
	...
	/* entry8 = ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetExceptionForHR_Zero */
	.entry8 = {
	...
	/* entry9 = ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetExceptionForHR */
	.entry9 = {
	...
	/* entry10 = ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestGetHRForException */
	.entry10 = {
	...
	/* entry11 = ErrorInfoBasicSubjects_ErrorInfoBasicNativeEntry_TestThrowExceptionForHR_S_OK */
	.entry11 = {
		/* entry_total_size = 28 */ 28u,
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ErrorInfoBasicSubjects_AutoGeneratedProgram[2] = {
	{ 0u, "ErrorInfoBasicSubjects/AutoGeneratedProgram::.ctor:System.Void()", ".ctor", "System.Void", 0, nullptr, 0u },
	{ 0u, "ErrorInfoBasicSubjects/AutoGeneratedProgram::Main:System.Void(System.String[])", "Main", "System.Void", 0, nullptr, 0u },
};
...
static const ReflectionQueryTypeDescriptor kReflTypes[3] = {
	...
	{ 0u, "ErrorInfoBasicSubjects/AutoGeneratedProgram", "ErrorInfoBasicSubjects/AutoGeneratedProgram", "", "AutoGeneratedProgram", "AutoGeneratedProgram", nullptr, nullptr, 0u, nullptr, 0u,
	kReflMethods_ErrorInfoBasicSubjects_AutoGeneratedProgram, 2u },
...
static const ReflectionQueryImageDescriptor kReflImage = { "ErrorInfoBasicSubjects", kReflTypePtrs, 3u };
...
// Managed method: ErrorInfoBasicSubjects/AutoGeneratedProgram::.ctor()
extern "C" void ErrorInfoBasicSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: ErrorInfoBasicSubjects/AutoGeneratedProgram::Main(System.String[])
extern "C" void ErrorInfoBasicSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
chaos_label_101:
	{
		const auto chaos_arg_1 = chaos_eval_stack[--chaos_stack_top];
		const auto chaos_arg_0 = chaos_eval_stack[--chaos_stack_top];
		reinterpret_cast<void(*)(CHAOS_IL2CPP_INTPTR, CHAOS_IL2CPP_INTPTR)>(kChaosExternalRuntimeFnTable[13])(chaos_arg_0, chaos_arg_1);
	}
chaos_label_108:
...
chaos_label_120:
	{
		const auto chaos_arg_0 = chaos_eval_stack[--chaos_stack_top];
		const auto chaos_result = reinterpret_cast<CHAOS_IL2CPP_INT32(*)(CHAOS_IL2CPP_INTPTR)>(kChaosExternalRuntimeFnTable[14])(chaos_arg_0);
		chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
	}
chaos_label_125:
