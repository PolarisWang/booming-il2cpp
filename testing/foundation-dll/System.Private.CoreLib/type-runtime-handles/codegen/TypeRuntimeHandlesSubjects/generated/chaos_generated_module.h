...
struct Functions {
    ...
    struct TypeRuntimeHandlesSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_10)(
...
struct TypeRuntimeHandlesSubjects {
    ...
    static inline void Subject_1(
        ...
        return kFunctions.typeRuntimeHandlesSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_7(
        );
    }
    static inline void Subject_8(
    ) {
        return kFunctions.typeRuntimeHandlesSubjects.Subject_8(
        );
    }
