...
public static partial class BoxingUnboxingCastsSubjects
{
    ...
    {
        try { if (((Convert.ChangeType(42, typeof(byte))).GetHashCode()) != ((Convert.ChangeType(42, typeof(byte))).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((Convert.ChangeType(42, typeof(byte), null)).GetHashCode()) != ((Convert.ChangeType(42, typeof(byte), null)).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((typeof(byte).IsInstanceOfType(42)) ? 1 : 0) != ((typeof(byte).IsInstanceOfType(42)) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
