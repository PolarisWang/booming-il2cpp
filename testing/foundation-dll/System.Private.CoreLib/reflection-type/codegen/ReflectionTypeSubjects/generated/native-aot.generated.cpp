...
CHAOS_IL2CPP_INTPTR chaos_reflection_resolve_method_handle(CHAOS_IL2CPP_INTPTR chaos_type_handle, const char* chaos_method_name) noexcept
{
	...
	switch (chaos_type_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(37548366u):
			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, ".ctor") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(108504484u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Main") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(109344249u);
			}
...
extern "C" void ReflectionTypeSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
extern "C" void ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
...
static constexpr CHAOS_IL2CPP_UINT32 s_abi_manifest_prefix_sum[46] = {
	0u,
	0u,
	0u,
	0u,
...
static constexpr struct {
	...
	::ChaosAbiMethodEntryV0 entries[45];
...
} s_abi_manifest_storage = {
	{
		...
		45u,
		1u,
		993631432u,  // FNV-1a over entries+params
	...
	},
	{
		...
		{ 0u, 0u },  // ReflectionTypeSubjects_AutoGeneratedProgram__ctor
		{ 0u, 1u },  // ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String
	},
	{
		2u,
	},
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[45] = {
	{ ".ctor", 0x00000030u, 0u },  // AutoGeneratedProgram
	{ "Main", 0x0000002Fu, 1u },  // AutoGeneratedProgram
...
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[2] = {
	...
	{ "ReflectionTypeSubjects", "", 2u, 43u },
};

// Token→Slot mapping (sorted by token for binary search)
static constexpr HotpatchSlotEntryV0 s_hotpatch_slots[45] = {
	{ 0x00000004u, 0u },
	{ 0x00000005u, 1u },
	{ 0x00000006u, 2u },
	{ 0x00000007u, 3u },
...
static HotpatchEntryV0 s_hotpatch_entries[45] = {
	...
	{ reinterpret_cast<void*>(&ReflectionTypeSubjects_AutoGeneratedProgram__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative },  // AutoGeneratedProgram::.ctor
	{ reinterpret_cast<void*>(&ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // AutoGeneratedProgram::Main
};
...
static void (*kAotMethods[45])() = {
	...
	reinterpret_cast<void(*)()>(&ReflectionTypeSubjects_AutoGeneratedProgram__ctor),
	reinterpret_cast<void(*)()>(&ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String),
};
...
extern "C" void (*kBenchmarkWrappers[45])() = {
	[]() {kAotMethods[0]();},
	[]() {kAotMethods[1]();},
	[]() {kAotMethods[2]();},
	[]() {kAotMethods[3]();},
...
static const struct {
	...
	/* ── Entry 40: ReflectionTypeSubjects_AutoGeneratedProgram__ctor ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 41: ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry40 = ReflectionTypeSubjects_AutoGeneratedProgram__ctor */
	.entry40 = {
		/* entry_total_size = 28 */ 28u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionTypeSubjects_AutoGeneratedProgram__ctor),
		/* frame_size = 16 */ 16u,
		/* num_gc_slots = 2 */ 2u,
		/* slots */ { 0u, 8u }
	},
	/* entry41 = ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String */
	.entry41 = {
		/* entry_total_size = 24 */ 24u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String),
		/* frame_size = 8 */ 8u,
		/* num_gc_slots = 1 */ 1u,
		/* slots */ { 0u }
	}
...
static const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 1536u;

// ── CodeRegistrationV0 ─────────────────────────────────────────
// method_pointers: flat array of all AOT function pointers.
static void* const kMethodPointers[45] = {
	reinterpret_cast<void*>(&ReflectionTypeSubjects_ReflectionTypeSubjects_Subject_0),
	reinterpret_cast<void*>(&ReflectionTypeSubjects_ReflectionTypeSubjects_Subject_1),
	reinterpret_cast<void*>(&ReflectionTypeSubjects_ReflectionTypeSubjects_Subject_2),
	reinterpret_cast<void*>(&ReflectionTypeSubjects_ReflectionTypeSubjects_Subject_3),
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ReflectionTypeSubjects_AutoGeneratedProgram[2] = {
	{ 0u, "ReflectionTypeSubjects/AutoGeneratedProgram::.ctor:System.Void()", ".ctor", "System.Void", 0, nullptr, 0u },
	{ 0u, "ReflectionTypeSubjects/AutoGeneratedProgram::Main:System.Void(System.String[])", "Main", "System.Void", 0, nullptr, 0u },
};
...
static const ReflectionQueryTypeDescriptor kReflTypes[2] = {
	...
	{ 0u, "ReflectionTypeSubjects/AutoGeneratedProgram", "ReflectionTypeSubjects/AutoGeneratedProgram", "", "AutoGeneratedProgram", "AutoGeneratedProgram", nullptr, nullptr, 0u, nullptr, 0u,
	kReflMethods_ReflectionTypeSubjects_AutoGeneratedProgram, 2u },
};
...
static const ReflectionQueryImageDescriptor kReflImage = { "ReflectionTypeSubjects", kReflTypePtrs, 2u };
...
// Managed method: ReflectionTypeSubjects/AutoGeneratedProgram::.ctor()
extern "C" void ReflectionTypeSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: ReflectionTypeSubjects/AutoGeneratedProgram::Main(System.String[])
extern "C" void ReflectionTypeSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
extern "C" const int kAotMethodCount = 45;
