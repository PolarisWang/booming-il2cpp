...
inline MethodTable chaos_mt_System_Private_CoreLib_System_PlatformNotSupportedException = {nullptr, nullptr, 3627294964229478006ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_System_Threading_Thread_System_Threading_ThreadInterruptedException = {nullptr, nullptr, 1689251155357643907ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
extern "C" void ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod6(void)
{
	...
	CHAOS_EH_CATCH_BEGIN
		if (!chaos_eh_match_type(CHAOS_EH_EXCEPTION_OBJ, chaos_mt_System_Private_CoreLib_System_PlatformNotSupportedException.AsTypeInfoHot()))
		{ CHAOS_EH_RETHROW; }
...
extern "C" void ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod7(void)
{
	...
	CHAOS_EH_CATCH_BEGIN
		if (!chaos_eh_match_type(CHAOS_EH_EXCEPTION_OBJ, chaos_mt_System_Threading_Thread_System_Threading_ThreadInterruptedException.AsTypeInfoHot()))
		{ CHAOS_EH_RETHROW; }
		_s0 = CHAOS_EH_EXCEPTION_OBJ;
	CHAOS_EH_END
	return;
