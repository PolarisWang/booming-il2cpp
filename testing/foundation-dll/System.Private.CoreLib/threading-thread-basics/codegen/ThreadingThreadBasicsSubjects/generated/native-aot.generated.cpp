...
extern "C" void ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
extern "C" void ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
...
static constexpr struct {
...
} s_abi_manifest_storage = {
	{
		...
		24u,
		1u,
		262033880u,  // FNV-1a over entries+params
	...
	},
	{
		...
		{ 0u, 0u },  // ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor
		{ 0u, 1u },  // ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[24] = {
	{ ".ctor", 0x0000001Cu, 0u },  // AutoGeneratedProgram
	{ "Main", 0x0000001Bu, 1u },  // AutoGeneratedProgram
	{ "CustomEntryMethod0", 0x00000010u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod1", 0x00000011u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod10", 0x0000001Au, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod2", 0x00000012u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod3", 0x00000013u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod4", 0x00000014u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod5", 0x00000015u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod6", 0x00000016u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod7", 0x00000017u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod8", 0x00000018u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntryMethod9", 0x00000019u, 0u },  // ThreadingThreadBasicsNativeEntry
	{ "CustomEntrySubject_0", 0x00000005u, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_1", 0x00000006u, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_2", 0x00000007u, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_3", 0x00000008u, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_4", 0x00000009u, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_5", 0x0000000Au, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_6", 0x0000000Bu, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_7", 0x0000000Cu, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_8", 0x0000000Du, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_9", 0x0000000Eu, 0u },  // ThreadingThreadBasicsSubjects
	{ "CustomEntrySubject_10", 0x0000000Fu, 0u },  // ThreadingThreadBasicsSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[3] = {
	{ "AutoGeneratedProgram", "", 0u, 2u },
	{ "ThreadingThreadBasicsNativeEntry", "", 2u, 11u },
	{ "ThreadingThreadBasicsSubjects", "", 13u, 11u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[24] = {
	...
	{ reinterpret_cast<void*>(&ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative },  // AutoGeneratedProgram::.ctor
	{ reinterpret_cast<void*>(&ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // AutoGeneratedProgram::Main
...
static const struct {
	...
	/* ── Entry 0: ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor ── */
	struct {
	...
	/* ── Entry 1: ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 2: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod0 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 3: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod1 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 4: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod10 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 5: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod2 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 6: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod3 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 7: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod4 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 8: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod5 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 9: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod6 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 10: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod7 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 11: ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod9 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry0 = ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor */
	.entry0 = {
		/* entry_total_size = 28 */ 28u,
		/* code_address */ reinterpret_cast<const void*>(&ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor),
		/* frame_size = 16 */ 16u,
		/* num_gc_slots = 2 */ 2u,
		/* slots */ { 0u, 8u }
	},
	/* entry1 = ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String */
	.entry1 = {
		/* entry_total_size = 24 */ 24u,
		/* code_address */ reinterpret_cast<const void*>(&ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String),
		/* frame_size = 8 */ 8u,
		/* num_gc_slots = 1 */ 1u,
		/* slots */ { 0u }
	},
	/* entry2 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod0 */
	.entry2 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry3 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod1 */
	.entry3 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry4 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod10 */
	.entry4 = {
		/* entry_total_size = 24 */ 24u,
	...
	/* entry5 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod2 */
	.entry5 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry6 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod3 */
	.entry6 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry7 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod4 */
	.entry7 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry8 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod5 */
	.entry8 = {
		/* entry_total_size = 28 */ 28u,
	...
	/* entry9 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod6 */
	.entry9 = {
		/* entry_total_size = 24 */ 24u,
	...
	/* entry10 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod7 */
	.entry10 = {
		/* entry_total_size = 24 */ 24u,
	...
	/* entry11 = ThreadingThreadBasicsSubjects_ThreadingThreadBasicsNativeEntry_CustomEntryMethod9 */
	.entry11 = {
		/* entry_total_size = 24 */ 24u,
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ThreadingThreadBasicsSubjects_AutoGeneratedProgram[2] = {
	{ 0u, "ThreadingThreadBasicsSubjects/AutoGeneratedProgram::.ctor:System.Void()", ".ctor", "System.Void", 0, nullptr, 0u },
	{ 0u, "ThreadingThreadBasicsSubjects/AutoGeneratedProgram::Main:System.Void(System.String[])", "Main", "System.Void", 0, nullptr, 0u },
};
...
static const ReflectionQueryTypeDescriptor kReflTypes[3] = {
	...
	{ 0u, "ThreadingThreadBasicsSubjects/AutoGeneratedProgram", "ThreadingThreadBasicsSubjects/AutoGeneratedProgram", "", "AutoGeneratedProgram", "AutoGeneratedProgram", nullptr, nullptr, 0u, nullptr, 0u,
	kReflMethods_ThreadingThreadBasicsSubjects_AutoGeneratedProgram, 2u },
...
static const ReflectionQueryImageDescriptor kReflImage = { "ThreadingThreadBasicsSubjects", kReflTypePtrs, 3u };
...
// Managed method: ThreadingThreadBasicsSubjects/AutoGeneratedProgram::.ctor()
extern "C" void ThreadingThreadBasicsSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: ThreadingThreadBasicsSubjects/AutoGeneratedProgram::Main(System.String[])
extern "C" void ThreadingThreadBasicsSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
