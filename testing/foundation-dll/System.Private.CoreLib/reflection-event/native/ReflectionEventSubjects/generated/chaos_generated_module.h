...
struct Functions {
    struct ReflectionEventSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct ReflectionEventSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.reflectionEventSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.reflectionEventSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.reflectionEventSubjects.Subject_2(
        );
    }
