...
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_ReflectionGenericsSubjects_ReflectionGenericsSubjects = static_cast<CHAOS_IL2CPP_INTPTR>(3653690386884475450ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(3653690386884475450ULL, sizeof(chaos_type_ReflectionGenericsSubjects_ReflectionGenericsSubjects), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<uintptr_t>(&chaos_mt_ReflectionGenericsSubjects_ReflectionGenericsSubjects), reinterpret_cast<uintptr_t>(&chaos_mt_ReflectionGenericsSubjects_ReflectionGenericsSubjects) + sizeof(chaos_mt_ReflectionGenericsSubjects_ReflectionGenericsSubjects));
...
// Bridge/import thunk for: ReflectionGenericsSubjects/ReflectionGenericsSubjects::_exitCode
...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[2] = {
		nullptr,
		reinterpret_cast<const TypeInfoHot*>(&chaos_mt_ReflectionGenericsSubjects_ReflectionGenericsSubjects),
	};
...
static const struct {
	...
	/* ── Entry 0: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_0 ── */
	struct {
	...
	/* ── Entry 1: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_1 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 2: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_2 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 3: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_3 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 4: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_4 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 5: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_5 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 6: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_6 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 7: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_7 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 8: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_8 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 9: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_9 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 10: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_10 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 11: ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_11 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry0 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_0 */
	.entry0 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_0),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry1 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_1 */
	.entry1 = {
		/* entry_total_size = 36 */ 36u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_1),
		/* frame_size = 32 */ 32u,
		/* num_gc_slots = 4 */ 4u,
		/* slots */ { 0u, 8u, 16u, 24u }
	},
	/* entry2 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_2 */
	.entry2 = {
		/* entry_total_size = 48 */ 48u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_2),
		/* frame_size = 56 */ 56u,
		/* num_gc_slots = 7 */ 7u,
		/* slots */ { 0u, 8u, 16u, 24u, 32u, 40u, 48u }
	},
	/* entry3 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_3 */
	.entry3 = {
		/* entry_total_size = 48 */ 48u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_3),
		/* frame_size = 56 */ 56u,
		/* num_gc_slots = 7 */ 7u,
		/* slots */ { 0u, 8u, 16u, 24u, 32u, 40u, 48u }
	},
	/* entry4 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_4 */
	.entry4 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_4),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry5 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_5 */
	.entry5 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_5),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry6 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_6 */
	.entry6 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_6),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry7 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_7 */
	.entry7 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_7),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry8 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_8 */
	.entry8 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_8),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry9 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_9 */
	.entry9 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_9),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry10 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_10 */
	.entry10 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_10),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry11 = ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_11 */
	.entry11 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_11),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	}
...
static constexpr ReflectionQueryFieldDescriptor kReflFields_ReflectionGenericsSubjects_ReflectionGenericsSubjects[1] = {
	{ 0x04000001u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::_exitCode", "_exitCode", "System.Int32", 0LL, 3u },
};
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ReflectionGenericsSubjects_ReflectionGenericsSubjects[12] = {
	{ 0x00000003u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_0:System.Void()", "Subject_0", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000004u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_1:System.Void()", "Subject_1", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000005u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_2:System.Void()", "Subject_2", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000006u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_3:System.Void()", "Subject_3", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000007u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_4:System.Void()", "Subject_4", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000008u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_5:System.Void()", "Subject_5", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000009u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_6:System.Void()", "Subject_6", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x0000000Au, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_7:System.Void()", "Subject_7", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x0000000Bu, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_8:System.Void()", "Subject_8", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x0000000Cu, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_9:System.Void()", "Subject_9", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x0000000Du, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_10:System.Void()", "Subject_10", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x0000000Eu, "ReflectionGenericsSubjects/ReflectionGenericsSubjects::Subject_11:System.Void()", "Subject_11", "System.Void", 0, nullptr, 0u, nullptr, 0u },
};

static const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	{ 0x00000001u, "ReflectionGenericsSubjects/ReflectionGenericsSubjects", "ReflectionGenericsSubjects/ReflectionGenericsSubjects", "", "ReflectionGenericsSubjects", "ReflectionGenericsSubjects", nullptr, kReflFields_ReflectionGenericsSubjects_ReflectionGenericsSubjects, 1u, nullptr, 0u,
nullptr, 0u,    kReflMethods_ReflectionGenericsSubjects_ReflectionGenericsSubjects, 12u, nullptr, 0u, 0u },
};
...
static const ReflectionQueryImageDescriptor kReflImage = { "ReflectionGenericsSubjects", kReflTypePtrs, 1u, 1, 0, 0, 0 };
...
extern "C" void ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_1(void)
{
	...
	CHAOS_EH_TRY
			...
			}
			{
				...
				const auto chaos_arg_0 = _s0;
				const auto chaos_result = ChaosReflectionMakeGenericType(chaos_arg_0, chaos_arg_1);
				_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
			}
			{
				const auto chaos_arg_0 = _s0;
...
extern "C" void ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_3(void)
{
	...
	CHAOS_EH_TRY
			...
			{
				const auto chaos_arg_0 = _s0;
				const auto chaos_result = ChaosReflectionGetGenericParamConstraints(chaos_arg_0);
				_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
			}
			_s0 = [&](){ auto* _c_arr = reinterpret_cast<chaos_managed_array*>(_s0); return _c_arr ? static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(_c_arr->length)) : CHAOS_IL2CPP_INTPTR{}; }();
			_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(_s0));
...
extern "C" void ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_4(void)
{
	...
	CHAOS_EH_TRY
			...
			{
				const auto chaos_arg_0 = _s0;
				const auto chaos_result = ChaosReflectionGetGenericParamPos(chaos_arg_0);
				_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
			}
			_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(41240749u);
			{
...
extern "C" void ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_5(void)
{
	...
	CHAOS_EH_TRY
			...
			{
				const auto chaos_arg_0 = _s0;
				const auto chaos_result = ChaosReflectionGetContainsGenericParams(chaos_arg_0);
				_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
			}
...
extern "C" void ReflectionGenericsSubjects_ReflectionGenericsSubjects_Subject_7(void)
{
	...
	CHAOS_EH_TRY
			...
			{
				const auto chaos_arg_0 = _s0;
				const auto chaos_result = ChaosReflectionGetIsGenericTypeDef(chaos_arg_0);
				_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
			}
			// brtrue (structured EH branch)
			_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(0);
