...
public static partial class ReflectionGenericsSubjects
{
    ...
    {
        try { var _ = ((typeof(byte).MakeGenericType(Array.Empty<System.Type>())).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).GetGenericArguments()).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).GetGenericParameterConstraints()).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = typeof(byte).GenericParameterPosition; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).ContainsGenericParameters) ? 1 : 0); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).IsGenericTypeDefinition) ? 1 : 0); }
        catch { _exitCode = 1; }
    }
