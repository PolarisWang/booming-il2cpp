...
public class Program
{
    ...
    {
        int failures = 0;
        GlobalizationCulturePatchEntry._exitCode = 0; GlobalizationCulturePatchEntry.Method0(); failures += GlobalizationCulturePatchEntry._exitCode << 0;
        GlobalizationCulturePatchEntry._exitCode = 0; GlobalizationCulturePatchEntry.Method1(); failures += GlobalizationCulturePatchEntry._exitCode << 1;
        GlobalizationCulturePatchEntry._exitCode = 0; GlobalizationCulturePatchEntry.Method2(); failures += GlobalizationCulturePatchEntry._exitCode << 2;
        GlobalizationCulturePatchEntry._exitCode = 0; GlobalizationCulturePatchEntry.Method3(); failures += GlobalizationCulturePatchEntry._exitCode << 3;
