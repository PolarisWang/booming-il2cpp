...
inline MethodTable chaos_mt_PinvokeDllimportSubjects_PinvokeDllimportSubjects = {nullptr, nullptr, 10274367341970332782ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[3] = {
		nullptr,
		chaos_mt_PinvokeDllimportSubjects_PinvokeDllimportSubjects.AsTypeInfoHot(),
		nullptr,
	};
...
extern "C" void (*kDefaultArgThunks[12])() = {
	...
	[]() {kMethodTable[4]();},
	[]() {kMethodTable[5]();},
	[]() {reinterpret_cast<void(*)(CHAOS_IL2CPP_INTPTR)>(kMethodTable[6])(0);},
	[]() {reinterpret_cast<void(*)(CHAOS_IL2CPP_INTPTR)>(kMethodTable[7])(0);},
	[]() {kMethodTable[8]();},
	[]() {kMethodTable[9]();},
	[]() {kMethodTable[10]();},
	[]() {kMethodTable[11]();},
