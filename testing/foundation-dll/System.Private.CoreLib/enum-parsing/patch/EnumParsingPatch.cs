...
public static class EnumParsingPatch
{
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_EnumParsing)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Enum_GetName_System_String_System_RuntimeType_System_UInt64() { _ = Enum.GetName(typeof(DayOfWeek), (object)1); }
    // Verify Enum.GetName after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Enum::GetName:System.String(System.Type,System.Object)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_EnumParsing)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Enum_GetName_System_String_System_Type_System_Object() { _ = Enum.GetName(typeof(DayOfWeek), (object)1); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_EnumParsing)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Enum_GetNames_System_String_System_Type() { _ = Enum.GetNames(typeof(byte)); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_EnumParsing)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Enum_GetValues_System_Array_System_Type() { _ = Enum.GetValues(typeof(byte)); }
    ...
    // Verify Enum.BoxToString after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Enum::BoxToString:System.String()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_EnumParsing)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Enum_BoxToString_System_String() { _ = DayOfWeek.Monday.BoxToString(); }}
