...
public static partial class ReflectionMemberBasicsSubjects
{
    ...
    {
        try { var _ = ((typeof(byte).GetFields()[0].GetValue(null)).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).GetProperties(BindingFlags.Public | BindingFlags.Static)[0].GetValue(null)).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).GetProperties(BindingFlags.Public | BindingFlags.Static)[0].GetValue(null, null)).GetHashCode()); }
        catch { _exitCode = 1; }
    }
