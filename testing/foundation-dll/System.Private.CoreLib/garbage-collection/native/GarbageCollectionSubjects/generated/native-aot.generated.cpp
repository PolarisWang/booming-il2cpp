...
CHAOS_IL2CPP_INTPTR chaos_reflection_resolve_method_handle(CHAOS_IL2CPP_INTPTR chaos_type_handle, const char* chaos_method_name) noexcept
{
	...
	switch (chaos_type_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(45611730u):
			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, ".ctor") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(108922624u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Main") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(112643965u);
			}
...
extern "C" void GarbageCollectionSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
extern "C" void GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
...
static constexpr struct {
...
} s_abi_manifest_storage = {
	{
		...
		9u,
		1u,
		3871626728u,  // FNV-1a over entries+params
	...
	},
	{
		...
		{ 0u, 0u },  // GarbageCollectionSubjects_AutoGeneratedProgram__ctor
		{ 0u, 1u },  // GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String
	},
	{
		2u,
	},
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[9] = {
	{ ".ctor", 0x0000000Cu, 0u },  // AutoGeneratedProgram
	{ "Main", 0x0000000Bu, 1u },  // AutoGeneratedProgram
	{ "Subject_0", 0x00000004u, 0u },  // GarbageCollectionSubjects
	{ "Subject_1", 0x00000005u, 0u },  // GarbageCollectionSubjects
	{ "Subject_2", 0x00000006u, 0u },  // GarbageCollectionSubjects
	{ "Subject_3", 0x00000007u, 0u },  // GarbageCollectionSubjects
	{ "Subject_4", 0x00000008u, 0u },  // GarbageCollectionSubjects
	{ "Subject_5", 0x00000009u, 0u },  // GarbageCollectionSubjects
	{ "Subject_6", 0x0000000Au, 0u },  // GarbageCollectionSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[2] = {
	{ "AutoGeneratedProgram", "", 0u, 2u },
	{ "GarbageCollectionSubjects", "", 2u, 7u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[9] = {
	...
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_AutoGeneratedProgram__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative },  // AutoGeneratedProgram::.ctor
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // AutoGeneratedProgram::Main
};
...
extern "C" const char* kChaosExternalRuntimeSubjects[14] = {
	...
	"System.Private.CoreLib/System.GCMemoryInfo::GetHashCode:System.Int32()",
...
static void (*kAotMethods[9])() = {
	...
	reinterpret_cast<void(*)()>(&GarbageCollectionSubjects_AutoGeneratedProgram__ctor),
	reinterpret_cast<void(*)()>(&GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String),
};
...
static const struct {
	...
	/* ── Entry 7: GarbageCollectionSubjects_AutoGeneratedProgram__ctor ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 8: GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry7 = GarbageCollectionSubjects_AutoGeneratedProgram__ctor */
	.entry7 = {
		/* entry_total_size = 28 */ 28u,
		/* code_address */ reinterpret_cast<const void*>(&GarbageCollectionSubjects_AutoGeneratedProgram__ctor),
		/* frame_size = 16 */ 16u,
		/* num_gc_slots = 2 */ 2u,
		/* slots */ { 0u, 8u }
	},
	/* entry8 = GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String */
	.entry8 = {
		/* entry_total_size = 24 */ 24u,
		/* code_address */ reinterpret_cast<const void*>(&GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String),
		/* frame_size = 8 */ 8u,
		/* num_gc_slots = 1 */ 1u,
		/* slots */ { 0u }
	}
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_GarbageCollectionSubjects_GarbageCollectionSubjects[7] = {
	...
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_6:System.Void()", "Subject_6", "System.Void", 0, nullptr, 0u },
};

static constexpr ReflectionQueryMethodDescriptor kReflMethods_GarbageCollectionSubjects_AutoGeneratedProgram[2] = {
	{ 0u, "GarbageCollectionSubjects/AutoGeneratedProgram::.ctor:System.Void()", ".ctor", "System.Void", 0, nullptr, 0u },
	{ 0u, "GarbageCollectionSubjects/AutoGeneratedProgram::Main:System.Void(System.String[])", "Main", "System.Void", 0, nullptr, 0u },
};
...
static const ReflectionQueryTypeDescriptor kReflTypes[2] = {
	...
	kReflMethods_GarbageCollectionSubjects_GarbageCollectionSubjects, 7u },
	{ 0u, "GarbageCollectionSubjects/AutoGeneratedProgram", "GarbageCollectionSubjects/AutoGeneratedProgram", "", "AutoGeneratedProgram", "AutoGeneratedProgram", nullptr, nullptr, 0u, nullptr, 0u,
	kReflMethods_GarbageCollectionSubjects_AutoGeneratedProgram, 2u },
};
...
static const ReflectionQueryImageDescriptor kReflImage = { "GarbageCollectionSubjects", kReflTypePtrs, 2u };
...
// Managed method: GarbageCollectionSubjects/AutoGeneratedProgram::.ctor()
extern "C" void GarbageCollectionSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: GarbageCollectionSubjects/AutoGeneratedProgram::Main(System.String[])
extern "C" void GarbageCollectionSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
