...
inline MethodTable chaos_mt_GuidRandomHashcodeSubjects__PrivateImplementationDetails_ = {nullptr, nullptr, 4123915259771640705ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects = {nullptr, nullptr, 5733992221058677214ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_System_Private_CoreLib_System_Guid = {nullptr, nullptr, 17983019571512764410ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_System_Private_CoreLib_System_Random = {nullptr, nullptr, 5623716467429953792ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(4123915259771640705ULL, sizeof(chaos_type_GuidRandomHashcodeSubjects__PrivateImplementationDetails_), nullptr, 0);
	registry.Register(5733992221058677214ULL, sizeof(chaos_type_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects), nullptr, 0);
	...
	registry.Register(5623716467429953792ULL, sizeof(chaos_type_System_Private_CoreLib_System_Random), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<uintptr_t>(&chaos_mt_GuidRandomHashcodeSubjects__PrivateImplementationDetails_), reinterpret_cast<uintptr_t>(&chaos_mt_GuidRandomHashcodeSubjects__PrivateImplementationDetails_) + sizeof(chaos_mt_GuidRandomHashcodeSubjects__PrivateImplementationDetails_));
	registry.RegisterTypeInfoRange(reinterpret_cast<uintptr_t>(&chaos_mt_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects), reinterpret_cast<uintptr_t>(&chaos_mt_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects) + sizeof(chaos_mt_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects));
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<uintptr_t>(&chaos_mt_System_Private_CoreLib_System_Random), reinterpret_cast<uintptr_t>(&chaos_mt_System_Private_CoreLib_System_Random) + sizeof(chaos_mt_System_Private_CoreLib_System_Random));
...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[4] = {
		nullptr,
		chaos_mt_GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects.AsTypeInfoHot(),
		chaos_mt_GuidRandomHashcodeSubjects__PrivateImplementationDetails_.AsTypeInfoHot(),
		nullptr,
	};
...
extern "C" void GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects_Subject_0(void)
{
	...
	CHAOS_EH_TRY
			...
			}
			{
				...
				chaos_object->header.type_info = chaos_mt_System_Private_CoreLib_System_Guid.AsTypeInfoHot();
	...
	CHAOS_EH_TRY
			{
				...
				chaos_object->header.type_info = chaos_mt_System_Private_CoreLib_System_Random.AsTypeInfoHot();
...
extern "C" void GuidRandomHashcodeSubjects_GuidRandomHashcodeSubjects_Subject_11(void)
{
	...
	CHAOS_EH_TRY
			...
			}
			{
				...
				chaos_object->header.type_info = chaos_mt_System_Private_CoreLib_System_Object.AsTypeInfoHot();
