...
// Family: eh-stress, Assembly: System.Private.CoreLib
using System;
...
{
    Int32.Parse((((i + 2)) % 100000 + 1).ToString());
    _g++;  // volatile side-effect prevents DCE
    return false;
}
    ...
    static void Main()
    {
        var results = new List<MethodResult>();
            ...
            { // [3] System.Private.CoreLib/System.String::IndexOf:System.Int32(System.Char) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 3,
