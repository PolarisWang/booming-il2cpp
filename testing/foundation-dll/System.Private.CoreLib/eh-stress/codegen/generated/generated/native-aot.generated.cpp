...
extern "C" void EhStressSubjects_EhStressSubjects_Subject_0(void);
extern "C" void EhStressSubjects_EhStressSubjects_Subject_1(void);
extern "C" void EhStressSubjects_EhStressSubjects_Subject_2(void);
extern "C" void EhStressSubjects_EhStressSubjects_Subject_3(void);

namespace chaos::il2cpp::codegen::EhStressSubjects {
...
inline MethodTable chaos_mt_EhStressSubjects_EhStressSubjects = {nullptr, nullptr, 6654604163227171374ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_EhStressSubjects_EhStressSubjects = static_cast<CHAOS_IL2CPP_INTPTR>(6654604163227171374ULL);
...
struct chaos_type_EhStressSubjects_EhStressSubjects
{
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(6654604163227171374ULL, sizeof(chaos_type_EhStressSubjects_EhStressSubjects), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<uintptr_t>(&chaos_mt_EhStressSubjects_EhStressSubjects), reinterpret_cast<uintptr_t>(&chaos_mt_EhStressSubjects_EhStressSubjects) + sizeof(chaos_mt_EhStressSubjects_EhStressSubjects));
...
CHAOS_IL2CPP_INT32 chaos_static_EhStressSubjects_EhStressSubjects___exitCode = 0;
...
// Bridge/import thunk for: EhStressSubjects/EhStressSubjects::_exitCode
...
static constexpr struct {
	...
	{
		{ 0u, 0u },  // EhStressSubjects_EhStressSubjects_Subject_0
		{ 0u, 0u },  // EhStressSubjects_EhStressSubjects_Subject_1
		{ 0u, 0u },  // EhStressSubjects_EhStressSubjects_Subject_2
		{ 0u, 0u },  // EhStressSubjects_EhStressSubjects_Subject_3
	},
	{
	},
};
...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[2] = {
		nullptr,
		chaos_mt_EhStressSubjects_EhStressSubjects.AsTypeInfoHot(),
	};
	...
	static const CHAOS_IL2CPP_UINT32 s_native_aot_module_id =
		::chaos::il2cpp::runtime_core::RegisterModule("EhStressSubjects", &s_native_aot_module);
// ── Hotpatch name index + dispatch table ────────────────────
// Method name index entries
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[4] = {
	{ "Subject_0", 0x00000003u, 0u },  // EhStressSubjects
	{ "Subject_1", 0x00000004u, 0u },  // EhStressSubjects
	{ "Subject_2", 0x00000005u, 0u },  // EhStressSubjects
	{ "Subject_3", 0x00000006u, 0u },  // EhStressSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[1] = {
	{ "EhStressSubjects", "", 0u, 4u },
};
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[4] = {
	{ reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_0), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhStressSubjects::Subject_0
	{ reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_1), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhStressSubjects::Subject_1
	{ reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_2), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhStressSubjects::Subject_2
	{ reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_3), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhStressSubjects::Subject_3
};
...
extern "C" const char* kChaosExternalRuntimeSubjects[7] = {
	...
	"EhStressSubjects/EhStressSubjects::_exitCode",
...
static const struct {
	...
	/* ── Entry 0: EhStressSubjects_EhStressSubjects_Subject_0 ── */
	struct {
	...
	/* ── Entry 1: EhStressSubjects_EhStressSubjects_Subject_1 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 2: EhStressSubjects_EhStressSubjects_Subject_2 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 3: EhStressSubjects_EhStressSubjects_Subject_3 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry0 = EhStressSubjects_EhStressSubjects_Subject_0 */
	.entry0 = {
		/* entry_total_size = 44 */ 44u,
		/* code_address */ reinterpret_cast<const void*>(&EhStressSubjects_EhStressSubjects_Subject_0),
		/* frame_size = 48 */ 48u,
		/* num_gc_slots = 6 */ 6u,
		/* slots */ { 0u, 8u, 16u, 24u, 32u, 40u }
	},
	/* entry1 = EhStressSubjects_EhStressSubjects_Subject_1 */
	.entry1 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&EhStressSubjects_EhStressSubjects_Subject_1),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry2 = EhStressSubjects_EhStressSubjects_Subject_2 */
	.entry2 = {
		/* entry_total_size = 32 */ 32u,
		/* code_address */ reinterpret_cast<const void*>(&EhStressSubjects_EhStressSubjects_Subject_2),
		/* frame_size = 24 */ 24u,
		/* num_gc_slots = 3 */ 3u,
		/* slots */ { 0u, 8u, 16u }
	},
	/* entry3 = EhStressSubjects_EhStressSubjects_Subject_3 */
	.entry3 = {
		/* entry_total_size = 36 */ 36u,
		/* code_address */ reinterpret_cast<const void*>(&EhStressSubjects_EhStressSubjects_Subject_3),
		/* frame_size = 32 */ 32u,
		/* num_gc_slots = 4 */ 4u,
		/* slots */ { 0u, 8u, 16u, 24u }
	}
...
static void* const kMethodPointers[4] = {
	reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_0),
	reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_1),
	reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_2),
	reinterpret_cast<void*>(&EhStressSubjects_EhStressSubjects_Subject_3),
};
...
extern "C" const CodegenRegistrationOptionsV0 chaos_codegen_options
	...
	.image_name_utf8    = "EhStressSubjects",
};
// ── Reflection Query Image Descriptor ──────────────────────────
// Used by ResolveSubjectId to resolve call_target via subjectId
// matching during IR lowering of patched methods.

static constexpr ReflectionQueryFieldDescriptor kReflFields_EhStressSubjects_EhStressSubjects[1] = {
	{ 0x04000001u, "EhStressSubjects/EhStressSubjects::_exitCode", "_exitCode", "System.Int32", 0LL, 3u },
};
static constexpr ReflectionQueryMethodDescriptor kReflMethods_EhStressSubjects_EhStressSubjects[4] = {
	{ 0x00000003u, "EhStressSubjects/EhStressSubjects::Subject_0:System.Void()", "Subject_0", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000004u, "EhStressSubjects/EhStressSubjects::Subject_1:System.Void()", "Subject_1", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000005u, "EhStressSubjects/EhStressSubjects::Subject_2:System.Void()", "Subject_2", "System.Void", 0, nullptr, 0u, nullptr, 0u },
	{ 0x00000006u, "EhStressSubjects/EhStressSubjects::Subject_3:System.Void()", "Subject_3", "System.Void", 0, nullptr, 0u, nullptr, 0u },
};

static const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	{ 0x00000001u, "EhStressSubjects/EhStressSubjects", "EhStressSubjects/EhStressSubjects", "", "EhStressSubjects", "EhStressSubjects", nullptr, kReflFields_EhStressSubjects_EhStressSubjects, 1u, nullptr, 0u,
nullptr, 0u,    kReflMethods_EhStressSubjects_EhStressSubjects, 4u, nullptr, 0u, 0u },
};
...
static const ReflectionQueryImageDescriptor kReflImage = { "EhStressSubjects", kReflTypePtrs, 1u, 1, 0, 0, 0 };
...
// Managed method: EhStressSubjects/EhStressSubjects::Subject_0()
extern "C" void EhStressSubjects_EhStressSubjects_Subject_0(void)
{
	...
	CHAOS_EH_TRY
			...
			_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(1);
			{
				...
				chaos_static_EhStressSubjects_EhStressSubjects___exitCode = chaos_value;
			}
...
// Managed method: EhStressSubjects/EhStressSubjects::Subject_1()
extern "C" void EhStressSubjects_EhStressSubjects_Subject_1(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: EhStressSubjects/EhStressSubjects::Subject_2()
extern "C" void EhStressSubjects_EhStressSubjects_Subject_2(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: EhStressSubjects/EhStressSubjects::Subject_3()
extern "C" void EhStressSubjects_EhStressSubjects_Subject_3(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
