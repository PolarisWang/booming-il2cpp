...
public static partial class PrimitiveNumericConversionsSubjects
{
    ...
    {
        try { _ = ((Convert.ToBoolean("true")) ? 1 : 0); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = (int)(Convert.ToDecimal("42")); }
        catch { _exitCode = 1; }
    }
