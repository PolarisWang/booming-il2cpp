...
struct Functions {
    ...
    struct ReflectionBindingSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_10)(
...
struct ReflectionBindingSubjects {
    ...
    static inline void Subject_1(
        ...
        return kFunctions.reflectionBindingSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_7(
        );
    }
    static inline void Subject_8(
    ) {
        return kFunctions.reflectionBindingSubjects.Subject_8(
        );
    }
