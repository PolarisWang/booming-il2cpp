...
inline MethodTable chaos_mt_ReflectionBindingSubjects_ReflectionBindingSubjects = {reinterpret_cast<const MethodTable*>(&chaos_mt_System_Private_CoreLib_System_Object), nullptr, 15879193500755149464ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo = {reinterpret_cast<const MethodTable*>(&chaos_mt_System_Private_CoreLib_System_Object), nullptr, 17040031516751226236ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_System_Private_CoreLib_System_Reflection_ParameterInfo = {reinterpret_cast<const MethodTable*>(&chaos_mt_System_Private_CoreLib_System_Object), nullptr, 10691557903995528663ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0, 0};
...
CHAOS_IL2CPP_INTPTR ChaosReflectionGetMemberName(CHAOS_IL2CPP_INTPTR chaos_member_value) noexcept
{
	...
	if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Type.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Type.AsTypeInfoHot())->stable_id)
	{
	...
	if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_MethodInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_MethodInfo.AsTypeInfoHot())->stable_id)
	{
	...
	if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_ConstructorInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_ConstructorInfo.AsTypeInfoHot())->stable_id)
	{
	...
	if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo.AsTypeInfoHot())->stable_id)
	{
...
CHAOS_IL2CPP_INTPTR ChaosReflectionGetDeclaringType(CHAOS_IL2CPP_INTPTR chaos_member_value)
{
	...
	else if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_MethodInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_MethodInfo.AsTypeInfoHot())->stable_id)
	{
		auto* chaos_method = reinterpret_cast<chaos_type_System_Private_CoreLib_System_Reflection_MethodInfo*>(chaos_member_value);
		chaos_declaring_type_handle = chaos_method->declaring_type_handle;
	}
	else if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_ConstructorInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_ConstructorInfo.AsTypeInfoHot())->stable_id)
	{
		auto* chaos_method = reinterpret_cast<chaos_type_System_Private_CoreLib_System_Reflection_ConstructorInfo*>(chaos_member_value);
		chaos_declaring_type_handle = chaos_method->declaring_type_handle;
	}
	else if (chaos_object_get_type_info(chaos_header) == chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo.AsTypeInfoHot()
		|| chaos_object_get_type_info(chaos_header)->stable_id == (chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo.AsTypeInfoHot())->stable_id)
	{
		auto* chaos_field = reinterpret_cast<chaos_type_System_Private_CoreLib_System_Reflection_FieldInfo*>(chaos_member_value);
	...
	switch (chaos_type->runtime_type_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(46055704u):
			if (CHAOS_IL2CPP_STRCMP(chaos_field_name, "_exitCode") == 0)
			{
				...
				chaos_field->header.type_info = chaos_mt_System_Private_CoreLib_System_Reflection_FieldInfo.AsTypeInfoHot();
...
CHAOS_IL2CPP_INTPTR ChaosReflectionGetGenericArguments(CHAOS_IL2CPP_INTPTR chaos_type_value)
{
	...
	if (chaos_type == nullptr)
	{
		return chaos_reflection_create_reference_array(
			chaos_mt_System_Private_CoreLib_System_Type.AsTypeInfoHot(),
			static_cast<CHAOS_IL2CPP_SIZE>(0));
	}
...
CHAOS_IL2CPP_INTPTR ChaosReflectionGetConstructors(CHAOS_IL2CPP_INTPTR chaos_type_value, CHAOS_IL2CPP_INT32 chaos_binding_flags)
{
	...
	{
		return chaos_reflection_create_reference_array(
			chaos_mt_System_Private_CoreLib_System_Reflection_ConstructorInfo.AsTypeInfoHot(),
			static_cast<CHAOS_IL2CPP_SIZE>(0));
	}
...
CHAOS_IL2CPP_INTPTR ChaosReflectionGetParameters(CHAOS_IL2CPP_INTPTR chaos_method_value)
{
	...
	{
		return chaos_reflection_create_reference_array(
			chaos_mt_System_Private_CoreLib_System_Reflection_ParameterInfo.AsTypeInfoHot(),
			static_cast<CHAOS_IL2CPP_SIZE>(0));
	}
	...
	switch (chaos_method_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(116605137u):
		{
			const auto chaos_array_value = chaos_reflection_create_reference_array(chaos_mt_System_Private_CoreLib_System_Reflection_ParameterInfo.AsTypeInfoHot(), static_cast<CHAOS_IL2CPP_SIZE>(0));
...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[2] = {
		nullptr,
		chaos_mt_ReflectionBindingSubjects_ReflectionBindingSubjects.AsTypeInfoHot(),
	};
...
extern "C" const int kSubjectSlotMap[12] = {
	0,
	1,
	2,
	3,
