...
{
    // Verify String.IndexOf after hot-update (host side)
    ...
    // Verify String.Substring after hot-update (host side)
    ...
    // Verify String.Compare after hot-update (host side)
    ...
    // Verify String.Concat after hot-update (host side)
    ...
    // Verify String.Format after hot-update (host side)
    ...
    // Verify String.StartsWith after hot-update (host side)
    ...
    // Verify String.Contains after hot-update (host side)
    ...
    // Verify String.Replace after hot-update (host side)
    ...
    // Verify String.Split after hot-update (host side)
    ...
    // Verify String.ToUpper after hot-update (host side)
    ...
    // Verify String.ToLower after hot-update (host side)
    ...
    // Verify String.Trim after hot-update (host side)
    ...
    // Verify String.Join after hot-update (host side)
    ...
    // Verify Char.IsDigit after hot-update (host side)
    ...
    // Verify Char.IsLetter after hot-update (host side)
    ...
    // Verify Char.IsWhiteSpace after hot-update (host side)
