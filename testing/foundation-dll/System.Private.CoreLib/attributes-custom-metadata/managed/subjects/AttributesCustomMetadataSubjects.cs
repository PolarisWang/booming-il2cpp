...
public static partial class AttributesCustomMetadataSubjects
{
    ...
    {
        try { var _ = ((typeof(byte).Assembly.GetCustomAttribute(typeof(AssemblyDescriptionAttribute))).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (new System.Collections.Generic.List<System.Attribute>(typeof(byte).Assembly.GetCustomAttributes(typeof(AssemblyDescriptionAttribute)).Cast<System.Attribute>()).Count); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (new System.Collections.Generic.List<System.Attribute>(typeof(byte).Assembly.GetCustomAttributes(false).Cast<System.Attribute>()).Count); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((typeof(byte).Assembly.IsDefined(typeof(AssemblyDescriptionAttribute))) ? 1 : 0); }
        catch { _exitCode = 1; }
    }
