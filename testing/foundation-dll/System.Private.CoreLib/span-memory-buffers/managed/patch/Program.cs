...
public class Program
{
    static int Main()
    {
        ...
        SpanMemoryBuffersPatchEntry._exitCode = 0; SpanMemoryBuffersPatchEntry.Method4(); failures += SpanMemoryBuffersPatchEntry._exitCode << 4;
        ...
        SpanMemoryBuffersPatchEntry._exitCode = 0; SpanMemoryBuffersPatchEntry.Method8(); failures += SpanMemoryBuffersPatchEntry._exitCode << 8;
        ...
        SpanMemoryBuffersPatchEntry._exitCode = 0; SpanMemoryBuffersPatchEntry.Method11(); failures += SpanMemoryBuffersPatchEntry._exitCode << 11;
        SpanMemoryBuffersPatchEntry._exitCode = 0; SpanMemoryBuffersPatchEntry.Method12(); failures += SpanMemoryBuffersPatchEntry._exitCode << 12;
        SpanMemoryBuffersPatchEntry._exitCode = 0; SpanMemoryBuffersPatchEntry.Method13(); failures += SpanMemoryBuffersPatchEntry._exitCode << 13;
        return failures;
    }
}
