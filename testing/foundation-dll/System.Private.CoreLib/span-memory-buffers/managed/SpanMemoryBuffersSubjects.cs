...
public static partial class SpanMemoryBuffersSubjects
{
    ...
    {
        try { _ = ((new Span<byte>(new byte[4])[0]).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new Span<byte>(new byte[4]).Slice(1).Length).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new Span<byte>(new byte[4]).Slice(1, 2).Length).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new byte[1].AsSpan().ToArray()).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((Span<byte>.Empty).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new ReadOnlySpan<byte>(new byte[4])[0]).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new ReadOnlySpan<byte>(new byte[4]).Slice(1).Length).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((new Memory<byte>(new byte[4]).Slice(1).Length).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = ((default(Memory<byte>).Span).GetHashCode()); }
        catch { _exitCode = 1; }
    }
