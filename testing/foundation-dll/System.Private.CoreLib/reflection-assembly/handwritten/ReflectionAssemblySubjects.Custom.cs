...
public static partial class ReflectionAssemblySubjects
{
    ...
    {
        try { _ = typeof(byte).Assembly.GetName().Version?.GetHashCode(); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = typeof(byte).Assembly.GetType("System.Byte")?.GetHashCode(); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = typeof(byte).Assembly.GetType("System.Byte", true)?.GetHashCode(); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = typeof(byte).Assembly.GetModule("System.Private.CoreLib.dll")?.GetHashCode(); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { _ = typeof(byte).Assembly.GetManifestResourceStream("NonExistent"); }
        catch { _exitCode = 1; }
    }
