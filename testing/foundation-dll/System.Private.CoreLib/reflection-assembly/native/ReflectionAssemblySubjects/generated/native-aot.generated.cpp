...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[2] = {
		nullptr,
		reinterpret_cast<const TypeInfoHot*>(&chaos_mt_ReflectionAssemblySubjects_ReflectionAssemblySubjects),
	};
...
extern "C" void ReflectionAssemblySubjects_ReflectionAssemblySubjects_CustomEntrySubject_21(void)
{
	...
	CHAOS_EH_CATCH_BEGIN
		...
		if (chaos_header != nullptr)
		{
			if (!chaos_is_type_compatible(chaos_object_get_type_info(chaos_header), reinterpret_cast<const TypeInfoHot*>(&chaos_mt_System_Private_CoreLib_System_NullReferenceException)))
			{ CHAOS_EH_RETHROW; }
		}
		_s0 = CHAOS_EH_EXCEPTION_OBJ;
	CHAOS_EH_END
