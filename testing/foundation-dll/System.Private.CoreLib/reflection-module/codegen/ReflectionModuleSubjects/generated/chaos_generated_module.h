...
struct ReflectionModuleSubjects {
    ...
    static inline void Subject_1(
        ...
        return kFunctions.reflectionModuleSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.reflectionModuleSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.reflectionModuleSubjects.Subject_3(
        );
    }
