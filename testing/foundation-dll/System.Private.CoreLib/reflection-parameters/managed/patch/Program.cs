...
public class Program
{
    static int Main()
    {
        ...
        ReflectionParametersPatchEntry._exitCode = 0; ReflectionParametersPatchEntry.Method7(); failures += ReflectionParametersPatchEntry._exitCode << 7;
        ReflectionParametersPatchEntry._exitCode = 0; ReflectionParametersPatchEntry.Method8(); failures += ReflectionParametersPatchEntry._exitCode << 8;
        ReflectionParametersPatchEntry._exitCode = 0; ReflectionParametersPatchEntry.Method9(); failures += ReflectionParametersPatchEntry._exitCode << 9;
        return failures;
    }
}
