...
public static partial class ReflectionParametersSubjects
{
    ...
    {
        try { var _ = ((default(ParameterInfo)!.Name).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.ParameterType).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.DefaultValue).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.RawDefaultValue).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.HasDefaultValue) ? 1 : 0); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.Attributes).GetHashCode()); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = default(ParameterInfo)!.Position; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.GetRequiredCustomModifiers()).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(ParameterInfo)!.GetOptionalCustomModifiers()).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((default(MethodInfo)!.GetParameters()).Length); }
        catch { _exitCode = 1; }
    }
