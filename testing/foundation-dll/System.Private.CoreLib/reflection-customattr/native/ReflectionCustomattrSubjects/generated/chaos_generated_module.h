...
struct Functions {
    struct ReflectionCustomattrSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct ReflectionCustomattrSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.reflectionCustomattrSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.reflectionCustomattrSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.reflectionCustomattrSubjects.Subject_2(
        );
    }
