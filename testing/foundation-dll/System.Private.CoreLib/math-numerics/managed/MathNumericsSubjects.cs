...
public static partial class MathNumericsSubjects
{
    ...
    {
        try { var _ = (int)(Math.Ceiling(42.0)); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (int)(Math.Max(42.0, 42.0)); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (int)(Math.Pow(42.0, 42.0)); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (int)(Math.BigMul(42, 42)); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((BitConverter.GetBytes(42)).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = ((BitConverter.GetBytes(42.0)).Length); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = BitConverter.ToInt32(new byte[4], 0); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { var _ = (int)(BitConverter.ToDouble(new byte[8], 0)); }
        catch { _exitCode = 1; }
    }
