...
extern "C" void ThreadingSyncSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
extern "C" void ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0);
...
static constexpr struct {
...
} s_abi_manifest_storage = {
	{
		...
		19u,
		1u,
		66919960u,  // FNV-1a over entries+params
	...
	},
	{
		...
		{ 0u, 0u },  // ThreadingSyncSubjects_AutoGeneratedProgram__ctor
		{ 0u, 1u },  // ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String
	},
	{
		2u,
	},
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[19] = {
	{ ".ctor", 0x00000016u, 0u },  // AutoGeneratedProgram
	{ "Main", 0x00000015u, 1u },  // AutoGeneratedProgram
	{ "Subject_0", 0x00000004u, 0u },  // ThreadingSyncSubjects
	{ "Subject_1", 0x00000005u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_2", 0x00000006u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_3", 0x00000007u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_4", 0x00000008u, 0u },  // ThreadingSyncSubjects
	{ "Subject_5", 0x00000009u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_6", 0x0000000Au, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_7", 0x0000000Bu, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_8", 0x0000000Cu, 0u },  // ThreadingSyncSubjects
	{ "Subject_9", 0x0000000Du, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_10", 0x0000000Eu, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_11", 0x0000000Fu, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_12", 0x00000010u, 0u },  // ThreadingSyncSubjects
	{ "Subject_13", 0x00000011u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_14", 0x00000012u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_15", 0x00000013u, 0u },  // ThreadingSyncSubjects
	{ "CustomEntrySubject_16", 0x00000014u, 0u },  // ThreadingSyncSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[2] = {
	{ "AutoGeneratedProgram", "", 0u, 2u },
	{ "ThreadingSyncSubjects", "", 2u, 17u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[19] = {
	...
	{ reinterpret_cast<void*>(&ThreadingSyncSubjects_AutoGeneratedProgram__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative },  // AutoGeneratedProgram::.ctor
	{ reinterpret_cast<void*>(&ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // AutoGeneratedProgram::Main
};
...
static void (*kAotMethods[19])() = {
	...
	reinterpret_cast<void(*)()>(&ThreadingSyncSubjects_AutoGeneratedProgram__ctor),
	reinterpret_cast<void(*)()>(&ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String),
};
...
static const struct {
	...
	/* ── Entry 5: ThreadingSyncSubjects_AutoGeneratedProgram__ctor ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 6: ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry5 = ThreadingSyncSubjects_AutoGeneratedProgram__ctor */
	.entry5 = {
		/* entry_total_size = 28 */ 28u,
		/* code_address */ reinterpret_cast<const void*>(&ThreadingSyncSubjects_AutoGeneratedProgram__ctor),
		/* frame_size = 16 */ 16u,
		/* num_gc_slots = 2 */ 2u,
		/* slots */ { 0u, 8u }
	},
	/* entry6 = ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String */
	.entry6 = {
		/* entry_total_size = 24 */ 24u,
		/* code_address */ reinterpret_cast<const void*>(&ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String),
		/* frame_size = 8 */ 8u,
		/* num_gc_slots = 1 */ 1u,
		/* slots */ { 0u }
	}
...
static const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 176u;
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ThreadingSyncSubjects_AutoGeneratedProgram[2] = {
	{ 0u, "ThreadingSyncSubjects/AutoGeneratedProgram::.ctor:System.Void()", ".ctor", "System.Void", 0, nullptr, 0u },
	{ 0u, "ThreadingSyncSubjects/AutoGeneratedProgram::Main:System.Void(System.String[])", "Main", "System.Void", 0, nullptr, 0u },
};

static const ReflectionQueryTypeDescriptor kReflTypes[2] = {
	{ 0u, "ThreadingSyncSubjects/ThreadingSyncSubjects", "ThreadingSyncSubjects/ThreadingSyncSubjects", "", "ThreadingSyncSubjects", "ThreadingSyncSubjects", nullptr, kReflFields_ThreadingSyncSubjects_ThreadingSyncSubjects, 1u, nullptr, 0u,
	kReflMethods_ThreadingSyncSubjects_ThreadingSyncSubjects, 17u },
	{ 0u, "ThreadingSyncSubjects/AutoGeneratedProgram", "ThreadingSyncSubjects/AutoGeneratedProgram", "", "AutoGeneratedProgram", "AutoGeneratedProgram", nullptr, nullptr, 0u, nullptr, 0u,
	kReflMethods_ThreadingSyncSubjects_AutoGeneratedProgram, 2u },
};
...
static const ReflectionQueryImageDescriptor kReflImage = { "ThreadingSyncSubjects", kReflTypePtrs, 2u };
...
// Managed method: ThreadingSyncSubjects/AutoGeneratedProgram::.ctor()
extern "C" void ThreadingSyncSubjects_AutoGeneratedProgram__ctor(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: ThreadingSyncSubjects/AutoGeneratedProgram::Main(System.String[])
extern "C" void ThreadingSyncSubjects_AutoGeneratedProgram_Main_System_String(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
