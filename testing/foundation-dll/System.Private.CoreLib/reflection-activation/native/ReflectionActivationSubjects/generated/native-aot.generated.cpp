...
// ── Module registration ──
	...
	static const TypeInfoHot* const s_type_info_ptrs[2] = {
		nullptr,
		reinterpret_cast<const TypeInfoHot*>(&chaos_mt_ReflectionActivationSubjects_ReflectionActivationSubjects),
	};
...
extern "C" void ReflectionActivationSubjects_ReflectionActivationSubjects_Subject_7(void)
{
	...
	CHAOS_EH_TRY
			...
			_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(0);
			{
				...
				chaos_array->element_type_info = reinterpret_cast<const TypeInfoHot*>(&chaos_mt_System_Private_CoreLib_System_Object);
				chaos_array->length = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_length);
