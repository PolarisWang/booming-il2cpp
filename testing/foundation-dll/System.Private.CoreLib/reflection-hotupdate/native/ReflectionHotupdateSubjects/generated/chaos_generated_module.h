...
struct Functions {
    struct ReflectionHotupdateSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct ReflectionHotupdateSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.reflectionHotupdateSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.reflectionHotupdateSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.reflectionHotupdateSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.reflectionHotupdateSubjects.Subject_3(
        );
    }
