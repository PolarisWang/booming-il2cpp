...
def generated_source(
    ...
    *,
    ...
    Produces a single file containing:
      - [Fact] test methods (discovered via reflection by FactRunner)
      - [Benchmark] benchmark methods (static, void)
      - [HotUpdate] hotupdate methods (static, void)
    ...
    if not method_subject_ids:
        ...
        for method_subject_id in method_subject_ids:
            ...
            # --- Benchmark method ([Benchmark], static void) ---
            ...
            # --- HotUpdate method ([HotUpdate], static void) ---
...
def patch_generated_source(
    ...
    *,
    ...
    — they mirror the Host side with [HotUpdate] marker.
    """
