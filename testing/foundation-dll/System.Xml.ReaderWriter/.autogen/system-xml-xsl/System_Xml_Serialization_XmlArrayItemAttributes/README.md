# AutoTestGenerator: System.Xml.Serialization.XmlArrayItemAttributes
...
- `CopyTo (ICollection non-generic leak: XmlArrayItemAttribute[])` — contains generic parameters, needs manual handling
