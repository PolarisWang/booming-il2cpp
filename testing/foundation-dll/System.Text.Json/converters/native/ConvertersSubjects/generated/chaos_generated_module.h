...
struct ConvertersSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.convertersSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.convertersSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.convertersSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.convertersSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.convertersSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.convertersSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.convertersSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.convertersSubjects.Subject_7(
        );
    }
    static inline void Subject_8(
    ) {
        return kFunctions.convertersSubjects.Subject_8(
        );
    }
