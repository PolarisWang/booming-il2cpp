...
/// Per-enum ToString dispatch for System.Memory/System.ExceptionArgument (17 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_MEMORY_SYSTEM_EXCEPTIONARGUMENT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("length");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("start");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("minimumBufferSize");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("elementIndex");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("comparable");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("comparer");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("destination");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("offset");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("startSegment");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("endSegment");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("startIndex");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("endIndex");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("array");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("culture");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("manager");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("count");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("writer");
...
/// Per-enum ToString dispatch for System.Memory/System.Buffers.ReadOnlySequence`1+SequenceType (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_MEMORY_SYSTEM_BUFFERS_READONLYSEQUENCE_1_SEQUENCETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("MultiSegment");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Array");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MemoryManager");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("String");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Empty");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x3DDB74u, &ChaosEnumToString_SYSTEM_MEMORY_SYSTEM_BUFFERS_READONLYSEQUENCE_1_SEQUENCETYPE },
    ...
    { 0x9942DFu, &ChaosEnumToString_SYSTEM_MEMORY_SYSTEM_EXCEPTIONARGUMENT },
