...
public static partial class ReaderSubjects
{
    ...
    {        try { _ = default(Utf8JsonReader).CopyString(default(Span<byte>)); } catch { _exitCode = 1; }    }

    // [1] System.Text.Json/System.Text.Json.Utf8JsonReader::CopyString:System.Int32(System.Span{System.Char})
    public static void CustomEntrySubject_1()
    {        try { _ = default(Utf8JsonReader).CopyString(default(Span<char>)); } catch { _exitCode = 1; }    }
    ...
    {        try { default(Utf8JsonReader).ValueSpan = default(ReadOnlySpan<byte>); } catch { _exitCode = 1; }    }
    ...
    {        try { default(Utf8JsonReader).TokenStartIndex = 42L; } catch { _exitCode = 1; }    }
    ...
    {        try { default(Utf8JsonReader).HasValueSequence = true; } catch { _exitCode = 1; }    }
    ...
    {        try { default(Utf8JsonReader).ValueIsEscaped = true; } catch { _exitCode = 1; }    }
    ...
    {        try { default(Utf8JsonReader).ValueSequence = default(ReadOnlySequence<byte>); } catch { _exitCode = 1; }    }
