...
public static partial class NodesSubjects
{
    ...
    {        try { _ = default(JsonNode)!.GetValue{T}(); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Explicit(default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(true); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit((byte)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit('A'); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(DateTime.UtcNow); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42m); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42.0); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(Guid.Empty); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit((short)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42L); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit((sbyte)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42.0f); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit("hello"); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit((ushort)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42u); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)!.op_Implicit(42uL); } catch { _exitCode = 1; }    }
    ...
    {        try { default(JsonNode)!.Parent = default; } catch { _exitCode = 1; }    }
    ...
    {        try { _ = default(JsonNode)![]; } catch { _exitCode = 1; }    }
    ...
    {        try { default(JsonNode)![] = default; } catch { _exitCode = 1; }    }
