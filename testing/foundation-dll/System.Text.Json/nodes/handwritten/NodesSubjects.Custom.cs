...
public static partial class NodesSubjects
{
    ...
    {        try { new JsonArray(default); } catch { _exitCode = 1; }    }
    ...
    {        try { new JsonArray(default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").GetValue{T}(); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Explicit(default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(true); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit((byte)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit('A'); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(DateTime.UtcNow); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42m); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42.0); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(Guid.Empty); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit((short)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42L); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit((sbyte)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42.0f); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit("hello"); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit((ushort)42); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42u); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}").op_Implicit(42uL); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse(out default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("hello", default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse(default(ReadOnlySpan<byte>), default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse(new MemoryStream(), default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { JsonNode.Parse("{}").Parent = default; } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonNode.Parse("{}")[]; } catch { _exitCode = 1; }    }
    ...
    {        try { JsonNode.Parse("{}")[] = default; } catch { _exitCode = 1; }    }
    ...
    {        try { new JsonObject(default, default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonValue.Create{T}(default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonValue.Create{T}(default, default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = JsonValue.TryGetValue{T}(out default); } catch { _exitCode = 1; }    }
