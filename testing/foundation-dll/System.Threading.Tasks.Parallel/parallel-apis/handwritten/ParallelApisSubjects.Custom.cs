...
public static partial class ParallelApisSubjects
{
    ...
    {        try { _ = Parallel.For(42, 42, default, default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { _ = Parallel.For(42L, 42L, default, default, default); } catch { _exitCode = 1; }    }
    ...
    {        try { Parallel.Invoke(default, default); } catch { _exitCode = 1; }    }
