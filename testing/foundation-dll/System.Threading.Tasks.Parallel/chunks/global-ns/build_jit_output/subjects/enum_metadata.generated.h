...
// ── Enum: System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE[] = {
    { "ParallelInvoke", 1 },
    { "ParallelFor", 2 },
    { "ParallelForEach", 3 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE = {
    kEnumFields_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE = {
    0u,
    0u,
    "System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType"
};

/// Per-enum ToString dispatch for System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ParallelInvoke");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ParallelFor");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("ParallelForEach");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0xEA81A5u, &kEnumTable_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE },
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0xEA81A5u, &ChaosEnumToString_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumToStringDispatchCount = 286u;
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE));
    ChaosRegisterExternalType(
