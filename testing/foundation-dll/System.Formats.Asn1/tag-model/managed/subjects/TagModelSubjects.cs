...
public static partial class TagModelSubjects
{
    ...
    {
        try { if (((default(Asn1Tag).AsConstructed()).GetHashCode()) != ((default(Asn1Tag).AsConstructed()).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).AsPrimitive()).GetHashCode()) != ((default(Asn1Tag).AsPrimitive()).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (default(Asn1Tag).CalculateEncodedSize() != default(Asn1Tag).CalculateEncodedSize()) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((Asn1Tag.Decode(default, out _)).GetHashCode()) != ((Asn1Tag.Decode(default, out _)).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (default(Asn1Tag).Encode(default(Span<byte>)) != default(Asn1Tag).Encode(default(Span<byte>))) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).Equals(default)) ? 1 : 0) != ((default(Asn1Tag).Equals(default)) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).IsConstructed) ? 1 : 0) != ((default(Asn1Tag).IsConstructed) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).TagClass).GetHashCode()) != ((default(Asn1Tag).TagClass).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (default(Asn1Tag).TagValue != default(Asn1Tag).TagValue) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (default(Asn1Tag).GetHashCode() != default(Asn1Tag).GetHashCode()) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).HasSameClassAndValue(default)) ? 1 : 0) != ((default(Asn1Tag).HasSameClassAndValue(default)) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag) == default(Asn1Tag)) ? 1 : 0) != ((default(Asn1Tag) == default(Asn1Tag)) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((default(Asn1Tag).ToString()).Length) != ((default(Asn1Tag).ToString()).Length)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if (((Asn1Tag.TryDecode(default, out _, out _)) ? 1 : 0) != ((Asn1Tag.TryDecode(default, out _, out _)) ? 1 : 0)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { new Asn1Tag(default, 42, true); }
        catch { _exitCode = 1; }
    }
