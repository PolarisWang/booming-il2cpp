...
struct Functions {
    struct OptionsErrorsSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct OptionsErrorsSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.optionsErrorsSubjects.Subject_6(
        );
    }
