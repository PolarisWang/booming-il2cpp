...
// ── Enum: System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES[] = {
    { "BER", 0 },
    { "CER", 1 },
    { "DER", 2 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES = {
    kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES = {
    0u,
    0u,
    "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules"
};

/// Per-enum ToString dispatch for System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("BER");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CER");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("DER");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthDecodeStatus ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS[] = {
    { "NeedMoreData", 0 },
    { "DerIndefinite", 1 },
    { "ReservedValue", 2 },
    { "LengthTooBig", 3 },
    { "LaxEncodingProhibited", 4 },
    { "Success", 5 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS = {
    kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS, 6
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS = {
    0u,
    0u,
    "System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthDecodeStatus"
};

/// Per-enum ToString dispatch for System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthDecodeStatus (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NeedMoreData");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DerIndefinite");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ReservedValue");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("LengthTooBig");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("LaxEncodingProhibited");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Success");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthValidity ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY[] = {
    { "CerRequiresIndefinite", 0 },
    { "PrimitiveEncodingRequiresDefinite", 1 },
    { "LengthExceedsInput", 2 },
    { "Valid", 3 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY = {
    kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY = {
    0u,
    0u,
    "System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthValidity"
};

/// Per-enum ToString dispatch for System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthValidity (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("CerRequiresIndefinite");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PrimitiveEncodingRequiresDefinite");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("LengthExceedsInput");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Valid");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Formats.Asn1/System.Formats.Asn1.TagClass ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS[] = {
    { "Universal", 0 },
    { "Application", 64 },
    { "ContextSpecific", 128 },
    { "Private", 192 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS = {
    kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS = {
    0u,
    0u,
    "System.Formats.Asn1/System.Formats.Asn1.TagClass"
};

/// Per-enum ToString dispatch for System.Formats.Asn1/System.Formats.Asn1.TagClass (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Universal");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("Application");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("ContextSpecific");
    if (value == 192) return CHAOS_IL2CPP_STRING_ID("Private");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Formats.Asn1/System.Formats.Asn1.UniversalTagNumber ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER[] = {
    { "EndOfContents", 0 },
    { "Boolean", 1 },
    { "Integer", 2 },
    { "BitString", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER = {
    kEnumFields_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER, 41
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER = {
    0u,
    0u,
    "System.Formats.Asn1/System.Formats.Asn1.UniversalTagNumber"
};

/// Per-enum ToString dispatch for System.Formats.Asn1/System.Formats.Asn1.UniversalTagNumber (41 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("EndOfContents");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Boolean");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Integer");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("BitString");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("OctetString");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Null");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("ObjectIdentifier");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("ObjectDescriptor");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("External");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("InstanceOf");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("Real");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("Enumerated");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("Embedded");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("UTF8String");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("RelativeObjectIdentifier");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("Time");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("Sequence");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("SequenceOf");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("Set");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("SetOf");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("NumericString");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("PrintableString");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("TeletexString");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("T61String");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("VideotexString");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("IA5String");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("UtcTime");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("GeneralizedTime");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("GraphicString");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("VisibleString");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("ISO646String");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("GeneralString");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("UniversalString");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("UnrestrictedCharacterString");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("BMPString");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("Date");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("TimeOfDay");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("DateTime");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("Duration");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("ObjectIdentifierIRI");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("RelativeObjectIdentifierIRI");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0x0D2E21u, &kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS },
    ...
    { 0x4CDE8Fu, &kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY },
    ...
    { 0x8C21ECu, &kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES },
    ...
    { 0x924BA4u, &kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER },
    ...
    { 0xD5B8C6u, &kEnumTable_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumDispatchCount = 292u;
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x0D2E21u, &ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS },
    ...
    { 0x4CDE8Fu, &ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY },
    ...
    { 0x8C21ECu, &ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES },
    ...
    { 0x924BA4u, &ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER },
    ...
    { 0xD5B8C6u, &ChaosEnumToString_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumToStringDispatchCount = 292u;
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Formats.Asn1/System.Formats.Asn1.UniversalTagNumber"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_UNIVERSALTAGNUMBER));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Formats.Asn1/System.Formats.Asn1.TagClass"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_TAGCLASS));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthDecodeStatus"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHDECODESTATUS));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNENCODINGRULES));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Formats.Asn1/System.Formats.Asn1.AsnDecoder+LengthValidity"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_FORMATS_ASN1_SYSTEM_FORMATS_ASN1_ASNDECODER_LENGTHVALIDITY));
    ChaosRegisterExternalType(
