...
// ── Enum: System.Runtime.Numerics/System.HexConverter+Casing ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING[] = {
    { "Upper", 0 },
    { "Lower", 8224 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING = {
    kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING, 2
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING = {
    0u,
    0u,
    "System.Runtime.Numerics/System.HexConverter+Casing"
};

/// Per-enum ToString dispatch for System.Runtime.Numerics/System.HexConverter+Casing (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Upper");
    if (value == 8224) return CHAOS_IL2CPP_STRING_ID("Lower");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Runtime.Numerics/System.Numerics.BigInteger+GetBytesMode ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE[] = {
    { "AllocateArray", 0 },
    { "Count", 1 },
    { "Span", 2 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE = {
    kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE = {
    0u,
    0u,
    "System.Runtime.Numerics/System.Numerics.BigInteger+GetBytesMode"
};

/// Per-enum ToString dispatch for System.Runtime.Numerics/System.Numerics.BigInteger+GetBytesMode (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("AllocateArray");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Count");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Span");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Runtime.Numerics/System.Numerics.BigNumber+ParsingStatus ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS[] = {
    { "OK", 0 },
    { "Failed", 1 },
    { "Overflow", 2 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS = {
    kEnumFields_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS = {
    0u,
    0u,
    "System.Runtime.Numerics/System.Numerics.BigNumber+ParsingStatus"
};

/// Per-enum ToString dispatch for System.Runtime.Numerics/System.Numerics.BigNumber+ParsingStatus (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("OK");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Failed");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Overflow");
    return 0;  // unrecognized value → caller falls through to decimal
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+CryptCreateHashFlags (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTCREATEHASHFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+GetDefaultProviderFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_GETDEFAULTPROVIDERFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CRYPT_MACHINE_DEFAULT");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CRYPT_USER_DEFAULT");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+CryptHashProperty (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTHASHPROPERTY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("HP_ALGID");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("HP_HASHVAL");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("HP_HASHSIZE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("HP_HMAC_INFO");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("HP_TLS1PRF_LABEL");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("HP_TLS1PRF_SEED");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+CryptGetKeyParamFlags (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTGETKEYPARAMFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KP_IV");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CRYPT_EXPORT");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("KP_PERMISSIONS");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("KP_ALGID");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("KP_KEYLEN");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+CryptProvParam (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTPROVPARAM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PP_CLIENT_HWND");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PP_IMPTYPE");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("PP_NAME");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("PP_CONTAINER");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("PP_PROVTYPE");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("PP_KEYSET_TYPE");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("PP_KEYEXCHANGE_PIN");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("PP_SIGNATURE_PIN");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("PP_UNIQUE_CONTAINER");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+KeySpec (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_KEYSPEC(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AT_KEYEXCHANGE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("AT_SIGNATURE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Advapi32+CryptSignAndVerifyHashFlags (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTSIGNANDVERIFYHASHFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CRYPT_NOHASHOID");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CRYPT_TYPE2_FORMAT");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CRYPT_X931_FORMAT");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+BCryptAlgPseudoHandle (19 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTALGPSEUDOHANDLE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("BCRYPT_MD5_ALG_HANDLE");
    if (value == 49) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA1_ALG_HANDLE");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA256_ALG_HANDLE");
    if (value == 81) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA384_ALG_HANDLE");
    if (value == 97) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA512_ALG_HANDLE");
    if (value == 145) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_MD5_ALG_HANDLE");
    if (value == 161) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA1_ALG_HANDLE");
    if (value == 177) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA256_ALG_HANDLE");
    if (value == 193) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA384_ALG_HANDLE");
    if (value == 209) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA512_ALG_HANDLE");
    if (value == 817) return CHAOS_IL2CPP_STRING_ID("BCRYPT_PBKDF2_ALG_HANDLE");
    if (value == 945) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA3_256_ALG_HANDLE");
    if (value == 961) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA3_384_ALG_HANDLE");
    if (value == 977) return CHAOS_IL2CPP_STRING_ID("BCRYPT_SHA3_512_ALG_HANDLE");
    if (value == 993) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA3_256_ALG_HANDLE");
    if (value == 1009) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA3_384_ALG_HANDLE");
    if (value == 1025) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HMAC_SHA3_512_ALG_HANDLE");
    if (value == 1041) return CHAOS_IL2CPP_STRING_ID("BCRYPT_CSHAKE128_ALG_HANDLE");
    if (value == 1057) return CHAOS_IL2CPP_STRING_ID("BCRYPT_CSHAKE256_ALG_HANDLE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+BCryptCreateHashFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTCREATEHASHFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("BCRYPT_HASH_REUSABLE_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+BCryptEncryptFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTENCRYPTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("BCRYPT_PAD_PKCS1");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("BCRYPT_PAD_OAEP");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+BCryptOpenAlgorithmProviderFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTOPENALGORITHMPROVIDERFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ALG_HANDLE_HMAC_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+BCryptSignVerifyFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTSIGNVERIFYFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("BCRYPT_PAD_PKCS1");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("BCRYPT_PAD_PSS");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+KeyBlobMagicNumber (24 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_KEYBLOBMAGICNUMBER(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 826364754) return CHAOS_IL2CPP_STRING_ID("BCRYPT_RSAPUBLIC_MAGIC");
    if (value == 827016005) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PUBLIC_P256_MAGIC");
    if (value == 827540293) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PUBLIC_P256_MAGIC");
    if (value == 843141970) return CHAOS_IL2CPP_STRING_ID("BCRYPT_RSAPRIVATE_MAGIC");
    if (value == 843206724) return CHAOS_IL2CPP_STRING_ID("BCRYPT_DSA_PUBLIC_MAGIC_V2");
    if (value == 843793221) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PRIVATE_P256_MAGIC");
    if (value == 844317509) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PRIVATE_P256_MAGIC");
    if (value == 844517444) return CHAOS_IL2CPP_STRING_ID("BCRYPT_DSA_PRIVATE_MAGIC_V2");
    if (value == 859919186) return CHAOS_IL2CPP_STRING_ID("BCRYPT_RSAFULLPRIVATE_MAGIC");
    if (value == 860570437) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PUBLIC_P384_MAGIC");
    if (value == 861094725) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PUBLIC_P384_MAGIC");
    if (value == 877347653) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PRIVATE_P384_MAGIC");
    if (value == 877871941) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PRIVATE_P384_MAGIC");
    if (value == 894124869) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PUBLIC_P521_MAGIC");
    if (value == 894649157) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PUBLIC_P521_MAGIC");
    if (value == 910902085) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PRIVATE_P521_MAGIC");
    if (value == 911426373) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PRIVATE_P521_MAGIC");
    if (value == 1112560452) return CHAOS_IL2CPP_STRING_ID("BCRYPT_DSA_PUBLIC_MAGIC");
    if (value == 1296188491) return CHAOS_IL2CPP_STRING_ID("BCRYPT_KEY_DATA_BLOB_MAGIC");
    if (value == 1346650949) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PUBLIC_GENERIC_MAGIC");
    if (value == 1347109701) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PUBLIC_GENERIC_MAGIC");
    if (value == 1447314245) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDSA_PRIVATE_GENERIC_MAGIC");
    if (value == 1447772997) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECDH_PRIVATE_GENERIC_MAGIC");
    if (value == 1448104772) return CHAOS_IL2CPP_STRING_ID("BCRYPT_DSA_PRIVATE_MAGIC");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+HASHALGORITHM_ENUM (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_HASHALGORITHM_ENUM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("DSA_HASH_ALGORITHM_SHA1");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DSA_HASH_ALGORITHM_SHA256");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("DSA_HASH_ALGORITHM_SHA512");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+DSAFIPSVERSION_ENUM (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_DSAFIPSVERSION_ENUM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("DSA_FIPS186_2");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DSA_FIPS186_3");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+ECC_CURVE_TYPE_ENUM (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_ECC_CURVE_TYPE_ENUM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECC_PRIME_SHORT_WEIERSTRASS_CURVE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECC_PRIME_TWISTED_EDWARDS_CURVE");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ECC_PRIME_MONTGOMERY_CURVE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+ECC_CURVE_ALG_ID_ENUM (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_ECC_CURVE_ALG_ID_ENUM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("BCRYPT_NO_CURVE_GENERATION_ALG_ID");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+CngBufferDescriptors (18 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_CNGBUFFERDESCRIPTORS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("KDF_HASH_ALGORITHM");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KDF_SECRET_PREPEND");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("KDF_SECRET_APPEND");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("KDF_HMAC_KEY");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KDF_TLS_PRF_LABEL");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("KDF_TLS_PRF_SEED");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("KDF_SECRET_HANDLE");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("KDF_TLS_PRF_PROTOCOL");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("KDF_ALGORITHMID");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("KDF_PARTYUINFO");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("KDF_PARTYVINFO");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("KDF_SUPPPUBINFO");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("KDF_SUPPPRIVINFO");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("KDF_LABEL");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("KDF_CONTEXT");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("KDF_SALT");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("KDF_ITERATION_COUNT");
    if (value == 60) return CHAOS_IL2CPP_STRING_ID("NCRYPTBUFFER_ECC_CURVE_NAME");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+BCrypt+NTSTATUS (7 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_NTSTATUS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("STATUS_SUCCESS");
    if (value == 3221225473) return CHAOS_IL2CPP_STRING_ID("STATUS_UNSUCCESSFUL");
    if (value == 3221225485) return CHAOS_IL2CPP_STRING_ID("STATUS_INVALID_PARAMETER");
    if (value == 3221225495) return CHAOS_IL2CPP_STRING_ID("STATUS_NO_MEMORY");
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertChainFlags (7 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCHAINFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == -2147483648) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_REVOCATION_CHECK_CACHE_ONLY");
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_DISABLE_AUTH_ROOT_AUTO_UPDATE");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_DISABLE_AIA");
    if (value == 268435456) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_REVOCATION_CHECK_END_CERT");
    if (value == 536870912) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_REVOCATION_CHECK_CHAIN");
    if (value == 1073741824) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_REVOCATION_CHECK_CHAIN_EXCLUDE_ROOT");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertContextPropId (11 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTEXTPROPID(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_KEY_PROV_INFO_PROP_ID");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_SHA1_HASH_PROP_ID");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CERT_KEY_CONTEXT_PROP_ID");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("CERT_FRIENDLY_NAME_PROP_ID");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("CERT_ARCHIVED_PROP_ID");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("CERT_KEY_IDENTIFIER_PROP_ID");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("CERT_PUBKEY_ALG_PARA_PROP_ID");
    if (value == 70) return CHAOS_IL2CPP_STRING_ID("CERT_OCSP_RESPONSE_PROP_ID");
    if (value == 78) return CHAOS_IL2CPP_STRING_ID("CERT_NCRYPT_KEY_HANDLE_PROP_ID");
    if (value == 101) return CHAOS_IL2CPP_STRING_ID("CERT_DELETE_KEYSET_PROP_ID");
    if (value == 125) return CHAOS_IL2CPP_STRING_ID("CERT_CLR_DELETE_KEY_PROP_ID");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertControlStoreFlags (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTROLSTOREFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertControlStoreType (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTROLSTORETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_CTRL_AUTO_RESYNC");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertEncodingType (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTENCODINGTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("X509_ASN_ENCODING");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("PKCS_7_ASN_ENCODING");
    if (value == 65537) return CHAOS_IL2CPP_STRING_ID("All");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertFindFlags (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTFINDFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertFindType (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTFINDTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_ANY");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_HASH");
    if (value == 524292) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_ISSUER_STR");
    if (value == 524295) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_SUBJECT_STR");
    if (value == 720896) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_SUBJECT_CERT");
    if (value == 851968) return CHAOS_IL2CPP_STRING_ID("CERT_FIND_EXISTING");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertUsageMatchType (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTUSAGEMATCHTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("USAGE_MATCH_TYPE_AND");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("USAGE_MATCH_TYPE_OR");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertNameFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_ISSUER_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertNameStringType (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMESTRINGTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_X500_NAME_STR");
    if (value == 33554432) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_REVERSE_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertNameStrTypeAndFlags (13 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMESTRTYPEANDFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_SIMPLE_NAME_STR");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_OID_NAME_STR");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_X500_NAME_STR");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_DISABLE_IE4_UTF8_FLAG");
    if (value == 131072) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_ENABLE_T61_UNICODE_FLAG");
    if (value == 262144) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_ENABLE_UTF8_UNICODE_FLAG");
    if (value == 524288) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_FORCE_UTF8_DIR_STR_FLAG");
    if (value == 33554432) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_REVERSE_FLAG");
    if (value == 67108864) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_COMMA_FLAG");
    if (value == 134217728) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_CRLF_FLAG");
    if (value == 268435456) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_NO_QUOTING_FLAG");
    if (value == 536870912) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_NO_PLUS_FLAG");
    if (value == 1073741824) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_STR_SEMICOLON_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertNameType (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_EMAIL_TYPE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_RDN_TYPE");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_ATTR_TYPE");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_SIMPLE_DISPLAY_TYPE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_FRIENDLY_DISPLAY_TYPE");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_DNS_TYPE");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_URL_TYPE");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_NAME_UPN_TYPE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertSetPropertyFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSETPROPERTYFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1073741824) return CHAOS_IL2CPP_STRING_ID("CERT_SET_PROPERTY_INHIBIT_PERSIST_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertStoreAddDisposition (7 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTOREADDDISPOSITION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_NEW");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_USE_EXISTING");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_REPLACE_EXISTING");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_ALWAYS");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_REPLACE_EXISTING_INHERIT_PROPERTIES");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_NEWER");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ADD_NEWER_INHERIT_PROPERTIES");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertStoreFlags (18 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTOREFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_NO_CRYPT_RELEASE_FLAG");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SET_LOCALIZED_NAME_FLAG");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_DEFER_CLOSE_UNTIL_LAST_FREE_FLAG");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_DELETE_FLAG");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_UNSAFE_PHYSICAL_FLAG");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SHARE_STORE_FLAG");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SHARE_CONTEXT_FLAG");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_MANIFOLD_FLAG");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_ENUM_ARCHIVED_FLAG");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_UPDATE_KEYID_FLAG");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_BACKUP_RESTORE_FLAG");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_MAXIMUM_ALLOWED_FLAG");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_CREATE_NEW_FLAG");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_OPEN_EXISTING_FLAG");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_READONLY_FLAG");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CERT_SYSTEM_STORE_CURRENT_USER");
    if (value == 131072) return CHAOS_IL2CPP_STRING_ID("CERT_SYSTEM_STORE_LOCAL_MACHINE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertStoreSaveAs (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTORESAVEAS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SAVE_AS_STORE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SAVE_AS_PKCS7");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertStoreSaveTo (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTORESAVETO(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_SAVE_TO_MEMORY");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+ChainEngineConfigFlags (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CHAINENGINECONFIGFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_CACHE_END_CERT");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_CACHE_ONLY_URL_RETRIEVAL");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_USE_LOCAL_MACHINE_STORE");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_ENABLE_CACHE_AUTO_UPDATE");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_ENABLE_SHARE_STORE");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_DISABLE_AIA");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+ContentType (14 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CONTENTTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_CERT");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_CTL");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_CRL");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_SERIALIZED_STORE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_SERIALIZED_CERT");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_SERIALIZED_CTL");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_SERIALIZED_CRL");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PKCS7_SIGNED");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PKCS7_UNSIGNED");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PKCS7_SIGNED_EMBED");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PKCS10");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PFX");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_CERT_PAIR");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_PFX_AND_LOAD");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptAcquireCertificatePrivateKeyFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTACQUIRECERTIFICATEPRIVATEKEYFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_CACHE_FLAG");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_USE_PROV_INFO_FLAG");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_COMPARE_KEY_FLAG");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_NO_HEALING");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_SILENT_FLAG");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_WINDOW_HANDLE_FLAG");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_ALLOW_NCRYPT_KEY_FLAG");
    if (value == 131072) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_PREFER_NCRYPT_KEY_FLAG");
    if (value == 262144) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_ONLY_NCRYPT_KEY_FLAG");
    if (value == 458752) return CHAOS_IL2CPP_STRING_ID("CRYPT_ACQUIRE_NCRYPT_KEY_FLAGS_MASK");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptAcquireContextFlags (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTACQUIRECONTEXTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("CRYPT_DELETEKEYSET");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CRYPT_MACHINE_KEYSET");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptDecodeObjectFlags (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTDECODEOBJECTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptImportPublicKeyInfoFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTIMPORTPUBLICKEYINFOFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NONE");
    if (value == 1073741824) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_PUBKEY_ENCRYPT_KEY_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptKeySpec (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTKEYSPEC(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == -1) return CHAOS_IL2CPP_STRING_ID("CERT_NCRYPT_KEY_SPEC");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AT_KEYEXCHANGE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("AT_SIGNATURE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptMsgParamType (35 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTMSGPARAMTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CMSG_TYPE_PARAM");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CMSG_CONTENT_PARAM");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CMSG_BARE_CONTENT_PARAM");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CMSG_INNER_CONTENT_TYPE_PARAM");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_COUNT_PARAM");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_INFO_PARAM");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_CERT_INFO_PARAM");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_HASH_ALGORITHM_PARAM");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_AUTH_ATTR_PARAM");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_UNAUTH_ATTR_PARAM");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("CMSG_CERT_COUNT_PARAM");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("CMSG_CERT_PARAM");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("CMSG_CRL_COUNT_PARAM");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("CMSG_CRL_PARAM");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("CMSG_ENVELOPE_ALGORITHM_PARAM");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("CMSG_RECIPIENT_COUNT_PARAM");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("CMSG_RECIPIENT_INDEX_PARAM");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("CMSG_RECIPIENT_INFO_PARAM");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("CMSG_HASH_ALGORITHM_PARAM");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("CMSG_HASH_DATA_PARAM");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("CMSG_COMPUTED_HASH_PARAM");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("CMSG_ENCRYPT_PARAM");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("CMSG_ENCRYPTED_DIGEST");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("CMSG_ENCODED_SIGNER");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("CMSG_ENCODED_MESSAGE");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("CMSG_VERSION_PARAM");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("CMSG_ATTR_CERT_COUNT_PARAM");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CMSG_ATTR_CERT_PARAM");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("CMSG_CMS_RECIPIENT_COUNT_PARAM");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("CMSG_CMS_RECIPIENT_INDEX_PARAM");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("CMSG_CMS_RECIPIENT_ENCRYPTED_KEY_INDEX_PARAM");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("CMSG_CMS_RECIPIENT_INFO_PARAM");
    if (value == 37) return CHAOS_IL2CPP_STRING_ID("CMSG_UNPROTECTED_ATTR_PARAM");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("CMSG_SIGNER_CERT_ID_PARAM");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("CMSG_CMS_SIGNER_INFO_PARAM");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CertQueryObjectType (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTQUERYOBJECTTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_OBJECT_FILE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_OBJECT_BLOB");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+ExpectedContentTypeFlags (15 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_EXPECTEDCONTENTTYPEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_CERT");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_CTL");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_CRL");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_SERIALIZED_STORE");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_SERIALIZED_CERT");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_SERIALIZED_CTL");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_SERIALIZED_CRL");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PKCS7_SIGNED");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PKCS7_UNSIGNED");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PKCS7_SIGNED_EMBED");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PKCS10");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PFX");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_CERT_PAIR");
    if (value == 16382) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_ALL");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_CONTENT_FLAG_PFX_AND_LOAD");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+ExpectedFormatTypeFlags (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_EXPECTEDFORMATTYPEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_FLAG_BINARY");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_FLAG_BASE64_ENCODED");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_FLAG_ASN_ASCII_HEX_ENCODED");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_FLAG_ALL");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+CryptOidInfoKeyType (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTOIDINFOKEYTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_OID_KEY");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_NAME_KEY");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_ALGID_KEY");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_SIGN_KEY");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_CNG_ALGID_KEY");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CRYPT_OID_INFO_CNG_SIGN_KEY");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+FormatType (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_FORMATTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_BINARY");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_BASE64_ENCODED");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CERT_QUERY_FORMAT_ASN_ASCII_HEX_ENCODED");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+MsgEncodingType (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_MSGENCODINGTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("X509_ASN_ENCODING");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("PKCS_7_ASN_ENCODING");
    if (value == 65537) return CHAOS_IL2CPP_STRING_ID("All");
    return 0;  // unrecognized value → caller falls through to decimal
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+PfxCertStoreFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_PFXCERTSTOREFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CRYPT_EXPORTABLE");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CRYPT_USER_PROTECTED");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("PKCS12_INCLUDE_EXTENDED_PROPERTIES");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CRYPT_MACHINE_KEYSET");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("PKCS12_PREFER_CNG_KSP");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("PKCS12_ALWAYS_CNG_KSP");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("CRYPT_USER_KEYSET");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("PKCS12_ALLOW_OVERWRITE_KEY");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("PKCS12_NO_PERSIST_KEY");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+PFXExportFlags (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_PFXEXPORTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("REPORT_NO_PRIVATE_KEY");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("REPORT_NOT_ABLE_TO_EXPORT_PRIVATE_KEY");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("EXPORT_PRIVATE_KEYS");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypt32+X509KeyUsageFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_X509KEYUSAGEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EncipherOnly");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CrlSign");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KeyCertSign");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("KeyAgreement");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("DataEncipherment");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("KeyEncipherment");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("NonRepudiation");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("DigitalSignature");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("DecipherOnly");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+NCrypt+AsymmetricPaddingMode (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_ASYMMETRICPADDINGMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("NCRYPT_NO_PADDING_FLAG");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("NCRYPT_PAD_PKCS1_FLAG");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("NCRYPT_PAD_OAEP_FLAG");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("NCRYPT_PAD_PSS_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+NCrypt+ErrorCode (11 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_ERRORCODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == -2147467259) return CHAOS_IL2CPP_STRING_ID("E_FAIL");
    if (value == -2146893818) return CHAOS_IL2CPP_STRING_ID("NTE_BAD_SIGNATURE");
    if (value == -2146893807) return CHAOS_IL2CPP_STRING_ID("NTE_NOT_FOUND");
    if (value == -2146893802) return CHAOS_IL2CPP_STRING_ID("NTE_BAD_KEYSET");
    if (value == -2146893785) return CHAOS_IL2CPP_STRING_ID("NTE_INVALID_PARAMETER");
    if (value == -2146893784) return CHAOS_IL2CPP_STRING_ID("NTE_BUFFER_TOO_SMALL");
    if (value == -2146893783) return CHAOS_IL2CPP_STRING_ID("NTE_NOT_SUPPORTED");
    if (value == -2146893782) return CHAOS_IL2CPP_STRING_ID("NTE_NO_MORE_ITEMS");
    if (value == -2144795642) return CHAOS_IL2CPP_STRING_ID("TPM_E_PCP_BUFFER_TOO_SMALL");
    if (value == -1073741823) return CHAOS_IL2CPP_STRING_ID("STATUS_UNSUCCESSFUL");
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("ERROR_SUCCESS");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+NCrypt+BufferType (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_BUFFERTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("KdfHashAlgorithm");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KdfSecretPrepend");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("KdfSecretAppend");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("KdfHmacKey");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KdfTlsLabel");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("KdfTlsSeed");
    if (value == 41) return CHAOS_IL2CPP_STRING_ID("PkcsAlgOid");
    if (value == 42) return CHAOS_IL2CPP_STRING_ID("PkcsAlgParam");
    if (value == 46) return CHAOS_IL2CPP_STRING_ID("PkcsSecret");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+NCrypt+SecretAgreementFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_SECRETAGREEMENTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("UseSecretAsHmacKey");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Internal.NativeCrypto.Cng+OpenAlgorithmProviderFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTERNAL_NATIVECRYPTO_CNG_OPENALGORITHMPROVIDERFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NONE");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("BCRYPT_ALG_HANDLE_HMAC_FLAG");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/Microsoft.Win32.SafeHandles.SafeNCryptHandle+OwnershipState (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_MICROSOFT_WIN32_SAFEHANDLES_SAFENCRYPTHANDLE_OWNERSHIPSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Owner");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Duplicate");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Holder");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.HexConverter+Casing (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_HEXCONVERTER_CASING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Upper");
    if (value == 8224) return CHAOS_IL2CPP_STRING_ID("Lower");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.FromBase64TransformMode (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_FROMBASE64TRANSFORMMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("IgnoreWhiteSpaces");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DoNotIgnoreWhiteSpaces");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.ThrowHelper+ExceptionArgument (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_THROWHELPER_EXCEPTIONARGUMENT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("inputBuffer");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("outputBuffer");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("inputOffset");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("inputCount");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CipherMode (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CIPHERMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CBC");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ECB");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("OFB");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CFB");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CTS");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngExportPolicies (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGEXPORTPOLICIES(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AllowExport");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("AllowPlaintextExport");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("AllowArchiving");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("AllowPlaintextArchiving");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngKeyCreationOptions (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYCREATIONOPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("MachineKey");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("OverwriteExistingKey");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngKeyHandleOpenOptions (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYHANDLEOPENOPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EphemeralKey");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngKeyOpenOptions (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYOPENOPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("UserKey");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("MachineKey");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("Silent");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngKeyUsages (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYUSAGES(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Decryption");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Signing");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KeyAgreement");
    if (value == 16777215) return CHAOS_IL2CPP_STRING_ID("AllUsages");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngPropertyOptions (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGPROPERTYOPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == -2147483648) return CHAOS_IL2CPP_STRING_ID("Persist");
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1073741824) return CHAOS_IL2CPP_STRING_ID("CustomProperty");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CngUIProtectionLevels (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGUIPROTECTIONLEVELS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ProtectKey");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ForceHighProtection");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CryptoStreamMode (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAMMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Read");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Write");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CspProviderFlags (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPROVIDERFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NoFlags");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("UseMachineKeyStore");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("UseDefaultKeyContainer");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("UseNonExportableKey");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("UseExistingKey");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("UseArchivableKey");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("UseUserProtectedKey");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("NoPrompt");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("CreateEphemeralKey");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.DSASignatureFormat (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREFORMAT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("IeeeP1363FixedFieldConcatenation");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Rfc3279DerSequence");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.ECCurve+ECCurveType (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECCURVE_ECCURVETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Implicit");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PrimeShortWeierstrass");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("PrimeTwistedEdwards");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PrimeMontgomery");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Characteristic2");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Named");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.ECDiffieHellmanKeyDerivationFunction (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECDIFFIEHELLMANKEYDERIVATIONFUNCTION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Hash");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Hmac");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Tls");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.ECKeyXmlFormat (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECKEYXMLFORMAT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Rfc4050");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.KeyNumber (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_KEYNUMBER(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Exchange");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Signature");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.OidGroup (11 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_OIDGROUP(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("All");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("HashAlgorithm");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("EncryptionAlgorithm");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PublicKeyAlgorithm");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("SignatureAlgorithm");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Attribute");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("ExtensionOrAttribute");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("EnhancedKeyUsage");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Policy");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("Template");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("KeyDerivationFunction");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.PaddingMode (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_PADDINGMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("PKCS7");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Zeros");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("ANSIX923");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("ISO10126");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.PbeEncryptionAlgorithm (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_PBEENCRYPTIONALGORITHM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unknown");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Aes128Cbc");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Aes192Cbc");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Aes256Cbc");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("TripleDes3KeyPkcs12");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.RSAEncryptionPaddingMode (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_RSAENCRYPTIONPADDINGMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Pkcs1");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Oaep");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.RSASignaturePaddingMode (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_RSASIGNATUREPADDINGMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Pkcs1");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Pss");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CapiHelper+CryptGetKeyParamQueryType (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CRYPTGETKEYPARAMQUERYTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KP_IV");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KP_MODE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("KP_MODE_BITS");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("KP_ALGID");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("KP_KEYLEN");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("KP_EFFECTIVE_KEYLEN");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CapiHelper+CspAlgorithmType (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CSPALGORITHMTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Rsa");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Dss");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.CapiHelper+ClrPropertyId (11 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CLRPROPERTYID(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CLR_KEYLEN");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CLR_PUBLICKEYONLY");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CLR_EXPORTABLE");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CLR_REMOVABLE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CLR_HARDWARE");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CLR_ACCESSIBLE");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CLR_PROTECTED");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CLR_UNIQUE_CONTAINER");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("CLR_ALGID");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("CLR_PP_CLIENT_HWND");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("CLR_PP_PIN");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.CertificateRequestLoadOptions (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTIFICATEREQUESTLOADOPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Default");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SkipSignatureValidation");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("UnsafeLoadCertificateExtensions");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.OpenFlags (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OPENFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("ReadOnly");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ReadWrite");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MaxAllowed");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("OpenExistingOnly");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("IncludeArchived");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.StoreLocation (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_STORELOCATION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CurrentUser");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("LocalMachine");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.StoreName (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_STORENAME(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AddressBook");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("AuthRoot");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("CertificateAuthority");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Disallowed");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("My");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Root");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("TrustedPeople");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("TrustedPublisher");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X500DistinguishedNameFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAMEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Reversed");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("UseSemicolons");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("DoNotUsePlusSign");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("DoNotUseQuotes");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("UseCommas");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("UseNewLines");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("UseUTF8Encoding");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("UseT61Encoding");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("ForceUTF8Encoding");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509ChainStatusFlags (26 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINSTATUSFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NoError");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("NotTimeValid");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("NotTimeNested");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Revoked");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("NotSignatureValid");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("NotValidForUsage");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("UntrustedRoot");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("RevocationStatusUnknown");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("Cyclic");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("InvalidExtension");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("InvalidPolicyConstraints");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("InvalidBasicConstraints");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("InvalidNameConstraints");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("HasNotSupportedNameConstraint");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("HasNotDefinedNameConstraint");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("HasNotPermittedNameConstraint");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("HasExcludedNameConstraint");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("PartialChain");
    if (value == 131072) return CHAOS_IL2CPP_STRING_ID("CtlNotTimeValid");
    if (value == 262144) return CHAOS_IL2CPP_STRING_ID("CtlNotSignatureValid");
    if (value == 524288) return CHAOS_IL2CPP_STRING_ID("CtlNotValidForUsage");
    if (value == 1048576) return CHAOS_IL2CPP_STRING_ID("HasWeakSignature");
    if (value == 16777216) return CHAOS_IL2CPP_STRING_ID("OfflineRevocation");
    if (value == 33554432) return CHAOS_IL2CPP_STRING_ID("NoIssuanceChainPolicy");
    if (value == 67108864) return CHAOS_IL2CPP_STRING_ID("ExplicitDistrust");
    if (value == 134217728) return CHAOS_IL2CPP_STRING_ID("HasNotSupportedCriticalExtension");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509ChainTrustMode (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINTRUSTMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("System");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CustomRootTrust");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509ContentType (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CONTENTTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unknown");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Cert");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("SerializedCert");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Pfx");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Pkcs12");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("SerializedStore");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Pkcs7");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Authenticode");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509FindType (15 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509FINDTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("FindByThumbprint");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("FindBySubjectName");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("FindBySubjectDistinguishedName");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("FindByIssuerName");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("FindByIssuerDistinguishedName");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("FindBySerialNumber");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("FindByTimeValid");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("FindByTimeNotYetValid");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("FindByTimeExpired");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("FindByTemplateName");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("FindByApplicationPolicy");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("FindByCertificatePolicy");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("FindByExtension");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("FindByKeyUsage");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("FindBySubjectKeyIdentifier");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509IncludeOption (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509INCLUDEOPTION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ExcludeRoot");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("EndCertOnly");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("WholeChain");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509KeyStorageFlags (7 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509KEYSTORAGEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("DefaultKeySet");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("UserKeySet");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MachineKeySet");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Exportable");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("UserProtected");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("PersistKeySet");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("EphemeralKeySet");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509KeyUsageFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509KEYUSAGEFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EncipherOnly");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CrlSign");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KeyCertSign");
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509NameType (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509NAMETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("SimpleName");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EmailName");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("UpnName");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("DnsName");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("DnsFromAlternativeName");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("UrlName");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509RevocationFlag (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONFLAG(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("EndCertificateOnly");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EntireChain");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ExcludeRoot");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509RevocationMode (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NoCheck");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Online");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Offline");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509RevocationReason (11 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONREASON(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unspecified");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KeyCompromise");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CACompromise");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("AffiliationChanged");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Superseded");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CessationOfOperation");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("CertificateHold");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("RemoveFromCrl");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("PrivilegeWithdrawn");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("AACompromise");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("WeakAlgorithmOrKey");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509SubjectKeyIdentifierHashAlgorithm (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509SUBJECTKEYIDENTIFIERHASHALGORITHM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Sha1");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ShortSha1");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CapiSha1");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X509VerificationFlags (14 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509VERIFICATIONFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NoFlag");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("IgnoreNotTimeValid");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("IgnoreCtlNotTimeValid");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("IgnoreNotTimeNested");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("IgnoreInvalidBasicConstraints");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("AllowUnknownCertificateAuthority");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("IgnoreWrongUsage");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("IgnoreInvalidName");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("IgnoreInvalidPolicy");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("IgnoreEndRevocationUnknown");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("IgnoreCtlSignerRevocationUnknown");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("IgnoreCertificateAuthorityRevocationUnknown");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("IgnoreRootRevocationUnknown");
    if (value == 4095) return CHAOS_IL2CPP_STRING_ID("AllFlags");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.CertStoreProvider (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTSTOREPROVIDER(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_PROV_MEMORY");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("CERT_STORE_PROV_SYSTEM_W");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.CryptDecodeObjectStructType (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CRYPTDECODEOBJECTSTRUCTTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("X509_BASIC_CONSTRAINTS");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("X509_KEY_USAGE");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("X509_BASIC_CONSTRAINTS2");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("X509_CERT_POLICIES");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("X509_UNICODE_ANY_STRING");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("X509_ENHANCED_KEY_USAGE");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("X509_DSS_PUBLICKEY");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("X509_DSS_PARAMETERS");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("X509_CERTIFICATE_TEMPLATE");
    if (value == 72) return CHAOS_IL2CPP_STRING_ID("CNG_RSA_PUBLIC_KEY_BLOB");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.CertTrustErrorStatus (26 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTTRUSTERRORSTATUS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_NO_ERROR");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_NOT_TIME_VALID");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_NOT_TIME_NESTED");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_REVOKED");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_NOT_SIGNATURE_VALID");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_NOT_VALID_FOR_USAGE");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_UNTRUSTED_ROOT");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_REVOCATION_STATUS_UNKNOWN");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_CYCLIC");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_INVALID_EXTENSION");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_INVALID_POLICY_CONSTRAINTS");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_INVALID_BASIC_CONSTRAINTS");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_INVALID_NAME_CONSTRAINTS");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_NOT_SUPPORTED_NAME_CONSTRAINT");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_NOT_DEFINED_NAME_CONSTRAINT");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_NOT_PERMITTED_NAME_CONSTRAINT");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_EXCLUDED_NAME_CONSTRAINT");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_PARTIAL_CHAIN");
    if (value == 131072) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_CTL_IS_NOT_TIME_VALID");
    if (value == 262144) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_CTL_IS_NOT_SIGNATURE_VALID");
    if (value == 524288) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_CTL_IS_NOT_VALID_FOR_USAGE");
    if (value == 1048576) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_WEAK_SIGNATURE");
    if (value == 16777216) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_OFFLINE_REVOCATION");
    if (value == 33554432) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_NO_ISSUANCE_CHAIN_POLICY");
    if (value == 67108864) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_EXPLICIT_DISTRUST");
    if (value == 134217728) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_NOT_SUPPORTED_CRITICAL_EXT");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.CertTrustInfoStatus (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTTRUSTINFOSTATUS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_EXACT_MATCH_ISSUER");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_KEY_MATCH_ISSUER");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_NAME_MATCH_ISSUER");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_SELF_SIGNED");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_PREFERRED_ISSUER");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_ISSUANCE_CHAIN_POLICY");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_HAS_VALID_NAME_CONSTRAINTS");
    if (value == 65536) return CHAOS_IL2CPP_STRING_ID("CERT_TRUST_IS_COMPLEX_CHAIN");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.ChainPolicy (1 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CHAINPOLICY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CERT_CHAIN_POLICY_BASE");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0x51B4D9u, &kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING },
    ...
    { 0x9E67C5u, &kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE },
    ...
    { 0xDA741Au, &kEnumTable_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumDispatchCount = 396u;
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x00ED7Du, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTROLSTORETYPE },
    ...
    { 0x0411A8u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTORESAVETO },
    { 0x05614Eu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_REFLECTION_METADATATOKENTYPE },
    { 0x05930Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTEXTPROPID },
    ...
    { 0x07203Cu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCONTROLSTOREFLAGS },
    { 0x076184u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_THREADING_TASKS_TASK_TASKSTATEFLAGS },
    { 0x0766A3u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_PBEENCRYPTIONALGORITHM },
    { 0x08254Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_ASYMMETRICPADDINGMODE },
    ...
    { 0x114136u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_PFXEXPORTFLAGS },
    ...
    { 0x118A49u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTACQUIRECERTIFICATEPRIVATEKEYFLAGS },
    ...
    { 0x16366Bu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONMODE },
    { 0x16BC9Au, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONFLAG },
    { 0x1738DBu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMESTRTYPEANDFLAGS },
    ...
    { 0x194B48u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_FROMBASE64TRANSFORMMODE },
    { 0x197A07u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_BUFFERS_OPERATIONSTATUS },
    { 0x19865Bu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMEFLAGS },
    { 0x1A7F8Au, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GC_GCCONFIGURATIONTYPE },
    { 0x1AF722u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTENCODINGTYPE },
    { 0x1B9D29u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_GETDEFAULTPROVIDERFLAGS },
    ...
    { 0x1FD541u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTORESAVEAS },
    ...
    { 0x254900u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMETYPE },
    { 0x2592F2u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_TIMEZONEINFOOPTIONS },
    { 0x25C4FEu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGUIPROTECTIONLEVELS },
    ...
    { 0x274D91u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509INCLUDEOPTION },
    { 0x2972CDu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GLOBALIZATION_UNICODECATEGORY },
    { 0x2BB2BBu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTCHAINFLAGS },
    ...
    { 0x30318Fu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509FINDTYPE },
    { 0x306E28u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CRYPTOSTREAMMODE },
    ...
    { 0x36D0E9u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTIMPORTPUBLICKEYINFOFLAGS },
    ...
    { 0x3CF18Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTOREADDDISPOSITION },
    ...
    { 0x3E964Du, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYHANDLEOPENOPTIONS },
    ...
    { 0x40C315u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECCURVE_ECCURVETYPE },
    ...
    { 0x435A46u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_ECC_CURVE_ALG_ID_ENUM },
    ...
    { 0x4AFB31u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGPROPERTYOPTIONS },
    ...
    { 0x4FA550u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_CNGBUFFERDESCRIPTORS },
    ...
    { 0x51B4D9u, &ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING },
    { 0x538B85u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GC_ENABLENOGCREGIONCALLBACKSTATUS },
    { 0x53AEA9u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CLRPROPERTYID },
    ...
    { 0x5634A2u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTERNAL_NATIVECRYPTO_CNG_OPENALGORITHMPROVIDERFLAGS },
    { 0x574C54u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CSPPROVIDERFLAGS },
    ...
    { 0x591819u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CONTENTTYPE },
    { 0x5A7820u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GLOBALIZATION_HEBREWNUMBER_HS },
    { 0x5A8108u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTTRUSTERRORSTATUS },
    ...
    { 0x5CE97Au, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTALGPSEUDOHANDLE },
    ...
    { 0x62ADC6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTTRUSTINFOSTATUS },
    ...
    { 0x65A67Du, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509KEYUSAGEFLAGS },
    { 0x66AFD2u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_THREADING_APARTMENTSTATE },
    { 0x66BA62u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTSTOREPROVIDER },
    { 0x67C078u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_ENVIRONMENT_SPECIALFOLDER },
    { 0x685799u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500DISTINGUISHEDNAMEFLAGS },
    { 0x686189u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_ERRORCODE },
    ...
    { 0x6B7F60u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CRYPTDECODEOBJECTSTRUCTTYPE },
    ...
    { 0x71CE3Au, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_STORELOCATION },
    ...
    { 0x736963u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CHAINPOLICY },
    { 0x7421A2u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GCCOLLECTIONMODE },
    { 0x74521Au, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CRYPTGETKEYPARAMQUERYTYPE },
    { 0x757E73u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_REFLECTION_METHODSEMANTICSATTRIBUTES },
    { 0x762609u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CAPIHELPER_CSPALGORITHMTYPE },
    { 0x76676Fu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_DIAGNOSTICS_TRACING_EVENTKEYWORDS },
    { 0x769152u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CONTENTTYPE },
    { 0x7700F9u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_EXPECTEDCONTENTTYPEFLAGS },
    ...
    { 0x7E11FCu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_KEYBLOBMAGICNUMBER },
    ...
    { 0x7FA645u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_HEXCONVERTER_CASING },
    ...
    { 0x805E6Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTQUERYOBJECTTYPE },
    ...
    { 0x80F43Cu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_BUFFERTYPE },
    { 0x81A306u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_KEYSPEC },
    ...
    { 0x835B9Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_MICROSOFT_WIN32_SAFEHANDLES_SAFENCRYPTHANDLE_OWNERSHIPSTATE },
    ...
    { 0x8F029Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CIPHERMODE },
    { 0x8F181Eu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_DIAGNOSTICS_TRACING_EVENTPIPESERIALIZATIONFORMAT },
    { 0x908537u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTHASHPROPERTY },
    ...
    { 0x928BBAu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_CERTIFICATEREQUESTLOADOPTIONS },
    { 0x92B1C3u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_TIMEZONEINFO_TIMEZONEINFORESULT },
    { 0x9305F4u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_KEYNUMBER },
    ...
    { 0x9481C2u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_FORMATTYPE },
    { 0x956273u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_REFLECTION_PROCESSORARCHITECTURE },
    { 0x956DA8u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTENCRYPTFLAGS },
    { 0x962F90u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYCREATIONOPTIONS },
    { 0x96825Cu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_IO_UNIXFILEMODE },
    { 0x96E4DAu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_STORENAME },
    { 0x977136u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_REFLECTION_TYPENAMEPARSER_TOKENTYPE },
    { 0x97E73Cu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTOIDINFOKEYTYPE },
    ...
    { 0x9A76E9u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTCREATEHASHFLAGS },
    ...
    { 0x9DABBBu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTUSAGEMATCHTYPE },
    { 0x9E67C5u, &ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE },
    { 0x9E8D3Eu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_LOADER_ASSEMBLYLOADCONTEXT_INTERNALSTATE },
    { 0x9EBA6Fu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSTOREFLAGS },
    ...
    { 0xA097A4u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_RSASIGNATUREPADDINGMODE },
    ...
    { 0xA25884u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTSIGNANDVERIFYHASHFLAGS },
    { 0xA41633u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_PFXCERTSTOREFLAGS },
    ...
    { 0xA75B7Bu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_OPENFLAGS },
    ...
    { 0xAB29C6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509VERIFICATIONFLAGS },
    ...
    { 0xAC37E6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_X509KEYUSAGEFLAGS },
    ...
    { 0xAF6F34u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509REVOCATIONREASON },
    { 0xB038F0u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_VARFLAGS },
    { 0xB04086u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTPROVPARAM },
    ...
    { 0xB6B852u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_DSAFIPSVERSION_ENUM },
    { 0xB6DC0Bu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_IO_FILEACCESS },
    { 0xB7DD37u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTOPENALGORITHMPROVIDERFLAGS },
    { 0xB841EBu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_MSGENCODINGTYPE },
    { 0xB9E5EEu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_LIBFLAGS },
    { 0xBA3939u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ADVAPI32_CRYPTGETKEYPARAMFLAGS },
    ...
    { 0xBC3873u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTSIGNVERIFYFLAGS },
    ...
    { 0xC0EA01u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_EXPECTEDFORMATTYPEFLAGS },
    { 0xC0EF6Eu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINSTATUSFLAGS },
    ...
    { 0xC3BBE1u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_RSAENCRYPTIONPADDINGMODE },
    ...
    { 0xC8437Fu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_BCRYPTCREATEHASHFLAGS },
    ...
    { 0xCA2B6Fu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_DSASIGNATUREFORMAT },
    ...
    { 0xCDC688u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTFINDTYPE },
    ...
    { 0xD17E9Au, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509CHAINTRUSTMODE },
    { 0xD1C617u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_INTEROPSERVICES_ARCHITECTURE },
    { 0xD54799u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTNAMESTRINGTYPE },
    { 0xD557E1u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTDECODEOBJECTFLAGS },
    ...
    { 0xD75124u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_PADDINGMODE },
    { 0xD7C4BCu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGEXPORTPOLICIES },
    { 0xD7EB67u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509NAMETYPE },
    ...
    { 0xD98933u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTFINDFLAGS },
    { 0xD9A6FEu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_DIAGNOSTICS_TRACING_RUNTIMEEVENTSOURCE_EVENTID },
    { 0xD9F0DDu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CHAINENGINECONFIGFLAGS },
    { 0xDA741Au, &ChaosEnumToString_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS },
    ...
    { 0xDD8FF6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_NTSTATUS },
    { 0xDEC631u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_INTEROPSERVICES_COMTYPES_IMPLTYPEFLAGS },
    { 0xDF9DE7u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYUSAGES },
    ...
    { 0xE31F89u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_NCRYPT_SECRETAGREEMENTFLAGS },
    ...
    { 0xE51F31u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTMSGPARAMTYPE },
    { 0xE6C643u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509KEYSTORAGEFLAGS },
    { 0xE7040Bu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTACQUIRECONTEXTFLAGS },
    ...
    { 0xE90EACu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_ECC_CURVE_TYPE_ENUM },
    ...
    { 0xF06941u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECKEYXMLFORMAT },
    ...
    { 0xF2A801u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CRYPTKEYSPEC },
    { 0xF3569Du, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509SUBJECTKEYIDENTIFIERHASHALGORITHM },
    ...
    { 0xF6BD9Fu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_THROWHELPER_EXCEPTIONARGUMENT },
    { 0xF7902Du, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_OIDGROUP },
    { 0xF95E40u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_RUNTIME_INTEROPSERVICES_GCHANDLETYPE },
    { 0xF96FCFu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPT32_CERTSETPROPERTYFLAGS },
    { 0xF97897u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_CNGKEYOPENOPTIONS },
    { 0xFA0AC6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_ECDIFFIEHELLMANKEYDERIVATIONFUNCTION },
    { 0xFC9DBDu, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_BCRYPT_HASHALGORITHM_ENUM },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumToStringDispatchCount = 396u;
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Runtime.Numerics/System.Numerics.BigInteger+GetBytesMode"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGINTEGER_GETBYTESMODE));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Runtime.Numerics/System.Numerics.BigNumber+ParsingStatus"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_NUMERICS_BIGNUMBER_PARSINGSTATUS));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Runtime.Numerics/System.HexConverter+Casing"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_RUNTIME_NUMERICS_SYSTEM_HEXCONVERTER_CASING));
    ChaosRegisterExternalType(
