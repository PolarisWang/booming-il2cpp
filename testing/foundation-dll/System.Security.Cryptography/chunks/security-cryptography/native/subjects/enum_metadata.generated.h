...
// ── Enum: System.Security.Cryptography/Interop+Crypto+EvpAlgorithmId ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID[] = {
    { "Unknown", 0 },
    { "RSA", 6 },
    { "DSA", 116 },
    { "ECC", 408 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+EvpAlgorithmId"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+EvpAlgorithmId (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unknown");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("RSA");
    if (value == 116) return CHAOS_IL2CPP_STRING_ID("DSA");
    if (value == 408) return CHAOS_IL2CPP_STRING_ID("ECC");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCodeUniversal ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL[] = {
    { "X509_V_OK", 0 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL, 63
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCodeUniversal"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCodeUniversal (63 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("X509_V_OK");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSPECIFIED");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_GET_CRL");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_DECODE_ISSUER_PUBLIC_KEY");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_SIGNATURE_FAILURE");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CRL_SIGNATURE_FAILURE");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_NOT_YET_VALID");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_HAS_EXPIRED");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CRL_NOT_YET_VALID");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CRL_HAS_EXPIRED");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OUT_OF_MEM");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_CHAIN_TOO_LONG");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_REVOKED");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PATH_LENGTH_EXCEEDED");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_PURPOSE");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_UNTRUSTED");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CERT_REJECTED");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUBJECT_ISSUER_MISMATCH");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_AKID_SKID_MISMATCH");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_KEYUSAGE_NO_CERTSIGN");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_KEYUSAGE_NO_CRL_SIGN");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION");
    if (value == 37) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_NON_CA");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE");
    if (value == 40) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED");
    if (value == 41) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_EXTENSION");
    if (value == 42) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_POLICY_EXTENSION");
    if (value == 43) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_NO_EXPLICIT_POLICY");
    if (value == 44) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_DIFFERENT_CRL_SCOPE");
    if (value == 45) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE");
    if (value == 46) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNNESTED_RESOURCE");
    if (value == 47) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PERMITTED_VIOLATION");
    if (value == 48) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EXCLUDED_VIOLATION");
    if (value == 49) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUBTREE_MINMAX");
    if (value == 50) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_APPLICATION_VERIFICATION");
    if (value == 51) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE");
    if (value == 52) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX");
    if (value == 53) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_NAME_SYNTAX");
    if (value == 54) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CRL_PATH_VALIDATION_ERROR");
    if (value == 56) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_INVALID_VERSION");
    if (value == 57) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_INVALID_ALGORITHM");
    if (value == 58) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_INVALID_CURVE");
    if (value == 59) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_INVALID_SIGNATURE_ALGORITHM");
    if (value == 60) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_LOS_NOT_ALLOWED");
    if (value == 61) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUITE_B_CANNOT_SIGN_P_384_WITH_P_256");
    if (value == 62) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_HOSTNAME_MISMATCH");
    if (value == 63) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EMAIL_MISMATCH");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_IP_ADDRESS_MISMATCH");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode102 ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102[] = {
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102 = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102 = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode102"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode102 (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_CA");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_CALL");
    if (value == 66) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_STORE_LOOKUP");
    if (value == 67) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PROXY_SUBJECT_NAME_VIOLATION");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode111 ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111[] = {
    { "X509_V_ERR_INVALID_CA", 24 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111 = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111, 16
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111 = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode111"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode111 (16 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_CA");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_DANE_NO_MATCH");
    if (value == 66) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EE_KEY_TOO_SMALL");
    if (value == 67) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_KEY_TOO_SMALL");
    if (value == 68) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_MD_TOO_WEAK");
    if (value == 69) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_CALL");
    if (value == 70) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_STORE_LOOKUP");
    if (value == 71) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_NO_VALID_SCTS");
    if (value == 72) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PROXY_SUBJECT_NAME_VIOLATION");
    if (value == 73) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OCSP_VERIFY_NEEDED");
    if (value == 74) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OCSP_VERIFY_FAILED");
    if (value == 75) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OCSP_CERT_UNKNOWN");
    if (value == 76) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SIGNATURE_ALGORITHM_MISMATCH");
    if (value == 77) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_NO_ISSUER_PUBLIC_KEY");
    if (value == 78) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_SIGNATURE_ALGORITHM");
    if (value == 79) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EC_KEY_EXPLICIT_PARAMS");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode30 ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30[] = {
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30 = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30, 31
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30 = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode30"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode30 (31 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_NO_ISSUER_PUBLIC_KEY");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_DANE_NO_MATCH");
    if (value == 66) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EE_KEY_TOO_SMALL");
    if (value == 67) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_KEY_TOO_SMALL");
    if (value == 68) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_MD_TOO_WEAK");
    ...
    if (value == 74) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OCSP_VERIFY_FAILED");
    if (value == 75) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_OCSP_CERT_UNKNOWN");
    if (value == 76) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_UNSUPPORTED_SIGNATURE_ALGORITHM");
    if (value == 77) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SIGNATURE_ALGORITHM_MISMATCH");
    if (value == 78) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SIGNATURE_ALGORITHM_INCONSISTENCY");
    if (value == 79) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_INVALID_CA");
    if (value == 80) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PATHLEN_INVALID_FOR_NON_CA");
    if (value == 81) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_PATHLEN_WITHOUT_KU_KEY_CERT_SIGN");
    if (value == 82) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_KU_KEY_CERT_SIGN_INVALID_FOR_NON_CA");
    if (value == 83) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_ISSUER_NAME_EMPTY");
    if (value == 84) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUBJECT_NAME_EMPTY");
    if (value == 85) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_MISSING_AUTHORITY_KEY_IDENTIFIER");
    if (value == 86) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_MISSING_SUBJECT_KEY_IDENTIFIER");
    if (value == 87) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EMPTY_SUBJECT_ALT_NAME");
    if (value == 88) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EMPTY_SUBJECT_SAN_NOT_CRITICAL");
    if (value == 89) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_BCONS_NOT_CRITICAL");
    if (value == 90) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_AUTHORITY_KEY_IDENTIFIER_CRITICAL");
    if (value == 91) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_SUBJECT_KEY_IDENTIFIER_CRITICAL");
    if (value == 92) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_CA_CERT_MISSING_KEY_USAGE");
    if (value == 93) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EXTENSIONS_REQUIRE_VERSION_3");
    if (value == 94) return CHAOS_IL2CPP_STRING_ID("X509_V_ERR_EC_KEY_EXPLICIT_PARAMS");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Crypto+EvpCipherDirection ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION[] = {
    { "NoChange", -1 },
    { "Decrypt", 0 },
    { "Encrypt", 1 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Crypto+EvpCipherDirection"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Crypto+EvpCipherDirection (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == -1) return CHAOS_IL2CPP_STRING_ID("NoChange");
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Decrypt");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Encrypt");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/Interop+Error ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR[] = {
    { "SUCCESS", 0 },
    { "E2BIG", 65537 },
    { "EACCES", 65538 },
    { "EADDRINUSE", 65539 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR, 85
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Error"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Error (85 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("SUCCESS");
    if (value == 65537) return CHAOS_IL2CPP_STRING_ID("E2BIG");
    if (value == 65538) return CHAOS_IL2CPP_STRING_ID("EACCES");
    if (value == 65539) return CHAOS_IL2CPP_STRING_ID("EADDRINUSE");
...
// ── Enum: System.Security.Cryptography/Interop+Sys+FileStatusFlags ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS[] = {
    { "None", 0 },
    { "HasBirthTime", 1 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS, 2
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS = {
    0u,
    0u,
    "System.Security.Cryptography/Interop+Sys+FileStatusFlags"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/Interop+Sys+FileStatusFlags (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("HasBirthTime");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
// ── Enum: System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X500NameEncoder+ParseState ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE[] = {
    { "Invalid", 0 },
    { "SeekTag", 1 },
    { "SeekTagEnd", 2 },
    { "SeekEquals", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE, 9
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE = {
    0u,
    0u,
    "System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X500NameEncoder+ParseState"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X500NameEncoder+ParseState (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Invalid");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SeekTag");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("SeekTagEnd");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("SeekEquals");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("SeekValueStart");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("SeekValueEnd");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("SeekEndQuote");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("MaybeEndQuote");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("SeekComma");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.KeyUsageFlagsAsn ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN[] = {
    { "None", 0 },
    { "DigitalSignature", 1 },
    { "NonRepudiation", 2 },
    { "KeyEncipherment", 4 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN, 10
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN = {
    0u,
    0u,
    "System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.KeyUsageFlagsAsn"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.KeyUsageFlagsAsn (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DigitalSignature");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("NonRepudiation");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KeyEncipherment");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("DataEncipherment");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("KeyAgreement");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("KeyCertSign");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CrlSign");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("EncipherOnly");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("DecipherOnly");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.ReasonFlagsAsn ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN[] = {
    { "Unused", 1 },
    { "KeyCompromise", 2 },
    { "CACompromise", 4 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN = {
    kEnumFields_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN, 9
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN = {
    0u,
    0u,
    "System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.ReasonFlagsAsn"
};

/// Per-enum ToString dispatch for System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.ReasonFlagsAsn (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Unused");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("KeyCompromise");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CACompromise");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("AffiliationChanged");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("Superseded");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("CessationOfOperation");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("CertificateHold");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("PrivilegeWithdrawn");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("AACompromise");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0x116EC6u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL },
    ...
    { 0x469784u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION },
    ...
    { 0x4FE804u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID },
    ...
    { 0x5D7048u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS },
    ...
    { 0x638712u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN },
    ...
    { 0x8E2EF3u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR },
    ...
    { 0x95AA60u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN },
    ...
    { 0x9DF126u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102 },
    ...
    { 0xA0FDF6u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111 },
    ...
    { 0xDC73C2u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30 },
    ...
    { 0xF844E9u, &kEnumTable_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumDispatchCount = 335u;
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x116EC6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL },
    ...
    { 0x469784u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION },
    ...
    { 0x4FE804u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID },
    ...
    { 0x5D7048u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS },
    ...
    { 0x638712u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN },
    ...
    { 0x8E2EF3u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR },
    ...
    { 0x95AA60u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN },
    ...
    { 0x9DF126u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102 },
    ...
    { 0xA0FDF6u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111 },
    ...
    { 0xDC73C2u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30 },
    ...
    { 0xF844E9u, &ChaosEnumToString_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumToStringDispatchCount = 335u;
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode102"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE102));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCodeUniversal"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODEUNIVERSAL));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+EvpCipherDirection"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPCIPHERDIRECTION));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Sys+FileStatusFlags"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_SYS_FILESTATUSFLAGS));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.KeyUsageFlagsAsn"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_KEYUSAGEFLAGSASN));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/System.Security.Cryptography.X509Certificates.Asn1.ReasonFlagsAsn"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_ASN1_REASONFLAGSASN));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode111"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE111));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+EvpAlgorithmId"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_EVPALGORITHMID));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Crypto+X509VerifyStatusCode30"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_CRYPTO_X509VERIFYSTATUSCODE30));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/System.Security.Cryptography.X509Certificates.X500NameEncoder+ParseState"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_SYSTEM_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X500NAMEENCODER_PARSESTATE));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Security.Cryptography/Interop+Error"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_SECURITY_CRYPTOGRAPHY_INTEROP_ERROR));
    ChaosRegisterExternalType(
