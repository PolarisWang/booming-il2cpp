...
struct Functions {
    struct ImmutableDictionarySubjects_t {
...
struct ImmutableDictionarySubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableDictionarySubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableDictionarySubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableDictionarySubjects.CustomEntrySubject_2(
        );
    }
