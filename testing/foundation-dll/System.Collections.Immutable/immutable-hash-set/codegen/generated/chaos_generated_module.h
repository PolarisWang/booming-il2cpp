...
struct Functions {
    struct ImmutableHashSetSubjects_t {
...
struct ImmutableHashSetSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableHashSetSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableHashSetSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableHashSetSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.immutableHashSetSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.immutableHashSetSubjects.CustomEntrySubject_4(
        );
    }
