...
struct Functions {
    struct ImmutableSortedSetSubjects_t {
...
struct ImmutableSortedSetSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableSortedSetSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableSortedSetSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableSortedSetSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.immutableSortedSetSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.immutableSortedSetSubjects.CustomEntrySubject_4(
        );
    }
