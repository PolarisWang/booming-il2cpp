...
public static class ImmutableListHotUpdate
{
    // Verify ImmutableList.Create<Byte> after hot-update (patch side)
    ...
    // Verify ImmutableList.Create<Int32> after hot-update (patch side)
    ...
    // Verify ImmutableList.Create<String> after hot-update (patch side)
