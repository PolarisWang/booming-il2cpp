...
struct Functions {
    struct ImmutableArraySubjects_t {
...
struct ImmutableArraySubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_4(
        );
    }
    static inline void CustomEntrySubject_5(
    ) {
        return kFunctions.immutableArraySubjects.CustomEntrySubject_5(
        );
    }
