...
public static class ImmutableQueueStackHotUpdate
{
    // Verify ImmutableQueue.Create<Byte> after hot-update (patch side)
    ...
    // Verify ImmutableQueue.Create<Int32> after hot-update (patch side)
    ...
    // Verify ImmutableStack.Create<Byte> after hot-update (patch side)
    ...
    // Verify ImmutableStack.Create<Int32> after hot-update (patch side)
