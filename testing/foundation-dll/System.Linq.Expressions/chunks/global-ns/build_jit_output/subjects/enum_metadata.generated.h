...
// ── Enum: System.Linq.Expressions/System.Linq.Expressions.AnalyzeTypeIsResult ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT[] = {
    { "KnownFalse", 0 },
    { "KnownTrue", 1 },
    { "KnownAssignable", 2 },
    { "Unknown", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.AnalyzeTypeIsResult"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.AnalyzeTypeIsResult (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("KnownFalse");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("KnownTrue");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("KnownAssignable");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Unknown");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Expression+TryGetFuncActionArgsResult ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT[] = {
    { "Valid", 0 },
    { "ArgumentNull", 1 },
    { "ByRef", 2 },
    { "PointerOrVoid", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Expression+TryGetFuncActionArgsResult"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Expression+TryGetFuncActionArgsResult (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Valid");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ArgumentNull");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ByRef");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PointerOrVoid");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.DebugViewWriter+Flow ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW[] = {
    { "None", 0 },
    { "Space", 1 },
    { "NewLine", 2 },
    { "Break", 32768 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.DebugViewWriter+Flow"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.DebugViewWriter+Flow (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Space");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("NewLine");
    if (value == 32768) return CHAOS_IL2CPP_STRING_ID("Break");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.ExpressionType ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE[] = {
    { "Add", 0 },
    { "AddChecked", 1 },
    { "And", 2 },
    { "AndAlso", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE, 85
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.ExpressionType"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.ExpressionType (85 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Add");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AddChecked");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("And");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("AndAlso");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("ArrayLength");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("ArrayIndex");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Call");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Coalesce");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Conditional");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("Constant");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("Convert");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("ConvertChecked");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("Divide");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("Equal");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("ExclusiveOr");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("GreaterThan");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("GreaterThanOrEqual");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("Invoke");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("Lambda");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("LeftShift");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("LessThan");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("LessThanOrEqual");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("ListInit");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("MemberAccess");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("MemberInit");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("Modulo");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("Multiply");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("MultiplyChecked");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("Negate");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("UnaryPlus");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("NegateChecked");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("New");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("NewArrayInit");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("NewArrayBounds");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("Not");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("NotEqual");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("Or");
    if (value == 37) return CHAOS_IL2CPP_STRING_ID("OrElse");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("Parameter");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("Power");
    if (value == 40) return CHAOS_IL2CPP_STRING_ID("Quote");
    if (value == 41) return CHAOS_IL2CPP_STRING_ID("RightShift");
    if (value == 42) return CHAOS_IL2CPP_STRING_ID("Subtract");
    if (value == 43) return CHAOS_IL2CPP_STRING_ID("SubtractChecked");
    if (value == 44) return CHAOS_IL2CPP_STRING_ID("TypeAs");
    if (value == 45) return CHAOS_IL2CPP_STRING_ID("TypeIs");
    if (value == 46) return CHAOS_IL2CPP_STRING_ID("Assign");
    if (value == 47) return CHAOS_IL2CPP_STRING_ID("Block");
    if (value == 48) return CHAOS_IL2CPP_STRING_ID("DebugInfo");
    if (value == 49) return CHAOS_IL2CPP_STRING_ID("Decrement");
    if (value == 50) return CHAOS_IL2CPP_STRING_ID("Dynamic");
    if (value == 51) return CHAOS_IL2CPP_STRING_ID("Default");
    if (value == 52) return CHAOS_IL2CPP_STRING_ID("Extension");
    if (value == 53) return CHAOS_IL2CPP_STRING_ID("Goto");
    if (value == 54) return CHAOS_IL2CPP_STRING_ID("Increment");
    if (value == 55) return CHAOS_IL2CPP_STRING_ID("Index");
    if (value == 56) return CHAOS_IL2CPP_STRING_ID("Label");
    if (value == 57) return CHAOS_IL2CPP_STRING_ID("RuntimeVariables");
    if (value == 58) return CHAOS_IL2CPP_STRING_ID("Loop");
    if (value == 59) return CHAOS_IL2CPP_STRING_ID("Switch");
    if (value == 60) return CHAOS_IL2CPP_STRING_ID("Throw");
    if (value == 61) return CHAOS_IL2CPP_STRING_ID("Try");
    if (value == 62) return CHAOS_IL2CPP_STRING_ID("Unbox");
    if (value == 63) return CHAOS_IL2CPP_STRING_ID("AddAssign");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("AndAssign");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("DivideAssign");
    if (value == 66) return CHAOS_IL2CPP_STRING_ID("ExclusiveOrAssign");
    if (value == 67) return CHAOS_IL2CPP_STRING_ID("LeftShiftAssign");
    if (value == 68) return CHAOS_IL2CPP_STRING_ID("ModuloAssign");
    if (value == 69) return CHAOS_IL2CPP_STRING_ID("MultiplyAssign");
    if (value == 70) return CHAOS_IL2CPP_STRING_ID("OrAssign");
    if (value == 71) return CHAOS_IL2CPP_STRING_ID("PowerAssign");
    if (value == 72) return CHAOS_IL2CPP_STRING_ID("RightShiftAssign");
    if (value == 73) return CHAOS_IL2CPP_STRING_ID("SubtractAssign");
    if (value == 74) return CHAOS_IL2CPP_STRING_ID("AddAssignChecked");
    if (value == 75) return CHAOS_IL2CPP_STRING_ID("MultiplyAssignChecked");
    if (value == 76) return CHAOS_IL2CPP_STRING_ID("SubtractAssignChecked");
    if (value == 77) return CHAOS_IL2CPP_STRING_ID("PreIncrementAssign");
    if (value == 78) return CHAOS_IL2CPP_STRING_ID("PreDecrementAssign");
    if (value == 79) return CHAOS_IL2CPP_STRING_ID("PostIncrementAssign");
    if (value == 80) return CHAOS_IL2CPP_STRING_ID("PostDecrementAssign");
    if (value == 81) return CHAOS_IL2CPP_STRING_ID("TypeEqual");
    if (value == 82) return CHAOS_IL2CPP_STRING_ID("OnesComplement");
    if (value == 83) return CHAOS_IL2CPP_STRING_ID("IsTrue");
    if (value == 84) return CHAOS_IL2CPP_STRING_ID("IsFalse");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.GotoExpressionKind ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND[] = {
    { "Goto", 0 },
    { "Return", 1 },
    { "Break", 2 },
    { "Continue", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND, 4
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.GotoExpressionKind"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.GotoExpressionKind (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Goto");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Return");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Break");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Continue");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.MemberBindingType ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE[] = {
    { "Assignment", 0 },
    { "MemberBinding", 1 },
    { "ListBinding", 2 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.MemberBindingType"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.MemberBindingType (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Assignment");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("MemberBinding");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ListBinding");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Interpreter.LabelScopeKind ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND[] = {
    { "Statement", 0 },
    { "Block", 1 },
    { "Switch", 2 },
    { "Lambda", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND, 9
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Interpreter.LabelScopeKind"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Interpreter.LabelScopeKind (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Statement");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Block");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Switch");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Lambda");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Try");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Catch");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Finally");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Filter");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Expression");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Compiler.VariableStorageKind ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND[] = {
    { "Local", 0 },
    { "Hoisted", 1 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND, 2
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Compiler.VariableStorageKind"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Compiler.VariableStorageKind (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Local");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Hoisted");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Compiler.LabelScopeKind ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND[] = {
    { "Statement", 0 },
    { "Block", 1 },
    { "Switch", 2 },
    { "Lambda", 3 },
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND, 9
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Compiler.LabelScopeKind"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Compiler.LabelScopeKind (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Statement");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Block");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Switch");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Lambda");
...
// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Compiler.LambdaCompiler+CompilationFlags ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS[] = {
...
static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS, 10
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Compiler.LambdaCompiler+CompilationFlags"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Compiler.LambdaCompiler+CompilationFlags (10 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EmitExpressionStart");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("EmitNoExpressionStart");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("EmitExpressionStartMask");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("EmitAsDefaultType");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("EmitAsVoidType");
    if (value == 240) return CHAOS_IL2CPP_STRING_ID("EmitAsTypeMask");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("EmitAsTail");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("EmitAsMiddle");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("EmitAsNoTail");
    if (value == 3840) return CHAOS_IL2CPP_STRING_ID("EmitAsTailCallMask");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+Stack ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK[] = {
    { "Empty", 0 },
    { "NonEmpty", 1 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK, 2
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+Stack"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+Stack (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Empty");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("NonEmpty");
    return 0;  // unrecognized value → caller falls through to decimal
}

// ── Enum: System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+RewriteAction ──────────────────────────────
static constexpr EnumFieldEntry kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION[] = {
    { "None", 0 },
    { "Copy", 1 },
    { "SpillStack", 3 },
};

static constexpr EnumMetadataTable kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION = {
    kEnumFields_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION, 3
};

static constexpr EnumTypeDescriptor kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION = {
    0u,
    0u,
    "System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+RewriteAction"
};

/// Per-enum ToString dispatch for System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+RewriteAction (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Copy");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("SpillStack");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumDispatchEntry kEnumDispatchTable[] = {
    ...
    { 0x139EA3u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND },
    ...
    { 0x255542u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND },
    ...
    { 0x3C2AE5u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK },
    ...
    { 0x4FD7F5u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND },
    ...
    { 0x7063E2u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT },
    ...
    { 0x7D9857u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION },
    ...
    { 0x8C9614u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW },
    ...
    { 0x977128u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE },
    ...
    { 0xA04D7Fu, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT },
    ...
    { 0xA175FDu, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE },
    ...
    { 0xA6E0C0u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS },
    ...
    { 0xD53762u, &kEnumTable_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND },
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x139EA3u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND },
    ...
    { 0x255542u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND },
    ...
    { 0x3C2AE5u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK },
    ...
    { 0x4FD7F5u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND },
    ...
    { 0x7063E2u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT },
    ...
    { 0x7D9857u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION },
    ...
    { 0x8C9614u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW },
    ...
    { 0x977128u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE },
    ...
    { 0xA04D7Fu, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT },
    ...
    { 0xA175FDu, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE },
    ...
    { 0xA6E0C0u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS },
    ...
    { 0xD53762u, &ChaosEnumToString_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND },
...
static void ChaosRegisterEnumGeneratedMetadata() noexcept {
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Compiler.LabelScopeKind"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LABELSCOPEKIND));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+RewriteAction"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_REWRITEACTION));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Compiler.LambdaCompiler+CompilationFlags"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_LAMBDACOMPILER_COMPILATIONFLAGS));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Compiler.StackSpiller+Stack"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_STACKSPILLER_STACK));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.GotoExpressionKind"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_GOTOEXPRESSIONKIND));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.MemberBindingType"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_MEMBERBINDINGTYPE));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Interpreter.LabelScopeKind"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_INTERPRETER_LABELSCOPEKIND));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.DebugViewWriter+Flow"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_DEBUGVIEWWRITER_FLOW));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.AnalyzeTypeIsResult"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_ANALYZETYPEISRESULT));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.ExpressionType"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSIONTYPE));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Expression+TryGetFuncActionArgsResult"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_EXPRESSION_TRYGETFUNCACTIONARGSRESULT));
    ChaosRegisterExternalType(
    ...
    ChaosRegisterExternalType(
        compute_enum_hash24("System.Linq.Expressions/System.Linq.Expressions.Compiler.VariableStorageKind"),
        reinterpret_cast<const chaos::il2cpp::runtime_core::ReflectionQueryTypeDescriptor*>(
            &chaos::il2cpp::codegen::kEnumTypeDesc_SYSTEM_LINQ_EXPRESSIONS_SYSTEM_LINQ_EXPRESSIONS_COMPILER_VARIABLESTORAGEKIND));
    ChaosRegisterExternalType(
