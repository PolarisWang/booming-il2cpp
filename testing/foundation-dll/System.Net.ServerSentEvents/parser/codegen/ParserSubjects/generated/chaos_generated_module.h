...
struct ParserSubjects {
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.parserSubjects.CustomEntrySubject_1(
        );
    }
    static inline void Subject_0(
    ) {
        return kFunctions.parserSubjects.Subject_0(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.parserSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.parserSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.parserSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.parserSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.parserSubjects.Subject_6(
        );
    }
    static inline void Subject_7(
    ) {
        return kFunctions.parserSubjects.Subject_7(
        );
    }
