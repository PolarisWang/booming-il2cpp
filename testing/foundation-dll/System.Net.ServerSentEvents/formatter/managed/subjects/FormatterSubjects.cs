...
public static partial class FormatterSubjects
{
    ...
    {
        try { if (((SseFormatter.WriteAsync(null!, new MemoryStream(), default)).GetHashCode()) != ((SseFormatter.WriteAsync(null!, new MemoryStream(), default)).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
