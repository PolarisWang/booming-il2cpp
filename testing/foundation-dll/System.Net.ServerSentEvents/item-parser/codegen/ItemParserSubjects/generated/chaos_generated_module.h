...
struct ItemParserSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.itemParserSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.itemParserSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.itemParserSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.itemParserSubjects.Subject_3(
        );
    }
