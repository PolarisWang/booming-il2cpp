...
struct SseItemSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.sseItemSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.sseItemSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.sseItemSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.sseItemSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.sseItemSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.sseItemSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.sseItemSubjects.Subject_6(
        );
    }
