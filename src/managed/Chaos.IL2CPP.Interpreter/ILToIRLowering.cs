...
public sealed class ILToIRLowering
{
        ...
        ref int temporaryIndex)
    {
        return instruction.Op switch
        {
            ...
            // .un variants: unsigned source, same opcodes (non-.un check is a conservative superset)
            "conv.ovf.i1.un" => new IRInstruction { OpCode = IROpCode.ConvOvfI4 },
            "conv.ovf.i2.un" => new IRInstruction { OpCode = IROpCode.ConvOvfI4 },
            "conv.ovf.i4.un" => new IRInstruction { OpCode = IROpCode.ConvOvfI4 },
            "conv.ovf.i8.un" => new IRInstruction { OpCode = IROpCode.ConvOvfI8 },
            "conv.ovf.u1.un" => new IRInstruction { OpCode = IROpCode.ConvOvfU4 },
            "conv.ovf.u2.un" => new IRInstruction { OpCode = IROpCode.ConvOvfU4 },
            "conv.ovf.u4.un" => new IRInstruction { OpCode = IROpCode.ConvOvfU4 },
            "conv.ovf.u8.un" => new IRInstruction { OpCode = IROpCode.ConvOvfU8 },
            "conv.ovf.i.un" => new IRInstruction { OpCode = IROpCode.ConvOvfI },
            "conv.ovf.u.un" => new IRInstruction { OpCode = IROpCode.ConvOvfU },
