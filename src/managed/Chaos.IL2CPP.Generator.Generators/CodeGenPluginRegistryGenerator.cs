...
namespace Chaos.IL2CPP.Generator.Generators;

[Generator]
public sealed class CodeGenPluginRegistryGenerator : IIncrementalGenerator
{
    private const string FamilyAttributeMetadataName = "Chaos.IL2CPP.Generator.RuntimeSkeletonFamilyPluginAttribute";
    private const string LoweringAttributeMetadataName = "Chaos.IL2CPP.Generator.LoweringPlanPluginAttribute";
    private const string TemplateBundleAttributeMetadataName = "Chaos.IL2CPP.Generator.CodegenTemplateBundlePluginAttribute";
    private const string RuntimeProviderAttributeMetadataName = "Chaos.IL2CPP.Generator.RuntimeProviderPluginAttribute";
