...
public sealed partial class NativeAotLoweringPlanner
{
    ...
    /// <summary>
    /// Emit JIT method entry table for interpreter dispatch.
    /// Generated only when codegen mode is Jit. Produces:
    /// <code>
    /// extern "C" const JitMethodEntry kChaosJitMethodEntries[] = { ... };
    /// extern "C" const uint32_t kChaosJitMethodEntryCount = N;
    /// </code>
        ...
        MetadataRegistrationArtifact metadataRegistration)
    {
        ...
        // Serialize each method to JSON and emit as a C++ string literal + JitMethodEntry.
        ...
        // Pre-serialize all methods to JSON (avoids double-serialization).
        ...
        // Emit JitMethodEntry array
        sb.Append("extern \"C\" const JitMethodEntry kChaosJitMethodEntries[")
        ...
        // Emit count symbol
        sb.Append("extern \"C\" const uint32_t kChaosJitMethodEntryCount = ")
            .Append(methodsForLowering.Count)
            .AppendLine("u;");
