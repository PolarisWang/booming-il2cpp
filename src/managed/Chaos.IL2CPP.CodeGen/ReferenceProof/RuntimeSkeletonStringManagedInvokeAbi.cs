...
internal static class RuntimeSkeletonStringManagedInvokeAbiFactory
{
    ...
    private static bool TryResolveTypedValueCarrier(string managedType, out string cppCarrier)
    {
        cppCarrier = managedType switch
        {
            ...
            "System.StringComparison" => "std::int32_t",
            "System.StringSplitOptions" => "std::int32_t",
            "System.Globalization.CompareOptions" => "std::int32_t",
            "System.Text.NormalizationForm" => "std::int32_t",
            "System.Text.TrimType" => "std::int32_t",
