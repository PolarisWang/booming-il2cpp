...
internal sealed record RuntimeSkeletonThreadingManagedInvokeAbi(
    string ContractId,
...
internal static class RuntimeSkeletonThreadingManagedInvokeAbiFactory
{
    public static bool TryCreate(
        TypedIlMethodArtifact method,
        string contractId,
        out RuntimeSkeletonThreadingManagedInvokeAbi abi)
    {
        abi = null!;
        ...
        var hasThisArgument = RuntimeSkeletonManagedInvokeAbiCore.IsInstanceLike(
            ...
            supportsConstructors: true,
            supportsInstanceFieldGetters: true);
        abi = new RuntimeSkeletonThreadingManagedInvokeAbi(
            contractId,
