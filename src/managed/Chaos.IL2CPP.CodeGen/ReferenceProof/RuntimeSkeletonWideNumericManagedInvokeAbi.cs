...
internal sealed record RuntimeSkeletonWideNumericManagedInvokeAbi(
    string ContractId,
...
{
    public const string HotUpdateStableContractId = "wide-numeric-managed-invoke-v1";
    ...
    public static bool TryCreate(
        ...
        out RuntimeSkeletonWideNumericManagedInvokeAbi abi) =>
        RuntimeSkeletonWideNumericManagedInvokeAbiFactory.TryCreate(method, out abi);
}

internal static class RuntimeSkeletonWideNumericManagedInvokeAbiFactory
{
    public static bool TryCreate(
        TypedIlMethodArtifact method,
        out RuntimeSkeletonWideNumericManagedInvokeAbi abi)
    {
        ...
        if (!RuntimeSkeletonValueTypeManagedInvokeCore.TryCreate(
                method,
                RuntimeSkeletonSemanticRegistry.WideNumericFamilyId,
                RuntimeSkeletonWideNumericManagedInvokeAbi.HotUpdateStableContractId,
                out var descriptor,
        ...
        abi = new RuntimeSkeletonWideNumericManagedInvokeAbi(
