...
{
	private void EmitReflectionObjectHelpers(StringBuilder builder, IReadOnlySet<string> referenceTypeSubjectIds, IReadOnlySet<string> boxedTypeSubjectIds)
	{
		...
		bool flag6 = UsesDefaultInterpolatedStringHandlerHelpers();
		bool flag7 = RequiresManagedStringRuntime();
		...
		builder.AppendLine("}");
		builder.AppendLine();
		if (RequiresManagedStringFactory())
		{
	...
	private void EmitExceptionMetadataHelpers(StringBuilder builder)
	{
		if (_methodsBySubjectId.Values.Any((AotCoreIrMethodArtifact method) => method.Instructions.Any((AotCoreIrInstructionArtifact instruction) => string.Equals(instruction.Callee, "System.Private.CoreLib/System.Exception::.ctor(System.String)", StringComparison.Ordinal) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.InvalidOperationException::.ctor(System.String)", StringComparison.Ordinal) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.ArgumentOutOfRangeException::.ctor(System.String,System.String)", StringComparison.Ordinal) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.Exception::get_Message()", StringComparison.Ordinal) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.ArgumentException::get_ParamName()", StringComparison.Ordinal))))
		{
	...
	private bool RequiresManagedStringRuntime()
	{
		...
		string elementTypeDisplayName;
		return _methodsBySubjectId.Values.Any((AotCoreIrMethodArtifact method) => method.Instructions.Any((AotCoreIrInstructionArtifact instruction) => string.Equals(instruction.Callee, "System.Private.CoreLib/System.String::Join(System.String,System.Collections.Generic.IEnumerable<System.String>)", StringComparison.Ordinal) || TryParseStringJoinGenericEnumerableElementType(instruction.Callee ?? string.Empty, out elementTypeDisplayName) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.String::StartsWith(System.String,System.StringComparison)", StringComparison.Ordinal) || string.Equals(instruction.Callee, "System.Private.CoreLib/System.String::Contains(System.String,System.StringComparison)", StringComparison.Ordinal)));
	}
