...
public sealed partial class NativeAotLoweringPlanner
{
	private void EmitReflectionObjectHelpers(StringBuilder builder, IReadOnlyList<AotCoreIrMethodArtifact> reachableMethods, IReadOnlySet<string> referenceTypeSubjectIds, IReadOnlySet<string> boxedTypeSubjectIds)
	{
		...
		if (flag2 || flag4 || flag5)
		{
			...
			builder.AppendLine("    chaos_array->elements = chaos_length == 0 ? nullptr : static_cast<CHAOS_IL2CPP_INTPTR*>(CHAOS_IL2CPP_NEW_GC_ARRAY(CHAOS_IL2CPP_INTPTR, chaos_length));");
			...
			if (flag5)
			{
				...
				builder.AppendLine("    }");
				builder.AppendLine();
				builder.AppendLine("    auto* chaos_header = reinterpret_cast<FatHeader*>(chaos_member_value);");
				stringBuilder = builder;
				...
				builder.AppendLine("    }");
				builder.AppendLine();
				builder.AppendLine("    auto* chaos_header = reinterpret_cast<FatHeader*>(chaos_method_value);");
