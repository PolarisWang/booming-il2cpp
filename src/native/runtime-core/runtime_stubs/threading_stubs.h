...
inline CHAOS_IL2CPP_INTPTR chaos_thread_get_current(void) CHAOS_STUB_NOEXCEPT
{
...
CHAOS_IL2CPP_INT32 ChaosMonitorTryEnter(CHAOS_IL2CPP_INTPTR obj, CHAOS_IL2CPP_INT32 timeout) CHAOS_STUB_NOEXCEPT;
...
void chaos_thread_ctor(CHAOS_IL2CPP_INTPTR thread_obj, CHAOS_IL2CPP_INTPTR thread_start_delegate) CHAOS_STUB_NOEXCEPT;
