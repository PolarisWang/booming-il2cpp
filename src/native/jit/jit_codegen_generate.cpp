...
// (OptimizeInstructions) for NativeCodeGenerator (T2.4 module split of
// jit_engine.cpp).
//
// Pure move: OptimizeInstructions, Generate were relocated verbatim from
// jit_engine.cpp; no logic changed.  Compile/CanCompile entry points and
// JitMethod lifecycle moved to jit_codegen_entry.cpp.
