...
public sealed class DispatchEmitter
{
    public string GenerateDispatch(IReadOnlyList<SubjectModel> subjects)
    {
        ...
        sb.Append("""
            ...
            // Benchmark functions use nullptr thunks. ChaosDispatchMethod falls through
            // to entry.direct_ptr from the hotpatch entries.
            ...
            extern "C" CHAOS_IL2CPP_INT32 RunFactAll() {
                ...
                auto result = ChaosDispatchMethodAllModules(CHAOS_DISPATCH_THUNKS);
            ...
            extern "C" BenchmarkResult RunBenchmark(int entry_index, int iterations) {
                ...
                // Warmup
                ChaosDispatchMethod(entries, kAotMethodCount, entry_index, CHAOS_DISPATCH_THUNKS);
