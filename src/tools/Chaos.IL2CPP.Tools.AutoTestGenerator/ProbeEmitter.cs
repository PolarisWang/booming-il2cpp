        ...
        for (int mi = 0; mi < methods.Count; mi++)
        {
            ...
            foreach (var set in allValueSets[mi])
            {
                ...
                else
                {
                    ...
                    // Box to object to support both value types (int, enum) and reference types
