...
public sealed class ProbeEmitter
{
        ...
        string targetFramework = "net8.0")
    {
        ...
        Console.Write("  Run 1/3... ");
        var run1 = RunProbe(probeDir);
        Console.WriteLine($"{run1.Count} results");

        Console.Write("  Run 2/3... ");
        var run2 = RunProbe(probeDir);
        Console.WriteLine($"{run2.Count} results");

        Console.Write("  Run 3/3... ");
        var run3 = RunProbe(probeDir);
        Console.WriteLine($"{run3.Count} results");

        return MergeResults(methods, allValueSets, run1, run2, run3);
    }
    ...
    private static string GenerateProbeCsproj(string targetFramework, string dllPath)
    {
        ...
        // Skip explicit reference for System.Private.CoreLib — it's already
        // part of the framework and adding it creates type conflicts.
        var dllName = Path.GetFileNameWithoutExtension(dllPath);
        var referenceItem = dllName == "System.Private.CoreLib"
            ? ""
            : $"  <ItemGroup>\n" +
