...
inline MethodTable chaos_mt_SnapshotTestFixtures_IComInternal = {nullptr, nullptr, 5466029519647613277ULL, 0u, 32, 2, 0, nullptr, nullptr, 0, 0, 0, 0};
...
inline MethodTable chaos_mt_SomeOtherAssembly_IComExternal = {nullptr, nullptr, 5031554472595150857ULL, 0u, 32, 2, 0, nullptr, nullptr, 0, 0, 0, 0};
...
struct chaos_boxed_type_SnapshotTestFixtures_IComInternal
{
	PureTypeHeader header{};
	chaos_valuetype_SnapshotTestFixtures_IComInternal value{};
};

struct chaos_boxed_type_SomeOtherAssembly_IComExternal
{
	PureTypeHeader header{};
	chaos_valuetype_SomeOtherAssembly_IComExternal value{};
};
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[3] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_CrossAssemblyComCaller_CallIt), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // CrossAssemblyComCaller::CallIt
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_IComInternal_Compute), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // IComInternal::Compute
	{ reinterpret_cast<void*>(&SomeOtherAssembly_IComExternal_Compute), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // IComExternal::Compute
};
...
extern "C" const char* kChaosExternalRuntimeSubjects[2] = {
	"SnapshotTestFixtures/IComInternal",
	"SomeOtherAssembly/IComExternal",
};
...
static void (*kDefaultArgThunks[3])() = {
	[]() {kMethodTable[0]();},
...
// Bridge/import thunk for: SnapshotTestFixtures/IComInternal
extern "C" void chaos_bridge_thunk_0(void)
{
	reinterpret_cast<void(*)()>(kChaosExternalRuntimeFnTable[0])();
}

// Bridge/import thunk for: SomeOtherAssembly/IComExternal
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_CrossAssemblyComCaller_CallIt(void)
{
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(35678013u);
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(49833065u);
	_s0 = 0;
