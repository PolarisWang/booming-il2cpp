...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_ArrayHelper_MakeAndFill), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // ArrayHelper::MakeAndFill
};
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_ArrayHelper[1] = {
	{ 0u, /*metadata_token — unused by ResolveSubjectId*/ "SnapshotTestFixtures/ArrayHelper::MakeAndFill:System.Int32()", "MakeAndFill", "System.Void", 0, nullptr, 0u },
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_ArrayHelper_MakeAndFill(void)
{
	...
	_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(42);
	{
		...
		const auto chaos_value = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(chaos_value_raw));
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(0);
	{
		...
		_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(chaos_element));
	}
