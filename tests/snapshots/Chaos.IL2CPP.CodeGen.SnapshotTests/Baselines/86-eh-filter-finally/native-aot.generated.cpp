...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhFilterFinallyHelper::FilterFinally
};
