...
inline MethodTable chaos_mt_System_Private_CoreLib_System_DivideByZeroException = {nullptr, nullptr, 14499175579798713746ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhMultipleCatchHelper_MultipleCatch), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhMultipleCatchHelper::MultipleCatch
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhMultipleCatchHelper_MultipleCatch(CHAOS_IL2CPP_INT32 chaos_fn_arg_0)
{
	...
	CHAOS_EH_TRY
			...
			_s1 = chaos_args[0];
			_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(static_cast<CHAOS_IL2CPP_INT32>(_s0), static_cast<CHAOS_IL2CPP_INT32>(_s1)));
			chaos_locals[0] = _s2;
	...
	CHAOS_EH_END
	CHAOS_EH_TRY
			_s5 = static_cast<CHAOS_IL2CPP_INTPTR>(100);
			_s6 = chaos_args[0];
			_s7 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(static_cast<CHAOS_IL2CPP_INT32>(_s5), static_cast<CHAOS_IL2CPP_INT32>(_s6)));
			chaos_locals[0] = _s7;
	CHAOS_EH_CATCH_BEGIN
		if (!chaos_eh_match_type(CHAOS_EH_EXCEPTION_OBJ, chaos_mt_System_Private_CoreLib_System_Exception.AsTypeInfoHot()))
		{ CHAOS_EH_RETHROW; }
		_s8 = CHAOS_EH_EXCEPTION_OBJ;
