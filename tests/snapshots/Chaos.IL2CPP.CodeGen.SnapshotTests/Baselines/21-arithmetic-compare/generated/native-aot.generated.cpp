...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_ArithmeticCompareHelper_RunCompare), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // ArithmeticCompareHelper::RunCompare
};
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_ArithmeticCompareHelper[1] = {
	{ 0u, /*metadata_token — unused by ResolveSubjectId*/ "SnapshotTestFixtures/ArithmeticCompareHelper::RunCompare:System.Int32()", "RunCompare", "System.Void", 0, nullptr, 0u },
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_ArithmeticCompareHelper_RunCompare(void)
{
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(4);
	{
		const auto chaos_right = static_cast<CHAOS_IL2CPP_INT32>(_s1);
		const auto chaos_left = static_cast<CHAOS_IL2CPP_INT32>(_s0);
		_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosRem(chaos_left, chaos_right));
	}
	chaos_locals[1] = _s0;
