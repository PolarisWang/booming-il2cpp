...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_ValueTypeHelper_RunValueType(void)
{
	...
	_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(42);
	{
		...
		auto* chaos_destination = chaos_resolve_managed_value_pointer<CHAOS_IL2CPP_INTPTR>(_s1);
		*chaos_destination = chaos_value;
	}
	_s3 = reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&chaos_locals[0]);
	{
		auto* chaos_source = chaos_resolve_managed_value_pointer<CHAOS_IL2CPP_INTPTR>(_s3);
		_s4 = *chaos_source;
	}
