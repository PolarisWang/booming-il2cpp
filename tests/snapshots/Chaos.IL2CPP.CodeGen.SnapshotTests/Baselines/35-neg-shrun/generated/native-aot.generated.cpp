...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_NegShiftHelper_RunNegShift), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // NegShiftHelper::RunNegShift
};
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_NegShiftHelper[1] = {
	{ 0u, /*metadata_token — unused by ResolveSubjectId*/ "SnapshotTestFixtures/NegShiftHelper::RunNegShift:System.Int32()", "RunNegShift", "System.Void", 0, nullptr, 0u },
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_NegShiftHelper_RunNegShift(void)
{
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(2);
	{
		...
		_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_shift_right_un_int32(chaos_value, chaos_shift));
	}
	chaos_locals[1] = _s0;
	_s0 = chaos_locals[0];
