...
inline TypeInfoHot chaos_type_info_SnapshotTestFixtures_FieldHelper = { nullptr, nullptr, 14105055411266533488ULL, 0u, 32 /* warm_delta */, 1 /* reference */, 1 };
inline TypeInfoWarm chaos_type_info_warm_SnapshotTestFixtures_FieldHelper = { nullptr, nullptr, 0, 0, 0, 0 };
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_SnapshotTestFixtures_FieldHelper = static_cast<CHAOS_IL2CPP_INTPTR>(14105055411266533488ULL);inline TypeInfoHot chaos_type_info_System_Private_CoreLib_System_Reflection_Assembly = { nullptr, nullptr, 5474029880995115448ULL, 0u, 32 /* warm_delta */, 1 /* reference */, 1 };
...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_FieldHelper_GetAndIncrement), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // FieldHelper::GetAndIncrement
};
...
// Native AOT entry for SnapshotTestFixtures/FieldHelper::GetAndIncrement:System.Int32()
// Managed symbol: SnapshotTestFixtures_FieldHelper_GetAndIncrement
extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 chaos_entry_index)
{
    return SnapshotTestFixtures_FieldHelper_GetAndIncrement();
}
