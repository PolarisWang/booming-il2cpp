...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhCatchFinallyNestedHelper_CatchFinallyNested), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhCatchFinallyNestedHelper::CatchFinallyNested
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhCatchFinallyNestedHelper_CatchFinallyNested(CHAOS_IL2CPP_INT32 chaos_fn_arg_0)
{
	...
	CHAOS_EH_TRY
			...
			CHAOS_EH_TRY_FINALLY
					...
					_s3 = chaos_args[0];
					_s4 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(static_cast<CHAOS_IL2CPP_INT32>(_s2), static_cast<CHAOS_IL2CPP_INT32>(_s3)));
					chaos_locals[0] = _s4;
