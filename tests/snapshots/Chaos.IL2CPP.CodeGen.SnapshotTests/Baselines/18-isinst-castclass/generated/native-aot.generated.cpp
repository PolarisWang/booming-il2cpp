...
inline TypeInfoHot chaos_type_info_SnapshotTestFixtures_MarkedClass = { nullptr, nullptr, 6112983511997078372ULL, 0u, 32 /* warm_delta */, 1 /* reference */, 1 };
inline TypeInfoWarm chaos_type_info_warm_SnapshotTestFixtures_MarkedClass = { nullptr, nullptr, 0, 0, 0, 0 };
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_SnapshotTestFixtures_MarkedClass = static_cast<CHAOS_IL2CPP_INTPTR>(6112983511997078372ULL);inline TypeInfoHot chaos_type_info_System_Private_CoreLib_System_Reflection_Assembly = { nullptr, nullptr, 5474029880995115448ULL, 0u, 32 /* warm_delta */, 1 /* reference */, 1 };
...
struct chaos_type_SnapshotTestFixtures_MarkedClass
{
...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_TypeCheckHelper_CheckAndCast), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // TypeCheckHelper::CheckAndCast
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_TypeCheckHelper_CheckAndCast(void)
{
	...
	{
		auto* chaos_object = new chaos_type_SnapshotTestFixtures_MarkedClass{};
		chaos_object->header.type_info = &chaos_type_info_SnapshotTestFixtures_MarkedClass;
	...
	_s1 = chaos_locals[0];
	{
		...
		{
			auto* chaos_header = reinterpret_cast<FatHeader*>(chaos_value);
			chaos_matches = chaos_is_type_compatible(chaos_object_get_type_info(chaos_header), &chaos_type_info_SnapshotTestFixtures_MarkedClass);
		}
	...
	}
	{
		...
		{
			auto* chaos_header = reinterpret_cast<FatHeader*>(chaos_value);
			if (!chaos_is_type_compatible(chaos_object_get_type_info(chaos_header), &chaos_type_info_SnapshotTestFixtures_MarkedClass))
			{
				CHAOS_IL2CPP_ABORT();
			}
		}
...
// Native AOT entry for SnapshotTestFixtures/TypeCheckHelper::CheckAndCast:System.Int32()
// Managed symbol: SnapshotTestFixtures_TypeCheckHelper_CheckAndCast
extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 chaos_entry_index)
{
    return SnapshotTestFixtures_TypeCheckHelper_CheckAndCast();
}
