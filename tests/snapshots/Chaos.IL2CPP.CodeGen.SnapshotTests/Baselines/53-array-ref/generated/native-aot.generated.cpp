...
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_System_Private_CoreLib_System_Object = static_cast<CHAOS_IL2CPP_INTPTR>(15228727185366376748ULL);inline TypeInfoHot chaos_type_info_System_Private_CoreLib_System_Reflection_Assembly = { nullptr, nullptr, 5474029880995115448ULL, 0u, 32 /* warm_delta */, 1 /* reference */, 1 };
...
static HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_ArrayRefHelper_RunArrayRef), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0u },  // ArrayRefHelper::RunArrayRef
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_ArrayRefHelper_RunArrayRef(void)
{
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(1);
	{
		...
		chaos_array->element_type_info = &chaos_type_info_System_Private_CoreLib_System_Object;
...
// Native AOT entry for SnapshotTestFixtures/ArrayRefHelper::RunArrayRef:System.Int32()
// Managed symbol: SnapshotTestFixtures_ArrayRefHelper_RunArrayRef
extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 chaos_entry_index)
{
    return SnapshotTestFixtures_ArrayRefHelper_RunArrayRef();
}
