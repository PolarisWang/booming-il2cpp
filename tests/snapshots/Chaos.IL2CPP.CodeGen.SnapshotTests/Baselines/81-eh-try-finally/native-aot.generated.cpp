...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhFinallyHelper::TryFinally_Only
};
