...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFaultHelper_TryFault), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhFaultHelper::TryFault
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFaultHelper_TryFault(CHAOS_IL2CPP_INT32 chaos_fn_arg_0)
{
	...
	CHAOS_EH_TRY
			...
			_s2 = chaos_args[0];
			_s3 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(static_cast<CHAOS_IL2CPP_INT32>(_s1), static_cast<CHAOS_IL2CPP_INT32>(_s2)));
			chaos_locals[0] = _s3;
	CHAOS_EH_CATCH_BEGIN
		_s4 = CHAOS_EH_EXCEPTION_OBJ;
