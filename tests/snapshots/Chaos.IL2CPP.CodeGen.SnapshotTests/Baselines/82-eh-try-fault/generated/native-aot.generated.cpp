...
chaos_label_2:
	chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(100);
chaos_label_3:
...
chaos_label_4:
	{
		...
		chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(chaos_left, chaos_right));
	}
chaos_label_5:
	chaos_locals[0] = chaos_eval_stack[--chaos_stack_top];
chaos_label_6:
