...
inline TypeInfo chaos_type_info_System_Private_CoreLib_System_Exception = { nullptr, 10972282733316558392ULL, nullptr, nullptr, 0, 0, 1 /* reference */ };
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhHelper_SafeDivide(void)
{
	...
	catch (const chaos_managed_exception& chaos_exception)
	{
		...
		if (!chaos_is_type_compatible(chaos_header->type_info, &chaos_type_info_System_Private_CoreLib_System_Exception))
		{
			throw;
		}
