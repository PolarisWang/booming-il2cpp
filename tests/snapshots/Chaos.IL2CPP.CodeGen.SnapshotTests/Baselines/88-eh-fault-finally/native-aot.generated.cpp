...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFaultFinallyHelper_FaultFinally), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // EhFaultFinallyHelper::FaultFinally
};
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFaultFinallyHelper_FaultFinally(CHAOS_IL2CPP_INT32 chaos_fn_arg_0)
{
	...
	CHAOS_EH_TRY_FINALLY
			...
			CHAOS_EH_TRY_FINALLY
					...
					_s4 = chaos_args[0];
					_s5 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosDiv(static_cast<CHAOS_IL2CPP_INT32>(_s3), static_cast<CHAOS_IL2CPP_INT32>(_s4)));
					chaos_locals[0] = _s5;
