...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_CpblkHelper_RunCpblk(void)
{
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(32);
	{
		...
		_s1 = reinterpret_cast<CHAOS_IL2CPP_INTPTR>(chaos_block);
	}
	chaos_locals[0] = _s1;
	_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(32);
	{
		const auto chaos_size = static_cast<CHAOS_IL2CPP_INTPTR>(_s2);
		if (chaos_size < 0)
		{
			CHAOS_IL2CPP_FAIL_FAST();
		}
		...
		_s3 = reinterpret_cast<CHAOS_IL2CPP_INTPTR>(chaos_block);
	}
	chaos_locals[1] = _s3;
	_s4 = chaos_locals[0];
	_s5 = chaos_locals[1];
	_s6 = static_cast<CHAOS_IL2CPP_INTPTR>(32);
	{
		const auto chaos_size = static_cast<CHAOS_IL2CPP_SIZE>(static_cast<CHAOS_IL2CPP_UINTPTR>(_s6));
		const auto chaos_source = _s5;
		const auto chaos_destination = _s4;
