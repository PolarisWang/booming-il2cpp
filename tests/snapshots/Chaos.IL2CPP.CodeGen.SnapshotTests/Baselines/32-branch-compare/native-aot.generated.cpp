		...
		if (chaos_left == chaos_right)
		{
			...
			_s3 = static_cast<CHAOS_IL2CPP_INTPTR>(3);
			{
				...
				if (chaos_left > chaos_right)
				{
					...
					{
						const auto chaos_right = static_cast<CHAOS_IL2CPP_INT32>(_s5);
						const auto chaos_left = static_cast<CHAOS_IL2CPP_INT32>(_s4);
						if (chaos_left < chaos_right)
						{
							_s6 = static_cast<CHAOS_IL2CPP_INTPTR>(3);
							_s7 = static_cast<CHAOS_IL2CPP_INTPTR>(4);
							{
								const auto chaos_right = static_cast<CHAOS_IL2CPP_INTPTR>(_s7);
								const auto chaos_left = static_cast<CHAOS_IL2CPP_INTPTR>(_s6);
								if (chaos_left != chaos_right)
								{
									_s8 = static_cast<CHAOS_IL2CPP_INTPTR>(1);
									return static_cast<CHAOS_IL2CPP_INT32>(_s8);
								}
								else
								{
