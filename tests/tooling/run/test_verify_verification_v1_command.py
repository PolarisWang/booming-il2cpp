    ...
    def test_verify_verification_v1_refreshes_and_returns_formal_output_paths(self) -> None:
        ...
        payload = {
            ...
            "artifacts": [
                ...
                "artifacts/testing-inventory/verification/latest/result-snapshot.json",
                "artifacts/testing-inventory/verification/master/result-master.json",
            ...
            "verificationData": {
                "latestResultPath": "artifacts/testing-inventory/verification/latest/result-snapshot.json",
                "masterResultPath": "artifacts/testing-inventory/verification/master/result-master.json",
                "reportSummaryPath": "docs/testing-inventory/verification/reports/completed/testing-inventory/summary.md",
                "codegenStubPaths": [
                    "subjects/FixtureSubject/verification/codegen-stubs/capability/7/31/native/stub-index.json",
                ],
            },
