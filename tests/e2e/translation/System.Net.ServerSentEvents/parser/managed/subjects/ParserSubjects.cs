...
public static partial class ParserSubjects
{
    ...
    {
        try { if ((long)((default(SseParser<byte>)!.ReconnectionInterval).Ticks) != (long)((default(SseParser<byte>)!.ReconnectionInterval).Ticks)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        // needs-manual — set_LastEventId with 1 params requires manual implementation: System.Net.ServerSentEvents/System.Net.ServerSentEvents.SseParser`1::set_LastEventId:System.Void(System.String)
    }
    ...
    {
        // needs-manual — set_ReconnectionInterval with 1 params requires manual implementation: System.Net.ServerSentEvents/System.Net.ServerSentEvents.SseParser`1::set_ReconnectionInterval:System.Void(System.TimeSpan)
    }
