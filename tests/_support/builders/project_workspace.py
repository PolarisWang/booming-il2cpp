...
def _write_owner_manifest(repo_root: Path, subject_id: str, payload: dict) -> None:
        ...
        subject_id,
        {
            ...
            "validation": {
                ...
                "unit": {
                    "kind": "unit",
                    "project": (
                        f"verification/catalog/owners/{subject_id}/support/unit/"
                        f"{subject_id}.Subject.UnitTests/{subject_id}.Subject.UnitTests.csproj"
                    ),
                    "framework": "xunit",
                    "defaultVariant": "CHECK",
                },
...
def write_hotupdate_subject_fixture(
    ...
    *,
    ...
    host_project = owner_root / "support" / "host" / f"{subject_id}.Host.csproj"
    ...
    solution_path = owner_root / "support" / "host" / f"{subject_id}.sln"
