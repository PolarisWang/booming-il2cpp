...
from tests.support import SOLUTION_CORE_PACK_BENCHMARKS_PROJECT_PATH, SOLUTION_CORE_PACK_BENCHMARKS_ROOT
...
ENTRY_SUBJECT_ID = "CoreRuntimeBenchmarks/AllocationBenchmarkEntry::RunWorkload()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "allocation-benchmark-native-aot"
...
class AllocationBenchmarkNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_avoids_unreachable_reflection_runtime_for_allocation_benchmark(self) -> None:
