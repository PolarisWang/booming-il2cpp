...
class SolutionCorePackGenericsDispatchCapabilitiesTests(unittest.TestCase):
    ...
    def test_loader_semantic_and_linker_lock_generics_dispatch_surface(self) -> None:
    ...
    def test_codegen_and_native_side_freeze_generics_dispatch_lowering_and_helper_surface(self) -> None:
