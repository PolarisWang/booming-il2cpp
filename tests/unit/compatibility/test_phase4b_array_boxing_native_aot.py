...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4b-array-boxing-native-aot"
...
class Phase4BArrayBoxingNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_driver_emits_native_aot_cpp_for_array_boxing_proof(self) -> None:
        ...
        for required_fragment in [
            ...
            "chaos_array->elements[static_cast<std::size_t>(chaos_index)]",
