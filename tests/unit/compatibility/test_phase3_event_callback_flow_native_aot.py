...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/EventCallbackFlowProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-event-callback-flow-native-aot"
...
class Phase3EventCallbackFlowNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_event_callback_flow(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/EventCallbackFlowHub::remove_Occurred(System.Action<System.Int32>)", generated_cpp)
