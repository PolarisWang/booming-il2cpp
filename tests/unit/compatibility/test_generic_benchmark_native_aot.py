...
ENTRY_SUBJECT_ID = "CoreRuntimeBenchmarks/GenericBenchmarkEntry::RunWorkload()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "generic-benchmark-native-aot"
...
class GenericBenchmarkNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_includes_object_equality_helper_for_dictionary_key_paths(self) -> None:
