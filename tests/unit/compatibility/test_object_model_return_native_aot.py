...
SOURCE_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ObjectModelAndDispatch" / "ObjectReturnProof.cs"
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/ObjectReturnProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "object-model-return-native-aot"
...
class ObjectModelReturnNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_object_return_proof_source_is_aot_friendly(self) -> None:
    ...
    def test_driver_emits_native_aot_cpp_for_object_return_proof(self) -> None:
        ...
        for required_fragment in [
            ...
            "new chaos_type_CoreRuntimeFeatures_ObjectReturnBox{}",
        ]:
