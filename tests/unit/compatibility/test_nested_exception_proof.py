...
SOURCE_PROGRAM_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ExceptionsAndControlFlow" / "NestedExceptionProof.cs"
...
class NestedExceptionProofTests(unittest.TestCase):
    def test_nested_exception_subject_tree_realizes_proof_slice(self) -> None:
    ...
    def test_codegen_surface_freezes_nested_exception_lowering_family(self) -> None:
        ...
        self.assertIn("NativeReferencePlanKind.NestedExceptionThrowCatchFinallyMinimal", planner_source)
        ...
        self.assertIn("NativeReferencePlanKind.NestedExceptionThrowCatchFinallyMinimal", emitter_source)
        self.assertIn("Stringify(NativeReferencePlanKind.NestedExceptionThrowCatchFinallyMinimal)", emitter_source)
