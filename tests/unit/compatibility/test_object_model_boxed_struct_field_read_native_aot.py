...
PROGRAM_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "Program.cs"
SOURCE_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ObjectModelAndDispatch" / "BoxedStructFieldReadProof.cs"
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/BoxedStructFieldReadProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "object-model-boxed-struct-field-read-native-aot"
...
class ObjectModelBoxedStructFieldReadNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_boxed_struct_field_read_proof_source_is_aot_friendly(self) -> None:
    ...
    def test_driver_emits_native_aot_cpp_for_boxed_struct_field_read_proof(self) -> None:
        ...
        for required_fragment in [
            ...
            "struct chaos_valuetype_CoreRuntimeFeatures_BoxedStructFieldReadState",
            "struct chaos_boxed_type_CoreRuntimeFeatures_BoxedStructFieldReadState",
            "chaos_resolve_managed_value_pointer<chaos_valuetype_CoreRuntimeFeatures_BoxedStructFieldReadState>",
            "chaos_eval_stack[chaos_stack_top++] = reinterpret_cast<std::intptr_t>(&chaos_boxed->value);",
            "auto* chaos_value = new chaos_valuetype_CoreRuntimeFeatures_BoxedStructFieldReadState{};",
            "*chaos_value = chaos_boxed->value;",
            "auto* chaos_destination = chaos_resolve_managed_value_pointer<chaos_valuetype_CoreRuntimeFeatures_BoxedStructFieldReadState>(chaos_eval_stack[--chaos_stack_top]);",
            "auto* chaos_source = reinterpret_cast<chaos_valuetype_CoreRuntimeFeatures_BoxedStructFieldReadState*>(chaos_eval_stack[--chaos_stack_top]);",
