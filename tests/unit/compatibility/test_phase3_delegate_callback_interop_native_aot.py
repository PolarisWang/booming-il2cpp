...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/DelegateCallbackInteropProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-delegate-callback-interop-native-aot"
...
class Phase3DelegateCallbackInteropNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_delegate_callback_interop_flow(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/DelegateCallbackInteropProofEntry::Run()", generated_cpp)
        self.assertIn("GetFunctionPointerForDelegate", generated_cpp)
