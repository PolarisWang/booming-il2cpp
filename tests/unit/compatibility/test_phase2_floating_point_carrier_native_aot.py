...
ENTRY_SUBJECT_ID = "CoreRuntimeBenchmarks/FloatingPointCarrierBenchmarkEntry::RunWorkload()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase2-floating-point-carrier-native-aot"
...
class Phase2FloatingPointCarrierNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_uses_precise_floating_point_abi_carriers(self) -> None:
        self._ensure_bundle_generated()
    ...
    def test_emit_native_aot_succeeds_for_floating_point_carrier_benchmark(self) -> None:
        ...
        self.assertIn("extern \"C\" float CoreRuntimeBenchmarks_FloatingPointCarrierBenchmarkMath_RoundTripSingle(float chaos_arg_0)", generated_cpp)
        self.assertIn("extern \"C\" double CoreRuntimeBenchmarks_FloatingPointCarrierBenchmarkMath_RoundTripDouble(double chaos_arg_0)", generated_cpp)
        self.assertIn("chaos_store_float32", generated_cpp)
        self.assertIn("chaos_store_float64", generated_cpp)
        self.assertIn("chaos_load_float32", generated_cpp)
        self.assertIn("chaos_load_float64", generated_cpp)
