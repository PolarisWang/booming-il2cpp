from tests.unit.compatibility.phase2_aot_core_ir_ldtoken_target_reference_test_support import *


class TestPhase2AotCoreIrLdtokenTargetReferenceSyntheticTokens(Phase2AotCoreIrLdtokenTargetReferenceTestSupport):
    def test_synthetic_field_and_method_ldtoken_get_target_reference(self) -> None:
        ...
        self.assertEqual(f"{SYNTHETIC_ASSEMBLY_NAME}/TokenHolder::Helper()", method_token["targetReference"]["subjectId"])
