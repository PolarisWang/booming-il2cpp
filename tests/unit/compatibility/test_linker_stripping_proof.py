...
SOURCE_PROGRAM_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ReflectionAndMetadata" / "LinkerStrippingProof.cs"
...
class LinkerStrippingProofTests(unittest.TestCase):
    @classmethod
    ...
    def test_linker_stripping_subject_tree_realizes_proof_slice(self) -> None:
