...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase2-int64-carrier-native-aot"
...
class Phase2Int64CarrierNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_uses_precise_int64_abi_carrier(self) -> None:
        self._ensure_bundle_generated()
    ...
    def test_emit_native_aot_succeeds_for_int64_carrier_benchmark(self) -> None:
        ...
        self.assertIn("chaos_load_int64", generated_cpp)
