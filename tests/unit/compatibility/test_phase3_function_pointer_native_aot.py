...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/FunctionPointerProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-function-pointer-native-aot"
...
class Phase3FunctionPointerNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_ldftn_and_calli_function_pointer_flow(self) -> None:
