...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "required-instantiation-collection-interface-native-aot"
...
class RequiredInstantiationCollectionInterfaceNativeAotTests(unittest.TestCase):
    @classmethod
