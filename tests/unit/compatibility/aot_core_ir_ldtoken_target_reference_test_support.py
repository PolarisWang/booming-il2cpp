...
SYNTHETIC_MAIN_SUBJECT_ID = f"{SYNTHETIC_ASSEMBLY_NAME}/Program::Main:System.Void()"
...
class AotCoreIrLdtokenTargetReferenceTestSupport(unittest.TestCase):
    @classmethod
...
const string helperMethodSubjectId = "SyntheticLdtokenHarness/TokenHolder::Helper:System.Void()";
const string mainMethodSubjectId = "SyntheticLdtokenHarness/Program::Main:System.Void()";
