...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/LoaderContractProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-loader-contract-native-aot"
...
class Phase3LoaderContractNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_loader_contract_proof(self) -> None:
