...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/GenericCollectionProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-generic-collection-proof-native-aot"
...
class Phase3GenericCollectionProofNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_generic_collection_proof(self) -> None:
