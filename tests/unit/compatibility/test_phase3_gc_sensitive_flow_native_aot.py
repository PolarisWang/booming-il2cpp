...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/GcSensitiveFlowProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-gc-sensitive-flow-native-aot"
...
class Phase3GcSensitiveFlowNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_gc_sensitive_flow(self) -> None:
        ...
        self.assertIn(
            "// Managed method: CoreRuntimeFeatures/GcSensitiveFlowProofEntry::AllocateProbe()",
            generated_cpp,
        )
