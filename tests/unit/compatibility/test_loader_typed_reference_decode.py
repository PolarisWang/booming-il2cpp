...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "loader-typed-reference-decode"
ASSEMBLY_NAME = "TypedReferenceDecodeRepro"
HELPER_SUBJECT_ID = f"{ASSEMBLY_NAME}/TypedReferenceHelper::CaptureRoundTrip:System.Int32()"
...
class LoaderTypedReferenceDecodeTests(unittest.TestCase):
    @classmethod
