...
SOURCE_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ObjectModelAndDispatch" / "DispatchProof.cs"
...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "dispatch-virtual-native-aot"
...
class DispatchVirtualNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_dispatch_source_is_native_aot_friendly(self) -> None:
    ...
    def test_native_aot_planner_exposes_dispatch_entrypoints(self) -> None:
    ...
    def test_driver_emits_native_aot_cpp_for_dispatch_proof(self) -> None:
