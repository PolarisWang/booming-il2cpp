...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/DelegateChainProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "multicast-delegate-native-aot"
...
class MulticastDelegateNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_multicast_delegate_chain(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/DelegateChainProofEntry::Run()", generated_cpp)
        self.assertIn(
            "chaos_external_runtime_System_Private_CoreLib_System_Delegate__Combine_System_Delegate_System_Delegate_",
            generated_cpp,
        )
        self.assertIn(
            "chaos_external_runtime_System_Private_CoreLib_System_Delegate__Remove_System_Delegate_System_Delegate_",
            generated_cpp,
        )
        self.assertIn("CHAOS_IL2CPP_INTPTR chaos_delegate_invocation_list = 0;", generated_cpp)
        self.assertIn("CHAOS_IL2CPP_INTPTR chaos_delegate_invocation_count = 0;", generated_cpp)
