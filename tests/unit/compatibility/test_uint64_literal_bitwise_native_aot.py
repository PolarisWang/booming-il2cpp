...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "uint64-literal-bitwise-native-aot"
...
class UInt64LiteralBitwiseNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_uint64_literal_bitwise_benchmark(self) -> None:
        ...
        self.assertIn(
            "extern \"C\" CHAOS_IL2CPP_UINT64 CoreRuntimeBenchmarks_UInt64BitwiseBenchmarkMath_LoadLiteralUInt64(void)",
            generated_cpp,
        )
