...
SOURCE_PATH = (
    ...
    / "BoxedStructFieldReadProof.cs"
)
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/BoxedStructFieldReadProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4b-boxed-struct-field-read-native-aot"
...
class Phase4BBoxedStructFieldReadNativeAotTests(unittest.TestCase):
    @classmethod
