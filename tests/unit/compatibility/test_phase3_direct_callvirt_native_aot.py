...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/DirectCallVirtProofEntry::Run()"
DIRECT_CALLEE_SUBJECT_ID = "CoreRuntimeFeatures/DirectCallVirtCarrier::ReadValue()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-direct-callvirt-native-aot"
...
class Phase3DirectCallVirtNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_marks_direct_instance_callvirt_as_direct_dispatch(self) -> None:
        self._ensure_bundle_generated()
    ...
    def test_emit_native_aot_succeeds_for_direct_callvirt_owner_proof(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/DirectCallVirtProofEntry::Run()", generated_cpp)
        self.assertIn("// Managed method: CoreRuntimeFeatures/DirectCallVirtCarrier::ReadValue()", generated_cpp)
