...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-aot-closure-validation-owner-native-aot"
...
class Phase3AotClosureValidationOwnerNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_real_owner_aot_closure_validation_proof_emits_native_aot(self) -> None:
