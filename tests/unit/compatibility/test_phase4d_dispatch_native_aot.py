...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4d-dispatch-native-aot"
...
class Phase4DDispatchNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_dispatch_source_is_phase4d_native_friendly(self) -> None:
    ...
    def test_native_aot_planner_exposes_phase4d_dispatch_entrypoints(self) -> None:
