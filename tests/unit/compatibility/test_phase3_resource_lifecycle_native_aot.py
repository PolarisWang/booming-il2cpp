...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/ResourceLifecycleProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-resource-lifecycle-native-aot"
...
class Phase3ResourceLifecycleNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_resource_lifecycle_proof(self) -> None:
