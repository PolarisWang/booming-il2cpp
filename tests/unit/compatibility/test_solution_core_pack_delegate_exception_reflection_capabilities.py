...
SOURCE_ROOT = SOLUTION_CORE_PACK_PROOFS_ROOT
...
class SolutionCorePackDelegateExceptionReflectionCapabilitiesTests(unittest.TestCase):
    def test_solution_core_pack_source_tree_realizes_capability_proof_slices(self) -> None:
    ...
    def test_contract_loader_semantic_and_linker_lock_delegate_exception_reflection_surface(self) -> None:
    ...
    def test_codegen_and_native_side_freeze_delegate_exception_reflection_lowering_and_helper_surface(self) -> None:
