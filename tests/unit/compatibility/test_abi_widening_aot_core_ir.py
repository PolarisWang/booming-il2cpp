...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "abi-widening-aot-core-ir"
...
class AbiWideningAotCoreIrTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_marks_value_type_parameter_and_return_as_widened_abi_carriers(self) -> None:
        ...
        echo_method = find_method_by_subject_id(artifact["methods"], ECHO_SUBJECT_ID)
        ...
        create_method = find_method_by_subject_id(artifact["methods"], CREATE_SUBJECT_ID)
