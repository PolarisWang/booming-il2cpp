...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/LinkerPreserveContractProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-linker-preserve-contract-native-aot"
...
class Phase3LinkerPreserveContractNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_linker_preserve_contract_proof(self) -> None:
