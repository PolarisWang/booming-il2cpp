...
SOURCE_PATH = (
    ...
    / "CastTypeCheckProof.cs"
)
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/CastTypeCheckProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4b-cast-type-check-native-aot"
...
class Phase4BCastTypeCheckNativeAotTests(unittest.TestCase):
    @classmethod
