...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4b-array-covariance-native-aot"
...
class Phase4BArrayCovarianceNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_driver_emits_native_aot_cpp_for_array_covariance_proof(self) -> None:
        ...
        for required_fragment in [
            "std::uint8_t element_type_shape = 0;",
            "std::intptr_t element_type_id = 0;",
