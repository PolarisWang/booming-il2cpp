...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4d-exception-native-aot"
...
class Phase4DExceptionNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_exception_source_retains_minimal_phase4d_catch_shape(self) -> None:
