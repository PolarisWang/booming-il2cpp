...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-string-composite-helpers-native-aot"
...
class Phase3StringCompositeHelpersNativeAotTests(unittest.TestCase):
    @classmethod
