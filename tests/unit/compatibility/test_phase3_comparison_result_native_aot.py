...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-comparison-result-native-aot"
GENERATED_CPP_RELATIVE_PATH = Path("generated") / "native-aot.generated.cpp"
SYNTHETIC_ASSEMBLY_NAME = "ComparisonResultNativeAotHarness"
...
class Phase3ComparisonResultNativeAotTests(unittest.TestCase):
    @classmethod
...
internal static class Program
{
    private static int Main()
    {
        ...
        return (same ? 1 : 0) + (greater ? 2 : 0) + (less ? 4 : 0);
    }
}
""".strip()
            + "\n",
    ...
    def test_emit_native_aot_succeeds_for_ceq_cgt_clt_result_ops(self) -> None:
        ...
        self.assertIn("// Managed method: ComparisonResultNativeAotHarness/Program::Main()", generated_cpp)
        self.assertIn("chaos_left == chaos_right ? 1 : 0", generated_cpp)
        self.assertIn("chaos_left > chaos_right ? 1 : 0", generated_cpp)
        self.assertIn("chaos_left < chaos_right ? 1 : 0", generated_cpp)
