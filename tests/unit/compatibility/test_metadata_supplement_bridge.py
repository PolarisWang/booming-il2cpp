...
TEST_TMP_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "metadata-supplement-bridge"
...
class MetadataSupplementBridgeTests(unittest.TestCase):
    maxDiff = None
    ...
    def test_convert_writes_supplemental_metadata_template_and_closure_manifest_reference(self) -> None:
        ...
        self.assertIn("GoldenSimpleLib.App/Program::Main:System.Int32()", registered_method_subject_ids)
        self.assertIn("GoldenSimpleLib.Library/Greeter::BuildMessage:System.String()", registered_method_subject_ids)
