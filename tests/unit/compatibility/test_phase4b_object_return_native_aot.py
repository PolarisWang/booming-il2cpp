...
SOURCE_PATH = (
    ...
    / "ObjectReturnProof.cs"
)
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/ObjectReturnProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4b-object-return-native-aot"
...
class Phase4BObjectReturnNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_object_return_proof_source_is_aot_friendly(self) -> None:
        ...
        self.assertIn("ObjectReturnProofEntry.Run,", program_text)
