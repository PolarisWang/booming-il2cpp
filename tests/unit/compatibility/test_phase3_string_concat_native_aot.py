...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-string-concat-native-aot"
GENERATED_CPP_RELATIVE_PATH = Path("generated") / "native-aot.generated.cpp"
SYNTHETIC_ASSEMBLY_NAME = "StringConcatNativeAotHarness"
...
class Phase3StringConcatNativeAotTests(unittest.TestCase):
    @classmethod
...
""".strip()
    ...
    def test_emit_native_aot_succeeds_for_pair_string_concat(self) -> None:
        ...
        self.assertIn("// Managed method: StringConcatNativeAotHarness/Program::Main()", generated_cpp)
        self.assertIn(
            "chaos_external_runtime_System_Private_CoreLib_System_String__Concat_System_String_System_String_",
            generated_cpp,
        )
        self.assertIn("chaos_reflection_concat_string_pair_values", generated_cpp)
