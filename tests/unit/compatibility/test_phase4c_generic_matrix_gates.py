...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase4c-generic-matrix-gates"
...
class Phase4CGenericMatrixGateTests(unittest.TestCase):
    @classmethod
    ...
    def test_driver_emits_generic_capability_matrix_sidecar_with_canonical_hotupdate_names(self) -> None:
        ...
        self.assertEqual("SolutionCorePack", artifact["ownerSubjectId"])
