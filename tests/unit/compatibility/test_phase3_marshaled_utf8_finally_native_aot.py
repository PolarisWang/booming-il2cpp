...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/MarshalingProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-marshaled-utf8-finally-native-aot"
...
class Phase3MarshaledUtf8FinallyNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_marshaled_utf8_finally_proof(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/MarshalingProofEntry::Run()", generated_cpp)
