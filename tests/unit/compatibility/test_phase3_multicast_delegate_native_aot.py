...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-multicast-delegate-native-aot"
...
class Phase3MulticastDelegateNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_multicast_delegate_chain(self) -> None:
        ...
        self.assertIn("std::intptr_t chaos_delegate_invocation_list = 0;", generated_cpp)
        self.assertIn("std::intptr_t chaos_delegate_invocation_count = 0;", generated_cpp)
