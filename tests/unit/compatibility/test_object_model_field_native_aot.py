...
SOURCE_PATH = SOLUTION_CORE_PACK_PROOFS_ROOT / "ObjectModelAndDispatch" / "ObjectFieldProof.cs"
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/ObjectFieldProofEntry::Run()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "object-model-field-native-aot"
...
class ObjectModelFieldNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_object_field_proof_source_exists_and_is_wired_for_solution_core_pack(self) -> None:
    ...
    def test_driver_emits_native_aot_cpp_for_object_field_proof(self) -> None:
        ...
        for required_fragment in [
            "new chaos_type_CoreRuntimeFeatures_ObjectFieldBox{}",
            "field_CoreRuntimeFeatures_ObjectFieldBox__Value",
            "chaos_static_CoreRuntimeFeatures_ObjectFieldState__Counter",
            "reinterpret_cast<CHAOS_IL2CPP_INTPTR>(",
            "reinterpret_cast<chaos_type_CoreRuntimeFeatures_ObjectFieldBox*>",
        ]:
