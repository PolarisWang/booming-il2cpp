...
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase1-loader-vararg-decode"
ASSEMBLY_NAME = "VarArgDecodeRepro"
HELPER_SUBJECT_ID = f"{ASSEMBLY_NAME}/Program::Helper(System.Int32,System.Int32,System.Int32)"
HELPER_DEFINITION_SUBJECT_ID = f"{ASSEMBLY_NAME}/Program::Helper(System.Int32)"
...
class Phase1LoaderVarArgDecodeTests(unittest.TestCase):
    @classmethod
