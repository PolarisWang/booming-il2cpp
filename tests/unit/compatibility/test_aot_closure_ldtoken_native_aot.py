...
OWNER_SUBJECT_ID = "CoreRuntimeFeatures/AotClosureManifest::BuildRequiredClosure:AotClosureRecord[]()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "aot-closure-ldtoken-native-aot"
...
class AotClosureLdtokenNativeAotTests(unittest.TestCase):
    @classmethod
