...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "generic-sharing-boundary-native-aot"
...
class GenericSharingBoundaryNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_generic_sharing_boundary_proof(self) -> None:
