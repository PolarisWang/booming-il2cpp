...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-required-instantiation-collection-interface-native-aot"
...
class Phase3RequiredInstantiationCollectionInterfaceNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_required_instantiation_interface_bridge(self) -> None:
