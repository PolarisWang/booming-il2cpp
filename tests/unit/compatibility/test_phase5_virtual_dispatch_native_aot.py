...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase5-virtual-dispatch-native-aot"
...
class Phase5VirtualDispatchNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_string_and_utf8_marshaling_benchmark(self) -> None:
        ...
        self.assertIn("chaos_external_runtime_System_Runtime_InteropServices_Marshal__StringToCoTaskMemUTF8_System_String_", generated_cpp)
        self.assertIn("chaos_external_runtime_System_Runtime_InteropServices_Marshal__FreeCoTaskMem_System_IntPtr_", generated_cpp)
