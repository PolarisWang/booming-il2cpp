...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/DelegateProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-instance-delegate-method-group-native-aot"
...
class Phase3InstanceDelegateMethodGroupNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_instance_method_group_delegate(self) -> None:
        ...
        self.assertIn("// Managed method: CoreRuntimeFeatures/DelegateProofEntry::Run()", generated_cpp)
        self.assertIn("// Managed method: CoreRuntimeFeatures/DelegateBanner::BuildMessage(System.String)", generated_cpp)
        self.assertIn("CoreRuntimeFeatures_DelegateBanner_BuildMessage", generated_cpp)
