...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase2-uint64-interop-carrier-native-aot"
...
class Phase2UInt64InteropCarrierNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_emit_native_aot_succeeds_for_uint64_interop_carrier_benchmark(self) -> None:
        ...
        self.assertIn(
            "extern \"C\" std::uint64_t CoreRuntimeBenchmarks_NativeCallInteropBenchmarkMethods_RoundTripUInt64(std::uint64_t chaos_arg_0)",
            generated_cpp,
        )
