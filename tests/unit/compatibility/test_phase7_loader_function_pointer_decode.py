...
PROOF_ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/FunctionPointerProofEntry::Run()"
BENCHMARK_ENTRY_SUBJECT_ID = "CoreRuntimeBenchmarks/FunctionPointerBenchmarkEntry::RunWorkload()"
TEST_OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase7-loader-function-pointer-decode"
...
class Phase7LoaderFunctionPointerDecodeTests(unittest.TestCase):
    @classmethod
