...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/SpanAndMemoryProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-span-memory-native-aot"
...
class Phase3SpanMemoryNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_freezes_field_handle_and_span_memory_runtime_family(self) -> None:
        self._ensure_bundle_generated()
        ...
        field_tokens = [
            ...
            if instruction["op"] == "ldtoken" and instruction["reference"]["subjectKind"] == "field"
        ]
        self.assertEqual(1, len(field_tokens))
        self.assertEqual("System.RuntimeFieldHandle", field_tokens[0]["resultType"])
        ...
        self.assertTrue(
            {
                ...
                "System.Memory/System.MemoryExtensions::AsSpan<System.Int32>(System.Int32[],System.Int32,System.Int32)",
                "System.Memory/System.MemoryExtensions::AsMemory<System.Int32>(System.Int32[])",
                "System.Private.CoreLib/System.Span<System.Int32>::get_Item(System.Int32)",
                "System.Private.CoreLib/System.Memory<System.Int32>::get_Span()",
            }.issubset(runtime_calls),
            msg=f"missing expected span/memory calls: {sorted(runtime_calls)}",
        )

    def test_emit_native_aot_succeeds_for_span_memory_owner_proof(self) -> None:
        ...
        for required_fragment in [
            "// Managed method: CoreRuntimeFeatures/SpanAndMemoryProofEntry::Run()",
            "chaos_span_runtime_entry",
            "chaos_memory_runtime_entry",
