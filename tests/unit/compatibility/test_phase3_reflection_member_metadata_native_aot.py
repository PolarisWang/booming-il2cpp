...
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-reflection-member-metadata-native-aot"
...
class Phase3ReflectionMemberMetadataNativeAotTests(unittest.TestCase):
    @classmethod
