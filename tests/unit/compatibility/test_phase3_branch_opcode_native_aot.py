...
ENTRY_SUBJECT_ID = "CoreRuntimeFeatures/BranchOpsProofEntry::Run()"
OUTPUT_ROOT = REPO_ROOT / "artifacts" / ".tmp-tests" / "phase3-branch-opcode-native-aot"
...
class Phase3BranchOpcodeNativeAotTests(unittest.TestCase):
    @classmethod
    ...
    def test_aot_core_ir_retains_branch_owner_surface_without_ldstr(self) -> None:
        self._ensure_bundle_generated()
