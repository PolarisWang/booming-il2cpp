...
MethodTable chaos_mt_System_Private_CoreLib_System_Int32 = {nullptr, nullptr, 11009693519287992193ULL, 0u, 32, 2, 0, nullptr, nullptr, 0, 0, 0, 0};
...
MethodTable chaos_mt_SnapshotTestFixtures_BoxInterfaceArrayDemo = {nullptr, nullptr, 3943773546219340206ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_BoxInterfaceArrayDemo = static_cast<CHAOS_IL2CPP_UINT64>(3943773546219340206ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(3943773546219340206ULL, sizeof(chaos_type_SnapshotTestFixtures_BoxInterfaceArrayDemo), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_BoxInterfaceArrayDemo), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_BoxInterfaceArrayDemo) + sizeof(chaos_mt_SnapshotTestFixtures_BoxInterfaceArrayDemo));
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_Int32(void) CHAOS_STUB_NOEXCEPT
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_Object(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_16547187 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: System.Private.CoreLib/System.Object — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_16547187;



	return ChaosExternalRuntimeFallback("System.Private.CoreLib/System.Object");
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "DemoBoxStore", 0x00000002u, 0u },  // BoxInterfaceArrayDemo
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_BoxInterfaceArrayDemo_DemoBoxStore), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // BoxInterfaceArrayDemo::DemoBoxStore
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_BoxInterfaceArrayDemo_DemoBoxStore ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_BoxInterfaceArrayDemo_DemoBoxStore */
...
extern const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 44u;
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_BoxInterfaceArrayDemo[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/BoxInterfaceArrayDemo::DemoBoxStore:System.Int32()", "DemoBoxStore", "System.Int32", 0, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/BoxInterfaceArrayDemo", "SnapshotTestFixtures/BoxInterfaceArrayDemo", "", "BoxInterfaceArrayDemo", "BoxInterfaceArrayDemo", nullptr, nullptr, 0u, nullptr, 0u,
...

{
	...
	_s0 = ChaosArrayNew1D(&chaos_type_info_managed_array.hot, chaos_mt_System_Private_CoreLib_System_Object.AsTypeInfoHot(), 1, _s0);
...

	{
		...
		BgcSatbPreWriteBarrier(reinterpret_cast<void**>(chaos_array_get_elements(chaos_array) + static_cast<CHAOS_IL2CPP_SIZE>(chaos_index)));
		...
		chaos_gc_dirty_card_dst_ref(chaos_array, reinterpret_cast<const void*>(chaos_value));
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_BoxInterfaceArrayDemo_DemoBoxStore(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_BoxInterfaceArrayDemo_DemoBoxStore(entryIndex);
