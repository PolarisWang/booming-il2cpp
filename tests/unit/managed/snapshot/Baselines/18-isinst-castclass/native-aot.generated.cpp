...
MethodTable chaos_mt_SnapshotTestFixtures_MarkedClass = {nullptr, nullptr, 6112983511997078372ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_MarkedClass = static_cast<CHAOS_IL2CPP_UINT64>(6112983511997078372ULL);



MethodTable chaos_mt_SnapshotTestFixtures_TypeCheckHelper = {nullptr, nullptr, 417436481281857076ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_TypeCheckHelper = static_cast<CHAOS_IL2CPP_UINT64>(417436481281857076ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(417436481281857076ULL, sizeof(chaos_type_SnapshotTestFixtures_TypeCheckHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_MarkedClass), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_MarkedClass) + sizeof(chaos_mt_SnapshotTestFixtures_MarkedClass));



	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_TypeCheckHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_TypeCheckHelper) + sizeof(chaos_mt_SnapshotTestFixtures_TypeCheckHelper));
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_MarkedClass(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_5332896 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/MarkedClass — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_5332896;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/MarkedClass");
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_MarkedClass___ctor_System_Void_System_Int32_(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_15111050 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/MarkedClass::.ctor:System.Void(System.Int32) — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_15111050;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/MarkedClass::.ctor:System.Void(System.Int32)");
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "CheckAndCast", 0x00000002u, 0u },  // TypeCheckHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_TypeCheckHelper_CheckAndCast), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative | HotpatchEncodeArgCount(0) },  // TypeCheckHelper::CheckAndCast
...
extern "C" void* kChaosExternalRuntimeFnTable[1] = {
	...
	reinterpret_cast<void*>(&chaos_external_runtime_SnapshotTestFixtures_MarkedClass___ctor_System_Void_System_Int32_),
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_TypeCheckHelper_CheckAndCast ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_TypeCheckHelper_CheckAndCast */
...
extern const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 36u;
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_TypeCheckHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/TypeCheckHelper::CheckAndCast:System.Int32()", "CheckAndCast", "System.Int32", 0, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/TypeCheckHelper", "SnapshotTestFixtures/TypeCheckHelper", "", "TypeCheckHelper", "TypeCheckHelper", nullptr, nullptr, 0u, nullptr, 0u,
...

{
...

	{
		...
		chaos_object->header.type_info = chaos_mt_SnapshotTestFixtures_MarkedClass.AsTypeInfoHot();
...

	{
...

		{
			...
			chaos_matches = chaos_is_type_compatible(chaos_object_get_type_info(chaos_header), chaos_mt_SnapshotTestFixtures_MarkedClass.AsTypeInfoHot());
...

	{
...

		{
			...
			if (!chaos_is_type_compatible(chaos_object_get_type_info(chaos_header), chaos_mt_SnapshotTestFixtures_MarkedClass.AsTypeInfoHot()))
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_TypeCheckHelper_CheckAndCast(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_TypeCheckHelper_CheckAndCast(entryIndex);
