...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_CalliHelper_RunCalli(CHAOS_IL2CPP_INT32 chaos_fn_arg_0);
...
MethodTable chaos_mt_SnapshotTestFixtures_CalliHelper = {nullptr, nullptr, 12914693014400469131ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_CalliHelper = static_cast<CHAOS_IL2CPP_UINT64>(12914693014400469131ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(12914693014400469131ULL, sizeof(chaos_type_SnapshotTestFixtures_CalliHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_CalliHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_CalliHelper) + sizeof(chaos_mt_SnapshotTestFixtures_CalliHelper));
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_CalliHelper__run_calli_target(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_2296962 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/CalliHelper::run-calli-target — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_2296962;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/CalliHelper::run-calli-target");
...
static constexpr struct {
...

	{
		...
		{ 1u, 1u },  // SnapshotTestFixtures_CalliHelper_RunCalli
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[2] = {
	...
	{ "RunCalli", 0x00000002u, 1u },  // CalliHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[2] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_CalliHelper_RunCalli), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchKeepNative | HotpatchEncodeArgCount(1) },  // CalliHelper::RunCalli
...
extern "C" const char* kChaosExternalRuntimeSubjects[1] = {
	...
	"SnapshotTestFixtures/CalliHelper::run-calli-target",
...
extern "C" void* kChaosExternalRuntimeFnTable[1] = {
	...
	reinterpret_cast<void*>(&chaos_external_runtime_SnapshotTestFixtures_CalliHelper__run_calli_target),
...
static void (*kMethodTable[2])() = {
	...
	reinterpret_cast<void(*)()>(&SnapshotTestFixtures_CalliHelper_RunCalli),
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_CalliHelper_RunCalli ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_CalliHelper_RunCalli */
	...
	.entry0 = {
		...
		/* code_address */ reinterpret_cast<const void*>(&SnapshotTestFixtures_CalliHelper_RunCalli),
...
extern const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 56u;
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_CalliHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/CalliHelper::RunCalli:System.Int32(System.Int32)", "RunCalli", "System.Int32", 1, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[2] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/CalliHelper", "SnapshotTestFixtures/CalliHelper", "", "CalliHelper", "CalliHelper", nullptr, nullptr, 0u, nullptr, 0u,
...

{
...

	{
		...
		const auto chaos_result = reinterpret_cast<CHAOS_IL2CPP_INT32(*)(CHAOS_IL2CPP_INT32)>(chaos_fnptr)(static_cast<CHAOS_IL2CPP_INT32>(chaos_arg_0));
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_CalliHelper_RunCalli(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_CalliHelper_RunCalli(entryIndex);
