...
MethodTable chaos_mt_SnapshotTestFixtures_LdindWideHelper = {nullptr, nullptr, 1103702072608282638ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_LdindWideHelper = static_cast<CHAOS_IL2CPP_UINT64>(1103702072608282638ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(1103702072608282638ULL, sizeof(chaos_type_SnapshotTestFixtures_LdindWideHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_LdindWideHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_LdindWideHelper) + sizeof(chaos_mt_SnapshotTestFixtures_LdindWideHelper));
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "RunLdindWide", 0x00000002u, 0u },  // LdindWideHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_LdindWideHelper_RunLdindWide), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // LdindWideHelper::RunLdindWide
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_LdindWideHelper_RunLdindWide ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_LdindWideHelper_RunLdindWide */
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_LdindWideHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/LdindWideHelper::RunLdindWide:System.Int32()", "RunLdindWide", "System.Int32", 0, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/LdindWideHelper", "SnapshotTestFixtures/LdindWideHelper", "", "LdindWideHelper", "LdindWideHelper", nullptr, nullptr, 0u, nullptr, 0u,
...

{
...

	{
		...
		const auto chaos_value = chaos_load_indirect<CHAOS_IL2CPP_INT16>(chaos_address);
...

	{
		...
		const auto chaos_value = chaos_load_indirect<CHAOS_IL2CPP_FLOAT32>(chaos_address);


		_s0 = ChaosStoreFloat32(chaos_value);
...

	{
		...
		const auto chaos_value = chaos_load_indirect<CHAOS_IL2CPP_FLOAT64>(chaos_address);


		_s0 = ChaosStoreFloat64(chaos_value);
...

	{
		...
		const auto chaos_value = chaos_load_indirect<CHAOS_IL2CPP_INTPTR>(chaos_address);
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_LdindWideHelper_RunLdindWide(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_LdindWideHelper_RunLdindWide(entryIndex);
