...
MethodTable chaos_mt_SnapshotTestFixtures_HasInstanceFields = {nullptr, chaos_vtable_SnapshotTestFixtures_HasInstanceFields, 17812473439196761566ULL, 1u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_HasInstanceFields = static_cast<CHAOS_IL2CPP_UINT64>(17812473439196761566ULL);
...
extern const ::chaos::il2cpp::vtable_registry::VTableSlot kSlots_SnapshotTestFixtures_HasInstanceFields[] =
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_HasInstanceFields__Value(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_16718193 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/HasInstanceFields::Value — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_16718193;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/HasInstanceFields::Value");
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[2] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_HasInstanceFields__ctor), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(1) },  // HasInstanceFields::.ctor


	{ reinterpret_cast<void*>(&SnapshotTestFixtures_InstanceFieldHelper_CreateAndUseFields), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // InstanceFieldHelper::CreateAndUseFields
...
extern "C" void* kChaosExternalRuntimeFnTable[1] = {
	...
	reinterpret_cast<void*>(&chaos_external_runtime_SnapshotTestFixtures_HasInstanceFields__Value),
...

{
...

	{
		...
		chaos_type_SnapshotTestFixtures_HasInstanceFields __chaos_stack_obj{};


		auto* chaos_object = &__chaos_stack_obj;


		tls_alloc_fast_bytes += sizeof(chaos_type_SnapshotTestFixtures_HasInstanceFields);
...

	{
		...
		chaos_gc_dirty_card_dst_ref(chaos_object, reinterpret_cast<const void*>(chaos_value));
