...
MethodTable chaos_mt_SnapshotTestFixtures_StelemAllHelper = {nullptr, nullptr, 8536855035855580287ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_StelemAllHelper = static_cast<CHAOS_IL2CPP_UINT64>(8536855035855580287ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(8536855035855580287ULL, sizeof(chaos_type_SnapshotTestFixtures_StelemAllHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_StelemAllHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_StelemAllHelper) + sizeof(chaos_mt_SnapshotTestFixtures_StelemAllHelper));
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_StelemAllHelper_TestAllElems), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // StelemAllHelper::TestAllElems
...
extern const CHAOS_IL2CPP_UINT32 kChaosGcSlotMapsSize = 144u;
...

{
...

	{
		...
		*reinterpret_cast<CHAOS_IL2CPP_INT16*>(chaos_array_get_elements(chaos_array) + static_cast<CHAOS_IL2CPP_SIZE>(chaos_index)) = static_cast<CHAOS_IL2CPP_INT16>(chaos_value);
