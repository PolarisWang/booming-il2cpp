...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only(CHAOS_IL2CPP_INT32 chaos_fn_arg_0);
...
MethodTable chaos_mt_SnapshotTestFixtures_EhFinallyHelper = {nullptr, nullptr, 11315518308839701116ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_EhFinallyHelper = static_cast<CHAOS_IL2CPP_UINT64>(11315518308839701116ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(11315518308839701116ULL, sizeof(chaos_type_SnapshotTestFixtures_EhFinallyHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_EhFinallyHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_EhFinallyHelper) + sizeof(chaos_mt_SnapshotTestFixtures_EhFinallyHelper));
...
static constexpr struct {
...

	{
		...
		{ 1u, 1u },  // SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "TryFinally_Only", 0x00000002u, 1u },  // EhFinallyHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(1) },  // EhFinallyHelper::TryFinally_Only
...
static void (*kMethodTable[1])() = {
	...
	reinterpret_cast<void(*)()>(&SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only),
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only */
	...
	.entry0 = {
		...
		/* code_address */ reinterpret_cast<const void*>(&SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only),
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_EhFinallyHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/EhFinallyHelper::TryFinally_Only:System.Int32(System.Int32)", "TryFinally_Only", "System.Int32", 1, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/EhFinallyHelper", "SnapshotTestFixtures/EhFinallyHelper", "", "EhFinallyHelper", "EhFinallyHelper", nullptr, nullptr, 0u, nullptr, 0u,
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_EhFinallyHelper_TryFinally_Only(entryIndex);
