...
MethodTable chaos_mt_SnapshotTestFixtures_StaticFieldWriteHelper = {nullptr, nullptr, 7187250757378180401ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_StaticFieldWriteHelper = static_cast<CHAOS_IL2CPP_UINT64>(7187250757378180401ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_StaticFieldWriteHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_StaticFieldWriteHelper) + sizeof(chaos_mt_SnapshotTestFixtures_StaticFieldWriteHelper));
...
CHAOS_IL2CPP_INTPTR chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___readTarget = 0;



CHAOS_IL2CPP_INTPTR chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget = 0;
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_StaticFieldWriteHelper___readTarget(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_14833489 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/StaticFieldWriteHelper::_readTarget — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_14833489;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/StaticFieldWriteHelper::_readTarget");
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget(void) CHAOS_STUB_NOEXCEPT
...

{
	...
	static const bool chaos_warned_12551430 = []() {
		...
		CHAOS_IL2CPP_LOG_WARN("ExternalRuntimeFallback",
			...
			"catch-all helper invoked: SnapshotTestFixtures/StaticFieldWriteHelper::_writeTarget — no native body; delegates to Phase 1/2, else returns 0");
	...
	(void)chaos_warned_12551430;



	return ChaosExternalRuntimeFallback("SnapshotTestFixtures/StaticFieldWriteHelper::_writeTarget");
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "WriteAndRead", 0x00000002u, 0u },  // StaticFieldWriteHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_StaticFieldWriteHelper_WriteAndRead), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // StaticFieldWriteHelper::WriteAndRead
...
extern "C" void* kChaosExternalRuntimeFnTable[2] = {
	...
	reinterpret_cast<void*>(&chaos_external_runtime_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget),


	reinterpret_cast<void*>(&chaos_external_runtime_SnapshotTestFixtures_StaticFieldWriteHelper___readTarget),
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_StaticFieldWriteHelper_WriteAndRead ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_StaticFieldWriteHelper_WriteAndRead */
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_StaticFieldWriteHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/StaticFieldWriteHelper::WriteAndRead:System.Int32()", "WriteAndRead", "System.Int32", 0, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/StaticFieldWriteHelper", "SnapshotTestFixtures/StaticFieldWriteHelper", "", "StaticFieldWriteHelper", "StaticFieldWriteHelper", nullptr, nullptr, 0u, nullptr, 0u,
...

{
...

	{
		...
		BgcSatbPreWriteBarrier(reinterpret_cast<void**>(&chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget));


		BgcRecordRootChange(reinterpret_cast<void**>(&chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget), reinterpret_cast<void*>(chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___writeTarget));
	...
	_s1 = chaos_static_SnapshotTestFixtures_StaticFieldWriteHelper___readTarget;
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_StaticFieldWriteHelper_WriteAndRead(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_StaticFieldWriteHelper_WriteAndRead(entryIndex);
