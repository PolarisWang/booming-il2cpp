...
MethodTable chaos_mt_SnapshotTestFixtures_CpblkHelper = {nullptr, nullptr, 12671015469352796770ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_CpblkHelper = static_cast<CHAOS_IL2CPP_UINT64>(12671015469352796770ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(12671015469352796770ULL, sizeof(chaos_type_SnapshotTestFixtures_CpblkHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_CpblkHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_CpblkHelper) + sizeof(chaos_mt_SnapshotTestFixtures_CpblkHelper));
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "RunCpblk", 0x00000002u, 0u },  // CpblkHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_CpblkHelper_RunCpblk), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(0) },  // CpblkHelper::RunCpblk
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_CpblkHelper_RunCpblk ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_CpblkHelper_RunCpblk */
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_CpblkHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/CpblkHelper::RunCpblk:System.Int32()", "RunCpblk", "System.Int32", 0, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/CpblkHelper", "SnapshotTestFixtures/CpblkHelper", "", "CpblkHelper", "CpblkHelper", nullptr, nullptr, 0u, nullptr, 0u,
...

{
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(32);
...

	{
		...
		const auto chaos_size = static_cast<CHAOS_IL2CPP_SIZE>(static_cast<CHAOS_IL2CPP_UINTPTR>(_s2));


		const auto chaos_source = _s1;


		const auto chaos_destination = _s0;


		if (chaos_size != static_cast<CHAOS_IL2CPP_SIZE>(0))


		{


			const auto chaos_resolve_cpblk_address = [](CHAOS_IL2CPP_INTPTR chaos_address) -> void*


			{


				if ((chaos_address & CHAOS_IL2CPP_RAW_POINTER_TAG) != 0)


				{


					return reinterpret_cast<void*>(static_cast<CHAOS_IL2CPP_UINTPTR>(chaos_address & ~CHAOS_IL2CPP_RAW_POINTER_TAG));
...

				{
					...
					return reinterpret_cast<void*>(static_cast<CHAOS_IL2CPP_UINTPTR>(chaos_address & ~chaos_managed_pointer_local_slot_tag));
			...
			CHAOS_IL2CPP_MEMCPY(chaos_resolve_cpblk_address(chaos_destination), chaos_resolve_cpblk_address(chaos_source), chaos_size);
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_CpblkHelper_RunCpblk(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_CpblkHelper_RunCpblk(entryIndex);
