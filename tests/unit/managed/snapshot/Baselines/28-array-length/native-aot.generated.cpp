...

{
	...
	_s0 = [&](){ auto* _c_arr = reinterpret_cast<chaos_managed_array*>(_i0); return _c_arr ? static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(_c_arr->length)) : CHAOS_IL2CPP_INTPTR{}; }();
