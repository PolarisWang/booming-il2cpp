...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally(CHAOS_IL2CPP_INT32 chaos_fn_arg_0);
...
MethodTable chaos_mt_SnapshotTestFixtures_EhFilterFinallyHelper = {nullptr, nullptr, 5381426445821634270ULL, 0u, 32, 1, 1, nullptr, nullptr, 0, 0, 0};



inline constexpr CHAOS_IL2CPP_UINT64 chaos_type_id_SnapshotTestFixtures_EhFilterFinallyHelper = static_cast<CHAOS_IL2CPP_UINT64>(5381426445821634270ULL);
...
extern "C" void ChaosRegisterGcLayouts() {
	...
	registry.Register(5381426445821634270ULL, sizeof(chaos_type_SnapshotTestFixtures_EhFilterFinallyHelper), nullptr, 0);
	...
	registry.RegisterTypeInfoRange(reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_EhFilterFinallyHelper), reinterpret_cast<CHAOS_IL2CPP_UINTPTR>(&chaos_mt_SnapshotTestFixtures_EhFilterFinallyHelper) + sizeof(chaos_mt_SnapshotTestFixtures_EhFilterFinallyHelper));
...
static constexpr struct {
...

	{
		...
		{ 1u, 1u },  // SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[1] = {
	...
	{ "FilterFinally", 0x00000002u, 1u },  // EhFilterFinallyHelper
...
extern "C" HotpatchEntryV0 s_hotpatch_entries[1] = {
	...
	{ reinterpret_cast<void*>(&SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, HotpatchEncodeArgCount(1) },  // EhFilterFinallyHelper::FilterFinally
...
static void (*kMethodTable[1])() = {
	...
	reinterpret_cast<void(*)()>(&SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally),
...
struct ChaosGcSlotMapsSectionV0 {
	...
	/* ── Entry 0: SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally ── */
...
extern const ChaosGcSlotMapsSectionV0 kChaosGcSlotMapsSection = {
	...
	/* entry0 = SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally */
	...
	.entry0 = {
		...
		/* code_address */ reinterpret_cast<const void*>(&SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally),
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_SnapshotTestFixtures_EhFilterFinallyHelper[1] = {
	...
	{ 0x00000002u, "SnapshotTestFixtures/EhFilterFinallyHelper::FilterFinally:System.Int32(System.Int32)", "FilterFinally", "System.Int32", 1, nullptr, 0u, nullptr, 0u },
...
extern const ReflectionQueryTypeDescriptor kReflTypes[1] = {
	...
	{ 0x00000001u, "SnapshotTestFixtures/EhFilterFinallyHelper", "SnapshotTestFixtures/EhFilterFinallyHelper", "", "EhFilterFinallyHelper", "EhFilterFinallyHelper", nullptr, nullptr, 0u, nullptr, 0u,
...
extern "C" CHAOS_IL2CPP_INT32 SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally(CHAOS_IL2CPP_INT32);


extern "C" CHAOS_IL2CPP_INT32 RunNativeAot(CHAOS_IL2CPP_INT32 entryIndex) {


    return SnapshotTestFixtures_EhFilterFinallyHelper_FilterFinally(entryIndex);
