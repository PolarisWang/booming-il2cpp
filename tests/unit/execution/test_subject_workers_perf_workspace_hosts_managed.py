...
class TestSubjectWorkersPerfWorkspaceHostsManaged(SubjectWorkersTestSupport):
    ...
    def test_runtime_perf_collect_passes_binding_manifest_for_hotupdate_benchmark_host(self) -> None:
        ...
        try:
            ...
            perf_result = {
                ...
                "baselinePath": "verification/catalog/owners/HotUpdateHostPack/benchmark-baselines/perf/windows-managed-perf/windows.json",
                "baseline": {},
                "baselineUpdated": False,
                "regressionStatus": "no-baseline",
                "regressions": [],
