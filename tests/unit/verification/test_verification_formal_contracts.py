    ...
    def test_build_records_and_payload_wrappers_follow_verification_v1_contract(self) -> None:
        ...
        evidence = contracts.build_evidence_record(
            ...
            source_refs=[
                {
                    "kind": "report",
                    "path": "docs/testing-inventory/verification/reports/completed/solution-core/semantic.md",
        ...
        try:
            stub_index = codegen_stubs.build_stub_index(
                ...
                managed_source_refs=[
                    {
                        "kind": "managed-source",
                        "path": "subjects/SolutionCorePack/source/Proofs/GenericSharingProof.cs",
                        "label": "managed proof",
                    }
                ],
                stub_refs=[
