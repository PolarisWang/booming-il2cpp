...
PROOF_HOST_DIR = REPO_ROOT / "tests" / "proof" / "native-reference" / "HelloWorldObject"
...
class Stage4BootstrapSupportSkeletonTests(unittest.TestCase):
    def test_bootstrap_support_and_proof_host_skeleton_files_exist(self) -> None:
        ...
        for path in expected_paths:
            self.assertTrue(path.exists(), msg=f"missing Stage 4 Chunk 4 skeleton path: {path}")
