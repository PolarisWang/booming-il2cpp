...
| --- | --- | --- | --- | --- | --- |
| `20260409-06-phase-4-mainline-feature-pack-onboarding` | `completed` | `archived` | `2026-04-09 15:20:01 +08:00` | 无。`MainlineFeaturePack` 已成为真实完整 subject，proof entry override、subject-scoped proof build 与 `output / trace / perf` 三条统一入口均已落地。 | `no` |
...
| `20260409-04-phase-2-core-contract-cutover` | `completed` | `archived` | `2026-04-09 13:12:00 +08:00` | 无。`Phase 2` contract cutover 已落地；subject-bearing contract 清理延后为单独 follow-up，父 roadmap 已继续派生 `Phase 3`。 | `no` |
