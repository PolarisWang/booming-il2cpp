...
- 创建：`docs/architecture/roadmap-0/schema-pack-v0.md`
...
- 创建：`docs/architecture/roadmap-0/trace-contract-v0.md`
...
运行：
```bash
git add analysis/contracts tests/contracts/schema tests/contracts/trace docs/architecture/roadmap-0
