...
- authority 鍒嗗伐宸插喕缁擄細
  - `docs/architecture/subject-test-framework-v1/INDEX.md` 鎷ユ湁 execution spine / layering / contract 杈圭晫
  - `docs/architecture/verification-v1/spec.md` 鎷ユ湁 formal verification / projection / archive 杈圭晫
