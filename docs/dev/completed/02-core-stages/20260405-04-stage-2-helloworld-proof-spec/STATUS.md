...
- 2026-04-06 00:04:02 +08:00: 已新增 `docs/architecture/roadmap-0/hello-world-proof-spec-v0.md`，把 canonical output、artifact 真源、shared `subjectId`、direct-call landing 与 gate 归属写成唯一长期规格。
