...
1. 把 capability-family-ledger、dual-axis 进度模型、waiver/exclusion/blocked 规则、source links 渲染规则同步到 `docs/architecture/verification-v1/spec.md`
...
在 `docs/architecture/verification-v1/spec.md` 中：
