...
| [half-op-explicit-c3861](half-op-explicit-c3861/handoff-2026-08-26.md) | debug | known-frontier | 2026-08-26 | CoreLib Half::op_Explicit(Half→Double) C3861 — post-scan 漏 emit-time resolved TargetSymbol；按 external-runtime-expert 定向修复 post-scan 收集缺口 | true |
