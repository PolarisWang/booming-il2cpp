...
current_dir: docs/dev/in-progress/20260408-03-unified-test-all-display
parent_task_id:
source_task_id:
source_relation:
active: false
...
- brainstorm: `docs/dev/in-progress/20260408-03-unified-test-all-display/brainstorm-v1-01.md`
- design: `docs/dev/in-progress/20260408-03-unified-test-all-display/design-v1-01.md`
- roadmap_or_plan: `docs/dev/in-progress/20260408-03-unified-test-all-display/plan-v1-01.md`
- latest_progress: `docs/dev/in-progress/20260408-03-unified-test-all-display/notes/progress-v1-01.md`
