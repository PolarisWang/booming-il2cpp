...
**技术栈：** .NET 程序集与元数据加载、IL 解码与 IR、AOT 闭世界分析、C++ 代码生成、运行时对象模型、GC 后端抽象、线程/异常/反射/PInvoke、原生构建系统、Golden Project 与跨平台验证。
...
- [ ] 与 `System.Reflection.Metadata` / `Mono.Cecil` 结果做结构对比测试
