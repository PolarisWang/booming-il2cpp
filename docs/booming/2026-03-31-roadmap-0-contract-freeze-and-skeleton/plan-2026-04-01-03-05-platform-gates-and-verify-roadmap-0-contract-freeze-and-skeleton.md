...
- 创建：`docs/architecture/roadmap-0/toolchain-matrix.md`
- 创建：`docs/architecture/roadmap-0/reference-desktop-gates.md`
...
运行：
```bash
git add CMakePresets.json build/toolchains build/scripts tests/platform tests/reference-desktop tests/contracts/trace docs/architecture/roadmap-0
