...
`docs/archive/architecture/roadmap-0/README.md` 至少包含：
...
`docs/archive/architecture/roadmap-0/ownership-map.md` 明确：
...
运行：`Get-ChildItem frontend,analysis,runtime,codegen,build,tests,docs/archive/architecture/roadmap-0`
预期：所有目标目录和 README / md 文件存在。

### 任务 2：建立契约索引、依赖顺序与 Gate 对照表

**文件：**
- 创建：`docs/archive/architecture/roadmap-0/contract-index.md`
- 创建：`docs/archive/architecture/roadmap-0/gates-and-artifacts.md`
...
- 创建：`docs/archive/architecture/roadmap-0/artifact-schemas-v0.md`
...
- 创建：`docs/archive/architecture/roadmap-0/preserve-format-v0.md`
...
- 创建：`docs/archive/architecture/roadmap-0/runtime-abi-v0.md`
...
- 创建：`docs/archive/architecture/roadmap-0/codegen-bridge-v0.md`
...
- 创建：`docs/archive/architecture/roadmap-0/toolchain-matrix-v0.md`
...
- 创建：`docs/archive/architecture/roadmap-0/mobile-validation-matrix-v0.md`
