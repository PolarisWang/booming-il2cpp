...
- [ ] **6.2** 更新 `docs/archive/architecture/runtime-baseline/schema-pack-v0.md`
- [ ] **6.3** 更新 `docs/archive/architecture/runtime-baseline/hello-world-proof-spec-v0.md`
- [ ] **6.4** 更新 `docs/archive/architecture/runtime-baseline/local-verification.md`
- [ ] **6.5** 更新 `docs/archive/architecture/subject-test-framework-v1/foundation-and-windows-cutover-v1.md`
