...
**预期知识沉淀：** `wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/managed-native-hotupdate-test-pipeline.md`、`wiki/06-测试验证/AOT新Feature接入自测规范.md`、`wiki/06-测试验证/INDEX.md`
