...
- `docs/archive/architecture/subject-test-framework-v1/INDEX.md`: 执行主线边界、长期契约、分层原则
- `docs/archive/architecture/verification-v1/spec.md`: formal verification、projection 与 archive 边界
