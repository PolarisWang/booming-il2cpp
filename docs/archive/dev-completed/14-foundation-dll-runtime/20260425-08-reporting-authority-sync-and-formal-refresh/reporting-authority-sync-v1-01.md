...
1. 把 capability-family-ledger、dual-axis 进度模型、waiver/exclusion/blocked 规则、source links 渲染规则同步到 `wiki/03-功能模块/06-il2cpp核心架构/05-架构参考/verification-v1/spec.md`
...
在 `wiki/03-功能模块/06-il2cpp核心架构/05-架构参考/verification-v1/spec.md` 中：
