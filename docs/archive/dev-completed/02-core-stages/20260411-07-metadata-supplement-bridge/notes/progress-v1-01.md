...
- 完成 Batch 4 subject 与验证
  ...
  - 同步 `tests/unit/run/test_managed_closure_contract_bundle.py` 与 `docs/architecture/roadmap-0/managed-minimal-closure-v0.md`，把 supplemental metadata template 纳入正式 bundle 契约
