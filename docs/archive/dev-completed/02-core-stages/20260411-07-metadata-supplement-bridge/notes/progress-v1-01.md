...
- 完成 Batch 4 subject 与验证
  ...
  - 同步 `tests/unit/run/test_managed_closure_contract_bundle.py` 与 `wiki/03-功能模块/06-il2cpp核心架构/05-架构参考/roadmap-0/managed-minimal-closure-v0.md`，把 supplemental metadata template 纳入正式 bundle 契约
