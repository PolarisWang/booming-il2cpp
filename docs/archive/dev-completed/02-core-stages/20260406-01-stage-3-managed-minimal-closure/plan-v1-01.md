...
- 创建或修改：`wiki/03-功能模块/06-il2cpp核心架构/05-架构参考/roadmap-0/managed-minimal-closure-v0.md`
...
- [ ] 创建 `wiki/03-功能模块/06-il2cpp核心架构/05-架构参考/roadmap-0/managed-minimal-closure-v0.md`。
- [ ] 写明 Stage 3 输入：
