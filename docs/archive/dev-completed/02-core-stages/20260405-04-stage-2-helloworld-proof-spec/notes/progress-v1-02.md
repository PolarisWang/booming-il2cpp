...
- 新增长期规格文档 `docs/architecture/roadmap-0/hello-world-proof-spec-v0.md`，固定 object-based `HelloWorld` 的 canonical truth、artifact 真源、direct-call landing 约束与 gate 归属。
