...
- `src/managed/Chaos.IL2CPP.Generator/**`
  ...
  - authority 鏂囨。鏄庣‘ `Chaos.IL2CPP.Generator` 涓?IL2CPP 鏍稿績 codegen 宸ョ▼銆?- `docs/archive/architecture/runtime-baseline/repo-layout.md`
  - 褰撳墠 repo layout 鐪熺浉婧愬垏鍒?`Generator`銆?- `docs/archive/architecture/runtime-baseline/ownership-map.md`
