...
**预期知识沉淀：** `docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`，并按执行结果更新 `wiki/06-测试验证/`
...
- [ ] 新增 `docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`
...
- [ ] 把长期边界写入 `docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`
