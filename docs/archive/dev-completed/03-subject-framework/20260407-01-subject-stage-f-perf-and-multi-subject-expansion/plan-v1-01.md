...
**预期知识沉淀：** `wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`，并按执行结果更新 `wiki/06-测试验证/`
...
- [ ] 新增 `wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`
...
- [ ] 把长期边界写入 `wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/subject-test-framework-v1/perf-and-multi-subject-expansion-v1.md`
