...
**预期知识沉淀：** `docs/archive/architecture/subject-test-framework-v1/reporting-and-public-cutover-v1.md`，并按执行结果回写 `wiki/06-测试验证/`
...
- [ ] 把长期边界写入 `docs/archive/architecture/subject-test-framework-v1/reporting-and-public-cutover-v1.md`
