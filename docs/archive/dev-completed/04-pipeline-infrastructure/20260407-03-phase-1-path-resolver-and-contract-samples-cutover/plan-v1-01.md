...
- 修改：[contracts/docs/v0/overview.md](D:/agent/booming-il2cpp/contracts/docs/v0/overview.md)
  - 更新 canonical 布局描述
- 修改：[wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/roadmap-0/schema-pack-v0.md](D:/agent/booming-il2cpp/wiki/03-功能模块/06-il2cpp核心架构/docs/archive/architecture/roadmap-0/schema-pack-v0.md)
