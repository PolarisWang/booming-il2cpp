...
struct Functions {
    struct ConverterFactorySubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct ConverterFactorySubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.converterFactorySubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.converterFactorySubjects.Subject_1(
        );
    }
