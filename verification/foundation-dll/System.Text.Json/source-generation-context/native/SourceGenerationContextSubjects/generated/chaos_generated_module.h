...
struct Functions {
    struct SourceGenerationContextSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct SourceGenerationContextSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.sourceGenerationContextSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.sourceGenerationContextSubjects.Subject_1(
        );
    }
