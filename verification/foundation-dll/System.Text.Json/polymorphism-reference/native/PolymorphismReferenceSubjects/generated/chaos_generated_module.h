...
struct Functions {
    struct PolymorphismReferenceSubjects_t {
...
struct PolymorphismReferenceSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_4(
        );
    }
    static inline void CustomEntrySubject_5(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_5(
        );
    }
    static inline void CustomEntrySubject_6(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_6(
        );
    }
    static inline void CustomEntrySubject_7(
    ) {
        return kFunctions.polymorphismReferenceSubjects.CustomEntrySubject_7(
        );
    }
