...
// native-reference runtime skeleton for family/System.Text.Json/attributes
#include "bootstrap.h"
...
{
namespace runtime_skeleton_attributes
{
...
{
    { 0, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::JsonAttribute::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::get_Property:System.Void()", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::Method1:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::Method2:System.Void(P0, P1)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::Validate:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::get_Value:System.Void()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::set_Value:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::get_Count:System.Void()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::set_Count:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::get_IsEmpty:System.Void()", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::set_IsEmpty:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::get_Key:System.Void()", DispatchRuntimeSkeletonPage0001, 11 },
    { 12, "System.Text.Json/System.Text.Json.Serialization.JsonAttribute::set_Key:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 12 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_attributes(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_attributes::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_attributes::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_attributes::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_attributes::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_attributes(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_attributes(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
