...
struct FormatterSubjects {
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.formatterSubjects.CustomEntrySubject_1(
        );
    }
    static inline void Subject_0(
    ) {
        return kFunctions.formatterSubjects.Subject_0(
        );
    }
