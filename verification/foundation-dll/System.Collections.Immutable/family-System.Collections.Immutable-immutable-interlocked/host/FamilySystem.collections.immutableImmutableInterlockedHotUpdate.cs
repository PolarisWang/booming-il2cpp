...
{
    // Verify ImmutableInterlocked.ImmutableInterlocked: after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.get_Property after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.Method1 after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.Method2 after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.Validate after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.get_Value after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.set_Value after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.get_Count after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.set_Count after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.get_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.set_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.get_Key after hot-update (patch side)
    ...
    // Verify ImmutableInterlocked.set_Key after hot-update (patch side)
