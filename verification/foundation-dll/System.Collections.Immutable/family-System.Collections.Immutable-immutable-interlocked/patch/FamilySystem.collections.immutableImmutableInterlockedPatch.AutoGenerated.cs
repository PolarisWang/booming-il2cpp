...
// Auto-generated patch-side skeletons for FamilySystem.collections.immutableImmutableInterlockedPatch.
// Each method exercises a method from the patch side back to the host after hot-update.
public static class FamilySystem.collections.immutableImmutableInterlockedPatch
{
    // Purpose: Verify ImmutableInterlocked.ImmutableInterlocked: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableInterlocked.set_Key executes correctly from patch side back to host
