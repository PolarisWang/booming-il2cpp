...
struct Functions {
    struct ImmutableQueueStackSubjects_t {
...
struct ImmutableQueueStackSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_4(
        );
    }
    static inline void CustomEntrySubject_5(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_5(
        );
    }
    static inline void CustomEntrySubject_6(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_6(
        );
    }
    static inline void CustomEntrySubject_7(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_7(
        );
    }
    static inline void CustomEntrySubject_8(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_8(
        );
    }
    static inline void CustomEntrySubject_9(
    ) {
        return kFunctions.immutableQueueStackSubjects.CustomEntrySubject_9(
        );
    }
