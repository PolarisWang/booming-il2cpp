...
public static class FrozenCollectionsPatch
{
    ...
    // Verify FrozenDictionary.Create<string,string> after hot-update (host side)
    ...
    // Verify FrozenSet.Create<Byte> after hot-update (host side)
    ...
    // Verify FrozenSet.Create<Int32> after hot-update (host side)
