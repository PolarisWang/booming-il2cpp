...
// Auto-generated patch-side skeletons for FamilySystem.collections.immutableImmutableHashSetPatch.
// Each method exercises a method from the patch side back to the host after hot-update.
public static class FamilySystem.collections.immutableImmutableHashSetPatch
{
    // Purpose: Verify ImmutableHashSet.ImmutableHashSet: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableHashSet.set_Key executes correctly from patch side back to host
