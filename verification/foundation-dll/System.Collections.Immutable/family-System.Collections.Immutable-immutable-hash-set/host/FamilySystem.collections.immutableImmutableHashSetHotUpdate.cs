...
{
    // Verify ImmutableHashSet.ImmutableHashSet: after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.get_Property after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.Method1 after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.Method2 after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.Validate after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.get_Value after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.set_Value after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.get_Count after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.set_Count after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.get_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.set_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.get_Key after hot-update (patch side)
    ...
    // Verify ImmutableHashSet.set_Key after hot-update (patch side)
