...
{
    // Verify ImmutableSortedDictionary.ImmutableSortedDictionary: after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.get_Property after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.Method1 after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.Method2 after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.Validate after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.get_Value after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.set_Value after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.get_Count after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.set_Count after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.get_IsEmpty after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.set_IsEmpty after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.get_Key after hot-update (host side)
    ...
    // Verify ImmutableSortedDictionary.set_Key after hot-update (host side)
