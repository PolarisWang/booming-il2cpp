...
// Auto-generated hot-update skeletons for FamilySystem.collections.immutableImmutableSortedDictionaryHotUpdate.
...
{
    // Purpose: Verify ImmutableSortedDictionary.ImmutableSortedDictionary: executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.get_Property executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.Method1 executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.Method2 executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.Validate executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.get_Value executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.set_Value executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.get_Count executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.set_Count executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.get_IsEmpty executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.set_IsEmpty executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.get_Key executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ImmutableSortedDictionary.set_Key executes correctly after hot-update patch (host side)
