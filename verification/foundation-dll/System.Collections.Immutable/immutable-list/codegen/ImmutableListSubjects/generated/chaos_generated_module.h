...
struct Functions {
    struct ImmutableListSubjects_t {
...
struct ImmutableListSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_4(
        );
    }
    static inline void CustomEntrySubject_5(
    ) {
        return kFunctions.immutableListSubjects.CustomEntrySubject_5(
        );
    }
