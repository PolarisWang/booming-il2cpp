...
// Auto-generated patch-side skeletons for FamilySystem.collections.immutableImmutableQueueStackPatch.
// Each method exercises a method from the patch side back to the host after hot-update.
public static class FamilySystem.collections.immutableImmutableQueueStackPatch
{
    // Purpose: Verify ImmutableQueue.ImmutableQueue: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.ImmutableStack: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableQueue.set_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableStack.set_Key executes correctly from patch side back to host
