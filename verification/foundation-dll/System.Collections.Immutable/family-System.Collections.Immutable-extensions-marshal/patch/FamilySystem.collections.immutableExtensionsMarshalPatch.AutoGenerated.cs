...
// Auto-generated patch-side skeletons for FamilySystem.collections.immutableExtensionsMarshalPatch.
// Each method exercises a method from the patch side back to the host after hot-update.
public static class FamilySystem.collections.immutableExtensionsMarshalPatch
{
    // Purpose: Verify ImmutableArrayExtensions.ImmutableArrayExtensions: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.ImmutableCollectionsMarshal: executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.get_Property executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.Method1 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.Method2 executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.Validate executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableArrayExtensions.set_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.get_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.set_Value executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.get_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.set_Count executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.get_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.set_IsEmpty executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.get_Key executes correctly from patch side back to host
    ...
    // Purpose: Verify ImmutableCollectionsMarshal.set_Key executes correctly from patch side back to host
