...
public static class ImmutableDictionaryHotUpdate
{
    // Verify ImmutableDictionary.Create<string,int> after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.Create<Byte,Byte> after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.Create<string,string> after hot-update (patch side)
