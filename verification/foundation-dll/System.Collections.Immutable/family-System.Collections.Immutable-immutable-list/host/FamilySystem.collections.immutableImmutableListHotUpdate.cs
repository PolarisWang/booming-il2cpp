...
{
    // Verify ImmutableList.ImmutableList: after hot-update (patch side)
    ...
    // Verify ImmutableList.get_Property after hot-update (patch side)
    ...
    // Verify ImmutableList.Method1 after hot-update (patch side)
    ...
    // Verify ImmutableList.Method2 after hot-update (patch side)
    ...
    // Verify ImmutableList.Validate after hot-update (patch side)
    ...
    // Verify ImmutableList.get_Value after hot-update (patch side)
    ...
    // Verify ImmutableList.set_Value after hot-update (patch side)
    ...
    // Verify ImmutableList.get_Count after hot-update (patch side)
    ...
    // Verify ImmutableList.set_Count after hot-update (patch side)
    ...
    // Verify ImmutableList.get_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableList.set_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableList.get_Key after hot-update (patch side)
    ...
    // Verify ImmutableList.set_Key after hot-update (patch side)
