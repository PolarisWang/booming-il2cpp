...
{
    // Verify ImmutableSortedSet.ImmutableSortedSet: after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.get_Property after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.Method1 after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.Method2 after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.Validate after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.get_Value after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.set_Value after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.get_Count after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.set_Count after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.get_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.set_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.get_Key after hot-update (patch side)
    ...
    // Verify ImmutableSortedSet.set_Key after hot-update (patch side)
