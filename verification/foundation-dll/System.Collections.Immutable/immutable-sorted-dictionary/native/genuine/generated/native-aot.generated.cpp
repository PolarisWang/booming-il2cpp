...
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method0(void);
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method1(void);
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Run(CHAOS_IL2CPP_INT32 chaos_arg_0);

extern "C" CHAOS_IL2CPP_INT32 chaos_external_runtime_ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry__Method0_System_Int32__(void)
{
    return ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method0();
}

extern "C" CHAOS_IL2CPP_INT32 chaos_external_runtime_ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry__Method1_System_Int32__(void)
{
    return ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method1();
}

extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Collections_Immutable_ImmutableSortedDictionary__Create_System_Byte_System_Byte__ImmutableSortedDictionary_System_Byte_System_Byte___(void)
{
    return static_cast<CHAOS_IL2CPP_INTPTR>(0);
}

extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Collections_Immutable_ImmutableSortedDictionary__Create_System_String_System_Int32__ImmutableSortedDictionary_System_String_System_Int32___(void)
{
    return static_cast<CHAOS_IL2CPP_INTPTR>(0);
}
}
...
// Managed method: ImmutableSortedDictionaryNativeEntry/ImmutableSortedDictionaryNativeEntry::Method0()
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method0(void)
{
    ...
    // Generic execution authority: definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>(); type=[]; method=[System.String, System.Int32]; support=Specialized; specialization=SpecializedBody; body=body:definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>();type=[];method=[System.String,System.Int32]; stub=stub:definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>();type=[];method=[System.String,System.Int32]
    {
        const auto chaos_result = chaos_external_runtime_System_Collections_Immutable_ImmutableSortedDictionary__Create_System_String_System_Int32__ImmutableSortedDictionary_System_String_System_Int32___();
...
// Managed method: ImmutableSortedDictionaryNativeEntry/ImmutableSortedDictionaryNativeEntry::Method1()
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method1(void)
{
    CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
    CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
    ...
    // Generic execution authority: definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>(); type=[]; method=[System.Byte, System.Byte]; support=Specialized; specialization=SpecializedBody; body=body:definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>();type=[];method=[System.Byte,System.Byte]; stub=stub:definition=System.Collections.Immutable/ImmutableSortedDictionary::Create:ImmutableSortedDictionary<!!0,!!1>();type=[];method=[System.Byte,System.Byte]
    {
        const auto chaos_result = chaos_external_runtime_System_Collections_Immutable_ImmutableSortedDictionary__Create_System_Byte_System_Byte__ImmutableSortedDictionary_System_Byte_System_Byte___();
        chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
    }
...
// Managed method: ImmutableSortedDictionaryNativeEntry/ImmutableSortedDictionaryNativeEntry::Run(System.Int32)
extern "C" CHAOS_IL2CPP_INT32 ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Run(CHAOS_IL2CPP_INT32 chaos_arg_0)
{
    CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
...

    {
        ...
        {
            {
                const auto chaos_result = ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method0();
                chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
            }
            chaos_locals[2] = chaos_eval_stack[--chaos_stack_top];
            {
                const auto chaos_result = ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Method1();
                chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
            }
            chaos_locals[2] = chaos_eval_stack[--chaos_stack_top];
...
// Native AOT entry for ImmutableSortedDictionaryNativeEntry/ImmutableSortedDictionaryNativeEntry::Run:System.Int32(System.Int32)
// Managed symbol: ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Run
extern "C" int RunNativeAot(CHAOS_IL2CPP_INT32 chaos_entry_index)
{
    return ImmutableSortedDictionaryNativeEntry_ImmutableSortedDictionaryNativeEntry_Run(chaos_entry_index);
}