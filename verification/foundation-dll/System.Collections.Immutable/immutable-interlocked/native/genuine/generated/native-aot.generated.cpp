...
extern "C" CHAOS_IL2CPP_INT32 ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Method0(void);
extern "C" CHAOS_IL2CPP_INT32 ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Run(CHAOS_IL2CPP_INT32 chaos_arg_0);
...
extern "C" CHAOS_IL2CPP_INT32 chaos_external_runtime_ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry__Method0_System_Int32__(void)
{
    return ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Method0();
}

extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Collections_Immutable_ImmutableInterlocked__Update_System_String__System_Boolean_System_String__System_Func_System_String_System_String__(CHAOS_IL2CPP_INTPTR chaos_arg_0, CHAOS_IL2CPP_INTPTR chaos_arg_1, CHAOS_IL2CPP_INTPTR chaos_arg_2)
{
    return static_cast<CHAOS_IL2CPP_INTPTR>(0);
}
}
...
// Managed method: ImmutableInterlockedNativeEntry/ImmutableInterlockedNativeEntry::Method0()
extern "C" CHAOS_IL2CPP_INT32 ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Method0(void)
{
    ...
    // Generic execution authority: definition=System.Collections.Immutable/ImmutableInterlocked::Update:System.Boolean(!!0&,System.Func<!!0,!!0>); type=[]; method=[System.String]; support=Specialized; specialization=SpecializedBody; body=body:definition=System.Collections.Immutable/ImmutableInterlocked::Update:System.Boolean(!!0&,System.Func<!!0,!!0>);type=[];method=[System.String]; stub=stub:definition=System.Collections.Immutable/ImmutableInterlocked::Update:System.Boolean(!!0&,System.Func<!!0,!!0>);type=[];method=[System.String]
    {
        ...
        const auto chaos_result = chaos_external_runtime_System_Collections_Immutable_ImmutableInterlocked__Update_System_String__System_Boolean_System_String__System_Func_System_String_System_String__(chaos_arg_0, chaos_arg_1, chaos_arg_2);
...
// Managed method: ImmutableInterlockedNativeEntry/ImmutableInterlockedNativeEntry::Run(System.Int32)
extern "C" CHAOS_IL2CPP_INT32 ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Run(CHAOS_IL2CPP_INT32 chaos_arg_0)
{
    CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
...

    {
        ...
        {
            {
                const auto chaos_result = ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Method0();
                chaos_eval_stack[chaos_stack_top++] = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
            }
...
// Native AOT entry for ImmutableInterlockedNativeEntry/ImmutableInterlockedNativeEntry::Run:System.Int32(System.Int32)
// Managed symbol: ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Run
extern "C" int RunNativeAot(CHAOS_IL2CPP_INT32 chaos_entry_index)
{
    return ImmutableInterlockedNativeEntry_ImmutableInterlockedNativeEntry_Run(chaos_entry_index);
}