...
{
    // Verify ImmutableDictionary.ImmutableDictionary: after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.get_Property after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.Method1 after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.Method2 after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.Validate after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.get_Value after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.set_Value after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.get_Count after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.set_Count after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.get_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.set_IsEmpty after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.get_Key after hot-update (patch side)
    ...
    // Verify ImmutableDictionary.set_Key after hot-update (patch side)
