...
// native-reference runtime skeleton for family/System.Runtime.InteropServices/exception-errors
#include "bootstrap.h"
...
{
namespace runtime_skeleton_exception_errors
{
...
{
    { 0, "System.Runtime.InteropServices/System.DllNotFoundException::DllNotFoundException::Void()", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Runtime.InteropServices/System.DllNotFoundException::DllNotFoundException::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Runtime.InteropServices/System.DllNotFoundException::DllNotFoundException::Void(System.Object, System.Object)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Runtime.InteropServices/System.Runtime.InteropServices.COMException::COMException::Void()", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Runtime.InteropServices/System.Runtime.InteropServices.COMException::COMException::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Runtime.InteropServices/System.Runtime.InteropServices.COMException::COMException::Void(System.Object, System.Object)", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Runtime.InteropServices/System.Runtime.InteropServices.COMException::ToString:System.Void()", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Runtime.InteropServices/System.Runtime.InteropServices.SEHException::SEHException::Void()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Runtime.InteropServices/System.Runtime.InteropServices.SEHException::SEHException::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Runtime.InteropServices/System.Runtime.InteropServices.SEHException::SEHException::Void(System.Object, System.Object)", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Runtime.InteropServices/System.Runtime.InteropServices.SEHException::CanResume:System.Void()", DispatchRuntimeSkeletonPage0001, 10 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_exception_errors(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_exception_errors::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_exception_errors::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_exception_errors::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_exception_errors::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_exception_errors(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_exception_errors(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
