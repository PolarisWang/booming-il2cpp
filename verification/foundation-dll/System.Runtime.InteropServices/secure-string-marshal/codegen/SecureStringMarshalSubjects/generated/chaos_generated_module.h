...
struct Functions {
    struct SecureStringMarshalSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct SecureStringMarshalSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.secureStringMarshalSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.secureStringMarshalSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.secureStringMarshalSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.secureStringMarshalSubjects.Subject_3(
        );
    }
