...
namespace chaos::il2cpp::generated::runtime_skeleton_function_pointers
{
...
constexpr CHAOS_IL2CPP_SIZE translation_unit_page_item_count = 1;
...
// Stub for System.Runtime.InteropServices/System.Runtime.InteropServices.UnmanagedCallersOnlyAttribute::UnmanagedCallersOnlyAttribute::Void()
int32_t CHAOS_RUNTIME_ABI_CALL NativeReferenceStub_System_Runtime_InteropServices_System_Runtime_InteropServices_UnmanagedCallersOnlyAttribute_UnmanagedCallersOnlyAttribute_Void(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
...
{
    &NativeReferenceStub_System_Runtime_InteropServices_System_Runtime_InteropServices_UnmanagedCallersOnlyAttribute_UnmanagedCallersOnlyAttribute_Void,
};
