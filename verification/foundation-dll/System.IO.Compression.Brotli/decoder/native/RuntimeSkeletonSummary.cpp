...
// native-reference runtime skeleton for family/System.IO.Compression.Brotli/decoder
#include "bootstrap.h"
...
{
namespace runtime_skeleton_decoder
{
...
{
    { 0, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::BrotliDecoder::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::get_Property:System.Void()", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::Method1:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::Method2:System.Void(P0, P1)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::Validate:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::get_Value:System.Void()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::set_Value:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::get_Count:System.Void()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::set_Count:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::get_IsEmpty:System.Void()", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::set_IsEmpty:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::get_Key:System.Void()", DispatchRuntimeSkeletonPage0001, 11 },
    { 12, "System.IO.Compression.Brotli/System.IO.Compression.BrotliDecoder::set_Key:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 12 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_decoder(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_decoder::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_decoder::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_decoder::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_decoder::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_decoder(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_decoder(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
