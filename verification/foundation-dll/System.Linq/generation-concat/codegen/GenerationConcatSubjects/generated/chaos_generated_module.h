...
struct Functions {
    struct GenerationConcatSubjects_t {
...
struct GenerationConcatSubjects {
    static inline void CustomEntrySubject_0(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_0(
        );
    }
    static inline void CustomEntrySubject_1(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_1(
        );
    }
    static inline void CustomEntrySubject_2(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_2(
        );
    }
    static inline void CustomEntrySubject_3(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_3(
        );
    }
    static inline void CustomEntrySubject_4(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_4(
        );
    }
    static inline void CustomEntrySubject_5(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_5(
        );
    }
    static inline void CustomEntrySubject_6(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_6(
        );
    }
    static inline void CustomEntrySubject_7(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_7(
        );
    }
    static inline void CustomEntrySubject_8(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_8(
        );
    }
    static inline void CustomEntrySubject_9(
    ) {
        return kFunctions.generationConcatSubjects.CustomEntrySubject_9(
        );
    }
