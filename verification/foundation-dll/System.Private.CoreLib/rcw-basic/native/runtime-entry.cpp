...
// Forward declaration for external runtime function table patcher (rcw_test_stubs.cpp)
extern "C" void PatchExternalRuntimeFnTable();
...
int main(int argc, char** argv) {
    ...
    // Populate unresolved external runtime function table entries (GCHandle,
    // Marshal) that can't be resolved through the hotpatch name registry in
    // per-family verification builds.
    PatchExternalRuntimeFnTable();
