...
// Auto-generated hot-update skeletons for SpanMemoryBuffersHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class SpanMemoryBuffersHotUpdate
{
    // Purpose: Verify Span.get_Item executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Span.Slice executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Span.ToArray executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Span.CopyTo executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Span.get_Empty executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ReadOnlySpan.get_Item executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ReadOnlySpan.Slice executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ReadOnlySpan.ToArray executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Memory.Slice executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Memory.get_Span executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Memory.ToArray executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify MemoryMarshal.GetReference executes correctly after hot-update patch (host side)
