...
public static class SpanMemoryBuffersPatch
{
    // Verify Span.get_Item after hot-update (host side)
    ...
    // Verify Span.get_Empty after hot-update (host side)
    ...
    // Verify ReadOnlySpan.get_Item after hot-update (host side)
    ...
    // Verify Memory.Slice after hot-update (host side)
    ...
    // Verify Memory.ToArray after hot-update (host side)
    ...
    // Verify MemoryMarshal.GetReference after hot-update (host side)
