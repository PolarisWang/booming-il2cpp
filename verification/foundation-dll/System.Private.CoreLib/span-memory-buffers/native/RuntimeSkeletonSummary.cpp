...
// native-reference runtime skeleton for family/System.Private.CoreLib/span/memory-buffers
#include "bootstrap.h"
...
{
namespace runtime_skeleton_span_memory_buffers
{
...
{
    { 0, "System.Private.CoreLib/System.Span`1::get_Item:T&(System.Int32)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Span`1::Slice:System.Span`1(System.Int32)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Span`1::Slice:System.Span`1(System.Int32,System.Int32)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Span`1::ToArray:T[](System.Int32)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Span`1::CopyTo:System.Void(System.Span`1)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Span`1::get_Empty:System.Span`1()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.ReadOnlySpan`1::get_Item:T&(System.Int32)", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.ReadOnlySpan`1::Slice:System.ReadOnlySpan`1(System.Int32)", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.ReadOnlySpan`1::ToArray:T[]()", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.Memory`1::Slice:System.Memory`1(System.Int32)", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Private.CoreLib/System.Memory`1::get_Span:System.Span`1()", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.Private.CoreLib/System.Memory`1::ToArray:T[]()", DispatchRuntimeSkeletonPage0001, 11 },
    { 12, "System.Private.CoreLib/System.Runtime.InteropServices.MemoryMarshal::GetReference:T&(System.ReadOnlySpan`1)", DispatchRuntimeSkeletonPage0001, 12 },
    { 13, "System.Private.CoreLib/System.Runtime.InteropServices.MemoryMarshal::GetReference:T&(System.Span`1)", DispatchRuntimeSkeletonPage0001, 13 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_span_memory_buffers(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_span_memory_buffers::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_span_memory_buffers::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_span_memory_buffers::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_span_memory_buffers::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_span_memory_buffers(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_span_memory_buffers(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
