...
// Auto-generated hot-update skeletons for ArrayIndexingCopyHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class ArrayIndexingCopyHotUpdate
{
    // Purpose: Verify Array.Copy executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.Clear executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.Resize executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.Sort executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.BinarySearch executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.IndexOf executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.LastIndexOf executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.Reverse executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.GetLength executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Array.GetValue executes correctly after hot-update patch (host side)
