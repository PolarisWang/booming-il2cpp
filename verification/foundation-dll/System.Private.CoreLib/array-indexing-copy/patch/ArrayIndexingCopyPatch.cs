...
{
    // Verify Array.Copy after hot-update (host side)
    ...
    // Verify Array.Clear after hot-update (host side)
    ...
    // Verify Array.Resize after hot-update (host side)
    ...
    // Verify Array.Sort after hot-update (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ArrayIndexingCopy)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Array_Sort_System_Void_System_Array_System_Collections_IComparer() { Array.Sort(new byte[1], System.Collections.Generic.Comparer<byte>.Default); }
    // Verify Array.BinarySearch after hot-update (host side)
    ...
    // Verify Array.IndexOf after hot-update (host side)
    ...
    // Verify Array.LastIndexOf after hot-update (host side)
    ...
    // Verify Array.Reverse after hot-update (host side)
    ...
    // Verify Array.GetLength after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Array::GetLength:System.Int32(System.Int32)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ArrayIndexingCopy)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Array_GetLength_System_Int32_System_Int32() { _ = new int[4].GetLength(0); }
    // Verify Array.GetValue after hot-update (host side)
