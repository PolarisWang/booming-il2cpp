...
{
    // Verify Guid..ctor after hot-update (patch side)
    ...
    public static void HotUpdate_System_Private_CoreLib_System_Guid_ctor_System_Void_System_String() { new Guid("00000000-0000-0000-0000-000000000000"); }
    // Verify Guid..ctor after hot-update (patch side)
    ...
    // Verify Guid.Parse after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Guid::Parse:System.Guid(System.String)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_GuidRandomHashcode)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Guid_Parse_System_Guid_System_String() { _ = Guid.Parse("00000000-0000-0000-0000-000000000000"); }
    // Verify Guid.TryParse after hot-update (patch side)
    ...
    // Verify Guid.ToString after hot-update (patch side)
    ...
    // Verify Random..ctor after hot-update (patch side)
    ...
    // Verify Random.Next after hot-update (patch side)
    ...
    // Verify Random.NextDouble after hot-update (patch side)
    ...
    // Verify Random.NextBytes after hot-update (patch side)
    ...
    // Verify HashCode.Add after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.HashCode::Add:System.Void(System.Object)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_GuidRandomHashcode)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_HashCode_Add_System_Void_System_Object() { default(HashCode).Add(new object()); }
    // Verify HashCode.ToHashCode after hot-update (patch side)
    ...
    // Verify HashCode.Combine after hot-update (patch side)
