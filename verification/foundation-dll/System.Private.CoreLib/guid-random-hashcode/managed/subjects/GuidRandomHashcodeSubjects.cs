...
public static partial class GuidRandomHashcodeSubjects
{
    ...
    {
        if (((Guid.NewGuid()).GetHashCode()) != 856493968) _exitCode = 1;
    }
    ...
    {
        if (new Random().Next() != 2100274156) _exitCode = 1;
    }
    ...
    {
        if (default(HashCode).ToHashCode() != 1070987500) _exitCode = 1;
    }

    // [13] System.Private.CoreLib/System.HashCode::Combine:System.Int32(System.Int32,System.Int32)
    public static void Subject_13()
    {
        if (HashCode.Combine(42, 42) != 432803180) _exitCode = 1;
    }
