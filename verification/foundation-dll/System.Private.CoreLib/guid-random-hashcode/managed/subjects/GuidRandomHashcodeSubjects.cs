...
public static partial class GuidRandomHashcodeSubjects
{
    ...
    {
        if (((Guid.NewGuid()).GetHashCode()) != -1231323614) _exitCode = 1;
    }
    ...
    {
        if (new Random().Next() != 1603566048) _exitCode = 1;
    }
    ...
    {
        if (default(HashCode).ToHashCode() != 1802641244) _exitCode = 1;
    }

    // [13] System.Private.CoreLib/System.HashCode::Combine:System.Int32(System.Int32,System.Int32)
    public static void Subject_13()
    {
        if (HashCode.Combine(42, 42) != 809249845) _exitCode = 1;
    }
