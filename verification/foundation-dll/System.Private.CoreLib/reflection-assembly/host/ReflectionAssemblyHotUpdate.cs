...
{
    // Verify Assembly.GetExecutingAssembly after hot-update (patch side)
    ...
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_Assembly_GetExecutingAssembly_System_Reflection_Assembly() { _ = Assembly.GetExecutingAssembly(); }
    // Verify Assembly.GetCallingAssembly after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.Assembly::GetCallingAssembly:System.Reflection.Assembly()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_Assembly_GetCallingAssembly_System_Reflection_Assembly() { _ = Assembly.GetCallingAssembly(); }
    // Verify Assembly.GetEntryAssembly after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.Assembly::GetEntryAssembly:System.Reflection.Assembly()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_Assembly_GetEntryAssembly_System_Reflection_Assembly() { _ = Assembly.GetEntryAssembly(); }
    // Verify Assembly.GetName after hot-update (patch side)
    ...
    // Verify Assembly.get_FullName after hot-update (patch side)
    ...
    // Verify Assembly.get_Location after hot-update (patch side)
    ...
    // Verify Assembly.get_ImageRuntimeVersion after hot-update (patch side)
    ...
    // Verify Assembly.GetExportedTypes after hot-update (patch side)
    ...
    // Verify Assembly.GetForwardedTypes after hot-update (patch side)
    ...
    // Verify Assembly.GetModule after hot-update (patch side)
    ...
    // Verify Assembly.GetManifestResourceStream after hot-update (patch side)
    ...
    // Verify Assembly.GetManifestResourceNames after hot-update (patch side)
    ...
    // Verify Assembly.get_EntryPoint after hot-update (patch side)
    ...
    // Verify AssemblyName.get_Name after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.AssemblyName::get_Name:System.String()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_AssemblyName_get_Name_System_String() { _ = default(AssemblyName)!.Name; }
    // Verify AssemblyName.get_Version after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.AssemblyName::get_Version:System.Version()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_AssemblyName_get_Version_System_Version() { _ = default(AssemblyName)!.Version; }
    // Verify AssemblyName.get_CultureInfo after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_AssemblyName_get_CultureInfo_System_Globalization_CultureInfo() { _ = default(AssemblyName)!.CultureInfo; }
