...
// Auto-generated patch-side skeletons for ReflectionAssemblyPatch.
// Each method exercises a method from the patch side back to the host after hot-update.
public static class ReflectionAssemblyPatch
{
    // Purpose: Verify Assembly.GetExecutingAssembly executes correctly from patch side back to host
    ...
    public static void Patch_System_Private_CoreLib_System_Reflection_Assembly_GetExecutingAssembly_System_Reflection_Assembly() { _ = typeof(byte).Assembly.GetExecutingAssembly(); }
    // Purpose: Verify Assembly.GetCallingAssembly executes correctly from patch side back to host
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.Assembly::GetCallingAssembly:System.Reflection.Assembly()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Reflection_Assembly_GetCallingAssembly_System_Reflection_Assembly() { _ = typeof(byte).Assembly.GetCallingAssembly(); }
    // Purpose: Verify Assembly.GetEntryAssembly executes correctly from patch side back to host
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.Assembly::GetEntryAssembly:System.Reflection.Assembly()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Reflection_Assembly_GetEntryAssembly_System_Reflection_Assembly() { _ = typeof(byte).Assembly.GetEntryAssembly(); }
    // Purpose: Verify Assembly.GetName executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.get_FullName executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.get_Location executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.get_ImageRuntimeVersion executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetTypes executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetExportedTypes executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetForwardedTypes executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetType executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetModule executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetModules executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetManifestResourceStream executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.GetManifestResourceNames executes correctly from patch side back to host
    ...
    // Purpose: Verify Assembly.get_EntryPoint executes correctly from patch side back to host
    ...
    // Purpose: Verify AssemblyName.get_Name executes correctly from patch side back to host
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.AssemblyName::get_Name:System.String()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Reflection_AssemblyName_get_Name_System_String() { _ = AssemblyName.Name; }
    // Purpose: Verify AssemblyName.get_Version executes correctly from patch side back to host
    [HotUpdateSubjectId("System.Private.CoreLib/System.Reflection.AssemblyName::get_Version:System.Version()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Reflection_AssemblyName_get_Version_System_Version() { _ = AssemblyName.Version; }
    // Purpose: Verify AssemblyName.get_CultureInfo executes correctly from patch side back to host
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionAssembly)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Reflection_AssemblyName_get_CultureInfo_System_Globalization_CultureInfo() { _ = AssemblyName.CultureInfo; }
