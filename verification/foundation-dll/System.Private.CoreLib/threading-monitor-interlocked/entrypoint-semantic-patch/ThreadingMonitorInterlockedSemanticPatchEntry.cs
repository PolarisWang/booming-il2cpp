...
public static class ThreadingMonitorInterlockedSemanticPatchEntry
{
    ...
    {
        System.Int32 __ref_0 = 99;
        return Interlocked.Exchange(ref __ref_0, 99);
    }
    ...
    {
        System.Int32 __ref_0 = 99;
        return Interlocked.CompareExchange(ref __ref_0, 99, 99);
    }
    ...
    {
        System.Int32 __ref_0 = 99;
        return Interlocked.Add(ref __ref_0, 99);
    }
