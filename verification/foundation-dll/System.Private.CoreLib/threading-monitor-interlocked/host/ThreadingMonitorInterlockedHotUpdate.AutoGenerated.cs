...
// Auto-generated hot-update skeletons for ThreadingMonitorInterlockedHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class ThreadingMonitorInterlockedHotUpdate
{
    // Purpose: Verify Monitor.Enter executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Monitor.Exit executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Monitor.TryEnter executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Monitor.Pulse executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Monitor.PulseAll executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Monitor.Wait executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.Increment executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.Decrement executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.Exchange executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.CompareExchange executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.Add executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Interlocked.MemoryBarrier executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Volatile.Read executes correctly after hot-update patch (host side)
