...
public static partial class ReflectionParametersSubjects
{
    ...
    {
        try { _ = default(ParameterInfo)!.Name; _exitCode = 1; }
    ...
    {
        try { _ = default(ParameterInfo)!.ParameterType; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { _ = default(ParameterInfo)!.DefaultValue; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { _ = default(ParameterInfo)!.RawDefaultValue; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { _ = default(ParameterInfo)!.HasDefaultValue; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { _ = default(ParameterInfo)!.Attributes; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { _ = default(ParameterInfo)!.Position; _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { default(ParameterInfo)!.GetRequiredCustomModifiers(); _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { default(ParameterInfo)!.GetOptionalCustomModifiers(); _exitCode = 1; }
        catch (NullReferenceException) { }
    }
    ...
    {
        try { default(MethodInfo)!.GetParameters(); _exitCode = 1; }
        catch (NullReferenceException) { }
    }
