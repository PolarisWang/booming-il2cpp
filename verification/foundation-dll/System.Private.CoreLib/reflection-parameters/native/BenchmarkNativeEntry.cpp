...
namespace chaos::benchmark::reflection_parameters
{
...
{
    if (entryIndex < 0 || static_cast<CHAOS_IL2CPP_SIZE>(entryIndex) >= chaos::benchmark::reflection_parameters::kBenchmarkEntryCount) { return -1; }
    return chaos::benchmark::reflection_parameters::kBenchmarkEntries[entryIndex]();
}
