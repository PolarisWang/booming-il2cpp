...
struct Functions {
    struct ThreadingThreadBasicsPatchEntry_t {
...
struct ThreadingThreadBasicsPatchEntry {
    static inline void CustomEntryMethod0(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod0(
        );
    }
    static inline void CustomEntryMethod10(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod10(
        );
    }
    static inline void CustomEntryMethod1(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod1(
        );
    }
    static inline void CustomEntryMethod2(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod2(
        );
    }
    static inline void CustomEntryMethod3(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod3(
        );
    }
    static inline void CustomEntryMethod4(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod4(
        );
    }
    static inline void CustomEntryMethod5(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod5(
        );
    }
    static inline void CustomEntryMethod6(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod6(
        );
    }
    static inline void CustomEntryMethod7(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod7(
        );
    }
    static inline void CustomEntryMethod8(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod8(
        );
    }
    static inline void CustomEntryMethod9(
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.CustomEntryMethod9(
        );
    }
    static inline void Run(
                CHAOS_IL2CPP_INT32 arg_0
    ) {
        return kFunctions.threadingThreadBasicsPatchEntry.Run(
                    arg_0
        );
    }
