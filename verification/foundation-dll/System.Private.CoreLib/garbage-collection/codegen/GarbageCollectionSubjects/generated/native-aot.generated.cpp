...
inline TypeInfoV0 chaos_mt_GarbageCollectionSubjects_GarbageCollectionSubjects = {{nullptr, nullptr, 6074204908258229484ULL, 0u, 32, 1, 1}, {nullptr, nullptr, 0, 0, 0, 0}};
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_GarbageCollectionSubjects_GarbageCollectionSubjects = static_cast<CHAOS_IL2CPP_INTPTR>(6074204908258229484ULL);inline TypeInfoV0 chaos_mt_System_Private_CoreLib_System_Object = {{nullptr, nullptr, 15228727185366376748ULL, 0u, 32, 1, 1}, {nullptr, nullptr, 0, 0, 0, 0}};
...
struct chaos_type_GarbageCollectionSubjects_GarbageCollectionSubjects
{
...
CHAOS_IL2CPP_INTPTR chaos_reflection_resolve_method_handle(CHAOS_IL2CPP_INTPTR chaos_type_handle, const char* chaos_method_name) noexcept
{
	...
	switch (chaos_type_handle)
	{
		case static_cast<CHAOS_IL2CPP_INTPTR>(36277100u):
			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_0") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(107589941u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_1") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(112019806u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_2") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(114679179u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_3") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(117174684u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_4") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(107815601u);
			}

			if (CHAOS_IL2CPP_STRCMP(chaos_method_name, "Subject_5") == 0)
			{
				return static_cast<CHAOS_IL2CPP_INTPTR>(101603642u);
			}
...
CHAOS_IL2CPP_INT32 chaos_static_GarbageCollectionSubjects_GarbageCollectionSubjects___exitCode = 0;
...
static void chaos_external_runtime_System_Private_CoreLib_System_GC__KeepAlive_System_Void_System_Object_(CHAOS_IL2CPP_INTPTR chaos_fn_arg_0)
{
	chaos_gc_keepalive(chaos_fn_arg_0);
}
...
static constexpr struct {
	...
	{
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_0
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_1
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4
		{ 0u, 0u },  // GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5
	},
	{
	},
};
...
// ── Module registration ──
	...
	static const ::chaos::il2cpp::runtime_core::ModuleDescriptor s_native_aot_module = {
		/* .name_utf8         = */ "GarbageCollectionSubjects",
		/* .image             = */ &kReflImage,
	...
	static const CHAOS_IL2CPP_UINT32 s_native_aot_module_id =
		::chaos::il2cpp::runtime_core::RegisterModule("GarbageCollectionSubjects", &s_native_aot_module);
// ── Hotpatch name index + dispatch table ────────────────────
// Method name index entries
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[6] = {
	{ "Subject_0", 0x00000003u, 0u },  // GarbageCollectionSubjects
	{ "Subject_1", 0x00000004u, 0u },  // GarbageCollectionSubjects
	{ "Subject_2", 0x00000005u, 0u },  // GarbageCollectionSubjects
	{ "Subject_3", 0x00000006u, 0u },  // GarbageCollectionSubjects
	{ "Subject_4", 0x00000007u, 0u },  // GarbageCollectionSubjects
	{ "Subject_5", 0x00000008u, 0u },  // GarbageCollectionSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[1] = {
	{ "GarbageCollectionSubjects", "", 0u, 6u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[6] = {
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_0), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_0
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_1), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_1
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_2
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_3
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_4
	{ reinterpret_cast<void*>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, kHotpatchActive },  // GarbageCollectionSubjects::Subject_5
};
...
extern "C" const char* kChaosExternalRuntimeSubjects[11] = {
	...
	"System.Private.CoreLib/System.GC::GetGeneration:System.Int32(System.Object)",
	"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode",
...
extern "C" void* kChaosExternalRuntimeFnTable[11] = {
	...
	nullptr,
	nullptr,
	reinterpret_cast<void*>(&chaos_external_runtime_System_Private_CoreLib_System_GC__KeepAlive_System_Void_System_Object_),
	nullptr,
	nullptr,
	nullptr,
...
static void (*kAotMethods[6])() = {
	...
	reinterpret_cast<void(*)()>(&GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3),
...
extern "C" const CodegenRegistrationOptionsV0 chaos_codegen_options
	...
	.image_name_utf8    = "GarbageCollectionSubjects",
};
// ── Reflection Query Image Descriptor ──────────────────────────
// Used by ResolveSubjectId to resolve call_target via subjectId
// matching during IR lowering of patched methods.

static constexpr ReflectionQueryFieldDescriptor kReflFields_GarbageCollectionSubjects_GarbageCollectionSubjects[1] = {
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode", "_exitCode", "System.Int32", 0LL },
};
static constexpr ReflectionQueryMethodDescriptor kReflMethods_GarbageCollectionSubjects_GarbageCollectionSubjects[6] = {
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_0:System.Void()", "Subject_0", "System.Void", 0, nullptr, 0u },
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_1:System.Void()", "Subject_1", "System.Void", 0, nullptr, 0u },
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_2:System.Void()", "Subject_2", "System.Void", 0, nullptr, 0u },
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_3:System.Void()", "Subject_3", "System.Void", 0, nullptr, 0u },
	{ 0u, "GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_4:System.Void()", "Subject_4", "System.Void", 0, nullptr, 0u },
...
// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_0()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_0(void)
{
...
// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_1()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_1(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
	...
	{
		reinterpret_cast<void(*)(void)>(kChaosExternalRuntimeFnTable[1])();
	}
	return;
}

// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_2()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
	...
	_s0 = reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&chaos_box_storage_0);
	{
		...
		chaos_external_runtime_System_Private_CoreLib_System_GC__KeepAlive_System_Void_System_Object_(chaos_arg_0);
	}
	return;
}

// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_3()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
	...
	{
		const auto chaos_arg_0 = _s0;
		const auto chaos_result = reinterpret_cast<CHAOS_IL2CPP_INT32(*)(CHAOS_IL2CPP_INTPTR)>(kChaosExternalRuntimeFnTable[4])(chaos_arg_0);
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_UINTPTR>(_s0) > static_cast<CHAOS_IL2CPP_UINTPTR>(_s1) ? 1 : 0);
	{
		if (_s0 != 0)
		{
			_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(1);
			{
				...
				chaos_static_GarbageCollectionSubjects_GarbageCollectionSubjects___exitCode = chaos_value;
			}
		}
		return;
	}
...
// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_4()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
...
// Managed method: GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_5()
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5(void)
{
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_args{};
	CHAOS_IL2CPP_ARRAY(CHAOS_IL2CPP_INTPTR, 1) chaos_locals{};
	...
	{
		const auto chaos_arg_0 = _s0;
		const auto chaos_result = chaos_external_runtime_System_Private_CoreLib_System_GC__GetTotalMemory_System_Int64_System_Boolean_(static_cast<CHAOS_IL2CPP_INT32>(chaos_arg_0));
		_s0 = ChaosStoreInt64(chaos_result);
	}
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INT32>(_s0));
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(52816);
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INTPTR>(_s0) == static_cast<CHAOS_IL2CPP_INTPTR>(_s1) ? 1 : 0);
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(0);
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INTPTR>(_s0) == static_cast<CHAOS_IL2CPP_INTPTR>(_s1) ? 1 : 0);
	{
...
static const char kMethodJson_0[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-0\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_0:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_0()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_0:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_0:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-0\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_0()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_0\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":0,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"call\",\"opCode\":14,\"ilOffset\":1,\"resultType\":\"System.Void\",\"callee\":\"System.Private.CoreLib/System.GC::Collect:System.Void()\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.GC::Collect:System.Void()\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.GC::Collect:System.Void()\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":7,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";
static const char kMethodJson_1[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-1\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_1:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_1()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_1:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_1:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-1\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_1()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_1\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":0,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"call\",\"opCode\":14,\"ilOffset\":1,\"resultType\":\"System.Void\",\"callee\":\"System.Private.CoreLib/System.GC::WaitForPendingFinalizers:System.Void()\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.GC::WaitForPendingFinalizers:System.Void()\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.GC::WaitForPendingFinalizers:System.Void()\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":7,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";
static const char kMethodJson_2[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-2\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_2:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_2()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_2:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_2:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-2\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_2()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":0,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":42,\"ilOffset\":1,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"box\",\"opCode\":35,\"operand\":\"System.Private.CoreLib/System.Int32\",\"ilOffset\":3,\"resultType\":\"System.Object\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"type\",\"subjectId\":\"System.Private.CoreLib/System.Int32\"},\"targetReference\":{\"kind\":1,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Int32\",\"typeShape\":1,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"runtimeServiceKind\":9,\"isPreserveSig\":false},{\"op\":\"call\",\"opCode\":14,\"ilOffset\":8,\"resultType\":\"System.Void\",\"callee\":\"System.Private.CoreLib/System.GC::KeepAlive:System.Void(System.Object)\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.GC::KeepAlive:System.Void(System.Object)\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.GC::KeepAlive:System.Void(System.Object)\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":14,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";
static const char kMethodJson_3[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-3\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_3:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_3()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_3:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_3:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-3\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_3()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":1,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":42,\"ilOffset\":1,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"box\",\"opCode\":35,\"operand\":\"System.Private.CoreLib/System.Int32\",\"ilOffset\":3,\"resultType\":\"System.Object\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"type\",\"subjectId\":\"System.Private.CoreLib/System.Int32\"},\"targetReference\":{\"kind\":1,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Int32\",\"typeShape\":1,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"runtimeServiceKind\":9,\"isPreserveSig\":false},{\"op\":\"call\",\"opCode\":14,\"ilOffset\":8,\"resultType\":\"System.Int32\",\"callee\":\"System.Private.CoreLib/System.GC::GetGeneration:System.Int32(System.Object)\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.GC::GetGeneration:System.Int32(System.Object)\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.GC::GetGeneration:System.Int32(System.Object)\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":0,\"ilOffset\":13,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"cgt.un\",\"opCode\":33,\"ilOffset\":14,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stloc\",\"opCode\":8,\"operand\":0,\"ilOffset\":16,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldloc\",\"opCode\":7,\"operand\":0,\"ilOffset\":17,\"isPreserveSig\":false},{\"op\":\"brfalse\",\"opCode\":19,\"operand\":26,\"ilOffset\":18,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":1,\"ilOffset\":20,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stsfld\",\"opCode\":13,\"operand\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"ilOffset\":21,\"resultType\":\"System.Void\",\"reference\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectKind\":\"field\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\"},\"targetReference\":{\"kind\":2,\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"declaringTypeShape\":1,\"fieldTypeSubjectId\":\"System.Int32\"},\"runtimeServiceKind\":5,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":26,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";
static const char kMethodJson_4[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-4\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_4:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_4()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_4:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_4:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-4\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_4()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":1,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"ldtoken\",\"opCode\":70,\"operand\":\"System.Private.CoreLib/System.Byte\",\"ilOffset\":1,\"resultType\":\"System.RuntimeTypeHandle\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"type\",\"subjectId\":\"System.Private.CoreLib/System.Byte\"},\"targetReference\":{\"kind\":1,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Byte\",\"typeShape\":1,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"isPreserveSig\":false},{\"op\":\"call\",\"opCode\":14,\"ilOffset\":6,\"resultType\":\"System.Type\",\"callee\":\"System.Private.CoreLib/System.Type::GetTypeFromHandle:System.Type(System.RuntimeTypeHandle)\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.Type::GetTypeFromHandle:System.Type(System.RuntimeTypeHandle)\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Type::GetTypeFromHandle:System.Type(System.RuntimeTypeHandle)\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":42,\"ilOffset\":11,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"call\",\"opCode\":14,\"ilOffset\":13,\"resultType\":\"System.Array\",\"callee\":\"System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32)\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32)\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32)\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"callvirt\",\"opCode\":15,\"ilOffset\":18,\"resultType\":\"System.Int32\",\"callee\":\"System.Private.CoreLib/System.Object::GetHashCode:System.Int32()\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.Object::GetHashCode:System.Int32()\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.Object::GetHashCode:System.Int32()\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":35342034,\"ilOffset\":23,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ceq\",\"opCode\":31,\"ilOffset\":28,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":0,\"ilOffset\":30,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ceq\",\"opCode\":31,\"ilOffset\":31,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stloc\",\"opCode\":8,\"operand\":0,\"ilOffset\":33,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldloc\",\"opCode\":7,\"operand\":0,\"ilOffset\":34,\"isPreserveSig\":false},{\"op\":\"brfalse\",\"opCode\":19,\"operand\":43,\"ilOffset\":35,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":1,\"ilOffset\":37,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stsfld\",\"opCode\":13,\"operand\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"ilOffset\":38,\"resultType\":\"System.Void\",\"reference\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectKind\":\"field\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\"},\"targetReference\":{\"kind\":2,\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"declaringTypeShape\":1,\"fieldTypeSubjectId\":\"System.Int32\"},\"runtimeServiceKind\":5,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":43,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";
static const char kMethodJson_5[] = "{\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-5\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_5:System.Void()\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_5()\",\"identity\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"definitionSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_5:System.Void()\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::Subject_5:System.Void()\",\"methodId\":\"garbage-collection-subjects.garbage-collection-subjects.subject-5\",\"signature\":\"System.Void GarbageCollectionSubjects::Subject_5()\"},\"nativeSymbol\":\"GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5\",\"isStatic\":true,\"returnType\":\"System.Void\",\"returnAbi\":{\"carrierKindCode\":0,\"typeShape\":1},\"parameterCount\":0,\"parameterAbis\":[],\"localCount\":1,\"exceptionRegionCount\":0,\"exceptionRegions\":[],\"instructions\":[{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":1,\"ilOffset\":1,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"call\",\"opCode\":14,\"ilOffset\":2,\"resultType\":\"System.Int64\",\"callee\":\"System.Private.CoreLib/System.GC::GetTotalMemory:System.Int64(System.Boolean)\",\"reference\":{\"assemblyName\":\"System.Private.CoreLib\",\"subjectKind\":\"method\",\"subjectId\":\"System.Private.CoreLib/System.GC::GetTotalMemory:System.Int64(System.Boolean)\"},\"targetReference\":{\"kind\":3,\"assemblyName\":\"System.Private.CoreLib\",\"subjectId\":\"System.Private.CoreLib/System.GC::GetTotalMemory:System.Int64(System.Boolean)\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeShape\":0},\"dispatchKindCode\":4,\"isPreserveSig\":false},{\"op\":\"conv.i4\",\"opCode\":39,\"ilOffset\":7,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":52816,\"ilOffset\":8,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ceq\",\"opCode\":31,\"ilOffset\":13,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":0,\"ilOffset\":15,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"ceq\",\"opCode\":31,\"ilOffset\":16,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stloc\",\"opCode\":8,\"operand\":0,\"ilOffset\":18,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldloc\",\"opCode\":7,\"operand\":0,\"ilOffset\":19,\"isPreserveSig\":false},{\"op\":\"brfalse\",\"opCode\":19,\"operand\":28,\"ilOffset\":20,\"resultType\":\"System.Void\",\"isPreserveSig\":false},{\"op\":\"ldc.i4\",\"opCode\":0,\"operand\":1,\"ilOffset\":22,\"resultType\":\"System.Int32\",\"isPreserveSig\":false},{\"op\":\"stsfld\",\"opCode\":13,\"operand\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"ilOffset\":23,\"resultType\":\"System.Void\",\"reference\":{\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectKind\":\"field\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\"},\"targetReference\":{\"kind\":2,\"assemblyName\":\"GarbageCollectionSubjects\",\"subjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects::_exitCode\",\"typeShape\":0,\"arrayElementTypeShape\":0,\"isSealed\":false,\"isComImport\":false,\"comInterfaceTypeKind\":0,\"declaringTypeSubjectId\":\"GarbageCollectionSubjects/GarbageCollectionSubjects\",\"declaringTypeShape\":1,\"fieldTypeSubjectId\":\"System.Int32\"},\"runtimeServiceKind\":5,\"isPreserveSig\":false},{\"op\":\"ret\",\"opCode\":53,\"ilOffset\":28,\"isPreserveSig\":false}],\"isPInvoke\":false,\"isUnmanagedCallersOnly\":false,\"importCallingConvention\":0,\"importCharSet\":0,\"importSetLastError\":false,\"isInternalLink\":false,\"isSuppressGCTransition\":false,\"hasBlittableStructReturn\":false,\"declaringAssemblyName\":\"GarbageCollectionSubjects\"}";

extern "C" const JitMethodEntry kChaosJitMethodEntries[6] =
{
    { kMethodJson_0, 1902u, 0x00000003u, 0u },
    { kMethodJson_1, 1953u, 0x00000004u, 0u },
    { kMethodJson_2, 2580u, 0x00000005u, 0u },
    { kMethodJson_3, 3908u, 0x00000006u, 0u },
    { kMethodJson_4, 5455u, 0x00000007u, 0u },
    { kMethodJson_5, 3668u, 0x00000008u, 0u }
};
