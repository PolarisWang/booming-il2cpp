...
static const struct {
	...
	/* ── Entry 0: GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2 ── */
	struct {
	...
	/* ── Entry 1: GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 2: GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 3: GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* ── Entry 4: GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_6 ── */
	struct {
		CHAOS_IL2CPP_UINT32 entry_total_size;
		const void*         code_address;
		CHAOS_IL2CPP_UINT32 frame_size;
	...
	/* entry0 = GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_2 */
	.entry0 = {
	...
	/* entry1 = GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_3 */
	.entry1 = {
	...
	/* entry2 = GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_4 */
	.entry2 = {
	...
	/* entry3 = GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5 */
	.entry3 = {
		/* entry_total_size = 36 */ 36u,
	...
	/* entry4 = GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_6 */
	.entry4 = {
...
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_5(void)
{
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(61040);
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INTPTR>(_s0) == static_cast<CHAOS_IL2CPP_INTPTR>(_s1) ? 1 : 0);
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(0);
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(static_cast<CHAOS_IL2CPP_INTPTR>(_s0) == static_cast<CHAOS_IL2CPP_INTPTR>(_s1) ? 1 : 0);
	{
...
extern "C" void GarbageCollectionSubjects_GarbageCollectionSubjects_Subject_6(void)
{
	...
	_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(-1851404613);
