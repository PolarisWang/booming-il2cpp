...
inline constexpr CHAOS_IL2CPP_INTPTR chaos_type_id_ReflectionTypeSubjects_ReflectionTypeSubjects = static_cast<CHAOS_IL2CPP_INTPTR>(14582329566846711146ULL);inline TypeInfoV0 chaos_mt_System_Private_CoreLib_System_Object = {{nullptr, nullptr, 15228727185366376748ULL, 0u, 32, 1, 1}, {nullptr, nullptr, 0, 0, 0, 0}};
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_ReflectionTypeSubjects_ReflectionTypeSubjects[44] = {
	...
	{ 0u, "ReflectionTypeSubjects/ReflectionTypeSubjects::Run:System.Void(System.Int32)", "Run", "System.Void", 0, nullptr, 0u },
};
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d33.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d34.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d35.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d36.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d37.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d38.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d39.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d40.method_key, nullptr, nullptr);
					}
					else
					{
			...
			{
				{
					...
					{
						::chaos::il2cpp::runtime_core::InterpreterEntryDirect(
							_d42.method_key, nullptr, nullptr);
					}
					else
					{
