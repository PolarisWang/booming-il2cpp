...
// Auto-generated hot-update skeletons for ReflectionTypeHotUpdate.
...
public static class ReflectionTypeHotUpdate
{
    ...
    // Purpose: Verify Type.get_Namespace executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_AssemblyQualifiedName executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsAbstract executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsSealed executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsInterface executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsByRef executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsPointer executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsNested executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsPublic executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsNotPublic executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsNestedPublic executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_IsNestedPrivate executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_DeclaringType executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_ReflectedType executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.get_UnderlyingSystemType executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetMethods_System_Reflection_MethodInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetMethods(null!); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetFields_System_Reflection_FieldInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetFields(null!); }
    // Purpose: Verify Type.GetProperties executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetProperties_System_Reflection_PropertyInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetProperties(null!); }
    // Purpose: Verify Type.GetEvents executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.GetConstructors executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetConstructors_System_Reflection_ConstructorInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetConstructors(null!); }
    // Purpose: Verify Type.GetMembers executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.GetInterfaces executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.GetElementType executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.GetNestedTypes executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Type.GetNestedType executes correctly after hot-update patch (host side)
