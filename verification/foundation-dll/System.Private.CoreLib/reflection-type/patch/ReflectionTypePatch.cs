...
public static class ReflectionTypePatch
{
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetType_System_Type_System_String_System_Boolean() { _ = Type.GetType("System.Int32", false); }
    // Verify Type.GetType after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Type::GetType:System.Type(System.String,System.Boolean,System.Boolean)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetType_System_Type_System_String_System_Boolean_System_Boolean() { _ = Type.GetType("System.Int32", false, false); }
    // Verify Type.GetTypeFromHandle after hot-update (host side)
    ...
    // Verify Type.get_Name after hot-update (host side)
    ...
    // Verify Type.get_FullName after hot-update (host side)
    ...
    // Verify Type.get_Namespace after hot-update (host side)
    ...
    // Verify Type.get_AssemblyQualifiedName after hot-update (host side)
    ...
    // Verify Type.get_TypeHandle after hot-update (host side)
    ...
    // Verify Type.get_IsValueType after hot-update (host side)
    ...
    // Verify Type.get_IsEnum after hot-update (host side)
    ...
    // Verify Type.get_IsAbstract after hot-update (host side)
    ...
    // Verify Type.get_IsSealed after hot-update (host side)
    ...
    // Verify Type.get_IsInterface after hot-update (host side)
    ...
    // Verify Type.get_IsArray after hot-update (host side)
    ...
    // Verify Type.get_IsByRef after hot-update (host side)
    ...
    // Verify Type.get_IsPointer after hot-update (host side)
    ...
    // Verify Type.get_IsNested after hot-update (host side)
    ...
    // Verify Type.get_IsPublic after hot-update (host side)
    ...
    // Verify Type.get_IsNotPublic after hot-update (host side)
    ...
    // Verify Type.get_IsNestedPublic after hot-update (host side)
    ...
    // Verify Type.get_IsNestedPrivate after hot-update (host side)
    ...
    // Verify Type.get_BaseType after hot-update (host side)
    ...
    // Verify Type.get_DeclaringType after hot-update (host side)
    ...
    // Verify Type.get_ReflectedType after hot-update (host side)
    ...
    // Verify Type.get_UnderlyingSystemType after hot-update (host side)
    ...
    // Verify Type.GetMethods after hot-update (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetMethods_System_Reflection_MethodInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetMethods(System.Reflection.BindingFlags.Default); }
    // Verify Type.GetFields after hot-update (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetFields_System_Reflection_FieldInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetFields(System.Reflection.BindingFlags.Default); }
    // Verify Type.GetProperties after hot-update (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetProperties_System_Reflection_PropertyInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetProperties(System.Reflection.BindingFlags.Default); }
    // Verify Type.GetEvents after hot-update (host side)
    ...
    // Verify Type.GetConstructors after hot-update (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionType)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Type_GetConstructors_System_Reflection_ConstructorInfo_System_Reflection_BindingFlags() { _ = typeof(byte).GetConstructors(System.Reflection.BindingFlags.Default); }
    // Verify Type.GetMembers after hot-update (host side)
    ...
    // Verify Type.GetInterfaces after hot-update (host side)
    ...
    // Verify Type.GetElementType after hot-update (host side)
    ...
    // Verify Type.GetNestedTypes after hot-update (host side)
    ...
    // Verify Type.GetNestedType after hot-update (host side)
