...
class ManagedBenchmarkHarness
{
    ...
    static void Main()
    {
        var results = new List<MethodResult>();
            { // [0] System.Private.CoreLib/System.Collections.Generic.List`1::Add:System.Void(T) — unsupported type
            ...
            { // [1] System.Private.CoreLib/System.Collections.Generic.List`1::Clear:System.Void() — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 1,
            ...
            { // [2] System.Private.CoreLib/System.Collections.Generic.List`1::Contains:System.Boolean(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 2,
            ...
            { // [3] System.Private.CoreLib/System.Collections.Generic.List`1::IndexOf:System.Int32(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 3,
            ...
            { // [4] System.Private.CoreLib/System.Collections.Generic.List`1::Remove:System.Boolean(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 4,
            ...
            { // [5] System.Private.CoreLib/System.Collections.Generic.List`1::RemoveAt:System.Void(System.Int32) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 5,
            ...
            { // [6] System.Private.CoreLib/System.Collections.Generic.List`1::Sort:System.Void() — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 6,
            ...
            { // [7] System.Private.CoreLib/System.Collections.Generic.List`1::ToArray:T[]() — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 7,
            ...
            { // [8] System.Private.CoreLib/System.Collections.Generic.Dictionary`2::Add:System.Void(TKey,TValue) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 8,
            ...
            { // [9] System.Private.CoreLib/System.Collections.Generic.Dictionary`2::get_Count:System.Int32() — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 9,
            ...
            { // [10] System.Private.CoreLib/System.Collections.Generic.Dictionary`2::TryGetValue:System.Boolean(TKey,TValue&) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 10,
            ...
            { // [11] System.Private.CoreLib/System.Collections.Generic.Dictionary`2::ContainsKey:System.Boolean(TKey) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 11,
            ...
            { // [12] System.Private.CoreLib/System.Collections.Generic.Dictionary`2::Remove:System.Boolean(TKey) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 12,
            ...
            { // [13] System.Private.CoreLib/System.Collections.Generic.HashSet`1::Add:System.Boolean(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 13,
            ...
            { // [14] System.Private.CoreLib/System.Collections.Generic.HashSet`1::Contains:System.Boolean(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 14,
            ...
            { // [15] System.Private.CoreLib/System.Collections.Generic.HashSet`1::Remove:System.Boolean(T) — unsupported type
                results.Add(new MethodResult {
                    MethodIndex = 15,
