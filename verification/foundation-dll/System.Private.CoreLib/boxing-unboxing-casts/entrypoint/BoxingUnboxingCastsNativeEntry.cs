...
public static class BoxingUnboxingCastsNativeEntry
{
    ...
    static int Method7()
    {
        return ((RuntimeHelpers.GetObjectValue(42)).GetHashCode());
    }
