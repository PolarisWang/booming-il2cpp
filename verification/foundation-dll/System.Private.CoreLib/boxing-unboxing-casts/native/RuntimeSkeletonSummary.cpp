...
// native-reference runtime skeleton for family/System.Private.CoreLib/boxing/unboxing-casts
#include "bootstrap.h"
...
{
namespace runtime_skeleton_boxing_unboxing_casts
{
...
constexpr std::size_t translation_unit_method_count = 11;
constexpr std::size_t translation_unit_page_size = 11;
...
{
    { 0, "System.Private.CoreLib/System.Convert::ChangeType:System.Object(System.Object,System.Type)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Convert::ChangeType:System.Object(System.Object,System.Type,System.IFormatProvider)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Type::IsAssignableFrom:System.Boolean(System.Type)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Type::IsInstanceOfType:System.Boolean(System.Object)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Type::IsSubclassOf:System.Boolean(System.Type)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Type::IsAssignableTo:System.Boolean(System.Type)", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Object::MemberwiseClone:System.Object()", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.Runtime.CompilerServices.RuntimeHelpers::GetObjectValue:System.Object(System.Object)", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32,System.Int32)", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Private.CoreLib/System.ValueType::Equals:System.Boolean(System.Object)", DispatchRuntimeSkeletonPage0001, 10 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_boxing_unboxing_casts(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_boxing_unboxing_casts::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_boxing_unboxing_casts::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_boxing_unboxing_casts::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_boxing_unboxing_casts::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_boxing_unboxing_casts(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_boxing_unboxing_casts(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
