...
extern "C" void SnapshotProverSubjects_SnapshotProverSubjects_Run(CHAOS_IL2CPP_INT32 chaos_fn_arg_0);
...
static constexpr struct {
...
} s_abi_manifest_storage = {
	{
		...
		11u,
		1u,
		4285459777u,  // FNV-1a over entries+params
		s_abi_manifest_prefix_sum  // O(1) prefix-sum
	},
	{
		{ 0u, 1u },  // SnapshotProverSubjects_SnapshotProverSubjects_Run
...
static constexpr HotpatchMethodEntryV0 s_hotpatch_methods[11] = {
	{ "Run", 0x0000000Du, 1u },  // SnapshotProverSubjects
	...
	{ "Subject_8", 0x0000000Bu, 0u },  // SnapshotProverSubjects
	{ "Subject_9", 0x0000000Cu, 0u },  // SnapshotProverSubjects
};

// Type name index entries (namespace, short_name)
static constexpr HotpatchTypeEntryV0 s_hotpatch_types[1] = {
	{ "SnapshotProverSubjects", "", 0u, 11u },
};
...
static HotpatchEntryV0 s_hotpatch_entries[11] = {
	{ reinterpret_cast<void*>(&SnapshotProverSubjects_SnapshotProverSubjects_Run), reinterpret_cast<void*>(&InterpreterEntryDirect), 0ull, 0 },  // SnapshotProverSubjects::Run
...
static void (*kAotMethods[11])() = {
	reinterpret_cast<void(*)()>(&SnapshotProverSubjects_SnapshotProverSubjects_Run),
...
static constexpr ReflectionQueryImageDescriptor kReflImage = { "SnapshotProverSubjects", kReflTypePtrs, 1u };
...
extern "C" void SnapshotProverSubjects_SnapshotProverSubjects_Subject_2(void)
{
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(25);
	{
		const auto chaos_right = static_cast<CHAOS_IL2CPP_INTPTR>(_s1);
		const auto chaos_left = static_cast<CHAOS_IL2CPP_INTPTR>(_s0);
		if (chaos_left == chaos_right)
...
extern "C" void SnapshotProverSubjects_SnapshotProverSubjects_Subject_4(void)
{
	...
	_s1 = static_cast<CHAOS_IL2CPP_INTPTR>(58);
	chaos_locals[0] = _s1;
	_s1 = chaos_locals[0];
	{
		const auto chaos_right = static_cast<CHAOS_IL2CPP_INT32>(_s1);
		const auto chaos_left = static_cast<CHAOS_IL2CPP_INT32>(_s0);
		_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(ChaosWrapSub(chaos_left, chaos_right));
	}
...
extern "C" void SnapshotProverSubjects_SnapshotProverSubjects_Subject_5(void)
{
	...
	_s0 = static_cast<CHAOS_IL2CPP_INTPTR>(84);
...
chaos_label_24:
	{
		auto chaos_value = chaos_eval_stack[--chaos_stack_top];
		chaos_static_SnapshotProverSubjects_SnapshotProverSubjects___exitCode = chaos_value;
	}
chaos_label_29:
	return;
...
extern "C" void SnapshotProverSubjects_SnapshotProverSubjects_Subject_9(void)
{
	...
	_s1 = chaos_locals[0];
	{
		const auto chaos_right = chaos_load_uint64(_s1);
		const auto chaos_left = chaos_load_uint64(_s0);
		_s0 = chaos_store_uint64(chaos_left & chaos_right);
	}
	{
		if (_s0 != static_cast<CHAOS_IL2CPP_INTPTR>(0))
		{
