...
// Auto-generated hot-update skeletons for ExceptionThrowDiagnosticsHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class ExceptionThrowDiagnosticsHotUpdate
{
    // Purpose: Verify Exception..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.get_Message executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.get_InnerException executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.get_StackTrace executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.get_HResult executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.ToString executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Exception.GetBaseException executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ArgumentException..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ArgumentNullException..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ArgumentOutOfRangeException..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify InvalidOperationException..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify NotSupportedException..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify NotImplementedException..ctor executes correctly after hot-update patch (host side)
