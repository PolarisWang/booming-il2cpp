...
public static class ExceptionThrowDiagnosticsHotUpdate
{
    // Verify Exception..ctor after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ExceptionThrowDiagnostics)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Exception_ctor_System_Void_System_String_System_Exception() { new Exception("hello", default); }
    // Verify Exception.get_Message after hot-update (patch side)
    ...
    // Verify Exception.get_InnerException after hot-update (patch side)
    ...
    // Verify Exception.get_StackTrace after hot-update (patch side)
    ...
    // Verify Exception.ToString after hot-update (patch side)
    ...
    // Verify Exception.GetBaseException after hot-update (patch side)
    ...
    // Verify ArgumentException..ctor after hot-update (patch side)
    ...
    // Verify ArgumentNullException..ctor after hot-update (patch side)
    ...
    // Verify ArgumentOutOfRangeException..ctor after hot-update (patch side)
    ...
    // Verify InvalidOperationException..ctor after hot-update (patch side)
    ...
    // Verify NotSupportedException..ctor after hot-update (patch side)
    ...
    // Verify NotImplementedException..ctor after hot-update (patch side)
    ...
    // Verify OSR.HotLoop after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/OSR::HotLoop:System.Void()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ExceptionThrowDiagnostics)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_OSR_HotLoop_System_Void() { OSR.HotLoop(); }
    // Verify Memory.CopyBlock after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/Memory::CopyBlock:System.Void()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ExceptionThrowDiagnostics)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_Memory_CopyBlock_System_Void() { default(Memory<byte>).CopyBlock(); }
    // Verify Memory.InitBlock after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/Memory::InitBlock:System.Void()")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ExceptionThrowDiagnostics)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_Memory_InitBlock_System_Void() { default(Memory<byte>).InitBlock(); }}
