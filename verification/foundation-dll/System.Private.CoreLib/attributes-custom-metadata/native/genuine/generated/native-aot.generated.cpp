...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_Reflection_CustomAttributeExtensions__GetCustomAttribute_System_Attribute_System_Reflection_Assembly_System_Type_(CHAOS_IL2CPP_INTPTR chaos_arg_0, CHAOS_IL2CPP_INTPTR chaos_arg_1)
{
    return chaos_reflection_get_custom_attribute(chaos_arg_0, chaos_arg_1);
}

extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_Reflection_CustomAttributeExtensions__IsDefined_System_Boolean_System_Reflection_Assembly_System_Type_(CHAOS_IL2CPP_INTPTR chaos_arg_0, CHAOS_IL2CPP_INTPTR chaos_arg_1)
{
    return chaos_reflection_is_defined(chaos_arg_0, chaos_arg_1);
}
