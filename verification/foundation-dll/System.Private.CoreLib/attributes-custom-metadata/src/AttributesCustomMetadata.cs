...
public partial class AttributesCustomMetadata
{
    ...
    public static void Benchmark_Attribute_GetCustomAttribute()
    {
    ...
    [BenchmarkRoute(BenchmarkRoute.Native)]
    [BenchmarkProfile(BenchmarkProfile.Default)]
    public static void Benchmark_Attribute_IsDefined()
    {
    ...
    [BenchmarkRoute(BenchmarkRoute.Native)]
    [BenchmarkProfile(BenchmarkProfile.Default)]
    public static void Benchmark_Attribute_GetCustomAttributes()
    {
        _ = typeof(byte).Assembly.GetCustomAttributes(typeof(AssemblyDescriptionAttribute), false);
    }

    // ============================================================
    // [HotUpdateSubjectId] 热更新 Host→Patch — 自定义属性
    // ============================================================
    ...
    public static void HotUpdate_Attribute_GetCustomAttribute_Assembly()
    {
        _ = typeof(byte).Assembly.GetCustomAttribute(typeof(AssemblyDescriptionAttribute));
    }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_Attribute_IsDefined_Assembly()
    {
        _ = typeof(byte).Assembly.IsDefined(typeof(AssemblyDescriptionAttribute));
    }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_Attribute_GetCustomAttributes_Member()
    {
        _ = typeof(string).GetCustomAttributes(typeof(SerializableAttribute), false);
    }
}
