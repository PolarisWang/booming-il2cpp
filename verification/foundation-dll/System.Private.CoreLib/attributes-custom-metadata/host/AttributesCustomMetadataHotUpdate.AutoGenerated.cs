...
// Auto-generated hot-update skeletons for AttributesCustomMetadataHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class AttributesCustomMetadataHotUpdate
{
    // Purpose: Verify Attribute.GetCustomAttribute executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Attribute.GetCustomAttributes executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Attribute_GetCustomAttributes_System_Attribute_System_Reflection_MemberInfo_System_Type() { _ = typeof(byte).Assembly.GetCustomAttributes(typeof(AssemblyDescriptionAttribute)); }
    // Purpose: Verify Attribute.GetCustomAttributes executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Attribute_GetCustomAttributes_System_Attribute_System_Reflection_Assembly_System_Type() { _ = typeof(byte).Assembly.GetCustomAttributes(typeof(AssemblyDescriptionAttribute)); }
    // Purpose: Verify Attribute.GetCustomAttributes executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Attribute_GetCustomAttributes_System_Attribute_System_Reflection_MemberInfo() { _ = typeof(byte).Assembly.GetCustomAttributes(); }
    // Purpose: Verify Attribute.GetCustomAttributes executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_AttributesCustomMetadata)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Attribute_GetCustomAttributes_System_Attribute_System_Reflection_Assembly() { _ = typeof(byte).Assembly.GetCustomAttributes(); }
    // Purpose: Verify Attribute.IsDefined executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Attribute.get_TypeId executes correctly after hot-update patch (host side)
