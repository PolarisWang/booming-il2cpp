...
public static partial class AttributesCustomMetadataSubjects
{
    ...
    {
        if (((typeof(byte).Assembly.GetCustomAttribute(typeof(AssemblyDescriptionAttribute))).GetHashCode()) != -1585855194) _exitCode = 1;
    }
    ...
    {
        if ((new System.Collections.Generic.List<System.Attribute>(typeof(byte).Assembly.GetCustomAttributes(typeof(AssemblyDescriptionAttribute)).Cast<System.Attribute>()).Count) != 1) _exitCode = 1;
    }
    ...
    {
        if ((new System.Collections.Generic.List<System.Attribute>(typeof(byte).Assembly.GetCustomAttributes(false).Cast<System.Attribute>()).Count) != 22) _exitCode = 1;
    }
    ...
    {
        if (((typeof(byte).Assembly.IsDefined(typeof(AssemblyDescriptionAttribute))) ? 1 : 0) != 1) _exitCode = 1;
    }
