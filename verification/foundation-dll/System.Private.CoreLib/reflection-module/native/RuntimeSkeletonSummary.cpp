...
// native-reference runtime skeleton for family/System.Private.CoreLib/reflection/module
#include "bootstrap.h"
...
{
namespace runtime_skeleton_reflection_module
{{
...
constexpr CHAOS_IL2CPP_SIZE translation_unit_method_count = 6;
constexpr CHAOS_IL2CPP_SIZE translation_unit_page_size = 6;
...
{
    { 0, "System.Private.CoreLib/System.Reflection.Module::get_FullyQualifiedName:System.String()", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Reflection.Module::get_Name:System.String()", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Reflection.Module::get_Assembly:System.Reflection.Assembly()", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Reflection.Module::GetType:System.Type(System.String)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Reflection.Module::GetTypes:System.Type[]()", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Reflection.Module::GetCustomAttributes:System.Object[](System.Type)", DispatchRuntimeSkeletonPage0001, 5 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_reflection_module(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_reflection_module::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_reflection_module::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_reflection_module::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_reflection_module::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_reflection_module(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_reflection_module(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
