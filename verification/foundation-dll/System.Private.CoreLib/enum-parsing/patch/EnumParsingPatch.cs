...
{
    // Verify Enum.Format after hot-update (host side)
    ...
    // Verify Enum.GetNames after hot-update (host side)
    ...
    // Verify Enum.GetValues after hot-update (host side)
    ...
    // Verify Enum.IsDefined after hot-update (host side)
