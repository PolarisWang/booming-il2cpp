...
public static class PrimitiveNumericConversionsPatch
{
    ...
    public static void Patch_System_Private_CoreLib_System_Convert_ToBoolean_System_Boolean_System_String() { _ = Convert.ToBoolean("true"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToByte_System_Byte_System_String() { _ = Convert.ToByte("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToInt16_System_Int16_System_String() { _ = Convert.ToInt16("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToInt32_System_Int32_System_String() { _ = Convert.ToInt32("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToInt64_System_Int64_System_String() { _ = Convert.ToInt64("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToSingle_System_Single_System_String() { _ = Convert.ToSingle("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToDouble_System_Double_System_String() { _ = Convert.ToDouble("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToDecimal_System_Decimal_System_String() { _ = Convert.ToDecimal("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToDecimal_System_Decimal_System_Double() { _ = Convert.ToDecimal(42.0); }
    // Verify Convert.ToInt32 after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Convert::ToInt32:System.Int32(System.Double)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Convert_ToInt32_System_Int32_System_Double() { _ = Convert.ToInt32(42.0); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Int32_Parse_System_Int32_System_String() { _ = int.Parse("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Int64_Parse_System_Int64_System_String() { _ = long.Parse("42"); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_PrimitiveNumericConversions)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_Double_Parse_System_Double_System_String() { _ = double.Parse("42"); }}
