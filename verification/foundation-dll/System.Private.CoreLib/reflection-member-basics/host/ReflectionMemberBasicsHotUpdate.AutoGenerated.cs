...
// Auto-generated hot-update skeletons for ReflectionMemberBasicsHotUpdate.
...
public static class ReflectionMemberBasicsHotUpdate
{
    ...
    // Purpose: Verify MethodInfo.GetParameters executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify FieldInfo.GetValue executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify FieldInfo.SetValue executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify PropertyInfo.GetValue executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify PropertyInfo.SetValue executes correctly after hot-update patch (host side)
