...
static CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_String__Contains_System_Boolean_System_String_System_StringComparison_(CHAOS_IL2CPP_INTPTR chaos_arg_0, CHAOS_IL2CPP_INTPTR chaos_arg_1, CHAOS_IL2CPP_INT32 chaos_arg_2)
{
	if (chaos_arg_2 != 4)
	{
		CHAOS_IL2CPP_FAIL();
...
extern "C" void* kChaosExternalRuntimeFnTable[15] = {
	...
	nullptr,
	reinterpret_cast<void*>(&chaos_external_runtime_System_Private_CoreLib_System_String__Contains_System_Boolean_System_String_System_StringComparison_),
			...
			}
			{
				if (_s3 == 0)
				{
					...
					_s4 = static_cast<CHAOS_IL2CPP_INTPTR>(5);
					{
						...
						const auto chaos_result = chaos_external_runtime_System_Private_CoreLib_System_String__Contains_System_Boolean_System_String_System_StringComparison_(chaos_arg_0, chaos_arg_1, static_cast<CHAOS_IL2CPP_INT32>(chaos_arg_2));
						_s2 = static_cast<CHAOS_IL2CPP_INTPTR>(chaos_result);
					}
					{
						if (_s2 != 0)
						...
						else
						{
							_s6 = chaos_locals[2];
							{{
								_s7 = CHAOS_IL2CPP_STRING_ID("80004005");
							}}
							_s8 = static_cast<CHAOS_IL2CPP_INTPTR>(5);
							{
