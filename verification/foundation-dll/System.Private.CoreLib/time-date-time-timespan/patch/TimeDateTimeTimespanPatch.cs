...
{
    // Verify DateTime..ctor after hot-update (host side)
    ...
    // Verify DateTime.Parse after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.DateTime::Parse:System.DateTime(System.String)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_TimeDateTimeTimespan)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_DateTime_Parse_System_DateTime_System_String() { _ = DateTime.Parse("2024-01-01"); }
    // Verify DateTime.TryParse after hot-update (host side)
    ...
    // Verify DateTime.ToString after hot-update (host side)
    ...
    // Verify DateTime.AddDays after hot-update (host side)
    ...
    // Verify DateTime.AddHours after hot-update (host side)
    ...
    // Verify DateTime.AddMinutes after hot-update (host side)
    ...
    // Verify DateTime.Compare after hot-update (host side)
    ...
    // Verify DateTime.DaysInMonth after hot-update (host side)
    ...
    // Verify TimeSpan..ctor after hot-update (host side)
    ...
    // Verify TimeSpan.FromDays after hot-update (host side)
    ...
    // Verify TimeSpan.FromHours after hot-update (host side)
    ...
    // Verify TimeSpan.FromMinutes after hot-update (host side)
    ...
    // Verify TimeSpan.Parse after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.TimeSpan::Parse:System.TimeSpan(System.String)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_TimeDateTimeTimespan)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_TimeSpan_Parse_System_TimeSpan_System_String() { _ = TimeSpan.Parse("1:00:00"); }}
