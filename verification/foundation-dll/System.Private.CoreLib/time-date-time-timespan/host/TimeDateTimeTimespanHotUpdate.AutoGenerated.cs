...
// Auto-generated hot-update skeletons for TimeDateTimeTimespanHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class TimeDateTimeTimespanHotUpdate
{
    // Purpose: Verify DateTime..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.Parse executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.TryParse executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.ToString executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.AddDays executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.AddHours executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.AddMinutes executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.Compare executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify DateTime.DaysInMonth executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TimeSpan..ctor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TimeSpan.FromDays executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TimeSpan.FromHours executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TimeSpan.FromMinutes executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TimeSpan.Parse executes correctly after hot-update patch (host side)
