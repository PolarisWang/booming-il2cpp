...
public static class TimeDateTimeTimespanBenchmarks
{
    ...
    [BenchmarkRoute(BenchmarkRoute.Native)]
    [BenchmarkProfile(BenchmarkProfile.Default)]
    public static void Benchmark_System_Private_CoreLib_System_DateTime_Parse_System_DateTime_System_String() { _ = DateTime.Parse("2024-01-01"); }
    ...
    [BenchmarkRoute(BenchmarkRoute.Native)]
    [BenchmarkProfile(BenchmarkProfile.Default)]
    public static void Benchmark_System_Private_CoreLib_System_TimeSpan_Parse_System_TimeSpan_System_String() { _ = TimeSpan.Parse("1:00:00"); }}
