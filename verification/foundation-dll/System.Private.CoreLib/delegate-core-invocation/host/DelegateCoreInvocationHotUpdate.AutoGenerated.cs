...
// Auto-generated hot-update skeletons for DelegateCoreInvocationHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class DelegateCoreInvocationHotUpdate
{
    // Purpose: Verify Delegate.Combine executes correctly after hot-update patch (host side)
    ...
    public static void HotUpdate_System_Private_CoreLib_System_Delegate_Combine_System_Delegate_System_Delegate_System_Delegate() { }
    // Purpose: Verify Delegate.Remove executes correctly after hot-update patch (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Delegate::Remove:System.Delegate(System.Delegate,System.Delegate)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_DelegateCoreInvocation)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Delegate_Remove_System_Delegate_System_Delegate_System_Delegate() { }
    // Purpose: Verify Delegate.DynamicInvoke executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Delegate.get_Method executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Delegate.get_Target executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Delegate.CreateDelegate executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify MulticastDelegate.GetInvocationList executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Delegate.op_Equality executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Delegate.op_Inequality executes correctly after hot-update patch (host side)
