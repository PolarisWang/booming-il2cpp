	...
	const chaos_type_System_Private_CoreLib_System_Delegate* chaos_delegate) noexcept
{
	if (chaos_delegate == nullptr ||
		chaos_delegate->chaos_delegate_invocation_list == 0 ||
		chaos_delegate->chaos_delegate_invocation_count <= 0)
	{
		return nullptr;
	}
	...
	const chaos_delegate_invocation_list& chaos_entries)
{
	...
	chaos_delegate->chaos_delegate_target = 0;
	chaos_delegate->chaos_delegate_method_ptr = 0;
...
{
	if (chaos_source_value == 0)
	{
		return 0;
	}

	if (chaos_value_to_remove == 0)
	{
...
static constexpr ReflectionQueryMethodDescriptor kReflMethods_DelegateCoreInvocationSubjects_DelegateCoreInvocationSubjects[11] = {
	...
	{ 0u, "DelegateCoreInvocationSubjects/DelegateCoreInvocationSubjects::Run:System.Void(System.Int32)", "Run", "System.Void", 0, nullptr, 0u },
};
