...
// native-reference runtime skeleton for family/System.Private.CoreLib/delegate/core-invocation
#include "bootstrap.h"
...
{
namespace runtime_skeleton_delegate_core_invocation
{
...
{
    { 0, "System.Private.CoreLib/System.Delegate::Combine:System.Delegate(System.Delegate,System.Delegate)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Delegate::Remove:System.Delegate(System.Delegate,System.Delegate)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Delegate::DynamicInvoke:System.Object(System.Object[])", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Delegate::get_Method:System.Reflection.MethodInfo()", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Delegate::get_Target:System.Object()", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Delegate::CreateDelegate:System.Delegate(System.Type,System.Object,System.String)", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Delegate::CreateDelegate:System.Delegate(System.Type,System.Reflection.MethodInfo)", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.MulticastDelegate::GetInvocationList:System.Delegate[]()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.Delegate::op_Equality:System.Boolean(System.Delegate,System.Delegate)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.Delegate::op_Inequality:System.Boolean(System.Delegate,System.Delegate)", DispatchRuntimeSkeletonPage0001, 9 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_delegate_core_invocation(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_delegate_core_invocation::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_delegate_core_invocation::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_delegate_core_invocation::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_delegate_core_invocation::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_delegate_core_invocation(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_delegate_core_invocation(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
