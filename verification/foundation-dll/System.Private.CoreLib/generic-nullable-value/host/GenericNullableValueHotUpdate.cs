...
{
    // Verify Nullable.get_HasValue after hot-update (patch side)
    ...
    // Verify Nullable.get_Value after hot-update (patch side)
    ...
    // Verify Nullable.Equals after hot-update (patch side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.Nullable`1::Equals:System.Boolean(System.Object)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_GenericNullableValue)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Nullable_1_Equals_System_Boolean_System_Object() { _ = default(Nullable<int>).Equals(null!); }
    // Verify Nullable.GetHashCode after hot-update (patch side)
    ...
    // Verify Nullable.ToString after hot-update (patch side)
    ...
    // Verify ValueType.GetHashCode after hot-update (patch side)
    ...
    // Verify ValueType.ToString after hot-update (patch side)
