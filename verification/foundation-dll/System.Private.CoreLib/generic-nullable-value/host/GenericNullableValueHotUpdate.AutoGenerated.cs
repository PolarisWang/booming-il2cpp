...
// Auto-generated hot-update skeletons for GenericNullableValueHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class GenericNullableValueHotUpdate
{
    // Purpose: Verify Nullable.get_HasValue executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Nullable.get_Value executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Nullable.GetValueOrDefault executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Nullable.Equals executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Nullable.GetHashCode executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Nullable.ToString executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ValueType.GetHashCode executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify ValueType.ToString executes correctly after hot-update patch (host side)
