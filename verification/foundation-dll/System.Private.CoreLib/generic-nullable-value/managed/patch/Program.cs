...
public class Program
{
    static int Main()
    {
        ...
        GenericNullableValuePatchEntry._exitCode = 0; GenericNullableValuePatchEntry.Method7(); failures += GenericNullableValuePatchEntry._exitCode << 7;
        GenericNullableValuePatchEntry._exitCode = 0; GenericNullableValuePatchEntry.Method8(); failures += GenericNullableValuePatchEntry._exitCode << 8;
        GenericNullableValuePatchEntry._exitCode = 0; GenericNullableValuePatchEntry.Method9(); failures += GenericNullableValuePatchEntry._exitCode << 9;
        return failures;
    }
}
