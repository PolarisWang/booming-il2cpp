...
public static class GenericNullableValueSemanticPatchEntry
{
    ...
    static int Method0()
    {
        return (new Nullable<int>(99).HasValue ? 1 : 0);
    }

    // [1] System.Private.CoreLib/System.Nullable`1::get_Value:T()
    static int Method1()
    {
        return new Nullable<int>(99).Value.GetHashCode();
    }

    // [2] System.Private.CoreLib/System.Nullable`1::GetValueOrDefault:T()
    static int Method2()
    {
        return new Nullable<int>(99).GetValueOrDefault().GetHashCode();
    }

    // [3] System.Private.CoreLib/System.Nullable`1::GetValueOrDefault:T(T)
    static int Method3()
    {
        // TODO: System.Private.CoreLib/System.Nullable`1::GetValueOrDefault:T(T) could not be auto-generated for semantic-patch
        return 0;
    }
    ...
    static int Method8()
    {
        return ((ValueType)99).GetHashCode();
    }

    // [9] System.Private.CoreLib/System.ValueType::ToString:System.String()
    static int Method9()
    {
        return (((ValueType)99).ToString()?.GetHashCode() ?? 0);
    }
