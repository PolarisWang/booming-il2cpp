...
// native-reference runtime skeleton for family/System.Private.CoreLib/generic/nullable-value
#include "bootstrap.h"
...
{
namespace runtime_skeleton_generic_nullable_value
{
...
{
    { 0, "System.Private.CoreLib/System.Nullable`1::get_HasValue:System.Boolean()", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Nullable`1::get_Value:T()", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Nullable`1::GetValueOrDefault:T()", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Nullable`1::GetValueOrDefault:T(T)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Nullable`1::Equals:System.Boolean(System.Object)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Nullable`1::GetHashCode:System.Int32()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Nullable`1::ToString:System.String()", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.ValueType::Equals:System.Boolean(System.Object)", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.ValueType::GetHashCode:System.Int32()", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.ValueType::ToString:System.String()", DispatchRuntimeSkeletonPage0001, 9 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_generic_nullable_value(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_generic_nullable_value::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_generic_nullable_value::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_generic_nullable_value::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_generic_nullable_value::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_generic_nullable_value(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_generic_nullable_value(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
