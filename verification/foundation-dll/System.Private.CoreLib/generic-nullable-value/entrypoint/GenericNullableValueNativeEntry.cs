...
public static class GenericNullableValueNativeEntry
{
    ...
    static int Method0()
    {
        return ((default(Nullable<int>).HasValue) ? 1 : 0);
    }
    ...
    static int Method4()
    {
        return ((default(Nullable<int>).Equals(42)) ? 1 : 0);
    }
    ...
    static int Method6()
    {
        return ((default(Nullable<int>).ToString()).Length);
    }
    ...
    static int Method9()
    {
        return ((((ValueType)42).ToString()).Length);
    }
