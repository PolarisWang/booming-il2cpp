...
public static class StringCharTextCoreNativeEntry
{
    ...
    static int Method16()
    {
        return ((String.Join("hello", Array.Empty<System.String>())).Length);
    }
