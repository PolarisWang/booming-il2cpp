...
{
    if (entryIndex < 0 || static_cast<CHAOS_IL2CPP_SIZE>(entryIndex) >= chaos::benchmark::type_runtime_handles::kBenchmarkEntryCount) { return -1; }
    return chaos::benchmark::type_runtime_handles::kBenchmarkEntries[entryIndex]();
}
