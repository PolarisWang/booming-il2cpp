...
// native-reference runtime skeleton for family/System.Private.CoreLib/type/runtime-handles
#include "bootstrap.h"
...
{
namespace runtime_skeleton_type_runtime_handles
{
...
constexpr RuntimeSkeletonMethodDispatchCatalogEntry kMethodDispatchCatalog[] =
{
    ...
    { 4, "System.Private.CoreLib/System.Type::get_IsValueType:System.Boolean()", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Type::get_IsEnum:System.Boolean()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Type::get_IsArray:System.Boolean()", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.Type::get_TypeHandle:System.RuntimeTypeHandle()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.Type::get_FullName:System.String()", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.Type::get_Name:System.String()", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Private.CoreLib/System.Type::get_BaseType:System.Type()", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.Private.CoreLib/System.Type::GetMethods:System.Reflection.MethodInfo[]()", DispatchRuntimeSkeletonPage0001, 11 },
    { 12, "System.Private.CoreLib/System.Type::GetFields:System.Reflection.FieldInfo[]()", DispatchRuntimeSkeletonPage0001, 12 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_type_runtime_handles(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_type_runtime_handles::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_type_runtime_handles::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_type_runtime_handles::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_type_runtime_handles::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_type_runtime_handles(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_type_runtime_handles(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
