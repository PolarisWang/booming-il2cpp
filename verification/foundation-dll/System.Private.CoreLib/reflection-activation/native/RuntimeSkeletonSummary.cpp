...
// native-reference runtime skeleton for family/System.Private.CoreLib/reflection/activation
#include "bootstrap.h"
...
{
namespace runtime_skeleton_reflection_activation
{{
...
constexpr CHAOS_IL2CPP_SIZE translation_unit_method_count = 8;
constexpr CHAOS_IL2CPP_SIZE translation_unit_page_size = 8;
...
{
    { 0, "System.Private.CoreLib/System.Activator::CreateInstance:System.Object(System.Type)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Activator::CreateInstance:System.Object(System.Type,System.Object[])", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Activator::CreateInstance:T()", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Activator::CreateInstance:System.Object(System.Type,System.Reflection.BindingFlags,System.Reflection.Binder,System.Object[],System.Globalization.CultureInfo)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32,System.Int32)", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Array::CreateInstance:System.Array(System.Type,System.Int32[])", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.Reflection.ConstructorInfo::Invoke:System.Object(System.Object[])", DispatchRuntimeSkeletonPage0001, 7 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_reflection_activation(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_reflection_activation::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_reflection_activation::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_reflection_activation::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_reflection_activation::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_reflection_activation(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_reflection_activation(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
