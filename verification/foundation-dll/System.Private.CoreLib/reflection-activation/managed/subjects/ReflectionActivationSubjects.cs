...
public static partial class ReflectionActivationSubjects
{
    ...
    {
        if (((Activator.CreateInstance(typeof(byte))).GetHashCode()) != ((Activator.CreateInstance(typeof(byte))).GetHashCode())) _exitCode = 1;
    }

    // [1] System.Private.CoreLib/System.Activator::CreateInstance:System.Object(System.Type,System.Object[])
    public static void Subject_1()
    {
        if (((Activator.CreateInstance(typeof(byte), Array.Empty<System.Object>())).GetHashCode()) != ((Activator.CreateInstance(typeof(byte), Array.Empty<System.Object>())).GetHashCode())) _exitCode = 1;
    }
    ...
    {
        if (((Activator.CreateInstance(typeof(byte), System.Reflection.BindingFlags.Default, null!, Array.Empty<System.Object>(), null!)).GetHashCode()) != ((Activator.CreateInstance(typeof(byte), System.Reflection.BindingFlags.Default, null!, Array.Empty<System.Object>(), null!)).GetHashCode())) _exitCode = 1;
    }
    ...
    {
        if (((Array.CreateInstance(typeof(byte), Array.Empty<System.Int32>())).GetHashCode()) != ((Array.CreateInstance(typeof(byte), Array.Empty<System.Int32>())).GetHashCode())) _exitCode = 1;
    }
