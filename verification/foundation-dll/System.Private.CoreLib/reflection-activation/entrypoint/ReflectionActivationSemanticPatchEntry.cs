...
public static class ReflectionActivationSemanticPatchEntry
{
    ...
    static int Method0()
    {
        return (Activator.CreateInstance(typeof(int))?.GetHashCode() ?? 0);
    }

    // [1] System.Private.CoreLib/System.Activator::CreateInstance:System.Object(System.Type,System.Object[])
    static int Method1()
    {
        return (Activator.CreateInstance(typeof(int), Array.Empty<System.Object>())?.GetHashCode() ?? 0);
    }
    ...
    static int Method3()
    {
        return (Activator.CreateInstance(typeof(int), System.Reflection.BindingFlags.Instance, null!, Array.Empty<System.Object>(), null!)?.GetHashCode() ?? 0);
    }
    ...
    static int Method6()
    {
        return Array.CreateInstance(typeof(int), Array.Empty<System.Int32>()).GetHashCode();
    }
