...
{
    // Verify Type.GetMethod after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionBinding)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetMethod_System_Reflection_MethodInfo_System_String_System_Reflection_BindingFlags() { _ = typeof(byte).GetMethod("hello", System.Reflection.BindingFlags.Default); }
    // Verify Type.GetMethod after hot-update (patch side)
    ...
    // Verify Type.GetField after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionBinding)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetField_System_Reflection_FieldInfo_System_String_System_Reflection_BindingFlags() { _ = typeof(byte).GetField("hello", System.Reflection.BindingFlags.Default); }
    // Verify Type.GetProperty after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionBinding)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetProperty_System_Reflection_PropertyInfo_System_String_System_Reflection_BindingFla() { _ = typeof(byte).GetProperty("hello", System.Reflection.BindingFlags.Default); }
    // Verify Type.GetProperty after hot-update (patch side)
    ...
    // Verify Type.GetEvent after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionBinding)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Type_GetEvent_System_Reflection_EventInfo_System_String_System_Reflection_BindingFlags() { _ = typeof(byte).GetEvent("hello", System.Reflection.BindingFlags.Default); }
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_ReflectionBinding)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Reflection_MethodBase_Invoke_System_Object_System_Object_System_Reflection_BindingFlags_Sy() { _ = default(MethodInfo)!.Invoke(null!, System.Reflection.BindingFlags.Default, default, Array.Empty<System.Object>(), default); }}
