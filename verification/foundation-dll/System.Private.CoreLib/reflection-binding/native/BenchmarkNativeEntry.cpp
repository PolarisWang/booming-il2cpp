...
namespace chaos::benchmark::reflection_binding
{
...
{
    if (entryIndex < 0 || static_cast<CHAOS_IL2CPP_SIZE>(entryIndex) >= chaos::benchmark::reflection_binding::kBenchmarkEntryCount) { return -1; }
    return chaos::benchmark::reflection_binding::kBenchmarkEntries[entryIndex]();
}
