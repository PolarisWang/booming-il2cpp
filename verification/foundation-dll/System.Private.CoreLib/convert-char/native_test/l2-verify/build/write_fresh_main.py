#!/usr/bin/env python3
"""Write fresh_main.cpp for debugging L2 crash."""
import os
...
p = r"D:\agent\booming-il2cpp\verification\foundation-dll\System.Private.CoreLib\convert-char\native_test\l2-verify\build\fresh_main.cpp"
