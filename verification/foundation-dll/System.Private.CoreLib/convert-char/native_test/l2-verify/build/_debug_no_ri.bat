...
echo === TEST: native_verify_main + generated, NO separate runtime_instantiation/convert ===
...
link /nologo /out:"%BUILD%\debug_no_separate_ri.exe" ^
...
echo === RUN ===
"%BUILD%\debug_no_separate_ri.exe"
