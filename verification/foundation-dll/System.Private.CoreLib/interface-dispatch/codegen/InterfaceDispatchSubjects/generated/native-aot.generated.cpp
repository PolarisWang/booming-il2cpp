...
extern "C" double BenchmarkMethod(
	...
	case 9: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcAdd__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 10: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcAdd_Add_System_Int32_System_Int32(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel),0,0);
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 11: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcAdd_Multiply_System_Int32_System_Int32(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel),0,0);
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 12: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcMul__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 13: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcMul_Add_System_Int32_System_Int32(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel),0,0);
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 14: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_CalcMul_Multiply_System_Int32_System_Int32(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel),0,0);
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 15: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 16: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond_BaseMethod(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 17: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond_DerivedMethod(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 18: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond2__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 19: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond2_BaseMethod(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 20: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplDiamond2_DerivedMethod(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 21: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplSimple__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 22: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplSimple_GetValue(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 23: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplWithDefault__ctor(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 24: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_ImplWithDefault_GetValue(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 25: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_InterfaceDispatchNativeEntry_Run_System_Int32(0);
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
	...
	case 34: {
		auto start = std::chrono::steady_clock::now();
		for (int i = 0; i < iterations; i++) {
			InterfaceDispatchSubjects_IWithDefault_GetValue(reinterpret_cast<CHAOS_IL2CPP_INTPTR>(&__g_benchmark_this_sentinel));
		}
		auto end = std::chrono::steady_clock::now();
		return std::chrono::duration<double, std::milli>(
			end - start).count();
