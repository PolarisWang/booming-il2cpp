...
// Auto-generated hot-update skeletons for MathNumericsHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class MathNumericsHotUpdate
{
    // Purpose: Verify Math.Abs executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Ceiling executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Floor executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Round executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Max executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Min executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Sqrt executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Pow executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Sin executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.Cos executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify Math.BigMul executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify BitConverter.GetBytes executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify BitConverter.ToInt32 executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify BitConverter.ToDouble executes correctly after hot-update patch (host side)
