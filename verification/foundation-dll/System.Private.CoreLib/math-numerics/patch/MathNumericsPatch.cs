...
public static class MathNumericsPatch
{
    // Verify Math.Abs after hot-update (host side)
    ...
    // Verify Math.Ceiling after hot-update (host side)
    ...
    // Verify Math.Floor after hot-update (host side)
    ...
    // Verify Math.Round after hot-update (host side)
    ...
    // Verify Math.Max after hot-update (host side)
    ...
    // Verify Math.Min after hot-update (host side)
    ...
    // Verify Math.Sqrt after hot-update (host side)
    ...
    // Verify Math.Pow after hot-update (host side)
    ...
    // Verify Math.Sin after hot-update (host side)
    ...
    // Verify Math.Cos after hot-update (host side)
    ...
    // Verify Math.BigMul after hot-update (host side)
    ...
    // Verify BitConverter.GetBytes after hot-update (host side)
    ...
    // Verify BitConverter.ToInt32 after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.BitConverter::ToInt32:System.Int32(System.Byte[],System.Int32)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_MathNumerics)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_BitConverter_ToInt32_System_Int32_System_Byte_System_Int32() { _ = BitConverter.ToInt32(new byte[4], 0); }
    // Verify BitConverter.ToDouble after hot-update (host side)
    [HotUpdateSubjectId("System.Private.CoreLib/System.BitConverter::ToDouble:System.Double(System.Byte[],System.Int32)")]
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_MathNumerics)]
    [HotUpdateDirection(HotUpdateDirection.PatchToHost)]
    public static void Patch_System_Private_CoreLib_System_BitConverter_ToDouble_System_Double_System_Byte_System_Int32() { _ = BitConverter.ToDouble(new byte[8], 0); }}
