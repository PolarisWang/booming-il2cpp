...
// native-reference runtime skeleton for family/System.Private.CoreLib/object/equality-identity
#include "bootstrap.h"
...
{
namespace runtime_skeleton_object_equality_identity
{
...
constexpr CHAOS_IL2CPP_SIZE translation_unit_method_count = 7;
constexpr CHAOS_IL2CPP_SIZE translation_unit_page_size = 7;
...
{
    { 0, "System.Private.CoreLib/System.Object::Equals:System.Boolean(System.Object)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Object::Equals:System.Boolean(System.Object,System.Object)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Object::ReferenceEquals:System.Boolean(System.Object,System.Object)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Object::GetHashCode:System.Int32()", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Object::ToString:System.String()", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Object::GetType:System.Type()", DispatchRuntimeSkeletonPage0001, 5 },
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_object_equality_identity(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_object_equality_identity::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_object_equality_identity::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_object_equality_identity::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_object_equality_identity::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_object_equality_identity(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_object_equality_identity(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
