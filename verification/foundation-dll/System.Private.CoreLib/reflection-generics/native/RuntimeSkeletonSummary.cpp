...
// native-reference runtime skeleton for family/System.Private.CoreLib/reflection/generics
#include "bootstrap.h"
...
{
namespace runtime_skeleton_reflection_generics
{{
...
{
    { 0, "System.Private.CoreLib/System.Type::GetGenericTypeDefinition:System.Type()", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Private.CoreLib/System.Type::MakeGenericType:System.Type(System.Type[])", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Private.CoreLib/System.Type::GetGenericArguments:System.Type[]()", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Private.CoreLib/System.Type::GetGenericParameterConstraints:System.Type[]()", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Private.CoreLib/System.Type::get_GenericParameterPosition:System.Int32()", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Private.CoreLib/System.Type::ContainsGenericParameters:System.Boolean()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Private.CoreLib/System.Type::get_IsGenericType:System.Boolean()", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Private.CoreLib/System.Type::get_IsGenericTypeDefinition:System.Boolean()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Private.CoreLib/System.Type::get_IsConstructedGenericType:System.Boolean()", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Private.CoreLib/System.Type::MakeArrayType:System.Type()", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Private.CoreLib/System.Type::MakeByRefType:System.Type()", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.Private.CoreLib/System.Type::MakePointerType:System.Type()", DispatchRuntimeSkeletonPage0001, 11 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_reflection_generics(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_reflection_generics::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_reflection_generics::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_reflection_generics::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_reflection_generics::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_reflection_generics(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_reflection_generics(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
