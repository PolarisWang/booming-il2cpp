...
{
    return chaos_reflection_get_generic_param_constraints(chaos_arg_0);
}
...
extern "C" CHAOS_IL2CPP_INTPTR chaos_external_runtime_System_Private_CoreLib_System_Type__get_ContainsGenericParameters_System_Boolean__(CHAOS_IL2CPP_INTPTR chaos_arg_0)
{
    return chaos_reflection_get_contains_generic_params(chaos_arg_0);
}
...
{
    return chaos_reflection_get_generic_param_pos(chaos_arg_0);
}
...
{
    return chaos_reflection_get_is_generic_type_def(chaos_arg_0);
}
