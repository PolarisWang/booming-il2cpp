...
{
    // Verify Type.GetGenericTypeDefinition after hot-update (patch side)
    ...
    // Verify Type.MakeGenericType after hot-update (patch side)
    ...
    // Verify Type.GetGenericArguments after hot-update (patch side)
    ...
    // Verify Type.GetGenericParameterConstraints after hot-update (patch side)
    ...
    // Verify Type.get_GenericParameterPosition after hot-update (patch side)
    ...
    // Verify Type.ContainsGenericParameters after hot-update (patch side)
    ...
    // Verify Type.get_IsGenericTypeDefinition after hot-update (patch side)
    ...
    // Verify Type.MakeArrayType after hot-update (patch side)
    ...
    // Verify Type.MakeByRefType after hot-update (patch side)
    ...
    // Verify Type.MakePointerType after hot-update (patch side)
