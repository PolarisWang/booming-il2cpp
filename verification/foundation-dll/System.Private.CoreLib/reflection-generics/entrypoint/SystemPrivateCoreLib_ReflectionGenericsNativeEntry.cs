...
public static class SystemPrivateCoreLib_ReflectionGenericsNativeEntry
{
    ...
    static int Method0()
    {
        return typeof(byte).GetGenericTypeDefinition().GetHashCode();
    }

    // [1] System.Private.CoreLib/System.Type::MakeGenericType:System.Type(System.Type[])
    static int Method1()
    {
        return typeof(byte).MakeGenericType(Array.Empty<System.Type>()).GetHashCode();
    }

    // [2] System.Private.CoreLib/System.Type::GetGenericArguments:System.Type[]()
    static int Method2()
    {
        return typeof(byte).GetGenericArguments().GetHashCode();
    }

    // [3] System.Private.CoreLib/System.Type::GetGenericParameterConstraints:System.Type[]()
    static int Method3()
    {
        return typeof(byte).GetGenericParameterConstraints().GetHashCode();
    }
    ...
    static int Method7()
    {
        return (typeof(byte).IsGenericTypeDefinition ? 1 : 0);
    }
    ...
    static int Method9()
    {
        return typeof(byte).MakeArrayType().GetHashCode();
    }

    // [10] System.Private.CoreLib/System.Type::MakeByRefType:System.Type()
    static int Method10()
    {
        return typeof(byte).MakeByRefType().GetHashCode();
    }

    // [11] System.Private.CoreLib/System.Type::MakePointerType:System.Type()
    static int Method11()
    {
        return typeof(byte).MakePointerType().GetHashCode();
    }
