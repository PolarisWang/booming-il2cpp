...
public static partial class GlobalizationCultureSubjects
{
    ...
    {
        if (((CultureInfo.CurrentCulture).GetHashCode()) != 1232686746) _exitCode = 1;
    }

    // [1] System.Private.CoreLib/System.Globalization.CultureInfo::get_InvariantCulture:System.Globalization.CultureInfo()
    public static void Subject_1()
    {
        if (((CultureInfo.InvariantCulture).GetHashCode()) != -329004626) _exitCode = 1;
    }
    ...
    {
        if (((CultureInfo.GetCultureInfo("")).GetHashCode()) != -329004626) _exitCode = 1;
    }
