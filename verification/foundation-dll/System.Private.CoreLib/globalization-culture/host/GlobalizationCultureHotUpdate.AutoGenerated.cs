...
// Auto-generated hot-update skeletons for GlobalizationCultureHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class GlobalizationCultureHotUpdate
{
    // Purpose: Verify CultureInfo.get_CurrentCulture executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.get_InvariantCulture executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.GetCultureInfo executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.get_Name executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.get_DisplayName executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.get_DateTimeFormat executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CultureInfo.get_NumberFormat executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CompareInfo.Compare executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify CompareInfo.IndexOf executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TextInfo.ToUpper executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TextInfo.ToLower executes correctly after hot-update patch (host side)
    ...
    // Purpose: Verify TextInfo.get_CultureName executes correctly after hot-update patch (host side)
