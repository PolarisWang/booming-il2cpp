...
{
    // Verify CultureInfo.get_CurrentCulture after hot-update (patch side)
    ...
    // Verify CultureInfo.get_InvariantCulture after hot-update (patch side)
    ...
    // Verify CultureInfo.GetCultureInfo after hot-update (patch side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.SystemPrivateCoreLib_GlobalizationCulture)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Private_CoreLib_System_Globalization_CultureInfo_GetCultureInfo_System_Globalization_CultureInfo_System_String() { _ = CultureInfo.GetCultureInfo(""); }
    // Verify CultureInfo.get_Name after hot-update (patch side)
    ...
    // Verify CultureInfo.get_DisplayName after hot-update (patch side)
    ...
    // Verify CultureInfo.get_DateTimeFormat after hot-update (patch side)
    ...
    // Verify CultureInfo.get_NumberFormat after hot-update (patch side)
    ...
    // Verify CompareInfo.Compare after hot-update (patch side)
    ...
    // Verify CompareInfo.IndexOf after hot-update (patch side)
    ...
    // Verify TextInfo.ToUpper after hot-update (patch side)
    ...
    // Verify TextInfo.ToLower after hot-update (patch side)
    ...
    // Verify TextInfo.get_CultureName after hot-update (patch side)
