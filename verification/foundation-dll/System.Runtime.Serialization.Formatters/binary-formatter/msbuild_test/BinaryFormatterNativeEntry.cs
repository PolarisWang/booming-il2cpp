...
public static partial class BinaryFormatterNativeEntry
{
    ...
    {
        try { if (((BinaryFormatter.Deserialize(null!)).GetHashCode()) != ((BinaryFormatter.Deserialize(null!)).GetHashCode())) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.AssemblyFormat) != (int)(BinaryFormatter.AssemblyFormat)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.Binder) != (int)(BinaryFormatter.Binder)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.Context) != (int)(BinaryFormatter.Context)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.FilterLevel) != (int)(BinaryFormatter.FilterLevel)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.SurrogateSelector) != (int)(BinaryFormatter.SurrogateSelector)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { if ((int)(BinaryFormatter.TypeFormat) != (int)(BinaryFormatter.TypeFormat)) _exitCode = 1; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.Serialize(null!, 42); }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.AssemblyFormat = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.Binder = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.Context = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.FilterLevel = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.SurrogateSelector = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { BinaryFormatter.TypeFormat = null!; }
        catch { _exitCode = 1; }
    }
    ...
    {
        try { new BinaryFormatter(null!, null!); }
        catch { _exitCode = 1; }
    }
