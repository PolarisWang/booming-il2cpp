...
struct Functions {
    struct BinderTypeStyleSubjects_t {
        void (*Subject_0)(
                void
        );
        void (*Subject_1)(
...
struct BinderTypeStyleSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.binderTypeStyleSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.binderTypeStyleSubjects.Subject_1(
        );
    }
