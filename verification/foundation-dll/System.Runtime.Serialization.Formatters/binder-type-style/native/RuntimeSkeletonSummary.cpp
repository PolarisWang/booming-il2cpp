...
// native-reference runtime skeleton for family/System.Runtime.Serialization.Formatters/binder-type-style
#include "bootstrap.h"
...
{
namespace runtime_skeleton_binder_type_style
{
...
constexpr CHAOS_IL2CPP_SIZE translation_unit_method_count = 3;
constexpr CHAOS_IL2CPP_SIZE translation_unit_page_size = 3;
...
{
    { 0, "System.Runtime.Serialization.Formatters/System.Runtime.Serialization.SerializationBinder::SerializationBinder::Void()", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Runtime.Serialization.Formatters/System.Runtime.Serialization.SerializationBinder::BindToName:System.Void(P0, P1, P2)", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Runtime.Serialization.Formatters/System.Runtime.Serialization.SerializationBinder::BindToType:System.Void(P0, P1)", DispatchRuntimeSkeletonPage0001, 2 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_binder_type_style(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_binder_type_style::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_binder_type_style::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_binder_type_style::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_binder_type_style::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_binder_type_style(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_binder_type_style(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
