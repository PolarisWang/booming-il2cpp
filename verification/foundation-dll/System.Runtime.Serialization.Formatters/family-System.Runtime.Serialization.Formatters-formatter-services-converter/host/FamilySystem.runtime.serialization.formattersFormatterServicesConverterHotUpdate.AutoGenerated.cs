...
// Auto-generated hot-update skeletons for FamilySystem.runtime.serialization.formattersFormatterServicesConverterHotUpdate.
// Each method exercises a method from the HostToPatch direction.
public static class FamilySystem.runtime.serialization.formattersFormatterServicesConverterHotUpdate
{
    ...
    // Purpose: Verify SerializationObjectManager.SerializationObjectManager: executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.None)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Runtime_Serialization_Formatters_System_Runtime_Serialization_SerializationObjectManager_SerializationObjectManag() { _ = SerializationObjectManager.SerializationObjectManager:(42); }
    // Purpose: Verify SerializationObjectManager.RaiseOnSerializedEvent executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.None)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Runtime_Serialization_Formatters_System_Runtime_Serialization_SerializationObjectManager_RaiseOnSerializedEvent_S() { SerializationObjectManager.RaiseOnSerializedEvent(); }
    // Purpose: Verify SerializationObjectManager.RegisterObject executes correctly after hot-update patch (host side)
    ...
    [CapabilityFamilyId(CapabilityFamilyId.None)]
    [HotUpdateDirection(HotUpdateDirection.HostToPatch)]
    public static void HotUpdate_System_Runtime_Serialization_Formatters_System_Runtime_Serialization_SerializationObjectManager_RegisterObject_System_Vo() { SerializationObjectManager.RegisterObject(null!); }}
