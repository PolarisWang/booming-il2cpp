...
struct LoopStateSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.loopStateSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.loopStateSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.loopStateSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.loopStateSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.loopStateSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.loopStateSubjects.Subject_5(
        );
    }
