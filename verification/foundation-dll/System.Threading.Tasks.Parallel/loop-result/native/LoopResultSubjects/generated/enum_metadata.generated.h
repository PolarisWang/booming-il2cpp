    ...
    const char* subject_id) noexcept
{
    ...
    switch (h) {
        ...
        case 0x53EA81A5u: {
            // Verify: System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType
            if (std::strcmp(subject_id, "System.Threading.Tasks.Parallel/System.Threading.Tasks.ParallelEtwProvider+ForkJoinOperationType") != 0) break;
            return &kEnumTable_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE;
        }
        case 0x53EDDA05u: {
    ...
    CHAOS_IL2CPP_UINT32 fnv24) noexcept
{
    switch (fnv24) {
        ...
        case 0xEA81A5u: return &kEnumTable_SYSTEM_THREADING_TASKS_PARALLEL_SYSTEM_THREADING_TASKS_PARALLELETWPROVIDER_FORKJOINOPERATIONTYPE;
