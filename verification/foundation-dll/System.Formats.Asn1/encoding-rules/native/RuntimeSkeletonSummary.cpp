...
// native-reference runtime skeleton for family/System.Formats.Asn1/encoding-rules
#include "bootstrap.h"
...
{
namespace runtime_skeleton_encoding_rules
{
...
{
    { 0, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::AsnEncodingRules::Void(System.Object)", DispatchRuntimeSkeletonPage0001, 0 },
    { 1, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::get_Property:System.Void()", DispatchRuntimeSkeletonPage0001, 1 },
    { 2, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::Method1:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 2 },
    { 3, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::Method2:System.Void(P0, P1)", DispatchRuntimeSkeletonPage0001, 3 },
    { 4, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::Validate:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 4 },
    { 5, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::get_Value:System.Void()", DispatchRuntimeSkeletonPage0001, 5 },
    { 6, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::set_Value:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 6 },
    { 7, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::get_Count:System.Void()", DispatchRuntimeSkeletonPage0001, 7 },
    { 8, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::set_Count:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 8 },
    { 9, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::get_IsEmpty:System.Void()", DispatchRuntimeSkeletonPage0001, 9 },
    { 10, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::set_IsEmpty:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 10 },
    { 11, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::get_Key:System.Void()", DispatchRuntimeSkeletonPage0001, 11 },
    { 12, "System.Formats.Asn1/System.Formats.Asn1.AsnEncodingRules::set_Key:System.Void(P0)", DispatchRuntimeSkeletonPage0001, 12 },
};
...
int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReferenceAssembly_encoding_rules(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    auto* domain = md::FindDomainByName(runtime_skeleton_encoding_rules::kAssemblyName);
    ...
    const auto* request = static_cast<const runtime_skeleton_encoding_rules::NativeReferenceAssemblyDispatchRequest*>(managed_args);
    if (request->method_id != 0) {
        return runtime_skeleton_encoding_rules::DispatchAssemblyMethodId(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->method_id, request->managed_args);
    }
    return runtime_skeleton_encoding_rules::DispatchAssemblySubject(bridge, &local_code_registration, metadata_registration, options, runtime, thread, request->subject_id, request->managed_args);
}

int32_t CHAOS_RUNTIME_ABI_CALL RunNativeReference_encoding_rules(
    const CodegenBridgeV0* bridge,
    const CodeRegistrationV0* code_registration,
    const MetadataRegistrationV0* metadata_registration,
    const CodegenRegistrationOptionsV0* options,
    ...
    ThreadState* thread,
    void* managed_args) {
    return RunNativeReferenceAssembly_encoding_rules(bridge, code_registration, metadata_registration, options, runtime, thread, managed_args);
}
}  // namespace chaos::il2cpp::generated
