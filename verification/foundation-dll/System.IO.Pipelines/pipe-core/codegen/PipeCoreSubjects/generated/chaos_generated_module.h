...
struct PipeCoreSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_5(
        );
    }
    static inline void Subject_6(
    ) {
        return kFunctions.pipeCoreSubjects.Subject_6(
        );
    }
