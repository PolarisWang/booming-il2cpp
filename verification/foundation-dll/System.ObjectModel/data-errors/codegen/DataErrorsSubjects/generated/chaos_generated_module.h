...
struct DataErrorsSubjects {
    static inline void Subject_0(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_0(
        );
    }
    static inline void Subject_1(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_1(
        );
    }
    static inline void Subject_2(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_2(
        );
    }
    static inline void Subject_3(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_3(
        );
    }
    static inline void Subject_4(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_4(
        );
    }
    static inline void Subject_5(
    ) {
        return kFunctions.dataErrorsSubjects.Subject_5(
        );
    }
