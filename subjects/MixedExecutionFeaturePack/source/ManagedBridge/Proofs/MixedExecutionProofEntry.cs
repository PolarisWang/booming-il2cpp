...
internal static class MixedExecutionProofEntry
{
    ...
    [ChaosUnitTest(
        ...
        Requires = ChaosRuntimeFeature.HotUpdate | ChaosRuntimeFeature.ExceptionFlow,
        Archetype = ChaosSolutionArchetype.MixedBridgeSolution,
        HotUpdateCapability = ChaosHotUpdateCapability.PackageLoad | ChaosHotUpdateCapability.PatchCallbackFlow,
        Priority = 1)]
