...
/// Per-enum ToString dispatch for Chaos.TestFramework.Runtime/Chaos.TestFramework.Runtime.ChaosManagedHostKind (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_RUNTIME_CHAOS_TESTFRAMEWORK_RUNTIME_CHAOSMANAGEDHOSTKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Proof");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Benchmark");
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosUnitCategory (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSUNITCATEGORY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("RuntimeContract");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MetadataContract");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("InteropContract");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("HostContract");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("HotUpdateContract");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosBenchmarkCategory (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSBENCHMARKCATEGORY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("RuntimeDispatch");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Startup");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Allocation");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("HotUpdate");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosExecutionMode (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSEXECUTIONMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Managed");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Native");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Interpreter");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("All");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosSubjectEntryKind (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSUBJECTENTRYKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Proof");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Benchmark");
    return 0;  // unrecognized value → caller falls through to decimal
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosSubjectSlice (12 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSUBJECTSLICE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("HotUpdateSkeletonProof");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MixedExecutionProof");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("InterpreterLoweringProof");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("SimpleLibrarySolutionManagedOutput");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("MultiProjectSolutionManagedOutput");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("PackageReferenceSolutionManagedOutput");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("CoreRuntimeFeaturesProof");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("ReferenceAssemblySolutionManagedOutput");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("CoreLibReferenceSolutionManagedOutput");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("MixedReferenceClosureSolutionManagedOutput");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("CoreRuntimeInterfaceDispatchProof");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosMetric (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSMETRIC(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("WallClockUs");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ManagedAllocBytes");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("NativeAllocBytes");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("PeakWorkingSet");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosCapabilityFamily (15 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSCAPABILITYFAMILY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PrimitivesAndOps");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("TypeSystemAndGenerics");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("AsyncAndIterators");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("DelegatesAndClosures");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("ExceptionsAndControlFlow");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("ReflectionAndMetadata");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("InteropAndMarshaling");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("ThreadingAndSynchronization");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("RuntimeServices");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("UnsafeAndLowLevel");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("DiagnosticsAndTracing");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("LinkerAndAotClosure");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("HotUpdateWorkflow");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("MixedExecution");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosCapabilityItem (69 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSCAPABILITYITEM(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ArithmeticOps");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("BitwiseOps");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("ComparisonAndBranch");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("NumericConversion");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("OverflowBehavior");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("ArrayBasics");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("ArrayBoxing");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("GenericInstantiation");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("GenericConstraint");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("GenericVirtualDispatch");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("GenericInterfaceDispatch");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("GenericCollections");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("GenericLayout");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("AsyncAwait");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("TaskAndValueTaskFlow");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("IteratorStateMachine");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("DelegateInvocation");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("DelegateChaining");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("LambdaClosureCapture");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("EventCallbackFlow");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("CustomAttributeLookup");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("MemberMetadataLookup");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("MetadataSupplement");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("MetadataClosure");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("LinkerPreserveContract");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("LinkerStripping");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("ExceptionBasic");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("NestedException");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("FinallyAndFilter");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("CrossBoundaryException");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("NativeCallInterop");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("StringAndUtf8Marshaling");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("StructMarshaling");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("DelegateCallbackInterop");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("Threading");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("TaskScheduling");
    if (value == 37) return CHAOS_IL2CPP_STRING_ID("MonitorAndLocking");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("ThreadLocalState");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("RuntimeHelpers");
    if (value == 40) return CHAOS_IL2CPP_STRING_ID("GcSensitiveFlow");
    if (value == 41) return CHAOS_IL2CPP_STRING_ID("ResourceLifecycle");
    if (value == 42) return CHAOS_IL2CPP_STRING_ID("LoaderContract");
    if (value == 43) return CHAOS_IL2CPP_STRING_ID("SpanAndMemory");
    if (value == 44) return CHAOS_IL2CPP_STRING_ID("RefStructAndStackalloc");
    if (value == 45) return CHAOS_IL2CPP_STRING_ID("UnsafePointer");
    if (value == 46) return CHAOS_IL2CPP_STRING_ID("FunctionPointer");
    if (value == 47) return CHAOS_IL2CPP_STRING_ID("RuntimeTraceOutput");
    if (value == 48) return CHAOS_IL2CPP_STRING_ID("NativeSymbolEvidence");
    if (value == 49) return CHAOS_IL2CPP_STRING_ID("CrashEvidence");
    if (value == 50) return CHAOS_IL2CPP_STRING_ID("FailureDiagnostics");
    if (value == 51) return CHAOS_IL2CPP_STRING_ID("RequiredInstantiationClosure");
    if (value == 52) return CHAOS_IL2CPP_STRING_ID("GenericSharingBoundary");
    if (value == 53) return CHAOS_IL2CPP_STRING_ID("AotClosureValidation");
    if (value == 54) return CHAOS_IL2CPP_STRING_ID("PackageLoad");
    if (value == 55) return CHAOS_IL2CPP_STRING_ID("SharedContractBinding");
    if (value == 56) return CHAOS_IL2CPP_STRING_ID("MethodReplacement");
    if (value == 57) return CHAOS_IL2CPP_STRING_ID("HotUpdateMetadataSupplement");
    if (value == 58) return CHAOS_IL2CPP_STRING_ID("PatchIntegrity");
    if (value == 59) return CHAOS_IL2CPP_STRING_ID("VersionRollback");
    if (value == 60) return CHAOS_IL2CPP_STRING_ID("PatchCallbackFlow");
    if (value == 61) return CHAOS_IL2CPP_STRING_ID("MixedBridgeDispatch");
    if (value == 62) return CHAOS_IL2CPP_STRING_ID("InterpreterLowering");
    if (value == 63) return CHAOS_IL2CPP_STRING_ID("InterpreterArithmetic");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("MixedGenericFlow");
    if (value == 65) return CHAOS_IL2CPP_STRING_ID("MixedExceptionFlow");
    if (value == 66) return CHAOS_IL2CPP_STRING_ID("MixedDelegateFlow");
    if (value == 67) return CHAOS_IL2CPP_STRING_ID("ObjectCastAndTypeCheck");
    if (value == 68) return CHAOS_IL2CPP_STRING_ID("ArrayCovariance");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosSolutionArchetype (12 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSOLUTIONARCHETYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SimpleLibrarySolution");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("MultiProjectSolution");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PackageReferenceSolution");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("ReferenceAssemblySolution");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("CoreLibReferenceSolution");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("MixedReferenceClosureSolution");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("SkeletonPatchSolution");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("FullProjectHotUpdateSolution");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("VersionCompatibilitySolution");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("ReferenceAssemblyPatchSolution");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("MixedBridgeSolution");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosHotUpdateCapability (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSHOTUPDATECAPABILITY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PackageLoad");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("SharedContractBinding");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("MethodReplacement");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("MetadataSupplement");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("PatchIntegrity");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("VersionRollback");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("PatchCallbackFlow");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.CapabilityFamilyId (36 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CAPABILITYFAMILYID(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ConvertChar");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_BufferMemory");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_EnumParsing");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_PrimitiveNumericConversions");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_StringCharTextCore");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ArrayIndexingCopy");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_SpanMemoryBuffers");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ObjectEqualityIdentity");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_TypeRuntimeHandles");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ExceptionThrowDiagnostics");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_GenericNullableValue");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_BoxingUnboxingCasts");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_DelegateCoreInvocation");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionMemberBasics");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_AttributesCustomMetadata");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ThreadingMonitorInterlocked");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ThreadingTasksPrimitives");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_TimeDateTimeTimespan");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_GuidRandomHashcode");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_MathNumerics");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_GlobalizationCulture");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_IOStreamsBasics");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_CollectionsGenericCore");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_RuntimeCompilerServices");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionType");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionAssembly");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionMemberComplete");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionGenerics");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionParameters");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionModule");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionBinding");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionActivation");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_ReflectionFieldProperty");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_GarbageCollection");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("SystemPrivateCoreLib_CodegenEdgeCases");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.VerificationRoute (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_VERIFICATIONROUTE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Managed");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Native");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("HotUpdate");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.BenchmarkRoute (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_BENCHMARKROUTE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Managed");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Native");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("HotUpdate");
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.BenchmarkProfile (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_BENCHMARKPROFILE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.HotUpdateDirection (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_HOTUPDATEDIRECTION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("HostToPatch");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("PatchToHost");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosRuntimeFeature (16 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSRUNTIMEFEATURE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("GenericSharing");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Reflection");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Delegate");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("ExceptionFlow");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("NativeInterop");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("HotUpdate");
    if (value == 64) return CHAOS_IL2CPP_STRING_ID("AsyncStateMachine");
    if (value == 128) return CHAOS_IL2CPP_STRING_ID("Threading");
    if (value == 256) return CHAOS_IL2CPP_STRING_ID("Synchronization");
    if (value == 512) return CHAOS_IL2CPP_STRING_ID("SpanMemory");
    if (value == 1024) return CHAOS_IL2CPP_STRING_ID("UnsafePointer");
    if (value == 2048) return CHAOS_IL2CPP_STRING_ID("FunctionPointer");
    if (value == 4096) return CHAOS_IL2CPP_STRING_ID("MetadataSupplement");
    if (value == 8192) return CHAOS_IL2CPP_STRING_ID("GenericVirtualDispatch");
    if (value == 16384) return CHAOS_IL2CPP_STRING_ID("RefStructStackalloc");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for Chaos.TestFramework.Sdk/Chaos.TestFramework.ChaosEvidenceKind (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSEVIDENCEKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Stdout");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("FileArtifact");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Metadata");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("NativeSymbol");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.JsonCommentHandling (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONCOMMENTHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Disallow");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Skip");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Allow");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.JsonSeparatorNamingPolicy+SeparatorState (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONSEPARATORNAMINGPOLICY_SEPARATORSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NotStarted");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("UppercaseLetter");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("LowercaseLetterOrDigit");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("SpaceSeparator");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.JsonSerializerDefaults (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONSERIALIZERDEFAULTS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("General");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Web");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.JsonValueKind (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONVALUEKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Undefined");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Object");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Array");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("String");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Number");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("True");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("False");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Null");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.JsonTokenType (12 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONTOKENTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("StartObject");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("EndObject");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("StartArray");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("EndArray");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("PropertyName");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Comment");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("String");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Number");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("True");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("False");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("Null");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.ConsumeNumberResult (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONSUMENUMBERRESULT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Success");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("OperationIncomplete");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("NeedMoreData");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.ConsumeTokenResult (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONSUMETOKENRESULT(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Success");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("NotEnoughDataRollBackState");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("IncompleteNoRollBackNecessary");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.PolymorphicSerializationState (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_POLYMORPHICSERIALIZATIONSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("PolymorphicReEntryStarted");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("PolymorphicReEntrySuspended");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("PolymorphicReEntryNotFound");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.ConverterStrategy (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONVERTERSTRATEGY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Object");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Value");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Enumerable");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("Dictionary");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.MetadataPropertyName (5 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_METADATAPROPERTYNAME(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Values");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Id");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Ref");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Type");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.StackFrameObjectState (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_STACKFRAMEOBJECTSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("StartToken");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ReadMetadata");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("ConstructorArguments");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("CreatedObject");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("ReadElements");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("EndToken");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("EndTokenValidation");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.StackFramePropertyState (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_STACKFRAMEPROPERTYSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("ReadName");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Name");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("ReadValue");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("ReadValueIsEnd");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("TryRead");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.ExceptionResource (41 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_EXCEPTIONRESOURCE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("ArrayDepthTooLarge");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("EndOfCommentNotFound");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("EndOfStringNotFound");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("RequiredDigitNotFoundAfterDecimal");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("RequiredDigitNotFoundAfterSign");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("RequiredDigitNotFoundEndOfData");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("ExpectedEndAfterSingleJson");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("ExpectedEndOfDigitNotFound");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("ExpectedFalse");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("ExpectedNextDigitEValueNotFound");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("ExpectedNull");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("ExpectedSeparatorAfterPropertyNameNotFound");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("ExpectedStartOfPropertyNotFound");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("ExpectedStartOfPropertyOrValueNotFound");
    if (value == 14) return CHAOS_IL2CPP_STRING_ID("ExpectedStartOfPropertyOrValueAfterComment");
    if (value == 15) return CHAOS_IL2CPP_STRING_ID("ExpectedStartOfValueNotFound");
    if (value == 16) return CHAOS_IL2CPP_STRING_ID("ExpectedTrue");
    if (value == 17) return CHAOS_IL2CPP_STRING_ID("ExpectedValueAfterPropertyNameNotFound");
    if (value == 18) return CHAOS_IL2CPP_STRING_ID("FoundInvalidCharacter");
    if (value == 19) return CHAOS_IL2CPP_STRING_ID("InvalidCharacterWithinString");
    if (value == 20) return CHAOS_IL2CPP_STRING_ID("InvalidCharacterAfterEscapeWithinString");
    if (value == 21) return CHAOS_IL2CPP_STRING_ID("InvalidHexCharacterWithinString");
    if (value == 22) return CHAOS_IL2CPP_STRING_ID("InvalidEndOfJsonNonPrimitive");
    if (value == 23) return CHAOS_IL2CPP_STRING_ID("MismatchedObjectArray");
    if (value == 24) return CHAOS_IL2CPP_STRING_ID("ObjectDepthTooLarge");
    if (value == 25) return CHAOS_IL2CPP_STRING_ID("ZeroDepthAtEnd");
    if (value == 26) return CHAOS_IL2CPP_STRING_ID("DepthTooLarge");
    if (value == 27) return CHAOS_IL2CPP_STRING_ID("CannotStartObjectArrayWithoutProperty");
    if (value == 28) return CHAOS_IL2CPP_STRING_ID("CannotStartObjectArrayAfterPrimitiveOrClose");
    if (value == 29) return CHAOS_IL2CPP_STRING_ID("CannotWriteValueWithinObject");
    if (value == 30) return CHAOS_IL2CPP_STRING_ID("CannotWriteValueAfterPrimitiveOrClose");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("CannotWritePropertyWithinArray");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("ExpectedJsonTokens");
    if (value == 33) return CHAOS_IL2CPP_STRING_ID("TrailingCommaNotAllowedBeforeArrayEnd");
    if (value == 34) return CHAOS_IL2CPP_STRING_ID("TrailingCommaNotAllowedBeforeObjectEnd");
    if (value == 35) return CHAOS_IL2CPP_STRING_ID("InvalidCharacterAtStartOfComment");
    if (value == 36) return CHAOS_IL2CPP_STRING_ID("UnexpectedEndOfDataWhileReadingComment");
    if (value == 37) return CHAOS_IL2CPP_STRING_ID("UnexpectedEndOfLineSeparator");
    if (value == 38) return CHAOS_IL2CPP_STRING_ID("ExpectedOneCompleteToken");
    if (value == 39) return CHAOS_IL2CPP_STRING_ID("NotEnoughData");
    if (value == 40) return CHAOS_IL2CPP_STRING_ID("InvalidLeadingZeroInNumber");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.NumericType (14 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_NUMERICTYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Byte");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SByte");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Int16");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Int32");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Int64");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Int128");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("UInt16");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("UInt32");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("UInt64");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("UInt128");
    if (value == 10) return CHAOS_IL2CPP_STRING_ID("Half");
    if (value == 11) return CHAOS_IL2CPP_STRING_ID("Single");
    if (value == 12) return CHAOS_IL2CPP_STRING_ID("Double");
    if (value == 13) return CHAOS_IL2CPP_STRING_ID("Decimal");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.DataType (9 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_DATATYPE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Boolean");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("DateOnly");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("DateTime");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("DateTimeOffset");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("TimeOnly");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("TimeSpan");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Base64String");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Guid");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("Version");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonIgnoreCondition (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONIGNORECONDITION(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Never");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Always");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("WhenWritingDefault");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("WhenWritingNull");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonKnownNamingPolicy (6 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONKNOWNNAMINGPOLICY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unspecified");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("CamelCase");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("SnakeCaseLower");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("SnakeCaseUpper");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("KebabCaseLower");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("KebabCaseUpper");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonNumberHandling (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONNUMBERHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Strict");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AllowReadingFromString");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("WriteAsString");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("AllowNamedFloatingPointLiterals");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonObjectCreationHandling (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONOBJECTCREATIONHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Replace");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Populate");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonUnmappedMemberHandling (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNMAPPEDMEMBERHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Skip");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Disallow");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonSourceGenerationMode (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONSOURCEGENERATIONMODE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Default");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Metadata");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Serialization");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonUnknownTypeHandling (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNKNOWNTYPEHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("JsonElement");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("JsonNode");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.JsonUnknownDerivedTypeHandling (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNKNOWNDERIVEDTYPEHANDLING(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("FailSerialization");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("FallBackToBaseType");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("FallBackToNearestAncestor");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.ReferenceHandlingStrategy (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_REFERENCEHANDLINGSTRATEGY(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Preserve");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("IgnoreCycles");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.Metadata.JsonTypeInfoKind (4 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_JSONTYPEINFOKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Object");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Enumerable");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("Dictionary");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.Metadata.FSharpCoreReflectionProxy+FSharpKind (8 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_FSHARPCOREREFLECTIONPROXY_FSHARPKIND(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("Unrecognized");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Option");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("ValueOption");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("List");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Set");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Map");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Record");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Union");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.Metadata.FSharpCoreReflectionProxy+SourceConstructFlags (12 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_FSHARPCOREREFLECTIONPROXY_SOURCECONSTRUCTFLAGS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("None");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("SumType");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("RecordType");
    if (value == 3) return CHAOS_IL2CPP_STRING_ID("ObjectType");
    if (value == 4) return CHAOS_IL2CPP_STRING_ID("Field");
    if (value == 5) return CHAOS_IL2CPP_STRING_ID("Exception");
    if (value == 6) return CHAOS_IL2CPP_STRING_ID("Closure");
    if (value == 7) return CHAOS_IL2CPP_STRING_ID("Module");
    if (value == 8) return CHAOS_IL2CPP_STRING_ID("UnionCase");
    if (value == 9) return CHAOS_IL2CPP_STRING_ID("Value");
    if (value == 31) return CHAOS_IL2CPP_STRING_ID("KindMask");
    if (value == 32) return CHAOS_IL2CPP_STRING_ID("NonPublicRepresentation");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.Metadata.JsonTypeInfo+ConfigurationState (3 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_JSONTYPEINFO_CONFIGURATIONSTATE(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 0) return CHAOS_IL2CPP_STRING_ID("NotConfigured");
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("Configuring");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("Configured");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
/// Per-enum ToString dispatch for System.Text.Json/System.Text.Json.Serialization.Converters.EnumConverterOptions (2 fields).
/// Returns compile-time string constant on match, 0 for unrecognized values
/// (caller falls through to decimal formatting).
static CHAOS_IL2CPP_INTPTR ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_CONVERTERS_ENUMCONVERTEROPTIONS(CHAOS_IL2CPP_INT64 value) noexcept {
    if (value == 1) return CHAOS_IL2CPP_STRING_ID("AllowStrings");
    if (value == 2) return CHAOS_IL2CPP_STRING_ID("AllowNumbers");
    return 0;  // unrecognized value → caller falls through to decimal
}
...
static constexpr EnumToStringDispatchEntry kEnumToStringDispatchTable[] = {
    ...
    { 0x11478Cu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONSEPARATORNAMINGPOLICY_SEPARATORSTATE },
    ...
    { 0x16729Au, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSUBJECTENTRYKIND },
    ...
    { 0x18BAABu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNMAPPEDMEMBERHANDLING },
    ...
    { 0x1E27DCu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSHOTUPDATECAPABILITY },
    { 0x1E4DCFu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_DIAGNOSTICS_CODEANALYSIS_DYNAMICALLYACCESSEDMEMBERTYPES },
    { 0x1EA7CFu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_METADATAPROPERTYNAME },
    ...
    { 0x23AB67u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_NUMERICTYPE },
    ...
    { 0x29FDC6u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_FSHARPCOREREFLECTIONPROXY_FSHARPKIND },
    ...
    { 0x301723u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_HOTUPDATEDIRECTION },
    ...
    { 0x33C2C8u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_CONVERTERS_ENUMCONVERTEROPTIONS },
    ...
    { 0x390391u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSEXECUTIONMODE },
    ...
    { 0x4A2ABEu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSUBJECTSLICE },
    ...
    { 0x501125u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_POLYMORPHICSERIALIZATIONSTATE },
    ...
    { 0x55736Du, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONKNOWNNAMINGPOLICY },
    ...
    { 0x586EF1u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_JSONTYPEINFO_CONFIGURATIONSTATE },
    { 0x5A7820u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GLOBALIZATION_HEBREWNUMBER_HS },
    { 0x5A8AF5u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONVALUEKIND },
    ...
    { 0x634D9Eu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSCAPABILITYFAMILY },
    { 0x641DD8u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSMETRIC },
    ...
    { 0x6916FCu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_BENCHMARKPROFILE },
    ...
    { 0x6E1D76u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONSUMENUMBERRESULT },
    { 0x6E5227u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_REFLECTION_RESOURCELOCATION },
    { 0x702B6Cu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_DATATYPE },
    ...
    { 0x716A83u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNKNOWNTYPEHANDLING },
    ...
    { 0x75A58Eu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONCOMMENTHANDLING },
    ...
    { 0x77D56Fu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_RUNTIME_CHAOS_TESTFRAMEWORK_RUNTIME_CHAOSMANAGEDHOSTKIND },
    ...
    { 0x7AA8E0u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_BENCHMARKROUTE },
    ...
    { 0x7F7963u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_STACKFRAMEOBJECTSTATE },
    ...
    { 0x82A5BCu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONSOURCEGENERATIONMODE },
    { 0x82C1B5u, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_GLOBALIZATION_CULTURETYPES },
    { 0x82F1DDu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONVERTERSTRATEGY },
    ...
    { 0x88EBF3u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONTOKENTYPE },
    ...
    { 0x89B6EEu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_CONSUMETOKENRESULT },
    { 0x8A9FC7u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONOBJECTCREATIONHANDLING },
    ...
    { 0x8DCF6Du, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_EXCEPTIONRESOURCE },
    ...
    { 0x929B03u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_REFERENCEHANDLINGSTRATEGY },
    ...
    { 0x9F4D8Bu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CAPABILITYFAMILYID },
    ...
    { 0xA81266u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSSOLUTIONARCHETYPE },
    { 0xA9119Eu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSRUNTIMEFEATURE },
    ...
    { 0xB241ECu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONNUMBERHANDLING },
    { 0xB2D957u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_FSHARPCOREREFLECTIONPROXY_SOURCECONSTRUCTFLAGS },
    ...
    { 0xC36164u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_VERIFICATIONROUTE },
    { 0xC40D0Fu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSBENCHMARKCATEGORY },
    ...
    { 0xC62746u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONUNKNOWNDERIVEDTYPEHANDLING },
    ...
    { 0xC9970Fu, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSEVIDENCEKIND },
    ...
    { 0xD3FA77u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_METADATA_JSONTYPEINFOKIND },
    { 0xD451C1u, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSCAPABILITYITEM },
    { 0xD5A67Eu, &ChaosEnumToString_SYSTEM_PRIVATE_CORELIB_SYSTEM_TYPENAMEFORMATFLAGS },
    { 0xD60BBBu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_SERIALIZATION_JSONIGNORECONDITION },
    ...
    { 0xF1011Au, &ChaosEnumToString_CHAOS_TESTFRAMEWORK_SDK_CHAOS_TESTFRAMEWORK_CHAOSUNITCATEGORY },
    ...
    { 0xF6BDECu, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_JSONSERIALIZERDEFAULTS },
    ...
    { 0xFF20A1u, &ChaosEnumToString_SYSTEM_TEXT_JSON_SYSTEM_TEXT_JSON_STACKFRAMEPROPERTYSTATE },
...
static constexpr CHAOS_IL2CPP_UINT32 kEnumToStringDispatchCount = 342u;
