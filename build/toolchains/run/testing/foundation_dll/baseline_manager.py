...
Stores per-family baselines in artifact/verification-history/:
  artifact/verification-history/<assembly>/<family>/baseline-checksums.json
  artifact/verification-history/<assembly>/<family>/baseline-benchmark.json
...
_DEFAULT_BASELINE_ROOT = _REPO_ROOT / "artifact" / "verification-history"
