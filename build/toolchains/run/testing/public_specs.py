...
PUBLIC_TEST_SPECS = [
    ...
    },
    {
        ...
        "level": "system",
        "primaryModuleId": "roadmap-0",
        "moduleIds": ["roadmap-0"],
        "subsystemIds": ["workflow"],
        "docRefs": ["wiki/06-测试验证/整体验证场景/roadmap-0-platform-gates.md"],
    },
    {
    ...
    },
    {
        ...
        "stages": ["all"],
        "supported_hosts": ["windows"],
        "legacy_commands": {"all": "test-workflow-roadmap-0-windows"},
        "level": "system",
        "primaryModuleId": "roadmap-0",
        "moduleIds": ["roadmap-0"],
        "subsystemIds": ["workflow"],
    ...
    },
    {
        ...
        "stages": ["all"],
        "supported_hosts": ["macos"],
        "legacy_commands": {"all": "test-workflow-roadmap-0-macos"},
        "level": "system",
        "primaryModuleId": "roadmap-0",
        "moduleIds": ["roadmap-0"],
        "subsystemIds": ["workflow"],
