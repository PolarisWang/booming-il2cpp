...
def _project_command_details(command_id: str, host_platform: str) -> dict[str, str]:
    ...
    if command_id == "generate-project-all":
        return {
            ...
            "outputs": "artifact/verification-catalog/workspaces/verification-all.manifest.json | artifact/verification-catalog/workspaces/verification-all.generation.report.json | artifact/verification-catalog/workspaces/subjects/<subject-id>/ | artifact/verification-catalog/workspaces/core/<host>/",
    ...
    if command_id == "generate-project-subject":
        return {
            ...
            "outputs": "artifact/verification-catalog/workspaces/subjects/<subject-id>/<subject-id>.sln | artifact/verification-catalog/workspaces/subjects/<subject-id>/native/<matrix-id>/",
    ...
    if command_id == "build-project-subject":
        return {
            ...
            "outputs": "artifact/verification-catalog/workspaces/subjects/<subject-id>/build.report.json | artifact/verification-catalog/workspaces/subjects/<subject-id>/workspace.manifest.json",
            "target_scope": "默认目标 / 指定目标 / 全部支持目标",
    ...
    if command_id == "generate-project-core":
        return {
            ...
            "outputs": "artifact/verification-catalog/workspaces/core/<host>/chaos-il2cpp-core.sln | artifact/verification-catalog/workspaces/core/<host>/native/<target-id>/",
            "target_scope": "默认目标 / 指定目标 / 全部支持目标",
    ...
    return {
        ...
        "outputs": "artifact/verification-catalog/workspaces/core/<host>/build.report.json | artifact/verification-catalog/workspaces/core/<host>/workspace.manifest.json",
        "target_scope": "默认目标 / 指定目标 / 全部支持目标",
        "host_support": core_targets,
