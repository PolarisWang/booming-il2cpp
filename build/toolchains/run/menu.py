...
COMMAND_TITLE_ALIASES = {
    ...
    "prepare-verify-roadmap-0-windows": "准备 Windows roadmap-0 工作流环境",
    "prepare-verify-roadmap-0-macos": "准备 macOS roadmap-0 工作流环境",
    "clean": "清理统一入口产生的全部输出",
    "clean-smoke": "清理 smoke 测试输出",
    "clean-verify-roadmap0-windows": "清理 Windows roadmap-0 工作流输出",
    "clean-verify-roadmap0-macos": "清理 macOS roadmap-0 工作流输出",
