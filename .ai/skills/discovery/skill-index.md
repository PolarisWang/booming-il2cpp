...
| `testing` | 任务涉及测试框架、subject 定义、测试生成或测试治理时读取本域 registry。 | [testing](./registries/testing.md) | 6 |
| `il2cpp` | 需要开发 il2cpp 翻译逻辑或查询架构路径时读取本域 registry。 | [il2cpp](./registries/il2cpp.md) | 19 |
