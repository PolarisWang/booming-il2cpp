...
| [`dev-il2cpp-abi-expert`](../../library/skills/dev-il2cpp-abi-expert/SKILL.md) | ABI 类型映射、返回类型一致性、跨平台调用约定修改 | il2cpp ABI 专家 — ABI 类型映射、extern C 声明、跨平台调用约定 | 1.0.0 | `00-skills-maintainers` | small | active |
| [`dev-il2cpp-external-runtime-expert`](../../library/skills/dev-il2cpp-external-runtime-expert/SKILL.md) | extern stub 生成、ShapeRegistry 注册、跨程序集路由 | il2cpp 外部运行时专家 — extern stub、ShapeRegistry、跨程序集编译 | 1.0.0 | `00-skills-maintainers` | small | active |
| [`dev-il2cpp-jit-expert`](../../library/skills/dev-il2cpp-jit-expert/SKILL.md) | JIT 编译、寄存器分配、SEH、unwind info、tier promotion、OSR | il2cpp JIT 专家 — 快速 JIT、完整 JIT、分层编译、OSR | 1.0.0 | `00-skills-maintainers` | small | active |
| [`dev-il2cpp-platform-expert`](../../library/skills/dev-il2cpp-platform-expert/SKILL.md) | 跨平台 PAL、CMakePresets、工具链、CI/CD、平台移植 | il2cpp 平台专家 — 跨平台支持、构建系统、工具链配置 | 1.0.0 | `00-skills-maintainers` | small | active |
