...
| `dev-il2cpp-atg-expert` | chunk 的 fact subjects 为 0；Probe 判定逻辑变更；SubjectId 不匹配；generatedMethodId 命名规范修改；metadata.json schema 变更 | AutoTestGenerator 测试合约专家 — Probe 机制、SubjectId 规范、Metadata 管线完整性、测试代码质量门 | 1.0.0 | `00-skills-maintainers` | small | active |
