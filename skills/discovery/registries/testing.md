...
| ----------- | -------- | ---- | ------- | ----- | ------ | ------ |
| [`dev-foundation-dll-ai-test-generation`](../../library/skills/dev-foundation-dll-ai-test-generation/SKILL.md) | 需要生成 foundation DLL 测试代码时；methodSubjectIds 已填充时；baseline AutoGenerated smoke stubs 已存在时 | 为 foundation DLL capability family 生成手写测试代码。 | 1.0.0 | `00-skills-maintainers` | large | active |
