...
| ---- | -------- | -------- | --------- |
| `workflow` | 需要开始、拆解、推进或调试实现任务时先读取本域 registry。 | [workflow](./registries/workflow.md) | 8 |
...
| `il2cpp` | 需要开发 il2cpp 翻译逻辑或查询架构路径时读取本域 registry。 | [il2cpp](./registries/il2cpp.md) | 1 |
| `skilling` | 需要判断该用哪些 skill，或要新建/改造 skill 体系时读取本域 registry。 | [skilling](./registries/skilling.md) | 3 |
